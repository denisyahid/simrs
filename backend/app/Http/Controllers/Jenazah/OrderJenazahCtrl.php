...
class OrderJenazahCtrl extends Controller
{
    use Valet;
    ...
    public function listRuangJenazah(Request $r)
    {
        $res['ruanganLab'] = Ruangan::mine()
            ->where('objectdepartemenfk', $this->settingFix('kdJenazah'))
            ->get();

        return $this->respond($res);
    }
    public function TindakanForJenazah (Request $r)
    {
    ...
    public function listRiwayatOrderJenazah(Request $r){
        $kdProfile =  $this->kdProfile;
        $depLab = $this->settingFix('kdJenazah');
    ...
    public function detailOrderJenazah(Request $r){
        $kdProfile =  $this->kdProfile;
