...
class OrderAmbulanCtrl extends Controller
{
    use Valet;
    ...
    public function listRuangJenazah(Request $r)
    {
        $res['ruanganLab'] = Ruangan::mine()
            ->where('objectdepartemenfk', $this->settingFix('kdAmbulance'))
            ->get();

        return $this->respond($res);
    }
    public function TindakanForAmbulance (Request $r)
    {
    ...
    public function listRiwayatOrderAmbulan(Request $r){
        $kdProfile =  $this->kdProfile;
        $depLab = $this->settingFix('kdAmbulance');
    ...
    public function detailOrderAmbulan(Request $r){
        $kdProfile =  $this->kdProfile;
    ...
    public function hapusOrderAmbulance (Request $request)
    {
        DB::beginTransaction();
        try {
