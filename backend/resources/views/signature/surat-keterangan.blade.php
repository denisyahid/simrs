                ...
                <div class="row text-center">
                    ...
                    @else
                        <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            {{-- @if(isset($key['addmission']))
                            <h5 class="mx-auto text-secondary" style="font-weight: bold;">dibuat oleh admission <span
                                    class="text-dark"
                                    style="font-weight: bold;">{{ strtoupper($key['addmission']) }}</span></h5>
                            @endif --}}
                        </div>
                    @endif
                </div>
