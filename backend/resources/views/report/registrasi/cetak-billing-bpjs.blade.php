                        ...
                        <tr>
                            <td class="text-center" style="text-align: center">
                                <span style="font-size: 12pt; color:#000000">
                                    <a href="#"><b>INVOICE NO.</b><br>{{$res['identitas']->nostruk}}</a>
                                </span>
                            </td>
                        </tr>
                    </table>
            ...
            <td>
                <table width="50%" cellspacing="0" cellpadding="0" style=" border: 1px solid black; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        @else
                            <span class="text-normal">Section</span>
                        @endif
                        </td>
                        <td width="40%" align="left">
                    ...
                    <tr>
                        ...
                        @else
                            <span class="text-normal"><b>Virtual Account</b></span>
                        @endif
                        </td>
                        <td width="40%" align="left" colspan="2">
                            <span class="text-normal">: </span>
                        ...
                        @foreach ($ruangan->groupBy('detailjenisproduk') as $item)
                            <tr  style="font-style:italic">
                                <td colspan="9">
                                    ...
                                    @elseif($res['identitas']->kebangsaan != 1 && $item[0]->detailjenisproduk == 'Tindakan')
                                        <b>Treatments</b>
                                    @else
                                        <b>{{ App\Traits\Valet::english(ucwords($item[0]->detailjenisproduk)) }}</b>
                                    @endif
                                    </span>
                                </td>
                            </tr>
                            ...
                            @foreach ($item as $data)
                                <tr>
                                    ...
                                    @else
                                        <span class="text">{{ App\Traits\Valet::english($data->namaproduk) }}</span>
                                    @endif
                                    </td>
            ...
            <td style="padding-top:10px">
                <table width="50%" cellspacing="0" cellpadding="0" style="border-top:2px solid black;">
                    <tr>
                        ...
                        @else
                            <span class="text-biasa"><b>TO WORD</b> : <br> # {{ ucwords(App\Traits\Valet::english(App\Traits\Valet::static_terbilang($jumlahbill))) }} #</span>
                        @endif
                        </td>
                ...
                <td style="padding-top:20px">
                    <table width="50%" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            @else
                                <span class="text-biasa">Patient</span>
                            @endif
                            </td>
                            <td valign="bottom"width="25%" class="text-center">
                            @if($res['identitas']->kebangsaan == 1)
