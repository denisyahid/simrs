...
<body>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" style="border-bottom: 1px solid black; border-collapse: collapse; padding: 0; page-break-inside: avoid !important;">
        <tr>
        ...
        <tr>
            ...
            <td>
                <span>
                    {{-- {{dd($data)}} --}}
                    {{ $data['tanggalLahirPasien'] . ' / ' . ($data['pasien']['umur']) }}
                </span>
            </td>
        </tr>
        <tr>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" style="border-bottom: 1px solid black; border-collapse: collapse; padding: 0; page-break-inside: avoid !important;">
        <tr>
            <td style="width: 200px;"><span>DIANEAL PD4 1.5%:</span></td>
            <td style="width: 20px;">:</td>
            <td><span>{{ isset($data['dianealPD1']) ? $data['dianealPD1'] : '-' }} bag</span></td>
        </tr>
        <tr>
            <td><span>DIANEAL PD4 2.5%</span></td>
            <td>:</td>
            <td>
                <span>
                    {{-- {{dd($data)}} --}}
                    {{ isset($data['dianealPD2']) ? $data['dianealPD2'] : '-'  }} bag
                </span>
            </td>
        </tr>
        <tr>
            <td><span>DIANEAL PD4 4.25%</span></td>
            <td>:</td>
            <td><span>{{ isset($data['dianealPD4']) ? $data['dianealPD4'] : '-'  }} bag</span></td>
        </tr>
        <tr>
            <td><span>MINICAP</span></td>
            <td>:</td>
            <td><span>{{ isset($data['minicap']) ? $data['minicap'] : '-' }} pcs</span></td>
        </tr>
    </table>
    ...
    <table class="no-page-break" width="100%" cellspacing="0" cellpadding="0"
        ...
        <tr>
            ...
            <td style="text-align: center" width="40%">
                <br>
                <span style="font-weight: bold;">Garut, {{ \Carbon\Carbon::parse($data['created_at'])->format('d F Y') }}</span> <br>
