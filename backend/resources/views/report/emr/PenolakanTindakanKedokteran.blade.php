...
<head>
    <title>Penolakan Tindakan Kedokteran</title>
    <style>
        * {
                ...
                <tr>
                    <td colspan="3" class="border">
                        <table class="fnt">
                            ...
                            <tr>
                                <td>
                                    <b>Peneriman Informasi/Pemberi Penolakan :</b>
                                    {{ isset($d['TBPemberiPersetujuan']) ? $d['TBPemberiPersetujuan'] : '-' }}<br>
                            ...
                            <tr>
                                <td style="padding: 0px;border-top: 0px">
                                    <table>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <b>PENOLAKAN TINDAKAN KEDOKTERAN (AGREEMENT FOR MEDICAL
                                                    ACTION)</b><br>
