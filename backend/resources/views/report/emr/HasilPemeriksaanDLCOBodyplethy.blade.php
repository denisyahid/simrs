...
@section('title')
    @if ($cekWargaNegaraWNA)
        DLCO Examination Results - Bodyplethysmograph
    @else
        Hasil Pemeriksaan DLCO - Bodyplethysmograph
    @endif
@endsection
@section('kode', 'RM 25/SIR/00')
@section('page-style')
    <style>
        body,
        table,
...
@section('content')
        ...
        <tr>
            <td align="center">
                <div style="font-size: 15pt; font-weight: bold; color: #000000;padding:8px">
                    <u> DLCO EXAMINATION RESULTS - BODYPLETHYSMOGRAPH </u><br>
                </div>
            </td>
        </tr>
        <tr>
                ...
                <div style="padding:7px">
                    ...
                    <div style="margin-top: 10px;">
                        <table width="100%">
                            ...
                            <tr>
                                <td width="60%">Height : {{ isset($data['TBSTinggiBadan']) ? $data['TBSTinggiBadan'] : '-' }} Cm</td>
                                <td style="text-align: center" width="40%">
                                    Examining Doctor
                                </td>
                            </tr>
    ...
    @else
        <tr>
            <td align="center">
                <div style="font-size: 15pt; font-weight: bold; color: #000000;padding:8px">
                    <u> HASIL PEMERIKSAAN DLCO - BODYPLETHYSMOGRAPH </u><br>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <div style="padding:7px">
                    ...
                    <div style="margin-top: 10px;">
                        <table width="100%">
                            <tr>
                                <td width="60%">Berat Badan : {{ isset($data['TBSBeratBadan']) ? $data['TBSBeratBadan'] : '-' }} Kg</td>
                                <td style="text-align: center" width="40%">
                                    <br>
                            ...
                            <tr>
                                <td width="60%">Tinggi Badan : {{ isset($data['TBSTinggiBadan']) ? $data['TBSTinggiBadan'] : '-' }} Cm</td>
                                <td style="text-align: center" width="40%">
                                    Dokter Pemeriksa
                                </td>
                            </tr>
