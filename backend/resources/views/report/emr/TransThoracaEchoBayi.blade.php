...
<body>
        ...
        <tbody>
            <tr>
                ...
                <td style="width: 30%; padding: 8px; vertical-align: top;">:
                    {{ isset($data['tglEksaminasi'])
                        ? \Carbon\Carbon::parse($data['tglEksaminasi'])->setTimezone('Asia/Jakarta')->format('d-m-Y')
                        : '-' }}
            ...
            <tr>
                ...
                <td style="padding: 8px; vertical-align: top;">:
                    ...
                    {{ hitungUmur($data['pasien']['tgllahir'], $data['registrasi']['tglregistrasi']) }}</td>
            </tr>
            <tr>
    ...
    <table width="100%" style="margin-top: 10px;">
        <thead>
            <tr style="text-align: start;">
                <td style="width: 120px; font-weight: bold;">AO DIAMETER</td>
                <td style="width: 10px;">:</td>
                <td>{{ $data['aoDiameter'] ?? '-' }}</td>
                <td>mm</td>

                <td style="width: 120px; font-weight: bold;">IVSd</td>
                <td>: {{ $data['ivsd'] ?? '-' }}</td>
                <td>mm</td>

                <td style="width: 120px; font-weight: bold;">MV/EA Ratio</td>
                <td>: {{ $data['mvEaRatio'] ?? '-' }}</td>
                <td></td>
            </tr>
            <tr style="text-align: start;">
                <td style="width: 120px; font-weight: bold;">LA DIAMETER</td>
                <td style="width: 10px;">:</td>
                <td>{{ $data['laDiameter'] ?? '-' }}</td>
                <td>mm</td>

                <td style="width: 120px; font-weight: bold;">LVIDd</td>
                <td>: {{ $data['lvidd'] ?? '-' }}</td>
                <td>mm</td>

                <td style="width: 120px; font-weight: bold;">MV e Spetal</td>
                <td>: {{ $data['mvESpetal'] ?? '-' }}</td>
                <td>cm/s</td>
            </tr>
            <tr style="text-align: start;">
                <td style="width: 120px; font-weight: bold;">EF BIPLANE</td>
                <td style="width: 10px;">:</td>
                <td>{{ $data['efBiplane'] ?? '-' }}</td>
                <td>%</td>

                <td style="width: 120px; font-weight: bold;">LVPWD</td>
                <td>: {{ $data['lvpwd'] ?? '-' }}</td>
                <td>mm</td>

                <td style="width: 120px; font-weight: bold;">MV e Lateral</td>
                <td>: {{ $data['mvELateral'] ?? '-' }}</td>
                <td>cm/s</td>
            </tr>
            <tr style="text-align: start;">
                <td style="width: 120px; font-weight: bold;">IVC MIN</td>
                <td style="width: 10px;">:</td>
                <td>{{ $data['ivcMin'] ?? '-' }}</td>
                <td>mm</td>
                ...
                <td style="width: 120px; font-weight: bold;">E/e¹</td>
                <td>: {{ $data['ee'] ?? '-' }}</td>
                <td></td>
            </tr>
            <tr style="text-align: start;">
                <td style="width: 120px; font-weight: bold;">IVC MAX</td>
                <td style="width: 10px;">:</td>
                <td>{{ $data['ivcMax'] ?? '-' }}</td>
                <td>mm</td>

                <td style="width: 120px; font-weight: bold;">EIF TEICH</td>
                <td>: {{ $data['eifTEICH'] ?? '-' }}</td>
                <td>%</td>

                <td style="width: 120px; font-weight: bold;">PV ACT</td>
                <td>: {{ $data['pvAct'] ?? '-' }}</td>
                <td>m/s</td>
            </tr>
            <tr style="text-align: start;">
                <td style="width: 120px; font-weight: bold;">TAPSE</td>
                <td style="width: 10px;">:</td>
                <td>{{ $data['tapse'] ?? '-' }}</td>
                <td>mm</td>

                <td style="width: 120px; font-weight: bold;">LVMI</td>
                <td>: {{ $data['lvmi'] ?? '-' }}</td>
                <td>g/m²</td>

                <td style="width: 120px; font-weight: bold;">AO VMax</td>
                <td>: {{ $data['aoVMax'] ?? '-' }}</td>
                <td>m/s</td>
            </tr>
        </thead>
    ...
    <table width="100%" style="margin-top: 10px;">
        <tr>
            <td width="100%" align="start">
                <span style="font-size: 10pt;">{{ $data['finding'] ?? '-' }}</span>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" style="margin-top: 10px;">
        <tr>
            <td width="100%" align="start">
                <span style="font-size: 10pt;">{{ $data['conclusion'] ?? '-' }}</span>
            </td>
        </tr>
    </table>
