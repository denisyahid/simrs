    ...
    <table class="table" width="100%" cellspacing="0" cellpadding="8"
        ...
        <tbody>
            <tr>
                ...
                <td style="width: 30%; padding: 8px; vertical-align: top;">:
                    {{ isset($data['jeniskelamin']) ? $data['jeniskelamin'] : '-' }}</td>
            </tr>
            <tr>
    ...
    <table width="100%" style="margin-left: 20px; margin-top: 10px;">
        <thead>
            <tr style="text-align: start;">
                ...
                {{-- <td>{!! isset($data['instrumenUjiFungsi']) ? nl2br(e($data['instrumenUjiFungsi'])) : '-' !!}</td> --}}
            ...
            <tr style="text-align: start;">
                ...
                <td style="width: 10px;">:</td>
                <td>{!! isset($data['hasilYangDidapatkan']) ? nl2br(e($data['hasilYangDidapatkan'])) : '-' !!}</td>
            </tr>
            ...
            <tr style="text-align: start;">
                <td style="width: 120px; font-weight: bold;">EVALUASI</td>
                <td style="width: 10px;">:</td>
                <td>
                    <div class="column is-10 pt-0 pl-0">
                        <input type="checkbox" id="evaluasiMinggu" name="evaluasiMinggu" value="2 minggu"
                            @if (isset($data['evaluasiMinggu']) && $data['evaluasiMinggu'] == '2 minggu') checked @endif>
                        <label for="evaluasiMinggu">
                            <span class="highlighted-label">2 minggu</span>
                        </label><br>

                        <input type="checkbox" id="rujukBalik" name="rujukBalik" value="Rujuk balik"
                            @if (isset($data['evaluasiMinggu']) && $data['evaluasiMinggu'] == 'Rujuk balik') checked @endif>
                        <label for="rujukBalik">
                            <span class="highlighted-label">Rujuk balik</span>
                        </label><br>

                        <input type="checkbox" id="stopTerapi" name="stopTerapi" value="Stop terapi"
                            @if (isset($data['evaluasiMinggu']) && $data['evaluasiMinggu'] == 'Stop terapi') checked @endif>
                        <label for="stopTerapi">
                            <span class="highlighted-label">Stop terapi</span>
                        </label><br>

                        <input type="checkbox" id="evaluasiLain" name="evaluasiLain" value="Lainnya2"
                            @if (isset($data['evaluasiMinggu']) && $data['evaluasiMinggu'] == 'Lainnya2') checked @endif>
                        <label for="evaluasiLain">
                            <span class="highlighted-label">Lainnya</span>
                        </label><br>

                        @if (isset($data['evaluasiLain']) && $data['evaluasiLain'] == 'Lainnya2')
                            {!! isset($data['textLainnya2']) ? nl2br(e($data['textLainnya2'])) : '-' !!}
                        @endif
                    </div>
                </td>
            </tr>
    ...
    <table class="no-page-break" width="100%" cellspacing="0" cellpadding="0"
        ...
        <tr>
            ...
            <td style="text-align: center" width="40%">
                <br>
                {{ date('j-F-Y', strtotime($data['registrasi']['tglregistrasi'])) }} <br>
