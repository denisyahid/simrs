...
<body>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" style="border-bottom: 1px solid black; border-collapse: collapse; padding: 0; page-break-inside: avoid !important;">
        <tr>
            <td style="width: 200px;"><span>Extend Life PD Transfer Set</span></td>
            <td style="width: 20px;">:</td>
            <td><span>{{ isset($data['extendLife']) ? $data['extendLife'] : '-' }}</span></td>
        </tr>
        <tr>
            <td><span>Ultraclamp</span></td>
            <td>:</td>
            <td>
                <span>
                    {{-- {{dd($data)}} --}}
                    {{ isset($data['ultracamp']) ? $data['ultracamp'] : '-'  }}
                </span>
            </td>
        </tr>
        <tr>
            <td><span>T202</span></td>
            <td>:</td>
            <td><span>{{ isset($data['t202']) ? $data['t202'] : '-'  }}</span></td>
        </tr>
        <tr>
            <td><span>Titanium Adaptor</span></td>
            <td>:</td>
            <td><span>{{ isset($data['titanium']) ? $data['titanium'] : '-' }}</span></td>
        </tr>
    </table>
