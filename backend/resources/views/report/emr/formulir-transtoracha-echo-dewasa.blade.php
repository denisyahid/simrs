...
<head>
    ...
    <title>EMR - formulir transtoracha echo dewasa</title>
</head>
            ...
            <td colspan="2">
                <table width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
                    <table width="100%">
                        <tr>
                            <td width="100%" align="center">
                                <span style="font-size: 14pt; font-weight: bold;">FORMULIR TRANSTORACHA ECHO
                                    DEWASA</span>
                            </td>
                        </tr>
                    </table>
                        ...
                        <table width="100%" style="font-weight: bold;">
                            <thead>
                                <tr>
                                    <td>IVC Max</td>
                                    <td style="width: 10px;">:</td>
                                    <td>{{ $data['ivcMaxEchoDewasa'] ?? '' }}</td>
                                    <td>mm</td>
                                </tr>
                                <tr>
                                    <td>Tapse</td>
                                    <td style="width: 10px;">:</td>
                                    <td>{{ $data['tapseEchoDewasa'] ?? '' }}</td>
                                    <td>mm</td>
                                </tr>
                                <tr>
                                    <td>LV MASS</td>
                                    <td style="width: 10px;">:</td>
                                    <td>{{ $data['lvMassEchoDewasa'] ?? '' }}</td>
                                    <td>g</td>
                                </tr>
                            </thead>
                        </table>
                        <table width="100%" style="font-weight: bold;">
                            <thead>
                                <tr>
                                    <td>RWT</td>
                                    <td style="width: 10px;">:</td>
                                    <td>{{ $data['RWTEchoDewasa'] ?? '' }}</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>PV ACT</td>
                                    <td style="width: 10px;">:</td>
                                    <td>{{ $data['pvActEchoDewasa'] ?? '' }}</td>
                                    <td>m/s</td>
                                </tr>
                                <tr>
                                    <td>AO VMax</td>
                                    <td style="width: 10px;">:</td>
                                    <td>{{ $data['aoVMaxEchoDewasa'] ?? '' }}</td>
                                    <td>m/s</td>
                                </tr>
                            </thead>
                        </table>
                    ...
                    <table width="100%" style="font-weight: bold;">
                        <thead>
                            <tr>
                                <td style="width: 300px;">Cardiac Chamber Dimension</td>
                                <td style="width: 10px;">:</td>
                                <td>{{ $data['cardiacChamberDimension'] ?? '' }}</td>
                            </tr>
                            <tr>
                                <td>LNH</td>
                                <td style="width: 10px;">:</td>
                            ...
                            <tr>
                                <td>Systolic LV Function</td>
                                <td style="width: 10px;">:</td>
                                <td>{{ $data['systolicLVFunction'] ?? '' }}</td>
                            </tr>
                            <tr>
                                <td>Diastolic LV Function</td>
                                <td style="width: 10px;">:</td>
                                <td>{{ $data['diastolicLVFunction'] ?? '' }}</td>
                            </tr>
                            <tr>
                                <td>Heart Wave</td>
                                <td style="width: 10px;">:</td>
