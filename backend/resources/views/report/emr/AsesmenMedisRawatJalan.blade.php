...
<head>
    ...
    <?php
        $peristaltikOptions = [
            ...
            ['value' => 2, 'label' => 'Meningkat'],
            ['value' => 3, 'label' => 'Menurun']
        ];
    ...
    ['value' => 1, 'label' => '< 10% BB Biasa'],
    ['value' => 2, 'label' => '> 10% BB Biasa'],
    ];

    $asupanterakhirGizi = [
        ['value' => 0, 'label' => 'Tidak Berubah'],
        ['value' => 1, 'label' => 'Menurun < 50%'],
        ['value' => 2, 'label' => 'Menurun > 50%'],
    ];

    $gangguansaluranGizi = [
        ['value' => 0, 'label' => 'Tidak Ada'],
        ['value' => 1, 'label' => 'Mual, ANOREKSIA'],
        ['value' => 2, 'label' => 'Muntah, Diare'],
    ];

    $kapasitasfungsiGizi = [
        ['value' => 0, 'label' => 'Tidak Berubah'],
        ['value' => 1, 'label' => 'Menurun/sub-optimal 2 Minggu'],
        ['value' => 2, 'label' => 'Bedridden 2 Minggu/lebih'],
    ];

    $stressMetabolikGizi = [
        ['value' => 0, 'label' => 'Ringan'],
    ...
    $pemeriksafisikkGizi = [
        ['value' => 0, 'label' => 'Tidak Ada'],
        ['value' => 1, 'label' => 'Ringan: +1'],
        ['value' => 2, 'label' => 'Sedang: +2'],
        ['value' => 3, 'label' => 'Berat: +3'],
    ];

    $sgaGizi = [
        ['value' => 0, 'label' => 'A(0) status gizi baik'],
        ['value' => 1, 'label' => 'B(1-2) malnutrisi ringan'],
        ['value' => 2, 'label' => 'C(>2) malnutrisi berat'],
    ];

    $imtGizi = [
        ['value' => 0, 'label' => '18,5-25'],
        ['value' => 1, 'label' => '25,1-30'],
        ['value' => 2, 'label' => '<18,5 atau>30'],
    ];

    $albuminGizi = [
        ['value' => 0, 'label' => '>3,4'],
        ['value' => 1, 'label' => '2,5-3,4'],
        ['value' => 2, 'label' => '< 2,5'],
    ];

    $tclGizi = [
        ['value' => 0, 'label' => '>1500'],
        ['value' => 1, 'label' => '900-1500'],
        ['value' => 2, 'label' => '< 1500'],
    ];

    $resikoMalnutrisiGizi = [
        ['value' => 0, 'label' => 'Rendah'],
        ['value' => 1, 'label' => 'Sedang -> kontrol kembali, mengikuti penyakit utamanya'],
        ['value' => 2, 'label' => 'Tinggi -> kontrol setiap minggu'],
    ];
...
$listPI = [
    ...
    $vulvaOptions = [
    ['value' => 1, 'label' => 'Normal'],
    ['value' => 2, 'label' => 'Condiloma'],
    ['value' => 3, 'label' => 'Lesi']
    ];
    $vaginaOptions = [
    ['value' => 1, 'label' => 'Normal'],
    ['value' => 2, 'label' => 'Inlamasi'],
    ...
    <style>
        ...
        .image-top, .image-bottom, .image-top-3 {
            position: absolute;
            width: 100%;
            height: 100%;
        }
...
<body>
    <section style="page-break-after: page;">
        <table>
                    ...
                    <table class="border font">
                        ...
                        <tr>
                            <td colspan="3" style="padding-left: 3px;padding-right: 3px" class="bt">
                                <table>
                                    <tr>
                                        <td style="width:50% word-wrap:break-word; white-space: normal; text-align:justify;;">
                                            Alloanamnesis :
            ...
            @if (!isset($ruangan) || stripos($ruangan, 'PSIKOLOGI') === false && stripos($ruangan, 'OBGYN') === false && stripos($ruangan, 'TRADISIONAL') === false && stripos($ruangan, 'ONKOLOGI RADIASI') === false)
            <tr>
                <td colspan="2">
                    <table class="border font">
                        <tr>
                            <td colspan="3">
                                <table>
                                    ...
                                    <tr>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['kepala']) ? 'checked' : '' }} />
                                            <span>Kepala
                                                {{ isset($data['ketKepala']) ? ': ' . $data['ketKepala'] : '' }}</span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['ubunubun']) ? 'checked' : '' }} />
                                            <span>Ubun-ubun besar
                                                {{ isset($data['ketUbunubun']) ? ': ' . $data['ketUbunubun'] : '' }}</span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['normal']) ? 'checked' : '' }} />
                                            <span>Normal</span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox"
                                    ...
                                    <tr>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['anemis']) ? 'checked' : '' }} />
                                            <span>Anemis
                                        ...
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['pupil']) ? 'checked' : '' }} />
                                            <span>Pupil Isokor
                                                {{ isset($data['ketPupil']) && $data['ketPupil'] == 1 ? ': ' . 'Ya' : ': Tidak' }}</span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['ikterus']) ? 'checked' : '' }} />
                                            <span>Ikterus
                                    ...
                                    <tr>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['hiperemi']) ? 'checked' : '' }} />
                                            <span>Hiperemi
                                                {{ isset($data['ketHiperemi']) && $data['ketHiperemi'] == 1 ? ': ' . 'Ya' : ': Tidak' }}</span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['refleks']) ? 'checked' : '' }} />
                                            <span>Refleks Cahaya
                                                {{ isset($data['ketRefleks']) ? ': ' . $data['ketRefleks'] : '-' }}</span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['refpupil']) ? 'checked' : '' }} />
                                            <span>Refleks Pupil
                                                {{ isset($data['ketIkterus']) ? ': ' . $data['ketIkterus'] : '-' }}
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['secret']) ? 'checked' : '' }} />
                                            <span>Secret
                                    ...
                                    <tr>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['oedema']) ? 'checked' : '' }} />
                                            <span>Oedema
                                                {{ isset($data['ketOedema']) && $data['ketOedema'] == 1 ? ': ' . 'Ya' : ': Tidak' }}</span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['oedemapal']) ? 'checked' : '' }} />
                                            <span>
                                                Oedema Palpebrae
                                        ...
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['skleraik']) ? 'checked' : '' }} />
                                            <span>Sklera Ikteris
                        ...
                        <tr>
                            <td colspan="3">
                                <table>
                                    ...
                                    <tr>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['tonsil']) ? 'checked' : '' }} />
                                            <span>
                                                Tonsil : {{ isset($data['ketTonsil']) ? $data['ketTonsil'] : '' }}
                                            </span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['hidung']) ? 'checked' : '' }} />
                                            <span>
                                                Hidung : {{ isset($data['ketHidung']) ? $data['ketHidung'] : '' }}
                                            </span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['lainlain']) ? 'checked' : '' }} />
                                            <span>
                                                Lain-lain : {{ isset($data['ketLain']) ? $data['ketLain'] : '' }}
                                            </span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['pharing']) ? 'checked' : '' }} />
                                            <span>
                                                Pharing : {{ isset($data['ketPharing']) ? $data['ketPharing'] : '' }}
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['bibir']) ? 'checked' : '' }} />
                                            <span>
                                                Bibir : {{ isset($data['ketBibir']) ? $data['ketBibir'] : '' }}
                                            </span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['lidah']) ? 'checked' : '' }} />
                                            <span>
                                                Lidah : {{ isset($data['ketLidah']) ? $data['ketLidah'] : '' }}
                                            </span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['telinga']) ? 'checked' : '' }} />
                                            <span>
                                                Telinga : {{ isset($data['ketTelinga']) ? $data['ketTelinga'] : '' }}
                                            </span>
                                        </td>
                                        <td style="width: 25%"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['jvp']) ? 'checked' : '' }} />
                                            <span>
                                        ...
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['tunggal']) ? 'checked' : '' }} />
                                            <span>
                                                Tunggal
                                            </span>
                                        </td>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['multiple']) ? 'checked' : '' }} />
                                            <span>
                                                Multiple
                                            </span>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 25%">
                                            <input type="checkbox" {{ isset($data['lainnya']) ? 'checked' : '' }} />
                                            <span>
                                                Lainnya : {{ isset($data['ketLainnya']) ? $data['ketLainnya'] : '' }}
                                            </span>
                                        </td>
                                        <td style="width: 50%" colspan="2">
                                            <input type="checkbox" {{ isset($data['kelenjar']) ? 'checked' : '' }} />
                                            <span>
                                                Pharing : {{ isset($data['ketKelenjar']) ? $data['ketKelenjar'] : '' }}
                                            </span>
                                        </td>
                                        <td style="width: 25%"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="width: 50%" colspan="2">
                                            <input type="checkbox" {{ isset($data['simetris']) ? 'checked' : '' }} />
                                            <span>
                                                Simetris / Asimetris :
                                        ...
                                        <td style="width: 50%" colspan="2">
                                            <input type="checkbox" {{ isset($data['retraksi']) ? 'checked' : '' }} />
                                            <span>
                                                Retraksi
                                                ...
                                                <tr>
                                                    <td style="width: 33%">
                                                        <table>
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['statis']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Inspeksi Statis
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['dinamis']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Inspeksi Dinamis
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['palpasi']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Palpasi: SF
                                                                    </span>
                                                                </td>
                                                    ...
                                                    <td style="width: 33%">
                                                        <table>
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['perkusi']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Perkusi
                                                                    </span>
                                                                </td>
                                                    ...
                                                    <td style="width: 33%">
                                                        <table>
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['auskultasi']) ? 'checked' : '' }} />
                                                                    <span>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['nafas']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Suara Nafas
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['lainnyapulmo']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Lain-lain
                                                                    </span>
                                                                </td>
                                                ...
                                                <tr>
                                                    <td style="width: 33%">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['souffle']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Souffle
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['nyeri']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Nyeri Tekan Lokasi
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['hepar']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Hepar
                                                                    </span>
                                                                </td>
                                                    ...
                                                    <td style="width: 33%">
                                                        <table>
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['distensi']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Distensi
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['ascites']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Ascites
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['lien']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Lien
                                                                    </span>
                                                                </td>
                                                    ...
                                                    <td style="width: 33%">
                                                        <table>
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['meteorismus']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Meteorismus
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['turgor']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Turgor
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 60%">
                                                                    <input type="checkbox" {{ isset($data['massa']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Massa
                                                                    </span>
                                                                </td>
                                                ...
                                                <tr>
                                                    <td style="width: 33%">
                                                        <table>
                                                            <tr>
                                                                <td style="width: 65%">
                                                                    <input type="checkbox" {{ isset($data['Kulit']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Kulit
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 65%">
                                                                    <input type="checkbox" {{ isset($data['genetalia']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Genetalia Eloxterna
                                                                    </span>
                                                                </td>
                                                    ...
                                                    <td style="width: 33%">
                                                        <table>
                                                            <tr>
                                                                <td style="width: 65%">
                                                                    <input type="checkbox" {{ isset($data['pubertasp']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Pubertas Perempuan
                                                                    </span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 65%">
                                                                    <input type="checkbox" {{ isset($data['pubertasl']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Pubertas Laki-Laki
                                                                    </span>
                                                                </td>
                                                    ...
                                                    <td style="width: 33%">
                                                        <table>
                                                            <tr>
                                                                <td style="width: 65%">
                                                                    <input type="checkbox" {{ isset($data['lala']) ? 'checked' : '' }} />
                                                                    <span>
                                                                        Lain-lain
                                                                    </span>
                                                                </td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="image-container">
                                        <img src="{{ $data['Gambar'] }}" width="690px" height="350px" alt="Gambar" class="image-top">
                                        <img src="{{ 'img/odon.png' }}" width="690px" height="370px" alt="Gambar Odon" class="image-bottom">
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <tr>
                            <td>
                                <div class="image-container-4">
                                    <img src="{{ $data['Gambar'] }}" width="500px" height="130px" alt="Gambar" class="image-top">
                                    <img src="{{ 'img/outline-only-body.jpg' }}" width="500px" height="150px" alt="Gambar Tubuh" class="image-bottom">
                                </div>
                ...
                <td colspan="3" class="bt">
                    <table class="border font">
                        ...
                        <tr>
                            <td>
                                <div class="image-container">
                                    <img src="{{ $data['Gambar'] }}" width="500px" height="500px" alt="Gambar" class="image-top">
                                    <img src="{{ 'img/tht-full.png' }}" width="500px" height="500px" alt="Gambar THT" class="image-bottom">
                                </div>
                            </td>
                        </tr>
                        <tr class="bt">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="image-container">
                                                <img src="{{ $data['Gambar'] }}" width="500px" height="130px" alt="Gambar" class="image-top">
                                                <img src="{{ 'img/ginekologifix.png' }}" width="500px" height="150px" alt="Gambar Ginekologi" class="image-bottom">
                                            </div>
                                        </td>
                                    </tr>
                                </table>
            ...
            <tr>
                <td colspan="3" class="bt">
                    <table class="border font">
                        ...
                        <tr>
                            <td colspan="3">
                                <p>{{ isset($data['pemeriksaankhususanak']) ? '' . $data['pemeriksaankhususanak'] : '' }}</p>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table class="border font">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="mb-5">
                                    <p>{{ isset($data['ambulansirehab']) ? '' . $data['ambulansirehab'] : '' }}</p>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <div class="mb-5">
                                    <p>{{ isset($data['penilaiannyerirehab']) ? '' . $data['penilaiannyerirehab'] : '' }}</p>
                                </div>
                            </td>
                            <td>
                                <div class="ml-5">
                                ...
                                <div class="mb-5">
                                    <p>{{ isset($data['resikojatuhrehab']) ? '' . $data['resikojatuhrehab'] : '' }}</p>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="mb-5">
                                    <p>{{ isset($data['balancerehab']) ? '' . $data['balancerehab'] : '' }}</p>
                                </div>
                            </td>
                            <td>
                                <div class="ml-5">
                                ...
                                <div class="mb-5">
                                    <p>{{ isset($data['coordlationrehab']) ? '' . $data['coordlationrehab'] : '' }}</p>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <div class="mb-5">
                                    <p>{{ isset($data['transferrehab']) ? '' . $data['transferrehab'] : '' }}</p>
                                </div>
                            </td>
                            <td>
                                <div class="ml-5">
                    ...
                    <table class="border font">
                        ...
                        <tr>
                            <td>
                                <div class="image-container">
                                    <img src="{{ $data['Gambar'] }}" width="500px" height="130px" alt="Gambar" class="image-top">
                                    <img src="{{ 'img/internafix.png' }}" width="500px" height="150px" alt="Gambar Interna" class="image-bottom">
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            (
                ...
                (stripos($ruangan, 'INTERNA') !== false ||
                stripos($ruangan, 'MEDICAL') !== false) &&
                        ...
                        <tr>
                            <td colspan="4">
                                <table border="1">
                                    ...
                                    <tr>
                                        <td style="text-align:start !important; vertical-align:middle !important;">
                                            {{ $item['caption'] }}
                                        </td>
                                        <td class="fc vac">
                                        ...
                                        @if ($index === 0)
                                            <td rowspan="{{ count($ListPSF) }}" style="font-weight:bold; text-align:left; vertical-align:middle;">
                                                Mandiri (20)<br>
                            ...
                            <td>
                                <table class="mt-7">
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBOnsetAkutdanFluktuatif']) && $data['CBOnsetAkutdanFluktuatif'] == "Ya" ? 'checked' : '' }} />
                                                <span>Ya</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBOnsetAkutdanFluktuatif']) && $data['CBOnsetAkutdanFluktuatif'] == "Tidak" ? 'checked' : '' }} />
                                                <span>Tidak</span>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <td>
                                <table class="mt-7">
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBPikiranTidakTerorganisir']) && $data['CBPikiranTidakTerorganisir'] == "Ya" ? 'checked' : '' }} />
                                                <span>Ya</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBPikiranTidakTerorganisir']) && $data['CBPikiranTidakTerorganisir'] == "Tidak" ? 'checked' : '' }} />
                                                <span>Tidak</span>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <td>
                                <table class="mt-7">
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBInatensi']) && $data['CBInatensi'] == "Ya" ? 'checked' : '' }} />
                                                <span>Ya</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBInatensi']) && $data['CBInatensi'] == "Tidak" ? 'checked' : '' }} />
                                                <span>Tidak</span>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <td>
                                <table class="mt-7">
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBPikiranTidakTerorganisir2']) && $data['CBPikiranTidakTerorganisir2'] == "Ya" ? 'checked' : '' }} />
                                                <span>Ya</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBPikiranTidakTerorganisir2']) && $data['CBPikiranTidakTerorganisir2'] == "Tidak" ? 'checked' : '' }} />
                                                <span>Tidak</span>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <td  colspan="3">
                                <table class="mt-7">
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBDelirium']) ? 'checked' : '' }} />
                ...
                <td colspan="3">
                    <table class="border font-2 btl">
                        <tr>
                            ...
                            <td width="22%">
                                <input type="checkbox" {{ isset($data['alergianestesi']) && $data['alergianestesi'] == 'YA' ? 'checked' : '' }}  />
                                <span>Ya</span>
                                <input type="checkbox" {{ isset($data['alergianestesi']) && $data['alergianestesi'] == 'TIDAK' ? 'checked' : '' }}  />
                                <span>Tidak</span>
                            </td>
                            <td width="28%">
                                <b>Alergi Makanan</b>
                            ...
                            <td width="22%">
                                <input type="checkbox" {{ isset($data['makanananestesi']) && $data['makanananestesi'] == 'YA' ? 'checked' : '' }}  />
                                <span>Ya</span>
                                <input type="checkbox" {{ isset($data['makanananestesi']) && $data['makanananestesi'] == 'TIDAK' ? 'checked' : '' }}  />
                                <span>Tidak</span>
                            </td>
                        </tr>
                        @if ((isset($data['alergianestesi']) && $data['alergianestesi'] == 'YA') || (isset($data['makanananestesi']) && $data['makanananestesi'] == 'YA'))
                            <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['anestesisebelumnya']) && $data['anestesisebelumnya'] == 'YA' ? 'checked' : '' }}  />
                                <span>Ya</span>
                                <input type="checkbox" {{ isset($data['anestesisebelumnya']) && $data['anestesisebelumnya'] == 'TIDAK' ? 'checked' : '' }}  />
                                <span>Tidak</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['mengkonsumsiobat']) && $data['mengkonsumsiobat'] == 'YA' ? 'checked' : '' }}  />
                                <span>Ya</span>
                                <input type="checkbox" {{ isset($data['mengkonsumsiobat']) && $data['mengkonsumsiobat'] == 'TIDAK' ? 'checked' : '' }}  />
                                <span>Tidak</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['riwayatkomplikasi']) && $data['riwayatkomplikasi'] == 'YA' ? 'checked' : '' }}  />
                                <span>Ya</span>
                                <input type="checkbox" {{ isset($data['riwayatkomplikasi']) && $data['riwayatkomplikasi'] == 'TIDAK' ? 'checked' : '' }}  />
                                <span>Tidak</span>
                            </td>
                            <td>
                                <b>Kebiasaan</b>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['merokok']) && $data['merokok'] == 'Merokok' ? 'checked' : '' }}  />
                                <span>Merokok</span>
                                <input type="checkbox" {{ isset($data['alkohol']) && $data['alkohol'] == 'Alkohol' ? 'checked' : '' }}  />
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <span>Asthma</span>
                                <input type="checkbox" {{ isset($data['bronchitis']) && $data['bronchitis'] == 'Bronchitis' ? 'checked' : '' }}  />
                                <span>Bronchitis</span>
                                <input type="checkbox" {{ isset($data['recent']) && $data['recent'] == 'Recent URI' ? 'checked' : '' }}  />
                                <span>Recent URI</span>
                                <input type="checkbox" {{ isset($data['copd']) && $data['copd'] == 'COPD' ? 'checked' : '' }}  />
                                <span>COPD</span>
                                <input type="checkbox" {{ isset($data['sob']) && $data['sob'] == 'SOB' ? 'checked' : '' }}  />
                                <span>SOB</span>
                                <input type="checkbox" {{ isset($data['dyspepsia']) && $data['dyspepsia'] == 'Duspepsia' ? 'checked' : '' }}  />
                                <span>Duspepsia</span>
                                <input type="checkbox" {{ isset($data['wnlrespiratory']) && $data['wnlrespiratory'] == 'WNLRespiratory' ? 'checked' : '' }}  />
                                <span>WNL</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['tuberculosis']) && $data['tuberculosis'] == 'Tuberculosis' ? 'checked' : '' }}  />
                                <span>Tuberculosis</span>
                                <input type="checkbox" {{ isset($data['arthopnea']) && $data['arthopnea'] == 'Arthopnea' ? 'checked' : '' }}  />
                                <span>Arthopnea</span>
                                <input type="checkbox" {{ isset($data['pneumonia']) && $data['pneumonia'] == 'Pneumonia' ? 'checked' : '' }}  />
                                <span>Pneumonia</span>
                                <input type="checkbox" {{ isset($data['productive']) && $data['productive'] == 'Productive Cough' ? 'checked' : '' }}  />
                        ...
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['hypertensi']) && $data['hypertensi'] == 'Hypertensi' ? 'checked' : '' }}  />
                                <span>Hypertensi</span>
                                <input type="checkbox" {{ isset($data['angina']) && $data['angina'] == 'Angina' ? 'checked' : '' }}  />
                                <span>Angina</span>
                                <input type="checkbox" {{ isset($data['mi']) && $data['mi'] == 'MI' ? 'checked' : '' }}  />
                                <span>MI</span>
                                <input type="checkbox" {{ isset($data['ashd']) && $data['ashd'] == 'ASHD' ? 'checked' : '' }}  />
                                <span>ASHD</span>
                                <input type="checkbox" {{ isset($data['murmur']) && $data['murmur'] == 'Murmur' ? 'checked' : '' }}  />
                                <span>Murmur</span>
                                <input type="checkbox" {{ isset($data['chf']) && $data['chf'] == 'CHF' ? 'checked' : '' }}  />
                                <span>CHF</span>
                                <input type="checkbox" {{ isset($data['wnlcardiovascular']) && $data['wnlcardiovascular'] == 'WNLCardiovascular' ? 'checked' : '' }}  />
                                <span>WNL</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['pacemaker']) && $data['pacemaker'] == 'Pacemaker' ? 'checked' : '' }}  />
                                <span>Pacemaker</span>
                                <input type="checkbox" {{ isset($data['dysrhythmia']) && $data['dysrhythmia'] == 'Dysrhythmia' ? 'checked' : '' }}  />
                                <span>Dysrhythmia</span>
                                <input type="checkbox" {{ isset($data['rheumatic']) && $data['rheumatic'] == 'Rheumatic' ? 'checked' : '' }}  />
                                <span>Rheumatic Fever</span>
                                <input type="checkbox" {{ isset($data['abnormal']) && $data['abnormal'] == 'Abnormal' ? 'checked' : '' }}  />
                                <span>Abnormal EKG</span>
                                <input type="checkbox" {{ isset($data['exercise']) && $data['exercise'] == 'Exercise' ? 'checked' : '' }}  />
                        ...
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['bowel']) && $data['bowel'] == 'Bowel' ? 'checked' : '' }}  />
                                <span>Bowel obstruction</span>
                                <input type="checkbox" {{ isset($data['hiatal']) && $data['hiatal'] == 'Hiatal' ? 'checked' : '' }}  />
                                <span>Hiatal hernia / reflux</span>
                                <input type="checkbox" {{ isset($data['ucer']) && $data['ucer'] == 'Ucer' ? 'checked' : '' }}  />
                                <span>Ucer</span>
                                <input type="checkbox" {{ isset($data['chrrosis']) && $data['chrrosis'] == 'Chrrosis' ? 'checked' : '' }}  />
                                <span>Chrrosis</span>
                                <input type="checkbox" {{ isset($data['nausea']) && $data['nausea'] == 'Nausea & Vormiting' ? 'checked' : '' }}  />
                                <span>Nausea & Vormiting</span>
                                <input type="checkbox" {{ isset($data['jaundice']) && $data['jaundice'] == 'Jaundice' ? 'checked' : '' }}  />
                                <span>Hepatitis/Jaundice</span>
                                <input type="checkbox" {{ isset($data['wnlhepato']) && $data['wnlhepato'] == 'WNLHepato' ? 'checked' : '' }}  />
                                <span>WNL</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['diabetes']) && $data['diabetes'] == 'Diabetes' ? 'checked' : '' }}  />
                                <span>Diabetes</span>
                                <input type="checkbox" {{ isset($data['thyroid']) && $data['thyroid'] == 'Thyroid' ? 'checked' : '' }}  />
                                <span>Thyroid Disease</span>
                                <input type="checkbox" {{ isset($data['renal']) && $data['renal'] == 'Renal' ? 'checked' : '' }}  />
                                <span>Renal Failure / Dalysis</span>
                                <input type="checkbox" {{ isset($data['weight']) && $data['weight'] == 'Weight Loss/ Gain' ? 'checked' : '' }}  />
                                <span>Weight Loss/ Gain</span>
                                <input type="checkbox" {{ isset($data['dysrythmiarenal']) && $data['dysrythmiarenal'] == 'Dysrythmia' ? 'checked' : '' }}  />
                                <span>Dysrythmia</span>
                                <input type="checkbox" {{ isset($data['urinary']) && $data['urinary'] == 'Urinary tract infection' ? 'checked' : '' }}  />
                                <span>Urinary tract infection</span>
                                <input type="checkbox" {{ isset($data['wnlrenal']) && $data['wnlrenal'] == 'WNLRenal' ? 'checked' : '' }}  />
                                <span>WNL</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['arteitis']) && $data['arteitis'] == 'Arteitis' ? 'checked' : '' }}  />
                                <span>Arteitis</span>
                                <input type="checkbox" {{ isset($data['muscule']) && $data['muscule'] == 'Muscule' ? 'checked' : '' }}  />
                                <span>Muscule</span>
                                <input type="checkbox" {{ isset($data['weaknes']) && $data['weaknes'] == 'Weaknes' ? 'checked' : '' }}  />
                                <span>Weaknes</span>
                                <input type="checkbox" {{ isset($data['DJD']) && $data['DJD'] == 'DJD' ? 'checked' : '' }}  />
                                <span>DJD</span>
                                <input type="checkbox" {{ isset($data['seizures']) && $data['seizures'] == 'Seizures' ? 'checked' : '' }}  />
                                <span>Seizures</span>
                                <input type="checkbox" {{ isset($data['backproblems']) && $data['backproblems'] == 'Back problems' ? 'checked' : '' }}  />
                                <span>Back problems</span>
                                <input type="checkbox" {{ isset($data['wnlback']) && $data['wnlback'] == 'WNLBack' ? 'checked' : '' }}  />
                                <span>WNL</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['neuromuscular']) && $data['neuromuscular'] == 'Neuromuscular' ? 'checked' : '' }}  />
                                <span>Neuromuscular dis paralys</span>
                                <input type="checkbox" {{ isset($data['cva']) && $data['cva'] == 'CVA / strok / VIA' ? 'checked' : '' }}  />
                                <span>CVA / strok / VIA</span>
                                <input type="checkbox" {{ isset($data['paresthesia']) && $data['paresthesia'] == 'Paresthesia' ? 'checked' : '' }}  />
                                <span>Paresthesia</span>
                                <input type="checkbox" {{ isset($data['syncope']) && $data['syncope'] == 'Syncope' ? 'checked' : '' }}  />
                                <span>Syncope</span>
                                <input type="checkbox" {{ isset($data['headaches']) && $data['headaches'] == 'Headaches' ? 'checked' : '' }}  />
                                <span>Headaches/ICP</span>
                                <input type="checkbox" {{ isset($data['consiousness']) && $data['consiousness'] == 'Loss of consiousness' ? 'checked' : '' }}  />
                        ...
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['anemia']) && $data['anemia'] == 'Anemia' ? 'checked' : '' }}  />
                                <span>Anemia</span>
                                <input type="checkbox" {{ isset($data['immunosuppresed']) && $data['immunosuppresed'] == 'Immunosuppresed' ? 'checked' : '' }}  />
                                <span>Immunosuppresed</span>
                                <input type="checkbox" {{ isset($data['bleeding']) && $data['bleeding'] == 'Bleeding tendencies' ? 'checked' : '' }}  />
                                <span>Bleeding tendencies</span>
                                <input type="checkbox" {{ isset($data['pregnancy']) && $data['pregnancy'] == 'Pregnancy' ? 'checked' : '' }}  />
                                <span>Pregnancy</span>
                                <input type="checkbox" {{ isset($data['cancer']) && $data['cancer'] == 'Cancer' ? 'checked' : '' }}  />
                                <span>Cancer</span>
                                <input type="checkbox" {{ isset($data['sickie']) && $data['sickie'] == 'Sickie cell dis / trait' ? 'checked' : '' }}  />
                                <span>Sickie cell dis / trait</span>
                                <input type="checkbox" {{ isset($data['wnlother']) && $data['wnlother'] == 'WNLOther' ? 'checked' : '' }}  />
                                <span>WNL</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['chemotherapy']) && $data['chemotherapy'] == 'Chemotherapy' ? 'checked' : '' }}  />
                                <span>Chemotherapy</span>
                                <input type="checkbox" {{ isset($data['steroids']) && $data['steroids'] == 'Recent steroids' ? 'checked' : '' }}  />
                                <span>Recent steroids</span>
                                <input type="checkbox" {{ isset($data['dehydration']) && $data['dehydration'] == 'Dehydration' ? 'checked' : '' }}  />
                                <span>Dehydration</span>
                                <input type="checkbox" {{ isset($data['transfusion']) && $data['transfusion'] == 'Tranfusion history' ? 'checked' : '' }}  />
                                <span>Tranfusion history</span>
                                <input type="checkbox" {{ isset($data['hemophilia']) && $data['hemophilia'] == 'Hemophilia' ? 'checked' : '' }}  />
                            ...
                            <td colspan="3">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBimt']) && $data['CBimt'] == "(0) < 19" ? 'checked' : '' }} />
                                                <span>(0) &lt; 19</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBimt']) && $data['CBimt'] == "(1) 19-21" ? 'checked' : '' }} />
                                                <span>(1) 19-21</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBimt']) && $data['CBimt'] == "(2) 21-23" ? 'checked' : '' }} />
                                                <span>(2) 21-23</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBimt']) && $data['CBimt'] == "(3) >23" ? 'checked' : '' }} />
                                                <span>(3) >23</span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBlingkarLenganAtas']) && $data['CBlingkarLenganAtas'] == "(0) <21" ? 'checked' : '' }} />
                                                <span>(0) &lt; 21</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBlingkarLenganAtas']) && $data['CBlingkarLenganAtas'] == "(0,5) 21-22" ? 'checked' : '' }} />
                                                <span>(0,5) 21-22</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBlingkarLenganAtas']) && $data['CBlingkarLenganAtas'] == "(1) >22" ? 'checked' : '' }} />
                                                <span>(1) >22</span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBlingkarBetis']) && $data['CBlingkarBetis'] == "(0) ≤31" ? 'checked' : '' }} />
                                                <span>(0) <span class="logo">≤</span>31</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBlingkarBetis']) && $data['CBlingkarBetis'] == "(1) >31" ? 'checked' : '' }} />
                                                <span>(1) >31</span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBbbSelama3bulan']) && $data['CBbbSelama3bulan'] == "(0) Kehilangan > 3kg" ? 'checked' : '' }} />
                                                <span>(0) Kehilangan > 3kg</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBbbSelama3bulan']) && $data['CBbbSelama3bulan'] == "(1) Tidak tahu" ? 'checked' : '' }} />
                                                <span>(1) Tidak tahu</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBbbSelama3bulan']) && $data['CBbbSelama3bulan'] == "(2) Kehilangan antara 1-3kg" ? 'checked' : '' }} />
                                                <span>(2) Kehilangan antara 1-3kg</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBbbSelama3bulan']) && $data['CBbbSelama3bulan'] == "(3) Tidak kehilangan BB" ? 'checked' : '' }} />
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBhidupTidakTergantung']) && $data['CBhidupTidakTergantung'] == "(0) Ya" ? 'checked' : '' }} />
                                                <span>(0) Ya</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBhidupTidakTergantung']) && $data['CBhidupTidakTergantung'] == "(1) Tidak" ? 'checked' : '' }} />
                                                <span>(1) Tidak</span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBmenggunakanLebihDari3JenisObat']) && $data['CBmenggunakanLebihDari3JenisObat'] == "(0) Ya" ? 'checked' : '' }} />
                                                <span>(0) Ya</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBmenggunakanLebihDari3JenisObat']) && $data['CBmenggunakanLebihDari3JenisObat'] == "(1) Tidak" ? 'checked' : '' }} />
                                                <span>(1) Tidak</span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <p>7. Mengalami stress psikologis atau penyakit akut dalam 3 bulan terakhir</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBmengalamiStressPsikologis']) && $data['CBmengalamiStressPsikologis'] == "(0) Ya" ? 'checked' : '' }} />
                                                <span>(0) Ya</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBmengalamiStressPsikologis']) && $data['CBmengalamiStressPsikologis'] == "(1) Tidak" ? 'checked' : '' }} />
                                                <span>(1) Tidak</span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBmobilitas']) && $data['CBmobilitas'] == "(0) Hanya terbaring/di atas kursi roda" ? 'checked' : '' }} />
                                                <span>(0) Hanya terbaring/di atas kursi roda</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBmobilitas']) && $data['CBmobilitas'] == "(1) Bisa bangkit dari tempat tidur tapi tidak keluar rumah" ? 'checked' : '' }} />
                                                <span>(1) Bisa bangkit dari tempat tidur tapi tidak keluar rumah</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBmobilitas']) && $data['CBmobilitas'] == "(2) Bisa keluar rumah" ? 'checked' : '' }} />
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBmasalahNeuropsikologis']) && $data['CBmasalahNeuropsikologis'] == "(0) Demensia berat dan depresi" ? 'checked' : '' }} />
                                                <span>(0) Demensia berat dan depresi</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBmasalahNeuropsikologis']) && $data['CBmasalahNeuropsikologis'] == "(1) Demensia ringan" ? 'checked' : '' }} />
                                                <span>(1) Demensia ringan</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBmasalahNeuropsikologis']) && $data['CBmasalahNeuropsikologis'] == "(2) Tidak ada masalah psikologis" ? 'checked' : '' }} />
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBnyeriTekanLukaKulit']) && $data['CBnyeriTekanLukaKulit'] == "(0) Ya" ? 'checked' : '' }} />
                                                <span>(0) Ya</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBnyeriTekanLukaKulit']) && $data['CBnyeriTekanLukaKulit'] == "(1) Tidak" ? 'checked' : '' }} />
                                                <span>(1) Tidak</span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBjumlahDagingYangDikonsumsi']) && $data['CBjumlahDagingYangDikonsumsi'] == "(0) 1x makan" ? 'checked' : '' }} />
                                                <span>(0) 1x makan</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBjumlahDagingYangDikonsumsi']) && $data['CBjumlahDagingYangDikonsumsi'] == "(1) 2x makan" ? 'checked' : '' }} />
                                                <span>(1) 2x makan</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBjumlahDagingYangDikonsumsi']) && $data['CBjumlahDagingYangDikonsumsi'] == "(2) 3x makan" ? 'checked' : '' }} />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBminimal1xPenyajian']) && $data['CBminimal1xPenyajian'] == "(0) Tidak" ? 'checked' : '' }} />
                                                <span>(0) Tidak</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBminimal1xPenyajian']) && $data['CBminimal1xPenyajian'] == "(1) Ya" ? 'checked' : '' }} />
                                                <span>(1) Ya</span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <div>
                                                b. Dua atau lebih penyajian produk kacang-kacangan dan telur per minggu
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBduaAtauLebihPenyajian']) && $data['CBduaAtauLebihPenyajian'] == "(0) Tidak" ? 'checked' : '' }} />
                                                <span>(0) Tidak</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBduaAtauLebihPenyajian']) && $data['CBduaAtauLebihPenyajian'] == "(1) Ya" ? 'checked' : '' }} />
                                                <span>(1) Ya</span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBdagingIkanUnggas']) && $data['CBdagingIkanUnggas'] == "(0) Tidak" ? 'checked' : '' }} />
                                                <span>(0) Tidak</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBdagingIkanUnggas']) && $data['CBdagingIkanUnggas'] == "(1) Ya" ? 'checked' : '' }} />
                                                <span>(1) Ya</span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBKonsumsi2ataulebihPenyajianSayur']) && $data['CBKonsumsi2ataulebihPenyajianSayur'] == "(0) Tidak" ? 'checked' : '' }} />
                                                <span>(0) Tidak</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBKonsumsi2ataulebihPenyajianSayur']) && $data['CBKonsumsi2ataulebihPenyajianSayur'] == "(1) Ya" ? 'checked' : '' }} />
                                                <span>(1) Ya</span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <div>
                                                14. Asupan makanan dalam 3 bulan terakhir (kehilangan nafsu makan)
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBAsupanMakananDalam3BulanTerakhir']) && $data['CBAsupanMakananDalam3BulanTerakhir'] == "(0) Berat" ? 'checked' : '' }} />
                                                <span>(0) Berat</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBAsupanMakananDalam3BulanTerakhir']) && $data['CBAsupanMakananDalam3BulanTerakhir'] == "(1) Sedang" ? 'checked' : '' }} />
                                                <span>(1) Sedang</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBAsupanMakananDalam3BulanTerakhir']) && $data['CBAsupanMakananDalam3BulanTerakhir'] == "(2) Ringan" ? 'checked' : '' }} />
                                                <span>(2) Ringan</span>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBJumlahCairanYangDikonsumsi']) && $data['CBJumlahCairanYangDikonsumsi'] == "(0) <3 cangkir" ? 'checked' : '' }} />
                                                <span>(0) &lt;3 cangkir</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBJumlahCairanYangDikonsumsi']) && $data['CBJumlahCairanYangDikonsumsi'] == "(0,5) 3-5 cangkir" ? 'checked' : '' }} />
                                                <span>(0,5) 3-5 cangkir</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBJumlahCairanYangDikonsumsi']) && $data['CBJumlahCairanYangDikonsumsi'] == "(1) >5 cangkir" ? 'checked' : '' }} />
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBpolaMakan']) && $data['CBpolaMakan'] == "(0) Tidak bisa makan tanpa bantuan" ? 'checked' : '' }} />
                                                <span>(0) Tidak bisa makan tanpa bantuan</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBpolaMakan']) && $data['CBpolaMakan'] == "(1) Makan sendiri dengan sedikit kesulitan" ? 'checked' : '' }} />
                                                <span>(1) Makan sendiri dengan sedikit kesulitan</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBpolaMakan']) && $data['CBpolaMakan'] == "(2) Makan sendiri tanpa kesulitan" ? 'checked' : '' }} />
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBapakahPasienMerasakanMasalahGizi']) && $data['CBapakahPasienMerasakanMasalahGizi'] == "(0) Malntrisi" ? 'checked' : '' }} />
                                                <span>(0) Malntrisi</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBapakahPasienMerasakanMasalahGizi']) && $data['CBapakahPasienMerasakanMasalahGizi'] == "(1) Tidak tahu/malnutrisi sedang" ? 'checked' : '' }} />
                                                <span>(1) Tidak tahu/malnutrisi sedang</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBapakahPasienMerasakanMasalahGizi']) && $data['CBapakahPasienMerasakanMasalahGizi'] == "(2) Tidak ada masalah gizi" ? 'checked' : '' }} />
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <div>
                                                18. Penilaian pasien terhadap kesehatannya bil dibandingkan dengan kelompok usia yang sama
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBpenilaianPasienTerhadapKesehatannya']) && $data['CBpenilaianPasienTerhadapKesehatannya'] == "(0) tidak baik" ? 'checked' : '' }} />
                                                <span>(0) tidak baik</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBpenilaianPasienTerhadapKesehatannya']) && $data['CBpenilaianPasienTerhadapKesehatannya'] == "(0,5) Tidak tahu" ? 'checked' : '' }} />
                                                <span>(0,5) Tidak tahu</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBpenilaianPasienTerhadapKesehatannya']) && $data['CBpenilaianPasienTerhadapKesehatannya'] == "(1) Sama baik" ? 'checked' : '' }} />
                                                <span>(1) Sama baik</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBpenilaianPasienTerhadapKesehatannya']) && $data['CBpenilaianPasienTerhadapKesehatannya'] == "(2) Lebih baik" ? 'checked' : '' }} />
                            ...
                            <td colspan="3">
                                <table>
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBtotalSkorPenilaianStatusNutrisi']) && $data['CBtotalSkorPenilaianStatusNutrisi'] == "Normal (Skor Penapisan ≥24)" ? 'checked' : '' }} />
                                                <span>Normal (Skor Penapisan <span class="logo">&ge;</span> 24)<span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBtotalSkorPenilaianStatusNutrisi']) && $data['CBtotalSkorPenilaianStatusNutrisi'] == "Berisiko Malnutrisi (Skor Pengkajian 17-23,5)  " ? 'checked' : '' }} />
                                                <span>Berisiko Malnutrisi (Skor Pengkajian 17-23,5)  </span>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                                <input type="checkbox" {{ isset($data['CBtotalSkorPenilaianStatusNutrisi']) && $data['CBtotalSkorPenilaianStatusNutrisi'] == "Malnutrisi (Skor Pengkajian <17)" ? 'checked' : '' }} />
            ...
            <tr>
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            <td colspan="4">
                                <span style="white-space: pre-line;">(5) Sekarang (hari),(tanggal),(bulan),(tahun) berapa,(musim) apa?
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <span>
                                    (5) Hitunglah berturut-turut selang 7 mulai dari 100 ke bawah. Berilah 1 angka untuk tiap jawaban yang benar. Berhenti setelah 5 hitungan (93,86,79,72,65). Kemungkinan lain, ejalah kata “dunia” dari akhir ke awal (a-i-n-u-d)
                                </span>
                                <div>
                                    <b>4. MENGINGAT</b>
                                </div>
                        ...
                        <tr>
                            <td colspan="4">
                                <img src="{{ 'img/AAM_Geriatri.png' }}" width="200" alt="Gambar Geriatri">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['CBSkorPenapisanKognitif']) && $data['CBSkorPenapisanKognitif'] == 'Normal (25 – 30)' ? 'checked' : '' }} />
                                <span>Normal (25 – 30)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBSkorPenapisanKognitif']) && $data['CBSkorPenapisanKognitif'] == 'Gangguan Kognitif ringan (MCI) (20 – 25)' ? 'checked' : '' }} />
                                <span>Gangguan Kognitif ringan (MCI) (20 – 25)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBSkorPenapisanKognitif']) && $data['CBSkorPenapisanKognitif'] == 'Gangguan kognitif pasti (< 20)' ? 'checked' : '' }} />
                                <span>Gangguan kognitif pasti (<span class="logo">&lt;</span> 20)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBSkorPenapisanKognitif']) && $data['CBSkorPenapisanKognitif'] == 'Tidak dapat dievaluasi' ? 'checked' : '' }} />
            ...
            <tr>
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['CBnormalPenapisanDepresi']) && $data['CBnormalPenapisanDepresi'] == 'Normal (0-9)' ? 'checked' : '' }} />
                                <span>Normal (0-9)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBdepresiRinganPenapisanDepresi']) && $data['CBdepresiRinganPenapisanDepresi'] == 'Depresi Ringan (10 – 19)' ? 'checked' : '' }} />
                                <span>Depresi Ringan (10 – 19)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBdepresiBeratPenapisanDepresi']) && $data['CBdepresiBeratPenapisanDepresi'] == 'Depresi berat (20 – 30)' ? 'checked' : '' }} />
                                <span>Depresi berat (20 – 30)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBtidakDapatDievaluasiPenapisanDepresi']) && $data['CBtidakDapatDievaluasiPenapisanDepresi'] == 'Tidak dapat dievaluasi' ? 'checked' : '' }} />
                                <span>Tidak dapat dievaluasi</span>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['CBtotalSkorPI']) && $data['CBtotalSkorPI'] == 'Tidak ada inkontinensia (0)' ? 'checked' : '' }} />
                                <span>Tidak ada inkontinensia (0)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBtotalSkorPI']) && $data['CBtotalSkorPI'] == 'Inkontinensia ringan (1 – 2.5)' ? 'checked' : '' }} />
                                <span>Inkontinensia ringan (1 – 2.5)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBtotalSkorPI']) && $data['CBtotalSkorPI'] == 'I. sedang (4 – 6.5)' ? 'checked' : '' }} />
                                <span>I. sedang (4 – 6.5)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBtotalSkorPI']) && $data['CBtotalSkorPI'] == 'I. berat (≥ 8)' ? 'checked' : '' }} />
            ...
            <tr>
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['CBtotalSkorPDVT']) && $data['CBtotalSkorPDVT'] == 'Risiko rendah (< 1)' ? 'checked' : '' }} />
                                <span>Risiko rendah (<span class="logo"><</span> 1)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBtotalSkorPDVT']) && $data['CBtotalSkorPDVT'] == 'Risiko sedang (1 – 2)' ? 'checked' : '' }} />
                                <span>Risiko sedang (1 – 2)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBtotalSkorPDVT']) && $data['CBtotalSkorPDVT'] == 'Risiko tinggi (> 3)' ? 'checked' : '' }} />
                        ...
                        <tr>
                            <td colspan="4">
                                <span style="white-space: pre-line;">
                                    ...
                                    Stadium I : Eritema nonblanchable pada kulit yang masih utuh atau perubahan warna kulit yang hangat, edema, dan berindurasi pada pasien dengan kulit gelap
            ...
            <tr>
                <td colspan="3">
                    <table class="border font">
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['CBSkorPenapisanInsomnia']) && $data['CBSkorPenapisanInsomnia'] == 'Tidak Insomnia (0-7)' ? 'checked' : '' }} />
                                <span>Tidak Insomnia (0-7)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBSkorPenapisanInsomnia']) && $data['CBSkorPenapisanInsomnia'] == 'Borderline Insomnia (8-14)' ? 'checked' : '' }} />
                                <span>Borderline Insomnia (8-14)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBSkorPenapisanInsomnia']) && $data['CBSkorPenapisanInsomnia'] == 'Insomnia Sedang (15-21)' ? 'checked' : '' }} />
                                <span>Insomnia Sedang (15-21)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBSkorPenapisanInsomnia']) && $data['CBSkorPenapisanInsomnia'] == 'Insomnia Berat (22-28)' ? 'checked' : '' }} />
                ...
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBFallsIFRJ']) && $data['CBFallsIFRJ'] == '≥ 3 kali' ? 'checked' : '' }} />
                                <span><span class="logo">≥</span> 3 kali</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBFallsIFRJ']) && $data['CBFallsIFRJ'] == '1-2 kali' ? 'checked' : '' }} />
                                <span>1-2 kali</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBFallsIFRJ']) && $data['CBFallsIFRJ'] == 'saat ini' ? 'checked' : '' }} />
                                <span>saat ini</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBFallsIFRJ']) && $data['CBFallsIFRJ'] == 'tidak pernah' ? 'checked' : '' }} />
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBTotalSkorMorseIFRJ']) && $data['CBTotalSkorMorseIFRJ'] == 'Risiko rendah (0-7)' ? 'checked' : '' }} />
                                <span>Risiko rendah (0-7)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBTotalSkorMorseIFRJ']) && $data['CBTotalSkorMorseIFRJ'] == 'Risiko tinggi (8-13)' ? 'checked' : '' }} />
                                <span>Risiko tinggi (8-13)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBTotalSkorMorseIFRJ']) && $data['CBTotalSkorMorseIFRJ'] == 'Risiko sangat tinggi (≥14)' ? 'checked' : '' }} />
            ...
            <tr>
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['CBPenurunanbbIF']) && $data['CBPenurunanbbIF'] == 'Penurunan berat badan yang progresif (1)' ? 'checked' : '' }} />
                                <span>Penurunan berat badan yang progresif (1)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBifSkor']) && $data['CBifSkor'] == 'Non frail (0)' ? 'checked' : '' }} />
                                <span>Non frail (0)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBifSkor']) && $data['CBifSkor'] == 'Pre frail (1-2)' ? 'checked' : '' }} />
                                <span>Pre frail (1-2)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBifSkor']) && $data['CBifSkor'] == 'Frailty (≥3)' ? 'checked' : '' }} />
                                <span>Frailty (<span class="logo">≥</span>3)</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['CBEnergidanEnduranceIF']) && $data['CBEnergidanEnduranceIF'] == 'Energi dan endurance yang lemah (1)' ? 'checked' : '' }} />
                                <span>Energi dan endurance yang lemah (1)</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['CBKecepatanBerjalanMelambatIF']) && $data['CBKecepatanBerjalanMelambatIF'] == 'Kecepatan berjalan melambat (1)' ? 'checked' : '' }} />
                                <span>Kecepatan berjalan melambat (1)</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['CBKeletihanatauDayatahanMenurunIF']) && $data['CBKeletihanatauDayatahanMenurunIF'] == 'Keletihan atau daya tahan menurun (1)' ? 'checked' : '' }} />
                                <span>Keletihan atau daya tahan menurun (1)</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['CBTingkatAktivitasFisikyangRendahIF']) && $data['CBTingkatAktivitasFisikyangRendahIF'] == 'Tingkat aktivitas fisik yang rendah (1)' ? 'checked' : '' }} />
            ...
            <tr>
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['CBPenurunanbbIFTT']) && $data['CBPenurunanbbIFTT'] == 'Penurunan berat badan >5% dari berat badan awal (1)' ? 'checked' : '' }} />
                                <span>Penurunan berat badan <span class="logo">></span>5% dari berat badan awal (1)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBifttSkor']) && $data['CBifttSkor'] == 'Tidak (<4)' ? 'checked' : '' }} />
                                <span>Tidak (<span class="logo"><</span>4)</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBifttSkor']) && $data['CBifttSkor'] == 'FailureTo Thrive (4)' ? 'checked' : '' }} />
                                <span>FailureTo Thrive (4)</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <input type="checkbox" {{ isset($data['CBPenurunanNafsuIFTT']) && $data['CBPenurunanNafsuIFTT'] == 'Penurunan nafsu makan (1)' ? 'checked' : '' }} />
                                <span>Penurunan nafsu makan (1)</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <input type="checkbox" {{ isset($data['CBMalnutrisiIFTT']) && $data['CBMalnutrisiIFTT'] == 'Malnutrisi (1)' ? 'checked' : '' }} />
                                <span>Malnutrisi (1)</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <input type="checkbox" {{ isset($data['CBImobilitasIFTT']) && $data['CBImobilitasIFTT'] == 'Imobilitas (1)' ? 'checked' : '' }} />
                ...
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBjenisKelaminIRF']) && $data['CBjenisKelaminIRF'] == 'Pria' ? 'checked' : '' }} />
                                <span>Pria</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBjenisKelaminIRF']) && $data['CBjenisKelaminIRF'] == 'Wanita' ? 'checked' : '' }} />
                                <span>Wanita</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBriwayatPatahTulangIRF']) && $data['CBriwayatPatahTulangIRF'] == 'Ya' ? 'checked' : '' }} />
                                <span>Ya</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBriwayatPatahTulangIRF']) && $data['CBriwayatPatahTulangIRF'] == 'Tidak' ? 'checked' : '' }} />
                                <span>Tidak</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBriwayatPatahTulangFemurIRF']) && $data['CBriwayatPatahTulangFemurIRF'] == 'Ya' ? 'checked' : '' }} />
                                <span>Ya</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBriwayatPatahTulangFemurIRF']) && $data['CBriwayatPatahTulangFemurIRF'] == 'Tidak' ? 'checked' : '' }} />
                                <span>Tidak</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBperokokIRF']) && $data['CBperokokIRF'] == 'Ya' ? 'checked' : '' }} />
                                <span>Ya</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBperokokIRF']) && $data['CBperokokIRF'] == 'Tidak' ? 'checked' : '' }} />
                                <span>Tidak</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBglukokortikoidIRF']) && $data['CBglukokortikoidIRF'] == 'Ya' ? 'checked' : '' }} />
                                <span>Ya</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBglukokortikoidIRF']) && $data['CBglukokortikoidIRF'] == 'Tidak' ? 'checked' : '' }} />
                                <span>Tidak</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBartritisRheumatoidIRF']) && $data['CBartritisRheumatoidIRF'] == 'Ya' ? 'checked' : '' }} />
                                <span>Ya</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBartritisRheumatoidIRF']) && $data['CBartritisRheumatoidIRF'] == 'Tidak' ? 'checked' : '' }} />
                                <span>Tidak</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBOsteoporosisSekunderIRF']) && $data['CBOsteoporosisSekunderIRF'] == 'Ya' ? 'checked' : '' }} />
                                <span>Ya</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBOsteoporosisSekunderIRF']) && $data['CBOsteoporosisSekunderIRF'] == 'Tidak' ? 'checked' : '' }} />
                                <span>Tidak</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBAlkohol3UnitIRF']) && $data['CBAlkohol3UnitIRF'] == 'Ya' ? 'checked' : '' }} />
                                <span>Ya</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBAlkohol3UnitIRF']) && $data['CBAlkohol3UnitIRF'] == 'Tidak' ? 'checked' : '' }} />
                                <span>Tidak</span>
                            </td>
                        </tr>
                    </table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span style="white-space: pre-line;">
                                                                ...
                                                                a. Risiko berat (<span class="logo">≥</span>20%)
                                                        ...
                                                        <td>
                                                            <span style="white-space: pre-line;">
                                                                <b>Hip fracture :</b>
                                                                a. Risiko berat (<span class="logo">≥</span>3%)
                ...
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBimpairOFvision']) && $data['CBimpairOFvision'] == 'Ya' ? 'checked' : '' }} />
                                <span>Ya</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBimpairOFvision']) && $data['CBimpairOFvision'] == 'Tidak' ? 'checked' : '' }} />
                                <span>Tidak</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" {{ isset($data['CBimpairOFhearing']) && $data['CBimpairOFhearing'] == 'Ya' ? 'checked' : '' }} />
                                <span>Ya</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['CBimpairOFhearing']) && $data['CBimpairOFhearing'] == 'Tidak' ? 'checked' : '' }} />
                                <span>Tidak</span>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="image-container-3">
                                                ...
                                                <img src="{{ $data['Gambar'] }}" width="500px" height="130px" alt="Gambar" class="image-top-2">
                                                @endif
                                                <img src="{{ 'img/obstetrifix.png' }}" width="500px" height="150px" alt="Gambar Obstetri" class="image-bottom">
                                            </div>
                                        </td>
                                    </tr>
                                </table>
            ...
            <tr>
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            <td colspan="1">
                                <input type="checkbox" {{ isset($data['kebrujukan']) && $data['kebrujukan'] == 'YA' ? 'checked' : '' }} />
                                <span>Ya</span>
                                <input type="checkbox" {{ isset($data['kebrujukan']) && $data['kebrujukan'] == 'TIDAK' ? 'checked' : '' }} />
                                <span>Tidak</span>
                            </td>
                            <td colspan="3"></td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="image-container-5">
                                    @if (isset($data['Gambar']))
                                    <img src="{{ $data['Gambar'] }}" width="300px" height="540px" alt="Gambar" class="image-top-3">
                                    @endif
                                    <img src="{{ 'img/kestrad.png' }}" width="300px" height="540px" alt="Gambar Kesehatan Tradisional" class="image-bottom">
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <td class="fc">
                                <div class="image-container-6 fc">
                                    ...
                                    <img src="{{ $data['canvasmata'] }}" width="380px" height="640x" alt="canvasmata" class="image-top-3">
                                    @endif
                                    <img src="{{ 'img/matafix-mirror.png' }}" width="380px" height="640x" alt="Gambar Mata" class="image-bottom">
                                </div>
                            </td>
                            <td>
                                <table>
            ...
            <tr>
                <td colspan="3">
                    <table class="border font">
                        <tr>
                            <td class="fc">
                                <input type="checkbox" {{ isset($data['optionsmata']) && $data['optionsmata'] == 'jauh' ? 'checked' : '' }} /><span>Jauh</span>&nbsp;
                                <input type="checkbox" {{ isset($data['optionsmata']) && $data['optionsmata'] == 'dekat' ? 'checked' : '' }} /><span>Dekat</span>&nbsp;
                                <input type="checkbox" {{ isset($data['optionsmata']) && $data['optionsmata'] == 'progresif' ? 'checked' : '' }} /><span>Progresif</span>&nbsp;
                                <input type="checkbox" {{ isset($data['optionsmata']) && $data['optionsmata'] == 'tidakada' ? 'checked' : '' }} /><span>Tidak ada</span>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            ...
                            <td class="padding-y">
                                <div><span>Pemeriksaan Fisik : &lt; lemak subkutan & muscle wasting :</span></div>
            ...
            <tr>
                <td colspan="3">
                    <table class="border font">
                        <tr>
                            <td colspan="4" class="fc">
                                <div class="image-container-7 fc">
                                    @if (isset($data['Gambar']))
                                    <img src="{{ $data['Gambar'] }}" width="250px" height="250px" alt="Gambar" class="image-top-3">
                                    @endif
                                    <img src="{{ 'img/paru-paru.jpeg' }}" width="250px" height="250px" alt="Gambar Paru-Paru" class="image-bottom">
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'BB Turun' || isset($data['kondisiVCT0']) && $data['kondisiVCT0'] == 'BB Turun' ? 'checked' : '' }} /><span>BB Turun</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Diare' || isset($data['kondisiVCT1']) && $data['kondisiVCT1'] == 'Diare' ? 'checked' : '' }} /><span>Diare</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Badan Panas' || isset($data['kondisiVCT2']) && $data['kondisiVCT2'] == 'Badan Panas' ? 'checked' : '' }} /><span>Badan Panas</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Jamur dimulut' || isset($data['kondisiVCT3']) && $data['kondisiVCT3'] == 'Jamur dimulut' ? 'checked' : '' }} /><span>Jamur dimulut</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Sulit menelan' || isset($data['kondisiVCT4']) && $data['kondisiVCT4'] == 'Sulit menelan' ? 'checked' : '' }} />
                                <span>Sulit menelan</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Batuk' || isset($data['kondisiVCT5']) && $data['kondisiVCT5'] == 'Batuk' ? 'checked' : '' }} />
                                <span>Batuk</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Gatal pada kulit' || isset($data['kondisiVCT6']) && $data['kondisiVCT6'] == 'Gatal pada kulit' ? 'checked' : '' }} />
                                <span>Gatal pada kulit</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Kelainan kulit' || isset($data['kondisiVCT7']) && $data['kondisiVCT7'] == 'Kelainan kulit' ? 'checked' : '' }} />
                                <span>Kelainan kulit</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Gangguan visus' || isset($data['kondisiVCT8']) && $data['kondisiVCT8'] == 'Gangguan visus' ? 'checked' : '' }} />
                                <span>Gangguan visus</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Herpes simplex' || isset($data['kondisiVCT9']) && $data['kondisiVCT9'] == 'Herpes simplex' ? 'checked' : '' }} />
                                <span>Herpes simplex</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Herpes zoster' || isset($data['kondisiVCT10']) && $data['kondisiVCT10'] == 'Herpes zoster' ? 'checked' : '' }} />
                                <span>Herpes zoster</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'ISPA berulang' || isset($data['kondisiVCT11']) && $data['kondisiVCT11'] == 'ISPA berulang' ? 'checked' : '' }} />
                                <span>ISPA berulang</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Nyeri kepala' || isset($data['kondisiVCT12']) && $data['kondisiVCT12'] == 'Nyeri kepala' ? 'checked' : '' }} />
                                <span>Nyeri kepala</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'TB paru' || isset($data['kondisiVCT13']) && $data['kondisiVCT13'] == 'TB paru' ? 'checked' : '' }} />
                                <span>TB paru</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'IMS' || isset($data['kondisiVCT14']) && $data['kondisiVCT14'] == 'IMS' ? 'checked' : '' }} />
                                <span>IMS</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Infeksi paru non TB' || isset($data['kondisiVCT15']) && $data['kondisiVCT15'] == 'Infeksi paru non TB' ? 'checked' : '' }} />
                                <span>Infeksi paru non TB</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Kesadaran menurun' || isset($data['kondisiVCT16']) && $data['kondisiVCT16'] == 'Kesadaran menurun' ? 'checked' : '' }} />
                                <span>Kesadaran menurun</span>
                            </td>
                            <td colspan="3">
                                <input type="checkbox" {{ isset($data['kondisiVCT']) && $data['kondisiVCT'] == 'Pembesaran KGB' || isset($data['kondisiVCT17']) && $data['kondisiVCT17'] == 'Pembesaran KGB' ? 'checked' : '' }} />
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Lymphoma Burkitt`s' || isset($data['aidsVCT0']) && $data['aidsVCT0'] == 'Lymphoma Burkitt`s' ? 'checked' : '' }} /><span>Lymphoma Burkitt`s</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Cocodiodomycosis' || isset($data['aidsVCT1']) && $data['aidsVCT1'] == 'Cocodiodomycosis' ? 'checked' : '' }} /><span>Cocodiodomycosis</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Cytomegalovirus' || isset($data['aidsVCT2']) && $data['aidsVCT2'] == 'Cytomegalovirus' ? 'checked' : '' }} /><span>Cytomegalovirus</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Herpes simplex' || isset($data['aidsVCT3']) && $data['aidsVCT3'] == 'Herpes simplex' ? 'checked' : '' }} /><span>Herpes simplex</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Kandidiasis Esofagus' || isset($data['aidsVCT4']) && $data['aidsVCT4'] == 'Kandidiasis Esofagus' ? 'checked' : '' }} /><span>Kandidiasis Esofagus</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Cryptococcosis' || isset($data['aidsVCT5']) && $data['aidsVCT5'] == 'Cryptococcosis' ? 'checked' : '' }} /><span>Cryptococcosis</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Sarkoma Kaposi' || isset($data['aidsVCT6']) && $data['aidsVCT6'] == 'Sarkoma Kaposi' ? 'checked' : '' }} /><span>Sarkoma Kaposi</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Histoplasmosis' || isset($data['aidsVCT7']) && $data['aidsVCT7'] == 'Histoplasmosis' ? 'checked' : '' }} /><span>Histoplasmosis</span>
                            </td>
                        </tr>

                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Ca Cervix invasif' || isset($data['aidsVCT8']) && $data['aidsVCT8'] == 'Ca Cervix invasif' ? 'checked' : '' }} /><span>Ca Cervix invasif</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Cryptosporidiosis' || isset($data['aidsVCT9']) && $data['aidsVCT9'] == 'Cryptosporidiosis' ? 'checked' : '' }} /><span>Cryptosporidiosis</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'HIV encephalopathy' || isset($data['aidsVCT10']) && $data['aidsVCT10'] == 'HIV encephalopathy' ? 'checked' : '' }} /><span>HIV encephalopathy</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Isosporiasis' || isset($data['aidsVCT11']) && $data['aidsVCT11'] == 'Isosporiasis' ? 'checked' : '' }} /><span>Isosporiasis</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'HIV Wasting syndrome' || isset($data['aidsVCT12']) && $data['aidsVCT12'] == 'HIV Wasting syndrome' ? 'checked' : '' }} /><span>HIV Wasting syndrome</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Penicilliosis' || isset($data['aidsVCT13']) && $data['aidsVCT13'] == 'Penicilliosis' ? 'checked' : '' }} /><span>Penicilliosis</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Reccurent pneumonia' || isset($data['aidsVCT14']) && $data['aidsVCT14'] == 'Reccurent pneumonia' ? 'checked' : '' }} /><span>Reccurent pneumonia</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Lymphoma Otak' || isset($data['aidsVCT15']) && $data['aidsVCT15'] == 'Lymphoma Otak' ? 'checked' : '' }} /><span>Lymphoma Otak</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Salmonella septicemia' || isset($data['aidsVCT16']) && $data['aidsVCT16'] == 'Salmonella septicemia' ? 'checked' : '' }} /><span>Salmonella septicemia</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'PCP' || isset($data['aidsVCT17']) && $data['aidsVCT17'] == 'PCP' ? 'checked' : '' }} /><span>PCP</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'M. Tuberculosis complex' || isset($data['aidsVCT18']) && $data['aidsVCT18'] == 'M. Tuberculosis complex' ? 'checked' : '' }} /><span>M. Tuberculosis complex</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Toxoplasmosis' || isset($data['aidsVCT19']) && $data['aidsVCT19'] == 'Toxoplasmosis' ? 'checked' : '' }} /><span>Toxoplasmosis</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Lymphoma Immunoblaastic' || isset($data['aidsVCT20']) && $data['aidsVCT20'] == 'Lymphoma Immunoblaastic' ? 'checked' : '' }} /><span>Lymphoma Immunoblaastic</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Cytomegalovirus retintis' || isset($data['aidsVCT21']) && $data['aidsVCT21'] == 'Cytomegalovirus retintis' ? 'checked' : '' }} /><span>Cytomegalovirus retintis</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Kandidiasis trakea/broncus/paru' || isset($data['aidsVCT22']) && $data['aidsVCT22'] == 'Kandidiasis trakea/broncus/paru' ? 'checked' : '' }} /><span>Kandidiasis trakea/broncus/paru</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Progressive Multifocal Leukeuncephalopathy' || isset($data['aidsVCT23']) && $data['aidsVCT23'] == 'Progressive Multifocal Leukeuncephalopathy' ? 'checked' : '' }} /><span>Progressive Multifocal Leukeuncephalopathy</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['aidsVCT']) && $data['aidsVCT'] == 'Mycobacterium non TBC' || isset($data['aidsVCT24']) && $data['aidsVCT24'] == 'Mycobacterium non TBC' ? 'checked' : '' }} /><span>Mycobacterium non TBC</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'INH Primer' ? 'checked' : '' }} /><span>INH Primer</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'INH Sekunder' ? 'checked' : '' }} /><span>INH Sekunder</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'Fansidar Primer' ? 'checked' : '' }} /><span>Fansidar Primer</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'Fansidar Sekunder' ? 'checked' : '' }} /><span>Fansidar Sekunder</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'Klindamisin' ? 'checked' : '' }} /><span>Klindamisin</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'Fluconazol Primer' ? 'checked' : '' }} /><span>Fluconazol Primer</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'Fluconazol Sekunder' ? 'checked' : '' }} /><span>Fluconazol Sekunder</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'Cotrimoxazol Primer' ? 'checked' : '' }} /><span>Cotrimoxazol Primer</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'Cotrimoxazol Sekunder' ? 'checked' : '' }} /><span>Cotrimoxazol Sekunder</span>
                            </td>
                            <td colspan="3">
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'Pirimetamin' ? 'checked' : '' }} /><span>Pirimetamin</span>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table class="border font">
                        ...
                        <tr>
                            <td colspan="6">
                                ...
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'Ya' ? 'checked' : '' }} /><span>Ya</span>&nbsp;&nbsp;
                                <input type="checkbox" {{ isset($data['profilaksisVCT']) && $data['profilaksisVCT'] == 'Tidak' ? 'checked' : '' }} /><span>Tidak</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['PMTCT_VCT']) ? 'checked' : '' }} /><span>PMTCT</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['ART_VCT']) ? 'checked' : '' }} /><span>PMTCT</span>
                            </td>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['PPP_VCT']) ? 'checked' : '' }} /><span>PMTCT</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" {{ isset($data['RSPEM_VCT']) ? 'checked' : '' }} /><span>RS. Pem</span>
                            </td>
                            <td>
                                <input type="checkbox" {{ isset($data['RSSwasta_VCT']) ? 'checked' : '' }} /><span>RS. Swasta</span>
                            </td>
                            <td colspan="4">
                                <input type="checkbox" {{ isset($data['PKM_VCT']) ? 'checked' : '' }} /><span>PKM</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6" class="padding-y">
            ...
            <tr>
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            <td>
                                <span><div>Membesar. :</div></span>
                                {{ isset($data['membesar']) ? $data['membesar'] : '' }}
                            </td>
                            <td>
                                <span><div>Bunyi Jantung :</div></span>
                                {{ isset($data['bunyiJantung']) ? $data['bunyiJantung'] : '' }}
                            </td>
                            <td>
                                <span><div>Auskultasi :</div></span>
                        ...
                        <tr>
                            <td>
                                <span><div>Nyeri :</div></span>
                                {{ isset($data['Nyeri']) ? $data['Nyeri'] : '' }}
                            </td>
                            <td>
                                <span><div>Ascites :</div></span>
                                {{ isset($data['Ascites']) ? $data['Ascites'] : '' }}
                            </td>
                            <td>
                                <span><div>Tumor :</div></span>
                        ...
                        <tr>
                            <td>
                                <span><div>Kifosis :</div></span>
                                {{ isset($data['Kifosis']) ? $data['Kifosis'] : '' }}
                            </td>
                            <td>
                                <span><div>Skollosis :</div></span>
                                {{ isset($data['Skollosis']) ? $data['Skollosis'] : '' }}
                            </td>
                            <td>
                                <span><div>Nyeri Tekanan atau Ketut :</div></span>
                        ...
                        <tr>
                            <td>
                                <span><div>Edema :</div></span>
                                {{ isset($data['Edema']) ? $data['Edema'] : '' }}
                            </td>
                            <td>
                                <span><div>Varices :</div></span>
                        ...
                        <tr>
                            <td colspan="3">
                                <span><div>Reflek Patologis :</div></span>
                ...
                <td colspan="3">
                    <table class="border font">
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="padding-y">
                                <span style="white-space: pre-line;">{{ isset($data['statusLokasiOnkologi']) ? $data['statusLokasiOnkologi'] : '' }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="padding-y">
                            ...
                            <td colspan="4" class="padding-y">
                                <span style="white-space: pre-line;">{{ isset($data['kelenjarGetahBening']) ? $data['kelenjarGetahBening'] : '' }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="padding-y">
                            ...
                            <td colspan="4" class="padding-y">
                                <span style="white-space: pre-line;">{{ isset($data['kelenjarGetahBeningLain']) ? $data['kelenjarGetahBeningLain'] : '' }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            <td colspan="3" class="btl">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" {{ isset($data['riwayatkeluar']) && $data['riwayatkeluar'] == 'Sembuh' ? 'checked' : '' }} />
                                            <span>Sembuh</span>
                                        </td>
                                        <td>
                                            <input type="checkbox" {{ isset($data['riwayatkeluar']) && $data['riwayatkeluar'] == 'Membaik' ? 'checked' : '' }} />
                                            <span>Membaik</span>
                                        </td>
                                        <td>
                                            <input type="checkbox" {{ isset($data['riwayatkeluar']) && $data['riwayatkeluar'] == 'Belum Sembuh' ? 'checked' : '' }} />
                                            <span>Belum Sembuh</span>
                                        </td>
                                        <td>
                                            <input type="checkbox" {{ isset($data['riwayatkeluar']) && $data['riwayatkeluar'] == 'Tidak Ada Perkembangan' ? 'checked' : '' }} />
                                            <span>Tidak Ada Perkembangan</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="checkbox" {{ isset($data['riwayatkeluar']) && $data['riwayatkeluar'] == 'Meninggal >= 48 Jam' ? 'checked' : '' }} />
                                        ...
                                        <td>
                                            <input type="checkbox" {{ isset($data['riwayatkeluar']) && $data['riwayatkeluar'] == 'DOA' ? 'checked' : '' }} />
                                            <span>DOA</span>
                                        </td>
                                        <td>
                                            <input type="checkbox" {{ isset($data['riwayatkeluar']) && $data['riwayatkeluar'] == 'Rawat Inap' ? 'checked' : '' }} />
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" {{ isset($data['statuskeluar']) && $data['statuskeluar'] == 'Belum Keluar RS' ? 'checked' : '' }} />
                                            <span>Belum Keluar RS</span>
                                        </td>
                                        <td>
                                            <input type="checkbox" {{ isset($data['statuskeluar']) && $data['statuskeluar'] == 'Tidak' ? 'checked' : '' }} />
                                            <span>Diijinkan Pulang</span>
                                        </td>
                                        <td>
                                            <input type="checkbox" {{ isset($data['statuskeluar']) && $data['statuskeluar'] == 'Pulang Paksa' ? 'checked' : '' }} />
                                            <span>Pulang Paksa</span>
                                        </td>
                                        <td>
                                            <input type="checkbox" {{ isset($data['statuskeluar']) && $data['statuskeluar'] == 'Dirujuk' ? 'checked' : '' }} />
                                            <span>Dirujuk</span>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" {{ isset($data['perlukontrol']) && $data['perlukontrol'] == 'Ya' ? 'checked' : '' }} />
                                            <span>Ya</span>
                                        </td>
                                        <td>
                                            <input type="checkbox" {{ isset($data['perlukontrol']) && $data['perlukontrol'] == 'Tidak' ? 'checked' : '' }} />
                                            <span>Tidak</span>
                                        </td>
                                        <td>
                                            <input type="checkbox" {{ isset($data['perlukontrol']) && $data['perlukontrol'] == 'Rujuk Balik' ? 'checked' : '' }} />
                    ...
                    <table class="border font">
                        <tr>
                            ...
                            <td width="25%" class="tc">
                                ...
                                alt="QR Code"> <br>
                                <span style="font-size: 12px;">{{ isset($data2['author']) ? $data2['author'] : '' }}</span>
                                @endisset
                            </td>
                        </tr>
                    </table>
