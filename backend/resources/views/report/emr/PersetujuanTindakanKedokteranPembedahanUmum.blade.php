...
<head>
    <title>Persetujuan Tindakan Kedokteran Pembedahaan Umum</title>
    <style>
        * {
            ...
            <thead>
                ...
                <tr>
                    ...
                    <td width="40%"
                        ...
                        class="border">
                        Persetujuan Tindakan Kedokteran Pembedahaan Umum
                    </td>
                                ...
                                <td>
                                    <table border="0" style="table-layout: fixed; width: 100%;">
                                        <tr>
                                            ...
                                            <td style="width: 65%">
                                                @php $count = 0; @endphp
                                                @if(isset($d['details']) && count($d['details']) > 0)
                                                    @foreach ($d['details'] as $item)
                                                        {{ $item['TBPemberiPersetujuan'] ?? null }},
                                                        @php $count++; @endphp
                                                        @if ($count % 3 == 0)
                                                            <br>
                                                        @endif
