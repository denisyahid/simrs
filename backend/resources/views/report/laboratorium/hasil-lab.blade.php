                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-right: 10px;  padding-bottom:7px;" width="26%">
                                                <font style="font-size: 9pt; font-weight: bold; word-wrap: break-word;"
                                                    color="#000000">:
                                                    {{ $dataReport['details'][0]->noorder ?? null }}</font>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-right: 10px;  padding-bottom:7px;">
                                                <font style="font-size: 9pt; font-weight: bold" color="#000000">:
                                                    {{ $dataReport['details'][0]->tglhasil ?? null }}
                                                </font>
                                            </td> -->
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-right: 10px;  padding-bottom:7px;" rowspan="2">
                                                <font style="font-size: 9pt; font-weight: bold" color="#000000">:
                                                    {{ isset($dataRegis->dokterpengirim )? $dataRegis->dokterpengirim : '-'  }}
    ...
    <footer>
        ...
        <table cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" border="0" width="100%">
            <tr>
                <td>
                    <div>
                        <span>Diperiksa oleh : {{ isset($dataReport['details'][0]->dokterdiperiksa) ? $dataReport['details'][0]->dokterdiperiksa : '-'  }}</span><br>
                        <span>Diotorisasi oleh : {{ isset($dataReport['details'][0]->diotorisasi) ? $dataReport['details'][0]->diotorisasi : '-'  }}</span><br><br>
                        <span> Interpretasi terhadap hasil laboratorium hanya dilakukan oleh dokter / klinisi.
                            Dokumen Hasil Pemeriksaan ini tidak memerlukan tandatangan basah karena telah divalidasi
                            dan
                            dicetak dari sistem informasi laboratorium.
                        </span>
                    </div>
                </td>
                <td style="text-align: center;vertical-align: middle" width="20%">
                    ...
                    <u>{{-- $dataReport['details'][0]->clinician ? $dataReport['details'][0]->clinician : '-'  --}}</u><br>
                    Penanggung Jawab
                </td>
            </tr>
        </table>
