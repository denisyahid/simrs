        ...
        <td style="padding-top:2px;">
            <table cellspacing="0" cellpadding="0" border="0" width="100%" class="infopasien">
                <tbody>
                    ...
                    <tr>
                        <td colspan="3">
                            <span class="bold">{{ $data->nopemerikasaan }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            <table cellspacing="0" cellpadding="0" border="0" width="100%" class="border">
                                <tr>
                                    ...
                                    <td width="24%">
                                        <span>{{ $data->jeniskelamin }}</span><br>
                                        <span
                                            class="italic h6">{{ $data->jeniskelamin == 'Laki-Laki' ? 'Male' : 'Female' }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="24%">
                                ...
                                <tr>
                                    ...
                                    <td width="24%">
                                        <span>{{ $data->jenisspesimen }}</span><br>
                                        <span class="italic h6">{{ $data->typespeciment }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="24%">
                                    ...
                                    <td width="24%">
                                        ...
                                        <span
                                            class="italic h6">{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $data->tglterimasampel)->format('M jS, Y g:i a') }}
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="24%">
                                        <span>{{ $data->tglselesaisampel }}</span><br>
                                        <span
                                            class="italic h6">{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $data->tglselesaisampel)->format('M jS, Y g:i a') }}
                                        </span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" width="100%"class="border-a">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="25%">
                                            <span>Jenis Pemeriksaan</span><br>
                                            <span class="h6 italic">Type of Examination</span>
                                        </td>
                                        <td width="25%">
                                            <span class="h6">Hasil</span><br>
                                            <span class="h6 italic">Result</span>
                                        </td>
                                        <td width="25%">
                                            <span class="h6">Keterangan</span><br>
                                            <span class="h6 italic">Other Infromation/Explanation</span>
                                        </td>
                                    </tr>
                                    <tr class="border-b">
                                        <td width="25%">
                                            <span>{{ $data->kodesampel }}</span>
                                        </td>
                                        <td width="25%">
                                            <span>{{ $data->namametodeperiksa }}</span><br>
                                            <span class="h6 italic">{{ $data->methodname }}</span>
                                        </td>
                                        <td width="25%">
                                            <span>{{ $data->hasil == true ? 'Positif' : 'Negatif' }}</span><br>
                                            <span
                                                class="h6 italic">{{ $data->hasil == true ? 'Positive' : 'Negative' }}</span>
                                        </td>
                                        <td width="25%">
                                            <span>{{ $data->keterangan }}</span><br>
                                            <span class="h6 italic">{{ $data->keterangan }}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <tr>
                        ...
                        <td width="90%" class="left">
                            <span class="h6">{{ $data->petugaspemeriksa }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td width="8%" class="left">
                        ...
                        <td width="90%" class="left">
                            <span class="h6">{{ $data->verifikator ?? $data->verifikator2 }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td width="8%" class="left">
                        ...
                        <td width="90%" class="left">
                            <span class="h6">{{ $data->petugasapproval }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td height="80px">
