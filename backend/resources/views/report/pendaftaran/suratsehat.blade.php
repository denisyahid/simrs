                            ...
                            <tr>
                                <td colspan="3" style="width:100%;">
                                    <span style="font-size: 11pt;" color="#000000">
                                        Yang bertanda tangan dibawah ini, Dokter {{$profile->namalengkap}} menerangkan bahwa:
                                    </span>
                                </td>
                            </tr>
                            <tr>
                ...
                <table style="width:90%; border:0; text-align:center">
                    ...
                    <tr>
                        ...
                        <td style="height:100px; text-align: center;">
                            <img src="data:image/png;base64, {!! $dataReport['tte'] !!}">
                        </td>
                    </tr>
                    <tr>
                        <td style="width:50%;"></td>
                        <td style="width:50%; text-align:center">
                            ...
                            <span style="font-size: 11pt;"
                                color="#000000">{{ $dataReport['identitas']->nip }}</span>
                        </td>
                    </tr>
                </table>
            </td>
