                        ...
                        @foreach ($item->groupBy('layanan_group') as $keyly => $lygroup)
                            ...
                            @foreach ($lygroup as $data)
                                @php
                                    ...
                                    $nomor = $nomor + 1;
                                    $subtotals = $subtotals + $data->total;
                                @endphp
                                <tr>
                            ...
                            @endforeach
                            <tr>
                                <td class="text-right" style="text-align: right; border-top: 1px solid black" colspan="10">
                                    <span class="text-normal-1">
                        ...
                        <tr>
                            ...
                            <td width="50%" class="text-center">
                                <span class="text-biasa">{!! $profile->namakota !!},
                                    {{-- &nbsp;&nbsp;{{ date('d/m/Y H:i') }}</span> --}}
                                    &nbsp;&nbsp;{{ date('j-F-Y', strtotime($res['identitas']->tglclosing ?? '')) }}
                            </td>
                        </tr>
                        <tr>
