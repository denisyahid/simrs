...
<body>
    ...
    <div align="center">
            ...
            <td>
                <table width="50%" cellspacing="0" cellpadding="0" style=" border: 1px solid black; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td width="40%" align="left" colspan="2">
                            <span class="text-normal">: <b>2407000018</b></span>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td>
                <table width="50%" cellspacing="0" cellpadding="0" style="border: 2px solid black; border-style: dashed;">
                    <tr>
                        <td align="center">
                            <span class="text-judul" style="font-size: 9pt;">Format Virtual Account Untuk Rumah Sakit Bali Mandara <br> 12952292407000018 <br> 129 (Kode BPD Bali) + 5229 (Kode Bali Mandara) + 2407000018</span>
                        </td>
                    </tr>
                </table>
            </td>
