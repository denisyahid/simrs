                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="text-center">
                                <span class="text-judul">DETAILS OF HOSPITALIZATION COSTS</span>
                            </td>
                        </tr>
                    </table>
                    <hr class="baris1">
            ...
            <tr>
                <td>
                    <table width="100%" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td width="15%">
                                <span class="text-normal">MRN / Age</span>
                            </td>
                            <td width="35%">
                                <span class="text-normal">:
                        ...
                        <tr>
                            ...
                            <td width="15%">
                                <span class="text-normal">Registration No.</span>
                            </td>
                            <td width="35%">
                                <span class="text-normal">:
                        ...
                        <tr>
                            ...
                            <td width="15%">
                                <span class="text-normal">Patient Name</span>
                            </td>
                            <td width="35%">
                                <span class="text-normal">: {{ $res['identitas']->namapasien }}
                                </span>
                            </td>
                            ...
                            <td width="35%">
                                <span class="text-normal">: {{ $res['identitas']->namaruangan }} / {{ $res['identitas']->namakamar }}</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="15%">
                                <span class="text-normal">Registration Date</span>
                            </td>
                            <td width="35%">
                                <span class="text-normal">:
                        ...
                        <tr>
                            ...
                            <td width="15%">
                                <span class="text-normal">Patient Type</span>
                            </td>
                            <td width="35%">
                                <span class="text-normal">:
                            ...
                            <td width="15%">
                                <span class="text-normal">Treatment Date </span>
                            </td>
                            <td width="35%">
                                <span class="text-normal">: {{ date_format(date_create($res['identitas']->tglregistrasi), 'j-F-Y') }} until {{ date_format(date_create($res['identitas']->tglpulang), 'j-F-Y') }}</span>
                            </td>
                        </tr>
                    </table>
                    <hr class="baris1">
            ...
            <tr>
                <td>
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="text-left">
                                <span class="text-judul" style="font-size: 11pt;">Cost Details</span>
                            </td>
                        </tr>
                    </table>
                    <hr class="baris1">
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" style="border-top:2px solid black; border-bottom:2px solid black;">
                        <tr>
                            ...
                            <td width="30%" class="text-left">
                                <span class="text-biasa">Grand Total Before Charge</span>
                            </td>
                            <td class="text-center">
                        ...
                        <tr>
                            <td width="40%"></td>
                            <td width="30%" class="text-left">
                                <span class="text-biasa">Additional Charge (1.6%)</span>
                            </td>
                            <td class="text-center">
                                <span class="text-biasa">=</span>
                            </td>
                            <td class="text-right">
                                <span class="text-biasa">
                                    {{ number_format( (16/1000*$res['total']), 0, '.', ',') }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td width="40%"></td>
                            <td width="30%" class="text-left">
                                <span class="text-biasa">Grand Total After Charge</span>
                            </td>
                            <td class="text-center">
                                <span class="text-biasa">=</span>
                            </td>
                            <td class="text-right">
                                <span class="text-biasa">
                                    {{ number_format((1016/1000*$res['total']), 0, '.', ',') }}</span>
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr>
                            <td>
                                <span class="text-biasa"><i>#
                                        {{ strtoupper(App\Traits\Valet::english(App\Traits\Valet::static_terbilang(1016/1000*$res['total']))) }}S #</i>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="35%" class="text-center">
                                <span class="text-biasa" class="text-center">(Patient / Family)</span>
                            </td>
                            <td width="30%" class="text-center">
                                <span class="text-biasa" class="text-center">{!! $profile->namakota !!},&nbsp;&nbsp;{{ date('d/m/Y H:i') }}</span>
                            </td>
                            <td width="35%" class="text-center">
                                <span class="text-biasa">(Cashier)</span>
                            </td>
                        </tr>
                        <tr>
                            <td width="35%" class="text-center"><span class="text-biasa"></span>
                            </td>
                            <td width="30%" class="text-center"><span class="text-biasa">(Administration)</span>
                            </td>
                            <td width="35%" class="text-center"><span class="text-biasa"></span>
                            </td>
                        </tr>
