...
<body>
    <table width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
        <thead>
            <tr>
                <th colspan="2" style="background-color: lightblue; padding:5px; font-weight:bold; width: 50%;text-align: left;border-top: 1px solid black;border-left:1px solid black">
                    RSUD MALANGBONG
                </th>
                <th style="background-color: lightblue; padding:5px; font-weight:bold; width: 50%; text-align: right;border-top: 1px solid black;border-right:1px solid black">
                    @yield('kode')
                </th>
            </tr>
            <tr>
                ...
                <td width="40%" style="vertical-align: middle;text-align: center;font-weight: bold;font-size: large"
                    class="border">
                    @yield('title')
                </td>
