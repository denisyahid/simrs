...
Trait Valet
{
    ...
    {
        $set = DB::table('settingdatafixed_m')->where('namafield', 'BPJS_userKeyVclaim')
    ...
    protected function getIdConsumerBPJS()
    {
        ...
        $set = DB::table('settingdatafixed_m')->where('namafield', 'BPJS_ConsID')
    ...
    {
        $statusBridgingProduction = DB::table('settingdatafixed_m')->where('namafield', 'isBridgingProduction')->first();
        if (!empty($statusBridgingProduction)) {
            if ($statusBridgingProduction->nilaifield == 'false') {
                $set = DB::table('settingdatafixed_m')->where('namafield', 'linkBPJS')->first();
            } else {
                $set = DB::table('settingdatafixed_m')->where('namafield', 'BPJS_urlVclaim')->first();
            }
        } else {
            $set = DB::table('settingdatafixed_m')->where('namafield', 'BPJS_urlVclaim')->first();
        }
    ...
    protected  function  getKdProfile()
    {
        ...
        return  DB::table('loginuser_s')->where('id', empty($session) ? 29 : $session['id'])->first()->kdprofile;
    }
    protected function getPasswordConsumerBPJS()
    {

        $set = DB::table('settingdatafixed_m')->where('namafield', 'BPJS_ConsPassword')
            ->where('kdprofile', $this->getKdProfile())->first()->nilaifield;
    ...
    {
        $statusBridgingProduction =  DB::table('settingdatafixed_m')->where('namafield', 'isAntreanBPJSProduction')->first();
        if ($statusBridgingProduction->nilaifield == 'false')
            $set =  DB::table('settingdatafixed_m')->where('namafield', 'UserKeyAntreanBPJS_dev')->first();
        else
            $set =  DB::table('settingdatafixed_m')->where('namafield', 'BPJS_userKeyAntrol')->first();
    ...
    protected function getUrlAntreanBPJSv2()
    {
        $statusBridgingProduction = DB::table('settingdatafixed_m')->where('namafield', 'isAntreanBPJSProduction')->first();
        if ($statusBridgingProduction->nilaifield == 'false')
            $set = DB::table('settingdatafixed_m')->where('namafield', 'UrlAntreanBPJS_dev')->first();
        else
            $set = DB::table('settingdatafixed_m')->where('namafield', 'BPJS_urlAntrol')->first();
