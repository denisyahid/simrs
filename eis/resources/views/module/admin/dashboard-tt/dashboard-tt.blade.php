                    ...
                    <div class="card-block">
                        <div class="row" style="margin-top:10px">
                            <div class="col-md-12 col-xl-3">
                                <div class="card widget-card-1"  style="border: 1px solid rgba(69, 90, 100, 0.14);">
                                    <div class="card-block-small">
                                        <i class="icofont icofont-bed-patient bg-c-blue card1-icon" style="background: #01a9ac;"></i>
                            ...
                            <div class="col-md-12 col-xl-3">
                                <div class="card widget-card-1"  style="border: 1px solid rgba(69, 90, 100, 0.14);">
                                    <div class="card-block-small">
                                        <i class="icofont icofont-listine-dots bg-c-pink card1-icon" style="background: #FF5EAA"></i>
                            ...
                            <div class="col-md-12 col-xl-3">
                                <div class="card widget-card-1"  style="border: 1px solid rgba(69, 90, 100, 0.14);">
                                    <div class="card-block-small">
                                        <i class="icofont icofont-hospital bg-c-green card1-icon"  style="background: #0ac282" ></i>
                            ...
                            <div class="col-md-12 col-xl-3">
                                <div class="card widget-card-1"  style="border: 1px solid rgba(69, 90, 100, 0.14);">
                                    <div class="card-block-small">
                                        <i class="icofont icofont-bed bg-c-yellow card1-icon"  style="background: #fe9365" ></i>
                    ...
                    <div class="card-block">
                        <div class="row">
                            <div class="col-md-4" style="padding: 0 2px 0 2px">
                                <div class="card text-center text-white bg-green-gradient">
                                    <div class="card-block">
                            ...
                            <div class="col-md-4" style="padding: 0 2px 0 2px">
                                <div class="card text-center text-white bg-red-gradient">
                                    <div class="card-block">
                            ...
                            <div class="col-md-4" style="padding: 0 2px 0 2px">
                                <div class="card text-center text-white  bg-yellow-gradient">
                                    <div class="card-block">
...
<script>
    ...
    //scrollTopBottom() //disabled scroll
