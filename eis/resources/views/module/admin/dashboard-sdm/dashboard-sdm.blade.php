                            ...
                            <div class="card">
                                <div class="panel panel-warning">
                                    ...
                                    @php
                                        ...
                                        $sama = false;
                                        $resultSumDep = [];
                                        $array = App\Http\Controllers\MainController::getLaporanLayanan(request()->get("tglawal"),request()->get("tglakhir"));
                                        // dd($array);
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @forelse($resultSumDep as $i => $d)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $d['count'] }}</td>
                                                                    <td><a href='#'
                                                                            class="btn btn-primary btn-outline-primary btn-mini click-layanan"
                                                            ...
                                                            @empty
                                                                <tr>
                                                                    <td colspan="3" style="text-align: center">Data Tidak
                                                                        ada</td>
                                                                </tr>
                                                            @endforelse
        ...
        <div class="modal-dialog modal-lg"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table id="tLayanan" class="table  table-striped table-sm table-styling"
                            style="width:100%">
                            <thead class="table-default">
                            <tr>
                                <th style="color:black;width: 10%">No </th>
                            ...
                            <tfoot>
                                <tr>
                                    <th style="color:black;font-weight:bold;" colspan="6">TOTAL </th>
                                    <th style="color:black;font-weight:bold;"><span id="totalTarifDokter"></span> </th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
...
@section('javascript')
    <script>
                ...
                tooltip: {
                    formatter: function(e) {
                        let point = this.point,
                            s = this.percentage.toFixed(2) +
                            ' %'; //this.key + ': ' + Highcharts.numberFormat(this.y, 0, '.', ',') + ' <br/>';
                        return s;
        ...
        $(".click-layanan").click(function(e) {
            ...
            // // var total = 0
            // // for (let i in datazz) {
            // //     if (dokter == datazz[i].dokter) {
            // //         total  =total+ parseFloat(datazz[i].totall) 
            // //         // datazz[i].qtyproduk = parseFloat(datazz[i].qtyproduk)
            // //         datas.push(datazz[i])
            // //     }
            // // }
            // // document.getElementById("totalTarifDokter").innerHTML =  formatRupiah(total,'Rp. ')    
            // // $('#tBodyLayanan').dataTable();

            // // $('#tBodyLayanan').empty();
            // // var trHTML = "";

            // // $.each(datas, function (i, item) {
            // //     trHTML += "<tr><td style='width:10%' >" + (i+1)
            // //         + "</td><td  >" + item.tglpelayanan
            // //         + "</td><td  >" + item.layanan
            // //         + "</td><td  >" + item.nocm
            // //         + "</td><td  >" + item.namapasien   
            // //         + "</td><td style='text-align:right'>" + formatRupiah(item.tariff,'Rp. ')
            // //         + "</td><td  >" + item.count       
            // //         + "</td><td style='text-align:right'>" + formatRupiah(item.totall,'Rp. ')   
            // //         + "</td></tr> ";
            // // });
            // // $('#tLayanan').append(trHTML);
            // $('#modalLayanan').modal("show");
        })
        setTimeout(function() {
