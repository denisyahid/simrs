...
<template>
    <div class="v-avatar" :class="[
        ...
        <slot name="avatar">
            ...
            <span v-else class="avatar is-fake"
                :class="[props.squared && 'is-squared', props.color && `is-${props.color}`]">
                <span>{{ props.initials }}</span>
            </span>
            <img v-if="props.picture && props.pictureDark" class="avatar dark-image"
                :class="[props.squared && 'is-squared']" :src="props.pictureDark" alt=""
                @error.once="(event) => onceImageErrored(event, '150x150')" />
        </slot>

        <slot name="badge">
            <i class="badge" v-if="props.badge" :class="props.badge" aria-hidden="true"></i>
            <!-- <img
        v-if="props.badge"
        class="badge"
        :src="props.badge"
...
.v-avatar {
    ...
    i.badge {
        ...
        z-index: 3;
        padding-top:2px;
        background-color: rgb(17, 104, 99);
    }
