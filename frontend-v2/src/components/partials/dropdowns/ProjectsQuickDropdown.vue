...
<template>
  ...
  <!-- <VDropdown class="project-dropdown" spaced>
    ...
    <template #content="{ close }">
      <a v-for="project in projects" :key="project.initials" class="dropdown-item dropdown-block"
        :class="[project.initials === selectedProject.initials && 'is-active']" tabindex="0" @keydown.space.prevent="
          () => {
