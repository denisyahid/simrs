...
<template>
  <div class="columns is-multiline widget-demo-columns">
    <div class="column is-3">
      <!--Widget-->
      <IllustrationWidget class="illustration-widget-v1" title="You unlocked 2 new Achievements"
        text="Congrats, your efforts have been rewarded. Keep up like this!" :picture="Widget1" :badge-left="Widget2"
        :badge-right="Widget3" />

      <!--Widget-->
      <ContactWidget picture="/images/avatars/svg/vuero-1.svg" username="Erik K." email="erikkovalsky@vuero.io"
        company="Vuero Ltd." position="Product Manager" location="Los Angeles, CA" phone="+1 444-5156" />

      <!--Widget-->
      <IllustrationWidget class="illustration-widget-v2" title="You unlocked 2 new Achievements"
        text="Congrats, your efforts have been rewarded. Keep up like this!" :picture="Widget7" />
    ...
    <div class="column is-3">
      <!--Widget-->
      <IllustrationWidget class="illustration-widget-v2" title="You unlocked 2 new Achievements"
        text="Congrats, your efforts have been rewarded. Keep up like this!" :picture="Widget4" />
    ...
    <div class="column is-3">
      ...
      <!--Widget-->
      <IllustrationWidget class="illustration-widget-v3" title="You unlocked 2 new Achievements"
        text="Congrats, your efforts have been rewarded. Keep up like this!" :picture="Widget5" />
    ...
    <div class="column is-3">
      ...
      <!--Widget-->
      <CallWidget picture="/@src/assets/illustrations/widgets/6.svg" badge="/demo/avatars/7.jpg" username="Alice" />

      <!--Widget-->
      <IllustrationWidget class="illustration-widget-v2" title="You unlocked 2 new Achievements"
        text="Congrats, your efforts have been rewarded. Keep up like this!" :picture="Widget8" />
    </div>
  </div>
</template>
