        ...
        <div class="columns is-multiline">
          ...
          <div class="column is-6">
            <div class="dashboard-card">
              ...
              <ApexChart id="overall-chart" :height="overallChartOptions.chart.height"
                :type="overallChartOptions.chart.type" :series="overallChartOptions.series"
          ...
          <div class="column is-6">
            <div class="dashboard-card">
              ...
              <ApexChart id="energy-chart" :height="energyChartOptions.chart.height"
                :type="energyChartOptions.chart.type" :series="energyChartOptions.series" :options="energyChartOptions">
              </ApexChart>
            </div>
          </div>
          ...
          <div class="column is-6">
            <div class="dashboard-card">
              ...
              <ApexChart id="overall-chart" :height="oxygenChartOptions.chart.height"
                :type="oxygenChartOptions.chart.type" :series="oxygenChartOptions.series" :options="oxygenChartOptions">
              </ApexChart>
            </div>
          </div>
          ...
          <div class="column is-6">
            <div class="dashboard-card">
              ...
              <ApexChart id="progress-chart" :height="progressChartOptions.chart.height"
                :type="progressChartOptions.chart.type" :series="progressChartOptions.series"
