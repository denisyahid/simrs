      ...
      <div class="column is-8">
        <div class="columns is-multiline is-flex-tablet-p">
          <div class="column is-6">
            <div class="dashboard-card is-welcome">
              ...
              <div class="welcome-progress">
                <VBillboardJS :options="progressGaugeOptions" @ready="onprogressGaugeReady" />
                <div class="meta">
                    ...
                    <VBlock title="263" subtitle="Interviews" center>
                      <template #icon>
                        <VIconBox color="purple" rounded>
                          <i aria-hidden="true" class="iconify" data-icon="feather:radio"></i>
                        </VIconBox>
                      </template>
                    </VBlock>
                  </div>
                    ...
                    <VBlock title="49" subtitle="Approved" center>
                      <template #icon>
                        <VIconBox color="green" rounded>
                          <i aria-hidden="true" class="iconify" data-icon="feather:user-check"></i>
                        </VIconBox>
                      </template>
                    </VBlock>
                  </div>
                    ...
                    <VBlock title="214" subtitle="Rejected" center>
                      <template #icon>
                        <VIconBox color="orange" rounded>
                          <i aria-hidden="true" class="iconify" data-icon="feather:frown"></i>
                        </VIconBox>
                      </template>
                    </VBlock>
                  </div>
          ...
          <div class="column is-6 h-hidden-mobile h-hidden-tablet-p">
            <img src="/@src/assets/illustrations/dashboards/personal/interviews.svg" alt="" />
          </div>

          <div class="column is-6">
            <div class="dashboard-card">
              <ApexChart id="interviews-chart" :height="interviewsOptions.chart.height"
                :type="interviewsOptions.chart.type" :series="interviewsOptions.series" :options="interviewsOptions">
              </ApexChart>
            </div>
          </div>
        </div>
