                  ...
                  <VDropdown icon="feather:more-vertical" spaced right v-tooltip.bubble="'AKSI'">
                    <template #content>
                      ...
                      <a role="menuitem" href="#" class="dropdown-item is-media" @click="pendaftaranBayi(items)"
                        v-if="items.jeniskelamin == 'Perempuan' && (items.isbayi == null || items.isbayi == false)">
                        <div class="icon">
                ...
                <div class="foot-block" style="margin-top: 10px;">
                  ...
                  <div class="developers">
                    ...
                    <VButton type="button" icon="fa fa-history" class="is-fullwidth mr-3" color="warning" outlined
                      ...
                      Riwayat </VButton>
                    <VButton type="button" icon="fa fa-history" class="is-fullwidth mr-3" color="warning" outlined
                      raised @click="riwayatSanata(items)">
                    ...
                    <VButton type="button" icon="feather:arrow-right-circle" class="is-fullwidth mr-3" color="purple"
                      ...
                      v-if="(items.tglmeninggal == null || items.tglmeninggal != null) && (kelompokUser != 'laboratorium' && kelompokUser != 'radiologi')">
                      Registrasi
                    </VButton>
                  </div>
                </div>
            ...
            <div class="column is-12">
              <VField>
                ...
                <VControl icon="feather:user">
                  <VInput type="text" v-model="item.qnocm" @keyup="normFormat(item.qnocm)" maxlength="8" v-on:keyup.enter="filter()" placeholder="No RM" />
                </VControl>
              </VField>
            </div>
            <div class="column is-12">
            ...
            <div class="column is-12">
              <VControl class="prime-auto">
                <VField>
                  ...
                  <Calendar v-model="item.tglLahir" :locale="'id'" selectionMode="single" :showIcon="true"
                    :manualInput="true" class="w-100" :dateFormat="H.dateTimeFormat().prime.date"
...
// PASIEN LAMA HAPUS CACHE NYA DISINI, KALO PERLU BUKA LAGI
