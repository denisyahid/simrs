            ...
            <VCard>
                <div class="column c-title pt-2 mb-0">
                    <div class="column is-10 p-0">
                        <label class="title-page">Daftar Kejadian Pasien Pulang Paksa</label>
                    </div>
                </div>
...
useHead({
    title: 'Daftar Pasie Pulang Paksa - ' + import.meta.env.VITE_PROJECT,
})
...
const fetchData = async () => {
    ...
    await useApi().get(`pmkp/get-laporan-pasien-pulang-paksa?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}${ruangan}`).then((response) => {
...
const exportExcel = () => {
    ...
    const worksheet = XLSX.utils.aoa_to_sheet([
        ['Daftar Pasien Pulang Paksa'],
        [],
        ['NO','TANGGAL REGISTRASI','NO REGISTRASI', 'NO CM', 'NAMA PASIEN', 'RUANGAN', 'TANGGAL PULANG'],
