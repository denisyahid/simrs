...
const op = ref();
const title = ref('Dokter Pemberi Pelayanan Rawat Inap');
...
const fetchData = async () => {
    ...
    await useApi().get(`pmkp/get-laporan-dokter-pelayanan-ranap?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}${ruangan}`).then((response) => {
