        ...
        <div class="column is-12">
            <VCard>
                ...
                <DataTable v-else :rows="5" :value="dataSource" :loading="loadSearch" :rowsPerPageOptions="[5, 10, 15]"
                    ...
                    <Column field="jumlah" header="Jumlah Layanan" />
...
useHead({
    title: 'Dokter Pemberi Pelayanan Poliklinik - ' + import.meta.env.VITE_PROJECT,
})
...
const op = ref();
const title = ref('Dokter Pemberi Pelayanan Poliklinik');
...
const fetchData = async () => {
    ...
    await useApi().get(`pmkp/get-laporan-dokter-pelayanan-poli?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}${ruangan}`).then((response) => {
...
const exportExcel = () => {
    ...
    const worksheet = XLSX.utils.aoa_to_sheet([
        ['Dokter Pemberi Pelayanan Poliklinik'],
        [],
