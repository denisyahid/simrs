        ...
        <div class="column is-12">
            <VCard>
                ...
                <DataTable v-else :rows="5" :value="dataSource" :loading="loadSearch" :rowsPerPageOptions="[5, 10, 15]"
                    ...
                    <Column field="lama_meninggal" header="Lama Meninggal">
                      <template #body="slotProps">
                     {{ slotProps.data.lama_meninggal + ' Jam'}}
                      </template>
                    </Column>
                </DataTable>
            </VCard>
...
const fetchData = async () => {
    ...
    await useApi().get(`pmkp/get-laporan-kematian-pasien-ranap?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}${ruangan}`).then((response) => {
