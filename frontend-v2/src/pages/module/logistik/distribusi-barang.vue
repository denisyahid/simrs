                                                ...
                                                <VField class="is-rounded-select is-autocomplete-select">
                                                    ...
                                                    <VControl icon="feather:search">
                                                        <Multiselect mode="single" v-model="item.ruanganTujuan"
                                                            ...
                                                            :disabled="PRIHAL == 'verifikasi' || ISEDIT_KIRIM ? true : false" />
                                                    </VControl>
                                                </VField>
                                            </div>
                                            <div class="column is-4">
                                        ...
                                        <div class="columns is-multiline">
                                            ...
                                            <DataTable :value="dataSource" showGridlines editMode="cell" class="p-datatable-sm"
                                                ...
                                                :paginator="true" :rows="5" :rowsPerPageOptions="[5, 10, 25]"> 
                                                    ...
                                                    <Column field="jumlah" header="Qty Amprahan"></Column>
...
const TITLE_PAGE = PRIHAL ? 'Verifikasi' : 'Distribusi Barang'
useHead({
...
const save = async () => {
    ...
    let url = '/logistik/distribusi-barang-produk-save'
    ...
    if(isNull.value == false){
        ...
        if(response.data != null){
            useApi().post(`/logistik/distribusi-barang-produk-save?norec=${response.data.Struk_Kirim.norec}&prihal=verifikasi`,objSaveVerif).then((response:any)=>{
