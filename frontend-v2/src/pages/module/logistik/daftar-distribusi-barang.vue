                  ...
                  <div class="column is-12">
                    <a class="flight-summary">
                      ...
                      <div class="meta" style="margin-left: 12rem;">
                        <TdaftarDistribusi :item="items" @batalKirim="DialogConfirm(items,'batal kirim')" @unverif="DialogConfirm(items,'unverif')" @editItems="editDis(items)" @cetakBuktiKirim="cetakBuktiKirim(items)"  @gotoRetur="gotoRetur(items)"  @verif="verif(items)"/>
...
useHead({
  title: 'Daftar Distribusi Barang - ' + import.meta.env.VITE_PROJECT,
})
