  ...
  <VCard>
    ...
    <div class="columns">
      <div class="column is-8">
        ...
        <div class="columns">
          <div class="column is-12" v-if="selectView == 'grid'">
          ...
          <div class="column is-12" v-else-if="selectView == 'list'">
...
const TITLE_PAGE = "Master Produk CSSD"
useHead({
...
const listDropdown = async () => {
  ...
  await useApi().get(`/stelilisasi/combo`).then((response: any) => {
    ...
    item.detailjenisproduk = DetailProduk.value[0].value
