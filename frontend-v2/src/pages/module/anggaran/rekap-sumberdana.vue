            ...
            <div class="form-outer">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                    <div class="form-header-inner">
                        <ConfirmDialog/>
                        <div class="left">
                            <h3>REKAP PER-SUB KEGIATAN(SUMBER DANA)</h3>
                        </div>
                        <div class="right">
                            <div class="buttons">
...
useHead({
  title: 'Rekap per SUMBER DANA - ' + import.meta.env.VITE_PROJECT,
})
...
if (item.terhadapdetail != undefined) {
    window.open(baseTransaksi + "report/get-cetak-rekap-SumberDana-anggaran-sebelum?tahun=" + moment(tahun).format('YYYY') + "&subsubkegiatan=" + subsubkegiatan + "&tahap=" + tahap + "&terhadap=" + terhadap + "&tglcetak=" + moment(item.tglCetak4).format('YYYY-MM-DD HH:mm')+kode, '_blank');
} else if(item.terhadapdetail == undefined){
  H.printBlade("report/get-cetak-rekap-SumberDana-anggaran-sebelum?tahun=" +moment(tahun).format('YYYY')+ "&subsubkegiatan=" + subsubkegiatan + "&tahap="+tahap+"&tglcetak="+moment(item.tglCetak4).format('YYYY-MM-DD HH:mm'), '_blank');
}
