...
useHead({
  title: 'Cetak Anggaran Kas - ' + import.meta.env.VITE_PROJECT,
})
...
if (item.terhadapdetail != undefined) {
  ...
  H.printBlade("report/get-cetak-kas?tahun=" +moment(tahun).format('YYYY')+ "&subsubkegiatan=" + subsubkegiatan + "&tahap="+tahap+"&tglcetak="+moment(item.tglCetak4).format('YYYY-MM-DD HH:mm'), '_blank');
}
