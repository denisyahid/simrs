...
useHead({
  title: 'REKAP TOTAL ANGGARAN - ' + import.meta.env.VITE_PROJECT,
})
...
if (item.terhadapdetail != undefined) {
  ...
  H.printBlade("report/get-cetak-rekap-total-anggaran?tahun=" +moment(tahun).format('YYYY')+ "&subsubkegiatan=" + subsubkegiatan + "&tahap="+tahap+"&tglcetak="+moment(item.tglCetak4).format('YYYY-MM-DD HH:mm'), '_blank');
}
