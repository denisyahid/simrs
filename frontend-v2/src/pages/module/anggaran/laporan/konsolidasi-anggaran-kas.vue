            ...
            <div class="form-outer">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                    <div class="form-header-inner">
                        <ConfirmDialog/>
                        <div class="left">
                            <h3>KONSOLIDASI RBA-BLUD KE REKENING SIPD PERMENDAGRI</h3>
                        </div>
                        <div class="right">
                            <div class="buttons">
...
useHead({
  title: 'Konsolidasi Anggaran Kas - ' + import.meta.env.VITE_PROJECT,
})
...
if (item.terhadapdetail != undefined) {
  ...
  H.printBlade("report/get-cetak-konsolidasi-per-permen?tahun=" +moment(tahun).format('YYYY')+ "&subsubkegiatan=" + subsubkegiatan+"&subkegiatan=" + subkegiatan + "&tahap="+tahap+"&tglcetak="+moment(item.tglCetak4).format('YYYY-MM-DD HH:mm'), '_blank');
}
