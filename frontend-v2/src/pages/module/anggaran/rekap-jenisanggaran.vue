            ...
            <div class="form-outer">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                    <div class="form-header-inner">
                        <ConfirmDialog/>
                        <div class="left">
                            <h3>REKAP PER-SUB KEGIATAN(JENIS ANGGARAN)</h3>
                        </div>
                        <div class="right">
                            <div class="buttons">
...
if (item.terhadapdetail != undefined) {
  ...
  H.printBlade("report/get-cetak-per-jenis-anggaran?tahun=" +moment(tahun).format('YYYY')+ "&subsubkegiatan=" + subsubkegiatan + "&tahap="+tahap+"&tglcetak="+moment(item.tglCetak4).format('YYYY-MM-DD HH:mm'), '_blank');
}
