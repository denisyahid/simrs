      ...
      <div class="column c-title pt-2 mb-0">
        <div class="columns p-2">
          <div class="column is-10">
            <label class="title-page">Daftar Pengeluaran Stok Darah</label>
            <label for="">List Stok Pengeluaran Darah</label>
          </div>
            ...
            <div v-else>
              <div class="p-0" v-if="dataLength < 1">
                ...
                <h3 style="text-align: center;font-weight: 600;color: var(--dark-text);font-family: var(--font-alt);">
                  Daftar Pengeluaran Stok Darah Saat ini tidak tersedia</h3>
              </div>
