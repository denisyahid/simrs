                                    ...
                                    <div class="title-wrap">
                                        <div class="columns">
                                            <div class="column is-3">
                                                <VAvatar size="small" :color="listColor[i]"
                                ...
                                <div class="foot-block">
                                    ...
                                    <div class="developers">
                                        <VButton type="button" icon="fas fa-notes-medical" class="is-fullwidth mr-3"
                                            color="warning" outlined raised @click="transaksiPelayanan(items)">
    ...
    <VCard v-if="activeValue == 2">
        ...
        <div class="columns  all-projects m-3 mt-0">
            ...
            return await fetchRuangan(query)
                        ...
                        <div class="column is-12">
                            <VButton @click="filterRanap()" :loading="ds_PASIENRANAP.loading" type="button"
