...
export function Konjungtiva(): any{
  return [
    ...
    {label: 'Anemis', value: 'Anemis'},
    {label: 'Sklera Ikterik', value: 'SkleraIkterik'},
    {label: 'Tidak Anemis', value: 'TidakAnemis'},
  ]
}
...
export function resikoJatuh(): any{
  return [
    ...
    {label: 'Skala Morse', value: 'SkalaMorse', model: 'skalaMorse'},
    // {label: 'Skala Mumpty Dumpty', value: 'SkalaMumptyDumpty'},
    {label: 'Rendah 0-7', value: 'Rendah0-7', model: 'rendah'},
    {label: 'Sedang 8-13', value: 'Sedang8-13', model: 'sedang'},
    {label: 'Tinggi ≥ 14', value: 'Tinggi≥14', model: 'tinggi'},
    {label: 'Skala Mumpty Dumpty', value: 'SkalaMumptyDumpty', model: 'skalaMumptyDumpty'},
    {label: 'Rendah 7-11', value: 'Rendah7-11', model: 'rendahMumpty'},
    {label: 'Tinggi ≥ 12', value: 'Tinggi≥12', model: 'tinggiMumpty'},
  ]
}
