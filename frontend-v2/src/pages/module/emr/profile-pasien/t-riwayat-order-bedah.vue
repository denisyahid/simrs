                                    ...
                                    <div class="meta-text">
                                        <table class="tb-order">
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td class="text-value">{{ item.tgloperasi }} Menit </td>
                                            </tr>
                                            <tr>
                                                <td>Jenis Operasi</td>
                                                <td>:</td>
                                                <td class="text-value">{{ item.jenisoperasi }}  </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="columns is-multiline">
                                        ...
                                        <div class="column is-12 ">
                                            ...
                                            <VIconButton icon="feather:file-text" @click="$emit('hasilItems', item)"
                                                raised circle class="mr-2 is-pulled-right" v-tooltip.bubble="'Hasil'" :loading="props.isLoading">
                                            </VIconButton>
                                            <VIconButton icon="feather:trash" @click="$emit('hapusItems', item)"
                                                color="danger" raised circle class="mr-2 is-pulled-right"
                                                v-tooltip.bubble="'Hapus'" :loading="props.isLoading">
                                            </VIconButton>
                                            <VIconButton icon="feather:edit" @click="$emit('editItems', item)"
                                                color="info" raised circle class="mr-2 is-pulled-right"
                                                v-tooltip.bubble="'Edit'" :loading="props.isLoading">
                                            </VIconButton>
                                        </div>
                                    </div>
                                </div>
