                                ...
                                <div class="box-end" style="width:30%">
                                    <div class="columns is-multiline">
                                        ...
                                        <div class="column is-12 ">
                                            <VIconButton v-if="item.status == 'pending'" icon="feather:trash" @click="$emit('hapusItems', item)"
                                                color="danger" raised circle class="mr-2 is-pulled-right"
                                                v-tooltip.bubble="'Hapus'">
                                            </VIconButton>
                                            <VIconButton v-if="item.status == 'pending' && !isHideEdit" icon="feather:edit" @click="$emit('editItems', item)" color="info"
                                                raised circle class="mr-2 is-pulled-right" v-tooltip.bubble="'Edit'"  v> 
                                            </VIconButton>
                                            <VIconButton v-if="item.status != 'pending'" icon="feather:file-text" @click="$emit('cetakItems', item)"
