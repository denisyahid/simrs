                                        ...
                                        <div class="meta-text">
                                            <table class="tb-order">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td class="text-value">{{ item.ruangantujuan }} </td>
                                                </tr>
                                                <tr>
                                                    <td>Dokter</td>
                                                    <td>:</td>
                                            ...
                                            <div v-for="(detail, index2) in item.details">
                                                <p>
                                                    <span class="status mt-1" style="position: absolute;"></span>
                                                    <span class="ml-3">
                                                        {{ detail.namaproduk }}
                                                    </span>
                                                </p>
                                    ...
                                    <div class="box-end" style="width:30%">
                                        <div class="columns is-multiline">
                                            ...
                                            <div class="column is-12 ">
                                                <VIconButton v-if="item.idruangantujuan == 123" icon="feather:file-text"
                                                    @click="$emit('hasilLabManual', item)" raised circle
                                                    class="mr-2 is-pulled-right" v-tooltip.bubble="'Hasil Lab PK'">
                                                </VIconButton>
                                                <VIconButton v-else-if="item.idruangantujuan == 124"
                                                    icon="feather:file-text" @click="$emit('hasilLabManual', item)"
                                                    raised circle class="mr-2 is-pulled-right"
                                                    v-tooltip.bubble="'Hasil Lab PA'">
                                                </VIconButton>
                                                <VIconButton v-if="item.status == 'pending'" icon="feather:trash"
                                                    @click="$emit('hapusItems', item)" color="danger" raised circle
                                                    class="mr-2 is-pulled-right" v-tooltip.bubble="'Hapus'">
                                                </VIconButton>
                                                <VIconButton v-if="item.status == 'pending'" icon="feather:edit"
                                                    @click="$emit('editItems', item)" color="info" raised circle
