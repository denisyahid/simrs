<template>
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>PEMASANGAN DAN PELEPASAN KATETER VENA SENTRAL / ARTERI PADA NEONATUS</h3>
                        </div>
                        <div class="right">
                        ...
                        <tr>
                            ...
                            <div style="display: flex; align-items: center; gap: 2rem; margin-top: 3rem;">
                                ...
                                <VField style="max-width: 50rem;">
                                    <VTextarea v-model="input.kul2" placeholder="Sebutkan" color="primary" rows="1" />
                                    </VField>
                            </div>
  ...
  const props = withDefaults(
    ...
    }>(),
    {
      ...
      FORM_NAME: '',
      FORM_URL: '',
      COLLECTION: 'pemasangandanpelepasankatetervenasentral',
    }
  )
