                        ...
                        <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-6" style="margin-top: -1rem;">
                                    <VField>
                                        <VControl>
                                            <VRadio v-model="input.defisitVolumeCairan" value="Ya"
                                                label="Defisit volume cairan (D.0036)" name="defisitVolumeCairan"
                                ...
                                <div class="column is-12 p-0">
                                    <div class="is-flex">
                                        <div class="column is-6" style="margin-top:0.5rem">
                                            <h1> Setelah dilakukan tindakan asuhan keperawatan selama : </h1>
                                        </div>
                                        <div class="column is-6" style="margin-left: -5rem;">
                                            <VField>
                                                <VControl>
                                                    <VInput type="text" class="input" placeholder=""
                                                        v-model="input.lamaTindakanAsuhan" />
                                                </VControl>
                                    ...
                                    <div class="column is-12 p-0">
                                        <div class="is-flex">
                                            <div class="column is-6" style="margin-top:0.5rem">
                                                <h1> Ketidakseimbangan cairan tidak terjadi dengan </h1>
                                            </div>
                                            <div class="column is-6" style="margin-left: -5rem;">
                                                <VField>
                                                    <VControl>
                                                        <VInput type="text" class="input" placeholder=""
                                                            v-model="input.kesetidakimbanganCairan" />
                                                    </VControl>
...
import * as EMR from '../page-emr-plugins/resiko-ketidakseimbangan'
...
const COLLECTION: any = ref('ResikoKetidakseimbangan') //table mongodb
