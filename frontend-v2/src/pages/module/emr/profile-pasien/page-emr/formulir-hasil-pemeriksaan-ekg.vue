        ...
        <div class="columns is-multiline">
          ...
          <div class="column is-12 is-flex">
            ...
            <div class="column is-10">
              <VField>
                <VDatePicker
                  v-model="input.tanggalEksaminasi"
                  mode="dateTime"
                  style="width: 100%"
                  trim-weeks
                  :max-date="new Date()"
...
import * as EMR from '../page-emr-plugins/hasil-pemeriksaan-ekg'
...
const print = async () => {
  H.printBlade(
    `emr/cetak-formulir-hasil-pemeriksaan-ekg?nocmfk=${ID_PASIEN}&norec_pd=${props.registrasi.norec_pd}&collection=${COLLECTION.value}&emrpasienfk=${NOREC_EMRPASIEN.value}`
  )
}
