                        ...
                        <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-6 pl-5">
                                    <VField>
                                        <VDatePicker v-model="input.tgl" mode="dateTime" style="width: 100%" trim-weeks
                                            :max-date="new Date()">
                            ...
                            <div class="column is-6" style="margin-top: -1rem;">
                                    <VField>
                                        <VControl>
                                            <VRadio v-model="input.resikoInfeksi" value="Ya" label="Resiko Infeksi (0142)"
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Diagnosa Keperawatan">
                                <div class="column is-12" style="margin-top: -1rem;">
                                    <VField>
                                        <VControl>
                                            <VRadio v-model="input.peningkatanPatogenik" value="Ya" label="Beresiko mengalami peningkatan terserang patogenik"
                                                name="peningkatan" color="info" square style="font-size: 15px" />
                                        </VControl>
                                    </VField>
                                </div>

                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Penyebab :</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-6" v-for="(data, i) in penyebab">
                                            <VField>
                                ...
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Malnutrisi :</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-6" v-for="(data, i) in malnutrisi">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.title"
                                                        :label="data.title" class="p-0" color="primary" square />
                                ...
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Ketidakseimbangan  pertahanan tubuh sekunder:</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-6" v-for="(data, i) in kesetidakimbangan">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.title"
                                                        :label="data.title" class="p-0" color="primary" square />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Perencanaan Keperawatan">
                                ...
                                <div class="column is-12 p-0">
                                    ...
                                    <div class="is-flex">
                                        <div class="column is-6" style="margin-top:0.5rem">
                                            <h1> Pasien tidak mengalami infeksi dengan </h1>
                                        </div>
                                        <div class="column is-6" style="margin-left: -5rem;">
                                            <VField>
                                                <VControl>
...
import * as EMR from '../page-emr-plugins/resiko-infeksi'

let ID_PASIEN = useRoute().query.nocmfk as string
let NOREC_PD = useRoute().query.norec_pd as string
let norec_emr = useRoute().query.norec_emr as string

let penyebab = ref(EMR.penyebab())
let malnutrisi = ref(EMR.malnutrisi())
let kesetidakimbangan = ref(EMR.kesetidakimbangan())
...
const COLLECTION: any = ref('ResikoInfeksi') //table mongodb
...
const print = async () => {
    H.printBlade(`emr/cetak-resiko-infeksi?nocmfk=${ID_PASIEN}&norec_pd=${props.registrasi.norec_pd}&collection=${COLLECTION.value}&emrpasienfk=${NOREC_EMRPASIEN.value}`)
}
setView()
loadRiwayat()
</script>