                    ...
                    <div class="column is-12">
                            ...
                            <Fieldset :toggleable="true" legend="Mayor">
                                <div class="column is-12">
                                    ...
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-4" v-for="(data, i) in subjektifMayor">
                                            <VField>
                            ...
                            <Fieldset :toggleable="true" legend="Minor">
                                <div class="column is-12">
                                    ...
                                    <div class="column is-6">
                                            <VField>
                                                <VControl>
                                                    <VInput type="text" class="input" placeholder="Data Subjektif"
                                ...
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Data Objektif:</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in objektifMinor">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.title"
                                                        :label="data.title" class="p-0" color="primary" square />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Outcome">
                                <div class="column is-12">
                                    ...
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-6" v-for="(data, i) in keseimbanganCairan">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.title"
                                                        :label="data.title" class="p-0" color="primary" square />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Intervensi">
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Manajemen Hipervolumia :</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in manajemenHipervolumia">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.title"
                                                        :label="data.title" class="p-0" color="primary" square />
...
import * as EMR from '../page-emr-plugins/hipervolemia'
...
let keseimbanganCairan = ref(EMR.keseimbanganCairan())
let manajemenHipervolumia = ref(EMR.manajemenHipervolumia())
...
const COLLECTION: any = ref('Hipervolemia') //table mongodb
