      ...
      <div class="form-outer" style="margin-top:15px">
        <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
          <div class="form-header-inner">
            <div class="left">
              <h3>Formulir Rekonsiliasi Obat Masuk Rumah Sakit</h3>
            </div>
            <div class="right">
        ...
        <div class="column">
          <div style="display: flex; justify-content: center; align-items: center;">
              ...
              "
              >REKONSILIASI OBAT SAAT PASIEN <b>MASUK RUMAH SAKIT</b></span>
          </div>
          ...
          <div class="column" style="overflow:auto">
            <table class="table">
              <tr>
                ...
                <th style="background-color: palegreen;width:12.5%">Lama Pakai Obat</th>
                <th style="background-color: palegreen;width:12.5%">Tindak Lanjut oleh DPJP</th>
              ...
              <tr v-for="(item, index) in input.details" :key="index">
                ...
                <td>
                  <VField>
                    <VTextarea rows="2" v-model="item.TBA"></VTextarea>
                  </VField>
                </td>
                <td>
                  <VControl>
          ...
          <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-4" style="margin-left: 21rem;text-align: left; margin-top:1rem">
                                    ...
                                    <thead>
                                        <tr>
                                        <th class="grey-background">Rekonsiliasi saat pasien Masuk Rumah Sakit :</th>
                                        </tr>
                                        <tr>
                                        <th class="grey-background">Membandingkan antara daftar penggunaan obat
                                        sebelum admisi dengan resep/instruksi pengobatan
                                        saat admisi</th>
                                        </tr>
                                    </thead>
                                </table>
...
useHead({ title: 'Formulir Rekonsiliasi Obat Masuk Rumah Sakit - ' + import.meta.env.VITE_PROJECT })
useViewWrapper().setPageTitle(import.meta.env.VITE_PROJECT)
useViewWrapper().setFullWidth(true)
let ID_PASIEN = useRoute().query.nocmfk as string
let NOREC_PD = useRoute().query.norec_pd as string
let norec_emr = useRoute().query.norec_emr as string
const COLLECTION: any = ref('rekonmasuk') //table mongodb
