<template>
            ...
            <div class="form-section-inner">
              ...
              <div class="columns is-multiline">
                ...
                <div class="column is-12">
                  <VField>
                    <VControl>
                      <VTextarea class="textarea" v-model="item.catataninvivo" rows="2" placeholder="catatan"
            ...
            <div class="form-section-inner">
              ...
              <div class="columns is-multiline">
                ...
                <div class="column is-12">
                  <VField>
                    <VControl>
                      <VTextarea class="textarea" v-model="item.catatanterapi" rows="2"
                        placeholder="Tambahan Terapi Radioaktif" autocomplete="off" autocapitalize="off"
                        spellcheck="true" />
                    </VControl>
                  </VField>
                </div>
  ...
  <!-- <VModal :open="modalAsuransi" title="Surat Eligibilitas Peserta" :noclose="false" size="big" actions="right"
   ...
   <Dialog v-model:visible="modalRiwayat" modal header="Riwayat Terapi" :style="{ width: '50vw' }">
      <TRiwayatOrderRad  :items="listRiwayat"  ></TRiwayatOrderRad>
  </Dialog>
</template>
...
const setFromRegistrasi = async (regis: any) => {
  ...
  item.iskelastitip = regis.iskelastitip
