    ...
    <div class="form-layout is-stacked-2">
      <div class="form-outer" style="margin-top: 15px">
            ...
            <VField>
              <VControl>
                <Multiselect v-model="input.keteranganJatuh" :attrs="{ value }" placeholder="--Pilih--" label="label"
                  :options="caraDatang" :searchable="true" track-by="label" mode="single" autocomplete="off">
                </Multiselect>
              </VControl>
            </VField>
          </div>
        ...
        <div class="column p-0">
          <div class="column is-2">
            <h1 style="font-weight: bold">Kriteria Mayor:</h1>
          </div>
          <div class="column is-12 pt-0 is-flex">
            <VField>
              <VControl>
                <VCheckbox v-model="input.pasienTampak" class="pt-1 pb-1" label="Pasien Tampak Kesakitan" true-value="kesakitan" color="primary" circle />
              </VControl>
            </VField>

            <VField>
              <VControl>
                <VCheckbox v-model="input.pasienTampak2" class="pt-1 pb-1" label="Pasien Tampak Sesak Nafas" true-value="sesak" color="primary" circle />
              </VControl>
            </VField>

            <VField>
              <VControl>
                <VCheckbox v-model="input.pasienTampak3" class="pt-1 pb-1" label="Pasien mengeluh adanya pendarahan aktif" true-value="pendarahan" color="primary" circle />
              </VControl>
            </VField>

            <VField>
              <VControl>
                <VCheckbox v-model="input.pasienTampak4" class="pt-1 pb-1" label="Pasien tidak sadar" color="primary" true-value="tidak sadar" circle />
              </VControl>
            </VField>
          </div>
        </div>
        ...
        <div class="column p-0">
          <div class="column is-2">
            <h1 style="font-weight: bold">Kriteria Minor:</h1>
          </div>
          <div class="column is-12 pt-0 is-flex">
            <VField>
              <VControl>
                <VCheckbox v-model="input.kriteriaMinor" class="pt-1 pb-1" label="Pasien Tampak Pucat" true-value="pucat" color="primary" circle />
              </VControl>
            </VField>

            <VField>
              <VControl>
                <VCheckbox v-model="input.kriteriaMinor2" class="pt-1 pb-1" label="Pasien Tampak Sangat Lemah" true-value="lemah" color="primary" circle />
              </VControl>
            </VField>

            <VField>
              <VControl>
                <VCheckbox v-model="input.kriteriaMinor3" class="pt-1 pb-1" label="Pasien tampak gelisah" true-value="gelisah" color="primary" circle />
              </VControl>
            </VField>

            <VField>
              <VControl>
                <VCheckbox v-model="input.kriteriaMinor4" class="pt-1 pb-1" label="Pasien demam" true-value="Demam" color="primary" circle />
              </VControl>
            </VField>
          </div>
        </div>
        ...
        <div class="column p-0">
          <div class="column is-2">
            <h1 style="font-weight: bold">Kriteria Klinis:</h1>
          </div>
          <div class="column is-12 pt-0 is-flex">
            <VField>
              <VControl>
                <VCheckbox v-model="input.kriteriaKlinis" class="pt-1 pb-1" label="Tekanan darah > 180/110 mmhg atau 90/60 mmhg" true-value="Tekanan darah > 180/110 mmhg atau 90/60 mmhg" color="primary" circle />
              </VControl>
            </VField>

            <VField>
              <VControl>
                <VCheckbox v-model="input.kriteriaKlinis2" class="pt-1 pb-1" label="Pernafasan >= 30 x/menit" true-value="Pernafasan >= 30 x/menit" color="primary" circle />
              </VControl>
            </VField>

            <VField>
              <VControl>
                <VCheckbox v-model="input.kriteriaKlinis3" class="pt-1 pb-1" label="Suhu tubuh >= 39°C" true-value="Suhu tubuh >= 39°C" color="primary" circle />
              </VControl>
            </VField>

            <VField>
              <VControl>
                <VCheckbox v-model="input.kriteriaKlinis4" class="pt-1 pb-1" label="Nadi < 60 atau Nadi > 100 x/menit" true-value="Nadi < 60 atau Nadi > 100 x/menit" color="primary" circle />
              </VControl>
            </VField>
          </div>
        </div>
        ...
        <div class="column is-12 columns is-multiline pb-0">
            ...
            <VField>
              <VControl>
                <Multiselect v-model="input.skalaNyeri" :attrs="{ value }" placeholder="--Pilih--" label="label"
                  :options="skalaNyeri" :searchable="true" track-by="label" mode="single" autocomplete="off">
                </Multiselect>
              </VControl>
            </VField>
          </div>
          <div class="column is-6">
            ...
            <VField>
              <VControl>
                <VInput v-model="input.lokasiNyeri" class="input" placeholder="Lokasi Nyeri" />
              </VControl>
            </VField>
          </div>
          <div class="column is-12">
            <img src="/images/emr/wongBaker-2.png" />
          </div>
        </div>

        <div class="column is-12 columns is-multiline pb-2">
          <div class="column is-6">
            <h1 style="font-weight: bold">Resiko Jatuh:</h1>
            <VField>
              <VControl>
                <Multiselect v-model="input.resikoJatuh" :attrs="{ value }" placeholder="--Pilih--" label="label"
          ...
          <div class="column is-6">
            ...
            <VField>
              <VControl>
                <Multiselect v-model="input.riwayatAlergi" :attrs="{ value }" placeholder="--Pilih--" label="label"
                  :options="riwayatAlergi" :searchable="true" track-by="label" mode="single" autocomplete="off">
                </Multiselect>
              </VControl>
            </VField>
          </div>
          <div class="column is-12">
            <h1 style="font-weight: bold">Tindak Lanjut:</h1>
            <VField>
              <VControl>
                <Multiselect v-model="input.tindakLanjut" :attrs="{ value }" placeholder="--Pilih--" label="label"
                  :options="tindakLanjut" :searchable="true" track-by="label" mode="single" autocomplete="off">
                </Multiselect>
              </VControl>
            </VField>
          </div>
...
const caraDatang: any = ref([{ value: 'Jalan', label: 'Jalan' }, { value: 'Kursi Road', label: 'Kursi Roda' }, { value: 'Tempat Tidur', label: 'Tempat Tidur' }])
const skalaNyeri: any = ref([
  { value: 'Ringan 0-3', label: 'Ringan 0-3' },
  { value: 'Sedang 4-6', label: 'Sedang 4-6' },
  { value: 'Berat 7-10', label: 'Berat 7-10' },
])
const resikoJatuh: any = ref([
  { value: 'Resiko Rendah', label: 'Resiko Rendah' },
  { value: 'Resiko Tinggi', label: 'Resiko Tinggi' },
  { value: 'Tidak Beresiko', label: 'Tidak Beresiko' },
])
const riwayatAlergi: any = ref([
  { value: 'Ya', label: 'Ya' },
  { value: 'Tidak', label: 'Tidak' },
])
const tindakLanjut: any = ref([
  { value: 'Antrian Sesuai Jadwal', label: 'Antrian Sesuai Jadwal' },
  { value: 'Diprioritaskan ke Poli / Pesawat', label: 'Diprioritaskan ke Poli / Pesawat' },
  { value: 'Penanganan Segera (aktifkan TMRC)', label: 'Penanganan Segera (aktifkan TMRC)' },
])
...
const COLLECTION: any = ref("SkriningUmumPasien"); //table mongodb
