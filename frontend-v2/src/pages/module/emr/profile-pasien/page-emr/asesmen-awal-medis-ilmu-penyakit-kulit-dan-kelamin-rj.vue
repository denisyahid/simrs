...
// Judul
useHead({
    title: 'Asesmen Awal Medis Ilmu Penyakit Kulit dan Kelamin - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('AsesmenAwalMedisIlmuPenyakitKulitdanKelaminRJ') //table mongodb
...
const loadGambar = async (element_id: string, value: string) => {
    ...
    if (sigCanvas) {
        ...
        background.onload = function () {
            context.drawImage(background, 0, 0, 1300, 920);
        }
    }
}
const simpan = () => {
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header" style="margin-bottom: 10px">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Asesmen Awal Medis Ilmu Penyakit Kulit dan Kelamin</h3>
                        </div>
                        <div class="right">
                            <div class="buttons">
                ...
                <div class="columns is-multiline p-2">
                    ...
                    <div class="column is-12">
                        <Fieldset :toggleable="true" legend="Pemeriksaan Fisik">
                            <div class="column is-12" style="padding: 10px; padding-top: 0px;">
                                ...
                                <div class="column is-12">
                                    <span><b>b. Status General</b></span>
                                </div>
                                <div class="column is-12 columns is-multiline">
                                    <div class="column is-12">
                                        <VField label="Kepala">
                    ...
                    <div class="column is-12">
                        <div class="column" style="font-weight:bold">Status Dermatologi</div>
                            ...
                            <tbody>
                                <tr>
                                    <td width="50%">
                                        <div class="column is-12">
                                            <VControl raw subcontrol>
                                                <VCheckbox class="p-0" color="primary" square true-value="Lokasi"
                                                    label="Lokasi (Jabarkan lokasi sesuai dengan regio anatomis)"
                                                    v-model="input.CBLokasiSD" />
                                            </VControl>
                                        </div>
                                        <div class="column is-12">
                                            <VField>
                                                <VTextarea rows="2" v-model="input.TALokasiSD"></VTextarea>
                                            </VField>
                                        </div>
                                    </td>
                                    <td rowspan="2" width="50%" style="overflow: auto;">
                                        <Gambarin elemenID="GambarTubuh" height="920" width="1300"
                                ...
                                <tr>
                                    <td>
                                        <div class="column is-12">
                                            <VControl raw subcontrol>
                                                <VCheckbox class="p-0" color="primary" square true-value="Eflorisensi"
                                                    label="Bentuk Kelainan Kulit (Eflorisensi)"
                                                    v-model="input.CBEflorisensiSD" />
                                            </VControl>
                                        </div>
                                        <div class="column is-12">
                                            <VField>
                                                <VTextarea rows="2" v-model="input.TAEflorisensiSD"></VTextarea>
                                            </VField>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="column">
                                            <VControl raw subcontrol>
                                                <VCheckbox class="p-0" color="primary" square
                                                    true-value="Stigmata Atopi"
                                                    label="Stigmata Atopi (Pit. Alba, Ikhtiosis, Keratosis, Denie- Morgagni, dll)"
                                                    v-model="input.CBStigmataAtopiSD" />
                                            </VControl>
                                        </div>
                                        <div class="column">
                                            <VControl raw subcontrol>
                                                <VCheckbox class="p-0" color="primary" square true-value="Mukosa"
                                                    label="Mukosa" v-model="input.CBMukosaSD" />
                                            </VControl>
                                            <VField style="margin-top:5px">
                                                <VTextarea rows="2" v-model="input.TAMukosaSD"></VTextarea>
                                            </VField>
                                        </div>
                                        <div class="column">
                                            <VControl raw subcontrol>
                                                <VCheckbox class="p-0" color="primary" square true-value="Rambut"
                                                    label="Rambut" v-model="input.CBRambutSD" />
                                            </VControl>
                                            <VField style="margin-top:5px">
                                                <VTextarea rows="2" v-model="input.TARambutSD"></VTextarea>
                                            </VField>
                                        </div>
                                        <div class="column">
                                            <VControl raw subcontrol>
                                                <VCheckbox class="p-0" color="primary" square true-value="Kuku"
                                                    label="Kuku" v-model="input.CBKukuSD" />
                                            </VControl>
                                            <VField style="margin-top:5px">
                                                <VTextarea rows="2" v-model="input.TAKukuSD"></VTextarea>
                                            </VField>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="column">
                                            <VControl raw subcontrol>
                                                <VCheckbox class="p-0" color="primary" square
                                                    true-value="Fungsi Kelenjar Keringat"
                                                    label="Fungsi Kelenjar Keringat : Hiperhidrosis, Anhidrosis"
                                                    v-model="input.CBStigmataAtopiSD" />
                                            </VControl>
                                        </div>
                                        <div class="column">
                                            <VControl raw subcontrol>
                                                <VCheckbox class="p-0" color="primary" square
                                                    true-value="Kelenjar Limfe" label="Kelenjar Limfe"
                                                    v-model="input.CBKelenjarLimfeSD" />
                                            </VControl>
                                            <VField style="margin-top:5px">
                                                <VTextarea rows="2" v-model="input.TAKelenjarLimfeSD"></VTextarea>
                                            </VField>
                                        </div>
                                        <div class="column">
                                            <VControl raw subcontrol>
                                                <VCheckbox class="p-0" color="primary" square true-value="Saraf"
                                                    label="Saraf : (Penebalan saraf perfer, parestesi, makula-anestesi)"
                                                    v-model="input.CBSarafSD" />
                                            </VControl>
                                        </div>
                                    </td>
                                </tr>
