        ...
        <div class="column is-12">
            <VCard>
                <div class="columns is-multiline">
                    ...
                    <div class="column is-12">
                        <Fieldset class="p-fieldsets" legend="PERSETUJUAN OPERAS/ PROSEDUR INVASIF"
                            :toggleable="true">
                            <div class="column is-12">
...
import * as EMR from '../page-emr-plugins/informed-tindakan-operasi'
...
const COLLECTION: any = ref('InformedConsentTindakanOperasi') //table mongodb
