  ...
  <div class="columns is-multiline p-2">
    ...
    <div class="column is-12">
      <VCard>
        ...
        <div class="columns is-multiline">
          <div class="column is-2">
            <h1 style="font-weight: bold">DIANEAL PD4 1.5%:</h1>
          </div>
          <div class="column is-10">
            <VField>
              <VControl>
                <VTextarea v-model="input.dianealPD1" rows="1"> </VTextarea>
              </VControl>
            </VField>
          </div>
        </div>
        ...
        <div class="columns is-multiline">
          <div class="column is-2">
            <h1 style="font-weight: bold">DIANEAL PD4 2.5%:</h1>
          </div>
          <div class="column is-10">
            <VField>
              <VControl>
                <VTextarea v-model="input.dianealPD2" rows="1"> </VTextarea>
              </VControl>
            </VField>
          </div>
        </div>
        ...
        <div class="columns is-multiline">
          <div class="column is-2">
            <h1 style="font-weight: bold">DIANEAL PD4 4.25%:</h1>
          </div>
          <div class="column is-10">
            <VField>
              <VControl>
                <VTextarea v-model="input.dianealPD4" rows="1"> </VTextarea>
              </VControl>
            </VField>
          </div>
        </div>
        ...
        <div class="columns is-multiline">
          <div class="column is-2">
            <h1 style="font-weight: bold">MINICAP:</h1>
          </div>
          <div class="column is-10">
            <VField>
              <VControl>
                <VTextarea v-model="input.minicap" rows="1"> </VTextarea>
              </VControl>
            </VField>
          </div>
        </div>
...
const COLLECTION: any = ref('ResepKhususCAPD')
