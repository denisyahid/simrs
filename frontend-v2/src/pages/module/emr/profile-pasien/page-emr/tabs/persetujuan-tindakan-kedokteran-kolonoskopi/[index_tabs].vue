        ...
        <div class="form-outer" style="margin-top:15px">
            <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                <div class="form-header-inner">
                    <div class="left">
                        <h3>Persetujuan Tindakan Kedokteran Kolonoskopi<br>Halaman ke-{{ route.params.index_tabs }}</h3>
                    </div>
                    <div class="right">
...
const COLLECTION: any = ref('PersetujuanTindakanKedokteranKolonoskopi') //table mongodb
...
const setAutoFill = () => {
    ...
    d.pemeriksaantextTindakanKedokteran = 'Kolonoskopi ± biopsi';
    d.pemeriksaantextIndikasiTindakan = 'Diagnostik'
    d.pemeriksaantextTataCara = 'Sesuai spo'
    d.pemeriksaantextTujuan = 'Diagnostik tegak'
    d.pemeriksaantextRisiko = 'Infeksi'
    d.pemeriksaantextKomplikasi = 'Perforasi'
    d.pemeriksaantextPrognosis = 'Dublus',
