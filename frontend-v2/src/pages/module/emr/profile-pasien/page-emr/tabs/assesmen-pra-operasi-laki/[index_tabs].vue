    ...
    <div class="form-outer" style="margin-top:15px">
      <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
        <div class="form-header-inner">
          ...
          <div class="right">
            <ButtonEmr :NOREC_EMRPASIEN="NOREC_EMRPASIEN" :ID_EMR="ID_EMR" :COLLECTION="COLLECTION"
      ...
      <div class="column is-6">
        ...
        <div class="columns is-multiline">
          ...
          <div class="column is-4">
            ...
            <VCheckbox class="fontcheckbox" v-model="input.perutKembung" true-value="Perut Kembung" color="primary" />
            <span v-html="highlightMatch('Perut Kembung')" class="highlighted-label"></span><br>
            <VCheckbox class="fontcheckbox" v-model="input.tidakBisaBAB" true-value="Tidak Bisa BAB" color="primary" />
            <span v-html="highlightMatch('Tidak Bisa BAB')" class="highlighted-label"></span><br>
            <VCheckbox class="fontcheckbox" v-model="input.BABBerdarah" true-value="BAB Berdarah" color="primary" />
            <span v-html="highlightMatch('BAB Berdarah')" class="highlighted-label"></span><br>
          </div>
        </div>
      </div>
      <div class="column is-6">
