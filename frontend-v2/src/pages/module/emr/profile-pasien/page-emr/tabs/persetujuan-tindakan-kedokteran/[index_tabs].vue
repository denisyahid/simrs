          ...
          <table class="table is-bordered  m-0" style="width: 100% !important;">
            ...
            <thead>
              <tr>
                ...
                <th>
                  <VField>
                    <VTextarea v-model="input.pemeriksaantextTindakanKedokteran" color="primary" rows="2" />
                  </VField>
                </th>
                <th style="text-align: center;">
              ...
              <tbody v-for="resep in listTemplateFix">
                ...
                <tr>
                  ...
                  <td style="width:15%;text-align:center;border:1px solid black;vertical-align: middle;padding: 3px;">
                    ...
                    <VIconButton type="button" raised circle icon="fas fa-trash" @click="hapusTemplate(resep.id)"
                      color="danger" v-tooltip-prime.top="'Hapus'">
                    </VIconButton>
                  </td>
                </tr>
              </tbody>
...
useHead({ title: 'Persetujuan Tindakan Kedokteran - ' + import.meta.env.VITE_PROJECT })
...
const COLLECTION: any = ref('PersetujuanTindakanKedokteran') //table mongodb
...
const addTemplate = (response: any) => {
  input.value = {}; // Reset dulu

  input.value = {
    ...response,
    namatemplate: null,
    DTttd: response.DTttd || new Date(),
    diagnosis: response.diagnosis || null,
    details: response.details && response.details.length ? response.details : [{ NO: 1 }]
  };
