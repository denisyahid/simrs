...
useHead({ title: 'Persetujuan Tindakan Kedokteran Masuk Ruang Intensif - ' + import.meta.env.VITE_PROJECT })
...
const COLLECTION: any = ref('PersetujuanTindakanKedokteranMasukRuangIntensif') //table mongodb
...
const simpan = () => {
  ...
  let json = {
    ...
    'url_form': route.name,
    'name_form': 'Persetujuan Tindakan Kedokteran Masuk Ruang Intensif',
