            ...
            <div class="column">
                <div class="column buttons mb-0 mt-0 p-1" style="margin:10px;vertical-align:middle">
                    ...
                    <VButton type="button" rounded outlined color="info" raised icon="feather:file-text"
                        :loading="isLoading" @click="pilihTemplate()"> Pilih Riwayat
                    </VButton>
                </div>
                    ...
                    <table class="table is-bordered  m-0" style="width: 100% !important;">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;">ISI INFORMASI<br><i>Description of the information</i>
                                </th>
                        ...
                        <thead>
                                ...
                                <th>
                                    <VField>
                                        <VControl raw subcontrol class="mr-4">
                                            <VCheckbox class="p-0" color="primary" square true-value="Diagnostik"
                                                label="Diagnostik" v-model="input.pemeriksaantextTindakanKedokteran" />
                                            <VTextarea v-model="input.pemeriksaantextTindakanKedokteranT" true-value="a"
                                                color="primary" rows="1" />
                                        </VControl>
                                        <VControl raw subcontrol class="mr-4">
                                            <VCheckbox class="p-0" color="primary" square true-value="Terapi"
                                                label="Terapi" v-model="input.terapi" />
                                        </VControl>
                                        <VControl raw subcontrol class="mr-4">
                                            <VCheckbox class="p-0" color="primary" square true-value="I-131"
                                                label="I-131" v-model="input.iAja" />
                                        </VControl>
                                        <VControl raw subcontrol class="mr-4">
                                            <VCheckbox class="p-0" color="primary" square true-value="Samarium 153"
                                                label="Samarium 153" v-model="input.samarium" />
                                        </VControl>
                                        <VControl raw subcontrol class="mr-4">
                                            <VCheckbox class="p-0" color="primary" square true-value="Phospor 32"
                                                label="Phospor 32" v-model="input.phospor" />
                                        </VControl>
                                        <VControl raw subcontrol class="mr-4">
                            ...
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextIndikasiTindakan" true-value="a"
                                            color="primary" rows="2" />
                                    </VField>
                                </th>
                            ...
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VControl raw subcontrol class="mr-4">
                                            <VCheckbox class="p-0" color="primary" square true-value="Oral (diminum)"
                                                label="Oral (diminum)" v-model="input.Oral" />
                                        </VControl>
                                        <VControl raw subcontrol class="mr-4">
                                            <VCheckbox class="p-0" color="primary" square
                                                true-value="Intra vena (melalui pembuluh darah vena)"
                                                label="Intra vena (melalui pembuluh darah vena)"
                                                v-model="input.IntraVena" />
                                        </VControl>
                                        <VControl raw subcontrol class="mr-4">
                                            <VTextarea v-model="input.pemeriksaantextTataCara" true-value="a"
                                                color="primary" rows="2" />
                                        </VControl>
                                    </VField>
                                </th>
                ...
                <th style="text-align: center;" class="yes-column">
                  <VCheckbox v-model="input.tujuanCheckbox" true-value="Ya" color="primary" />
                            ...
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextRisiko" true-value="a" color="primary"
                                            rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;" class="yes-column">
                            ...
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextKomplikasi" true-value="a"
                                            color="primary" rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;" class="yes-column">
                                    <VCheckbox v-model="input.pemeriksaantextKomplikasiCheckbox" true-value="Ya"
                                        color="primary" />
                                </th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextPrognosis" true-value="a"
                                            color="primary" rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;">
                                    <VCheckbox v-model="input.pemeriksaantextPrognosisCheckbox" true-value="Ya"
                                        color="primary" />
                                </th>
                            </tr>
                        </thead>
                        <tr>
                            ...
                            <th class="yes-column">
                                <VField>
                                    <VControl raw subcontrol class="mr-4">
                                        <VCheckbox class="p-0" color="primary" square
                                            true-value="Tidak sedang hamil (Not pregnant)"
                                            label="Tidak sedang hamil (Not pregnant)"
                                            v-model="input.tidakSedangHamil" />
                                    </VControl>
                                    <VControl raw subcontrol class="mr-4">
                                        <VCheckbox class="p-0" color="primary" square
                                            true-value="Tidak sedang menyusui (Not breastfeeding)"
                                            label="Tidak sedang menyusui (Not breastfeeding)"
                                            v-model="input.tidakSedangMenyusui" />
                                    </VControl>
                                    <VControl raw subcontrol class="mr-4">
                                        <VCheckbox class="p-0" color="primary" square
                    ...
                    <VTextarea v-model="input.pemeriksaantextTataCara" true-value="a" color="primary" rows="2" />
                            ...
                            <th style="text-align: center;" class="yes-column">
                                <VCheckbox v-model="input.pemeriksaantextAlternatifCheckbox" true-value="Ya"
                                    color="primary" />
                            </th>
                        </tr>
                        <thead>
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextLainLain" true-value="a"
                                            color="primary" rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;">
                    ...
                    <div class="is-12">
                        <h1 style="font-weight: bold;">PERSETUJUAN TINDAKAN KEDOKTERAN KN (AGREEMENT FOR MEDICAL ACTION)
                        </h1>
                    </div>
                    <div class="is-12">
                            ...
                            <tbody v-for="resep in listTemplate">
                                <tr>
                                    <td
                                        ...
                                        <VIconButton type="button" raised circle icon="fas fa-eye"
                                            @click="addRiwayat(resep)" color="info" v-tooltip-prime.top="'Pilih'">
                                        </VIconButton>
                                    </td>
                                    <td
                                        style="width:10%;text-align:center;vertical-align: middle;border: 1px solid black;">
                                        <span class="mb-2">{{ resep.index_tabs ? resep.index_tabs : 1 }}</span><br>
                                    </td>
                                    <td
                                        style="width:10%;text-align:center;vertical-align: middle;border: 1px solid black;">
                                        <span class="mb-2">{{ resep.created_at }}</span><br>
                                    ...
                                    <td
                                        style="width:20%;text-align:center;vertical-align: middle;border: 1px solid black;">
                                        <span class="mb-2">{{ resep.registrasi.namaruangan }}</span><br>
                                    </td>
                                    <td
                                        style="width:20%;text-align:center;vertical-align: middle;border: 1px solid black;">
...
const loadRiwayat = async () => {
    ...
    await useApi().get(`/emr/get-emr?nocmfk=${ID_PASIEN}&index_tabs=${route.params.index_tabs}&norec_pd=${NOREC_PD}&collection=${COLLECTION.value}&emrpasienfk=${NOREC_EMRPASIEN.value}`).then((response: any) => {
        if (response.length) {
...
const simpan = () => {
    ...
    let json = {
        ...
        'url_form': route.name,
        'name_form': 'Persetujuan Tindakan Kedokteran',
...
const addTemplate = (response: any) => {
    ...
    H.tandaTangan().set('TTDpihakkeluarga', response.TTDpihakkeluarga)
    H.tandaTangan().set('TTDpihak', response.TTDpihak)
