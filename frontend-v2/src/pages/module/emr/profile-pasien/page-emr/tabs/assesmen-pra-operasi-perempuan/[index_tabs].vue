<template>
  ...
  <div class="column is-12 mt-5">
    <div class="columns is-multiline mt-5">
      <div class="column is-6">
        ...
        <div class="columns is-multiline">
          <div class="column is-4">
            ...
            <VCheckbox class="fontcheckbox" v-model="input.nyeri" true-value="Nyeri" color="primary" /><span
              v-html="highlightMatch('Nyeri')" class="highlighted-label"></span><br>
            <VCheckbox class="fontcheckbox" v-model="input.nyeriPerut" true-value="Nyeri Perut" color="primary" /><span
              v-html="highlightMatch('Nyeri Perut')" class="highlighted-label"></span><br>
            <VCheckbox class="fontcheckbox" v-model="input.mualMuntah" true-value="Mual Muntah" color="primary" /><span
              v-html="highlightMatch('Mual Muntah')" class="highlighted-label"></span><br>
            <VCheckbox class="fontcheckbox" v-model="input.perutKembung" true-value="Perut Kembung" color="primary" /><span
              v-html="highlightMatch('Perut Kembung')" class="highlighted-label"></span><br>
            <VCheckbox class="fontcheckbox" v-model="input.tidakBisaBAB" true-value="Tidak Bisa BAB" color="primary" /><span
              v-html="highlightMatch('Tidak Bisa BAB')" class="highlighted-label"></span><br>
            <VCheckbox class="fontcheckbox" v-model="input.BABBerdarah" true-value="BAB Berdarah" color="primary" /><span
              v-html="highlightMatch('BAB Berdarah')" class="highlighted-label"></span><br>
          </div>
          <div class="column is-4">
      ...
      <div class="column is-6">
        ...
        <div class="columns is-multiline">
          <div class="column is-4">
          <VCheckbox class="fontcheckbox" v-model="input.tidakAda" true-value="Tidak Ada" color="primary" /><span
              v-html="highlightMatch('Tidak Ada')" class="highlighted-label"></span><br>
    ...
    <div class="columns is-multiline">
      ...
      <div class="column is-6">
        <div class="columns is-multiline">
          ...
          <div class="column is-6" style="margin-top: -5px;">
            <VCheckbox class="fontcheckbox" v-model="input.usg" true-value="EKG" color="primary" /><span
    ...
    <div class="columns is-multiline">
      <div class="column is-6">
        <div class="columns is-multiline">
          ...
          <div class="is-6" style="margin-left: 10px;">
            <VButton type="button" rounded outlined color="primary" raised icon="feather:folder"
              @click="DiagnosaCPPT()">
              Diagnosa CPPT
            </VButton>
  ...
  <div class="column is-12 mt-5">
    <h1 style="font-size:larger;font-weight:bold; text-align: center;">SITE MARKING PEREMPUAN</h1>
    <div class="columns is-multiline" style="margin-top: 50px;">
      ...
      <div class="column is-12 mb-0 mt-5">
        <div class="columns is-multiline">
          <div class="column is-6 mt-5">
            <ImgDraw elemenID="Gambar1" height="780" width="600" imageSrc="/images/simrs/fullbodyperempuan.png" />
          ...
          <!-- <div class="column is-6 mt-5">
                      ...
                      <ImgDraw elemenID="Gambar3" height="300" width="650" imageSrc="/images/simrs/kepaladepan.png"/>
...
const COLLECTION: any = ref('AssesmenPraOperasiPerempuan') //table mongodb
...
const simpan = () => {
  ...
  let json = {
    ...
    'url_form': route.name,
    'name_form': 'Assesment Pra Operasi Perempuan',
...
watch(
  ...
  (newValue, oldValue) => {
    ...
    H.tandaTangan().clear("TTDDokter1")
    H.tandaTangan().clear("TTDDokter3")
    H.tandaTangan().clear("Gambar1")
    H.tandaTangan().clear("Gambar2")
    H.tandaTangan().clear("Gambar3")
    H.tandaTangan().clear("Gambar4")
    H.tandaTangan().clear("Gambar5")
    H.tandaTangan().clear("Gambar6")
    H.tandaTangan().clear("Gambar7")
    input.value.jamPemeriksaan = new Date()
    ID_EMR.value = ""
    loadRiwayat()
