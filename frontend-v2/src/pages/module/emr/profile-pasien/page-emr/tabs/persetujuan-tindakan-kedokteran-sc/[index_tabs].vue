        ...
        <div class="form-outer" style="margin-top:15px">
            <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                <div class="form-header-inner">
                    <div class="left">
                        <h3>Persetujuan Tindakan Kedokteran SC<br>Halaman ke-{{ route.params.index_tabs }}</h3>
                    </div>
                    <div class="right">
                    ...
                    <table class="table is-bordered  m-0" style="width: 100% !important;">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextTindakanKedokteran" true-value="a"
                            ...
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextTujuan" true-value="a" color="primary"
                                            rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;" class="yes-column">
                        ...
                        <tr>
                            ...
                            <th class="yes-column">
                                <VField>
                                    <VTextarea v-model="input.pemeriksaantextAlternatif" true-value="a" color="primary"
                                        rows="2" />
                                </VField>
                            </th>
                            <th style="text-align: center;" class="yes-column">
...
const setAutoFill = () => {
    let d = input.value
    d.Diagnosistextdasar = 'Anamnesa, Pemeriksaan fisik, penunjang';
    d.pemeriksaantextTindakanKedokteran = 'SC';
    d.pemeriksaantextTataCara = 'Mengeluarkan bayi melalui insisi per-abdominal'
    d.pemeriksaantextTujuan = 'Melahirkan bayi dan plasenta'
    d.pemeriksaantextRisiko = 'Perdarahan, infeksi'
    d.pemeriksaantextKomplikasi = 'Perdarahan, infeksi'
    d.pemeriksaantextPrognosis = 'dubia ad bonam'
    d.persetujuan = 'SC'
}
