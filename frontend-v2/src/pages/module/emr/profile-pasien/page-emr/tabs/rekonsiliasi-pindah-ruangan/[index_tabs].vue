      ...
      <div class="form-outer" style="margin-top:15px">
        <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
          <div class="form-header-inner">
            <div class="left">
              <h3>Formulir Rekonsiliasi Obat Pindah Ruangan</h3>
            </div>
            <div class="right">
        ...
        <div class="column">
          <div style="display: flex; justify-content: center; align-items: center;">
            <span style="
              ...
              ">REKONSILIASI OBAT SAAT PASIEN <b>PINDAH RUANGAN</b></span>
          </div>
          ...
          <div class="column" style="overflow:auto">
            <table class="table">
              <tr>
                ...
                <th style="background-color: palegreen;width:12.5%;">Dosis/Frekuensi</th>
                <th style="background-color: palegreen;width:12.5%;">Rute</th>
                <th style="background-color: palegreen;width:12.5%;">Tindak Lanjut Oleh Dokter Penerima</th>
                <th style="background-color: palegreen;width:12.5%;">Perubahan Aturan Pakai</th>
                <th style="background-color: palegreen;width:12.5%;">Tanda Tangan Dokter</th>
              ...
              <tr v-for="(item, index) in input.details" :key="index">
                ...
                <td>
                  <VField>
                    <VTextarea rows="2" v-model="item.TBRute"></VTextarea>
                  </VField>
                </td>
            ...
            <div class="columns is-multiline">
              ...
              <div class="column is-4" style="margin-left: 21rem;text-align: left; margin-top:1rem">
                <table style="border: 1px solid black; border-collapse: collapse;">
                  <thead>
                    <tr>
                      <th class="grey-background">Rekonsiliasi saat pasien Pindah Ruangan :</th>
                    </tr>
                    <tr>
                      <th class="grey-background">Membandingkan antara :
                        <br>- Daftar Penggunaan Obat sebelum admisi
                        <br>- Daftar Penggunaan Obat dari Ruang Rawat Sebelumnya
                        <br>- Resep/Instruksi Pengobatan di Ruang Rawat Sekarang
                      </th>
                    </tr>
                  </thead>
                </table>
...
useHead({ title: 'Formulir Rekonsiliasi Obat Pindah Ruangan - ' + import.meta.env.VITE_PROJECT })
useViewWrapper().setPageTitle(import.meta.env.VITE_PROJECT)
useViewWrapper().setFullWidth(true)
let ID_PASIEN = useRoute().query.nocmfk as string
let NOREC_PD = useRoute().query.norec_pd as string
let norec_emr = useRoute().query.norec_emr as string
const COLLECTION: any = ref('rekonpindahruangan') //table mongodb
