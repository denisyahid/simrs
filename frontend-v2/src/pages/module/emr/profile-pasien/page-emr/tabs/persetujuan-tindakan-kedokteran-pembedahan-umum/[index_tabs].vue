...
useHead({ title: 'Persetujuan Tindakan Kedokteran Pembedahan (Umum) - ' + import.meta.env.VITE_PROJECT })
...
const COLLECTION: any = ref('PersetujuanTindakanKedokteranPembedahanUmum') //table mongodb
...
const simpan = () => {
  ...
  let json = {
    ...
    'url_form': route.name,
    'name_form': 'Persetujuan Tindakan Kedokteran Pembedahan Umum',
