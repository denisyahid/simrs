        ...
        <div class="form-outer" style="margin-top:15px">
            <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                <div class="form-header-inner">
                    <div class="left">
                        <h3>Persetujuan Tindakan Kedokteran Endoskopi<br>Halaman ke-{{ route.params.index_tabs }}</h3>
                    </div>
                    <div class="right">
            ...
            <div class="column">
                ...
                <div class="column">
                    ...
                    <table class="table is-bordered  m-0" style="width: 100% !important;">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;">
                                    <VCheckbox v-model="input.pemeriksaanDiagnosis" true-value="Ya" checked color="primary" />
                                </th>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <th style="text-align: center;" class="yes-cumn">
                                    <VCheckbox v-model="input.diagnosisTextDasar" true-value="Ya" checked color="primary" />
                                </th>
                            </tr>
                        </thead>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextTindakanKedokteran"
                                            color="primary" rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;">
                                    <VCheckbox v-model="input.TindakanKedokteranCheckbox" true-value="Ya" checked
                                        color="primary" />
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextIndikasiTindakan"
                                            color="primary" rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;" class="yes-column">
                                    <VCheckbox v-model="input.pemeriksaantextIndikasiTindakanCheckbox" true-value="Ya" checked
                                        color="primary" />
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextTataCara"
                                            color="primary" rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;" class="yes-column">
                                    <VCheckbox v-model="input.pemeriksaantextTataCaraCheckbox" true-value="Ya" checked
                                        color="primary" />
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextTujuan" color="primary"
                                            rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;" class="yes-column">
                                    <VCheckbox v-model="input.tujuanCheckbox" true-value="Ya" checked color="primary" />
                                </th>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextRisiko" color="primary"
                                            rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;" class="yes-column">
                                    <VCheckbox v-model="input.pemeriksaantextRisikoCheckbox" true-value="Ya" checked
                                        color="primary" />
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextKomplikasi"
                                            color="primary" rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;" class="yes-column">
                                    <VCheckbox v-model="input.pemeriksaantextKomplikasiCheckbox" true-value="Ya" checked
                                        color="primary" />
                                </th>
                            </tr>
                        </thead>
                        <thead>
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextPrognosis"
                                            color="primary" rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;">
                                    <VCheckbox v-model="input.pemeriksaantextPrognosisCheckbox" true-value="Ya" checked
                                        color="primary" />
                                </th>
                            </tr>
                        </thead>
                        <tr>
                            ...
                            <th class="yes-column">
                                <VField>
                                    <VTextarea v-model="input.pemeriksaantextAlternatif" color="primary"
                                        rows="2" />
                                </VField>
                            </th>
                            <th style="text-align: center;" class="yes-column">
                                <VCheckbox v-model="input.pemeriksaantextAlternatifCheckbox" true-value="Ya" checked
                                    color="primary" />
                            </th>
                        </tr>
                        <thead>
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VField>
                                        <VTextarea v-model="input.pemeriksaantextLainLain"
                                            color="primary" rows="2" />
                                    </VField>
                                </th>
                                <th style="text-align: center;">
                                    <VCheckbox v-model="input.pemeriksaantextLainLainCheckbox" true-value="Ya" checked
                                        color="primary" />
                                </th>
                            </tr>
                        </thead>
                    ...
                    <div class="is-12">
                        <h1 style="font-weight: bold;">PERSETUJUAN TINDAKAN KEDOKTERAN (AGREEMENT FOR MEDICAL ACTION)
                        </h1>
                    </div>
                    <div class="is-12">
...
useHead({ title: 'Persetujuan Tindakan Kedokteran SC - ' + import.meta.env.VITE_PROJECT })
...
const COLLECTION: any = ref('PersetujuanTindakanKedokteranEndoskopi') //table mongodb
...
const setAutoFill = () => {
    let d = input.value
    d.Diagnosistextdasar = 'Anamnesis dan pemeriksaan fisik';
    d.pemeriksaantextTindakanKedokteran = 'Endoskopi atas ± biopsi';
    d.pemeriksaantextIndikasiTindakan = 'Diagnostik'
    d.pemeriksaantextTataCara = 'Sesuai spo'
    d.pemeriksaantextTujuan = 'Diagnostik tegak'
    d.pemeriksaantextRisiko = 'Aspirasi'
    d.pemeriksaantextKomplikasi = 'Vagal reflex'
    d.pemeriksaantextPrognosis = 'Dubius',
    d.pemeriksaantextAlternatif = 'Tidak'
    d.pemeriksaantextLainLain = 'MRS jika terjadi komplikasi pasca tindakan'
}
