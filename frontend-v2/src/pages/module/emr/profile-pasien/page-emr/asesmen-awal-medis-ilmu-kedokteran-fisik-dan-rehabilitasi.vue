...
// Judul
useHead({
    title: 'Asesmen Awal Medis Ilmu Kedokteran Fisik dan Rehabilitasi - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('AsesmenAwalMedisIlmuKedokteranFisikdanRehabilitasiRJ') //table mongodb
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header" style="margin-bottom: 10px">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Asesmen Awal Medis Ilmu Kedokteran Fisik dan Rehabilitasi</h3>
                        </div>
                        <div class="right">
                            <div class="buttons">
                ...
                <div class="columns is-multiline p-2">
                            ...
                            <div class="columns is-multiline">
                                <div class="column is-12">
                                    <VField>
                                        ...
                                        <VTextarea v-model="input.TAkeluhanUtama" rows="3">
                                        </VTextarea>
                                    </VField>
                                </div>
                                <div class="column is-12">
                                    <VField>
                                        ...
                                        <VTextarea v-model="input.TAriwayatPenyakitSekarang" rows="3">
                                        </VTextarea>
                                    </VField>
                                </div>
                                <div class="column is-6">
                                    <VField>
                                        <label>Kondisi Kemampuan Fungsional :</label>
                                        <VTextarea v-model="input.TAkondisiKemampuanFungsional" rows="3">
                                        </VTextarea>
                                    </VField>
                                </div>
                                <div class="column is-6">
                                    <VField>
                                        <label>Riwayat Pengobatan dan Rehabilitasi :</label>
                                        <VTextarea v-model="input.TAriwayatPengobatandanRehab" rows="3">
                                        </VTextarea>
                                    </VField>
                                </div>
                                <div class="columns is-multiline column is-12">
                                    <div class="column is-12">Riwayat Penyakit Dahulu :</div>
                                    <div class="column is-3">
                                        <VControl raw subcontrol>
                                    ...
                                    <div class="column is-3">
                                        <VControl raw subcontrol>
                                            <VCheckbox class="p-0" color="primary" square true-value="Diabetes melitus"
                                                label="Diabetes melitus" v-model="input.CBDiabetesMelitusRPD" />
                                        </VControl>
                                    </div>
                                    <div class="column is-3">
                                        <VControl raw subcontrol>
                                    ...
                                    <div class="column is-3">
                                        <VControl raw subcontrol>
                                            <VCheckbox class="p-0" color="primary" square true-value="Malignancy"
                                                label="Malignancy" v-model="input.CBMalignancyRPD" />
                                        </VControl>
                                    </div>
                                    <div class="column is-3">
                                        <VControl raw subcontrol>
                                            <VCheckbox class="p-0" color="primary" square true-value="Alergi"
                                                label="Alergi" v-model="input.CBAlergiRPD" />
                                        </VControl>
                                    </div>
                                    <div class="column is-3">
                                        <VControl raw subcontrol>
                                            <VCheckbox class="p-0" color="primary" square true-value="Operasi"
                                                label="Operasi" v-model="input.CBOperasiRPD" />
                                        </VControl>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="column is-12">
                        <Fieldset :toggleable="true" legend="Pemeriksaan Fisik">
                            <div class="columns is-multiline" style="padding: 10px; padding-top: 0px">
                                ...
                                <div class="column is-12">
                                    <span><b>C. Status Rehabilitasi Medik</b></span>
                                </div>
                                <div class="column is-12 columns is-multiline">
                                    <div class="column is-3">
                                        <VField label="Postur :">
                                            <VTextarea rows="2" v-model="input.TAposturSRM"></VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-3">
                                        <VField label="Ambulasi :">
                                            <VTextarea rows="2" v-model="input.TAambulasiSRM"></VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-3">
                                        <VField label="Penilaian Nyeri :">
                                            <VTextarea rows="2" v-model="input.TApenilaianNyeriSRM"></VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-3">
                                        <VField label="Resiko Jatuh :">
                                            <VTextarea rows="2" v-model="input.TAresikoJatuhSRM"></VTextarea>
                                        </VField>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="column is-12">
                        <Fieldset :toggleable="true" legend="Status Musculoskeletal dan Neuromuscular">
                            <VField>
                                <VTextarea rows="2" v-model="input.TAsmdn"></VTextarea>
                            </VField>
                        </Fieldset>
                    </div>
                    <div class="column is-12">
                        <Fieldset :toggleable="true" legend="Pemeriksaan Fisik Khusus Lain">
                            <VField>
                                <VTextarea rows="2" v-model="input.TApfkl"></VTextarea>
                            </VField>
                        </Fieldset>
                    </div>
                    <div class="column is-12">
                        <Fieldset :toggleable="true" legend="Status Fungsional">
                            <div class="columns">
                                <div class="column is-3">
                                    <VField label="Balance :">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBbalanceSF" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-3">
                                    <VField label="Transfer :">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBtransferSF" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-3">
                                    <VField label="Coordination :">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBcoordinationSF" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-3">
                                    <VField>
                                        <label>Pemeriksaan fungsional lainnya :</label>
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBpemeriksaanFungsionalSF" />
                                        </VControl>
                                    </VField>
                                </div>
                            </div>
