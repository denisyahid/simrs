    ...
    <div class="form-outer" style="margin-top:15px">
      <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
        <div class="form-header-inner">
          <div class="left">
            <h3>Persetujuan Tindakan Kedokteran THT</h3>
          </div>
          <div class="right">
      ...
      <div class="column">
        ...
        <div class="column">
          ...
          <table class="table is-bordered  m-0" style="width: 100% !important;">
            ...
            <thead>
              ...
              <tr>
                ...
                <th class="yes-column">
                  <span>Klinis + Biopsi + CT Scan</span>
                </th>
          ...
          <div class="is-12">
            <h1 style="font-weight: bold;">PERSETUJUAN TINDAKAN KEDOKTERAN (AGREEMENT FOR MEDICAL ACTION)</h1>
          </div>
          <div class="is-12">
          ...
          <div class="p-0 is-12 is-flex">
            ...
            <div class="column is-10">
              <VField>
                <VControl>
                  <VInput v-model="input.namaPasien" class="input" type="text" style="text-transform: uppercase;" />
                </VControl>
              </VField>
            </div>
          </div>
          ...
          <div class="p-0 is-12 is-flex">
            ...
            <div class="column is-10">
              <VField>
                <VControl>
                  <VInput v-model="input.jeniskelamin" class="input" type="text" style="text-transform: uppercase;" />
                </VControl>
              </VField>
            </div>
          </div>
          ...
          <div class="p-0 is-12 is-flex">
            ...
            <div class="column is-10">
              <VField>
                <VControl>
                  <VInput v-model="input.alamat" class="input" type="text" style="text-transform: uppercase;" />
                </VControl>
              </VField>
            </div>
          </div>
          ...
          <div class="p-0 is-12 is-flex">
            <div class="column is-5">
              <h1 style="font-weight: bold">dengan ini menyatakan Persetujuan untuk dilakukannya tindakan <b>KEMOTERAPI</b>: </h1>
            </div>
          ...
          <div class="p-0 is-12 is-flex">
            ...
            <div class="column is-10">
              <VField>
                <VControl>
                  <VInput v-model="input.namaPasienTerhadap" class="input" type="text" style="text-transform: uppercase;"/>
                </VControl>
              </VField>
            </div>
          </div>
          ...
          <div class="p-0 is-12 is-flex">
            ...
            <div class="column is-10">
              <VField>
                <VControl>
                  <VInput v-model="input.jeniskelaminTerhadap" class="input" type="text" style="text-transform: uppercase;" />
                </VControl>
              </VField>
            </div>
          </div>
          ...
          <div class="p-0 is-12 is-flex">
            ...
            <div class="column is-10">
              <VField>
                <VControl>
                  <VInput v-model="input.alamatTerhadap" class="input" type="text" style="text-transform: uppercase;" />
                </VControl>
              </VField>
            </div>
          </div>
        ...
        <div class="columns">
          <div class="column is-4">
            <div class="column" style="text-align:center;">
              <h1 style="font-weight: bold;">Yang Menyatakan*<br><i>Consignee</i></h1>
          ...
          <div class="column is-4">
            <div class="column" style="text-align:center;">
              <h1 style="font-weight: bold;">Pihak Keluarga <br> <i>Family</i></h1>
          ...
          <div class="column is-4">
            <div class="column" style="text-align:center;">
              <h1 style="font-weight: bold;">Pihak Rumah Sakit <br><i>Hospital’s Staﬀ</i></h1>
...
useHead({ title: 'Persetujuan Tindakan Kedokteran THT - ' + import.meta.env.VITE_PROJECT })
...
const COLLECTION: any = ref('PersetujuanTindakanKedokteranTht') //table mongodb
...
const simpan = () => {
  ...
  let json = {
    ...
    'url_form': route.name,
    'name_form': 'Persetujuan Tindakan Kedokteran THT',
