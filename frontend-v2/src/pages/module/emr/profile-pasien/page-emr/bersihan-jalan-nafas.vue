                            ...
                            <Fieldset :toggleable="true" legend="Standar Diagnosa Keperawatan Indonesia (SDKI)">
                                ...
                                <div class="columns is-12 pt-2">
                                    <div class="column is-4 pt-4">
                                        <h1 style="font-weight: bold;"> Hasil Penunjang</h1>
                                    </div>
                                    <div class="column is-6" style="margin-left: -8rem;">
                                        <VField>
                                            <VControl>
                                                <VInput type="text" class="input" placeholder="Data Objektif Lainnya"
                                                    v-model="input.hasilPenunjang" />
                                            </VControl>
                                        </VField>
                                    </div>
                                </div>
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Standar Luar Keperawatan Indonesia (SLKI)">
                                ...
                                <div class="column is-12">
                                    ...
                                    <h1 class="pb-1">
                                        2. Produksi sputum : Membaik
                                    </h1>
                                    <h1 class="pb-1">
                                        3. Dispnea/Ortopnea : Menurun
                                    </h1>
                                    <h1 class="pb-1">
...
import * as EMR from '../page-emr-plugins/bersihan-jalan-nafas'
...
const COLLECTION: any = ref('BersihanJalanNafasTidakEfektif') //table mongodb
