                            ...
                            <div class="column is-12" v-if="!isLoadingPasien">
                                <VCard class="border-card pink">
                                    ...
                                    <div class="columns is-multiline p-3">
                                        ...
                                        <div class="column is-12">
                                            <p class="mb-2">Pemeriksaan Fisik</p>
                                            <VField>
                                                <VControl>
                                        ...
                                        <div class="column is-12">
                                            <p class="mb-2">Pemeriksaan Penunjang</p>
                                            <VField>
                                                <VControl>
...
const COLLECTION: any = ref('ResumeMedisRawatJalan') //table mongodb
...
const print = async () => {
    H.printBlade(`emr/cetak-resume-medis-rj?nocmfk=${ID_PASIEN}&norec_pd=${props.registrasi.norec_pd}&collection=${COLLECTION.value}&emrpasienfk=${NOREC_EMRPASIEN.value}`)
}
