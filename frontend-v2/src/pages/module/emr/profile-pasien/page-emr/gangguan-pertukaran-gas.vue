                    ...
                    <div class="column is-12">
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Standar Diagnosa Keperawatan Indonesia (SDKI)">
                                <div class="column is-12">
                                    ...
                                    <h1>Ketidakmampuan membersihkan
                                        secret atau obstruksi jalan napas untuk
                                        mempertahankan jalan nafas tetap paten </h1>
                                </div>
                                ...
                                <div class="column is-8">
                                    <VField>
                                        <VControl>
                                            <VInput type="text" class="input" placeholder="Berhubungan dengan"
                                                v-model="input.berhubunganDengan" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-12">
                                        ...
                                        <VField>
                                            <VControl>
                                                <VInput type="text" class="input"
                                                    placeholder="Keterangan Pemeriksaaan Penunjang"
                            ...
                            <Fieldset :toggleable="true" legend="Standar Luar Keperawatan Indonesia (SLKI)">
                                <div class="column is-12">
                                    <h1 style="font-weight: bold">
                                        Bersihan jalan nafas tidak efektif (L.01001)
                                    </h1>
                                </div>
                                <div class="column is-12">
                                    <h1 style="font-weight: bold">
                                ...
                                <div class="column is-12">
                                    ...
                                    <h1 class="pb-1">
                                        2. Dispnea / bunyi nafas tambahan : Menurun
                                    </h1>
                                    <h1 class="pb-1">
                                        3. Pusing : Menurun
                                    </h1>
                                    <h1 class="pb-1">
                                        4. Hasil PCO2 : : Membaik
                                    </h1>
                                    <div class="column is-8">
                                        <VField>
                                            <VControl>
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Standar Intervensi Keperawatan Indonesia (SIKI)">
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Manajemen Jalan Napas (I.01011)</h1>
                                </div>
                                <div class="column is-12">
                        ...
                        <div class="column is-4" style="margin-left: auto;">
                            <VCard>
                                <div class="column p-0">
                                    <h1 class="" style="font-weight: bold;">Tanggal dan Jam</h1>
                                    <div class="column">
                                        <VField>
                                            <VDatePicker v-model="input.tglKomit" mode="dateTime" style="width: 100%"
                                ...
                                <div class="column p-0">
                                    <h1 class="" style="font-weight: bold;">Perawat</h1>
                                    <VField>
                                        <VControl class="prime-auto">
                                            <AutoComplete v-model="item.petugas" :suggestions="d_Petugas"
                                                @complete="fetchPetugas($event)" :optionLabel="'label'" :dropdown="true"
                                                :minLength="2" :appendTo="'body'" :loadingIcon="'pi pi-spinner'"
...
import * as EMR from '../page-emr-plugins/gangguan-pertukaran-gas'
...
const COLLECTION: any = ref('GangguanPertukaranGas') //table mongodb
