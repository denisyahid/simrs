          ...
          <div class="columns is-multiline">
            <div class="column is-12">
              ...
              <div class="column is-12">
                <div class="flex">
                  <h1 style="font-weight: bold">
                    Dalam hal ini bertindak sebagai diri sendiri/suami/istri/ayah/ibu/wali penganggung jawab * dari pasien
                  </h1>
              ...
              <div class="column is-12 p-1">
                <h1 style="font-weight: bold;">
                    Saya telah mendapatkan penjelasan sepenuhnya dari Dokter mengenai sifat dan tujuan untuk menjalani rawat bersama, serta telah mendapatkan informasi dari Petugas mengenai tata tertib dan biaya perawatan di Rumah Sakit ini, Dengan demikian saya menyatakan :
                </h1>
              ...
              <div class="column is-12 p-1">
                <div class="flex">
                  <h1>
                    1. Setuju untuk dilakukan rawat bersama di Rumah Sakit ini :
                  </h1>
              ...
              <div class="column is-12">
                <div class="columns is-multiline">
                  <div class="column is-3">
                    <h1 class="p-1"> Nama Dokter I</h1>
                    <VField class="is-rounded-select_Z  is-autocomplete-select" v-slot="{ id }">
                      <VControl icon="fa:users" fullwidth class="prime-auto ">
                        <AutoComplete v-model="input.dokterRawat" :suggestions="d_Dokter" @complete="fetchDokter($event)"
                          :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'"
                          :loadingIcon="'pi pi-spinner'" :field="'label'" placeholder="ketik untuk dokter..." />
                      </VControl>
                    </VField>
                  </div>
                  <div class="column is-6">
                    <h1 class="p-1"> Sebagai Dokter </h1>
  
                    <div class="flex">
                      <VField v-for="items in dokterJabatan" :key="items.value" style="padding:0px;">
                        <VControl raw subcontrol>
                          <VCheckbox v-model="input.jenisDokter" class="pt-1 pb-1 " :true-value="items.label"
                            :label="items.label" color="primary" square />
                        </VControl>
                      </VField>
                      <VField>
                        <VControl>
                          <VInput type="text" class="input" placeholder="Keterangan Dokter"
                            v-model="input.ketJenisDokter" />
                        </VControl>
              ...
              <div class="column is-12">
                <div class="columns is-multiline">
                  <div class="column is-3">
                    <h1 class="p-1"> Nama Dokter II</h1>
                    <VField class="is-rounded-select_Z  is-autocomplete-select" v-slot="{ id }">
                      <VControl icon="fa:users" fullwidth class="prime-auto ">
                        <AutoComplete v-model="input.dokterRawat2" :suggestions="d_Dokter" @complete="fetchDokter($event)"
                          :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'"
                          :loadingIcon="'pi pi-spinner'" :field="'label'" placeholder="ketik untuk dokter..." />
                      </VControl>
                    </VField>
                  ...
                  <div class="column is-6">
                    ...
                    <div class="flex">
                      <VField v-for="items in dokterJabatan" :key="items.value" style="padding:0px;">
                        <VControl raw subcontrol>
                          <VCheckbox v-model="input.jenisDokter2" class="pt-1 pb-1 " :true-value="items.label"
                            :label="items.label" color="primary" square />
                        </VControl>
                      </VField>
                      <VField>
              ...
              <div class="column is-12 p-1">
                <h1>
                    3. Telah menyetujui dan telah bersedia mentaati segala peraturan dan tata tertib Rumah Sakit ini
                </h1>
              </div>
              <div class="column is-12 p-1">
                <h1>
              ...
              <div class="column is-12 p-1">
                <h1>
                    5. Memberi kuasa kepada Dokter/Rumah Sakit untuk memberikan keterangan yang diperlukan oleh pihak penanggung biaya perawatan saya/pasien tersebut diatas.
                </h1>
              </div>
              ...
              <div class="column is-12 p-1">
                <h1 style="font-weight: bold;">
                  Demikian pernyataan ini saya buat dengan sebenernya dan penuh kesadaran tanpa paksaan dari pihak manapun.
                </h1>
              </div>
                    ...
                    <VField>
                      <VControl class="prime-auto">
                        <AutoComplete v-model="input.petugasPerawat" :suggestions="d_Dokter"
                          ...
                          :appendTo="'body'" :loadingIcon="'pi pi-spinner'" :field="'label'" placeholder="Perawat..."
