        ...
        <div class="column is-12">
            <VCard>
                <div class="columns is-multiline">
                    ...
                    <div class="column is-10">
                        <VField>
                            <VDatePicker v-model="input.tgllahir" mode="date"
                    ...
                    <div class="column is-10">
                        <VField>
                            <VControl>
                                <VTextarea v-model="input.radiofarmaka" rows="1">
                                </VTextarea>
                            </VControl>
                        </VField>
                    </div>
                    <div class="column is-2">
                        <h1 style="font-weight: bold;">
                            DOSIS/AKTIVITAS RADIOFARMAKA
                        </h1>
                    </div>
                    <div class="column is-10">
                        <VField addons>
                            <VControl expanded>
                                <VInput type="text" class="input" placeholder="" v-model="input.dosisradiofarmaka" />
                            </VControl>
                    ...
                    <div class="column is-10">
                        <VField>
                            <VDatePicker v-model="input.tanggaldanjam" mode="dateTime"
                                style="width: 100%" trim-weeks :max-date="new Date()">
                                <template #default="{ inputValue, inputEvents }">
                                    <VField>
                                        <VControl icon="feather:calendar" fullwidth>
                                            <VInput :value="inputValue" placeholder="Tanggal dan Jam"
                                                v-on="inputEvents" />
                                        </VControl>
                                    </VField>
                                </template>
                    ...
                    <div class="column is-2">
                        <h1 style="font-weight: bold;">
                            PARAF PENANGGUNG JAWAB HOT LAB
                        </h1>
                    </div>
                    <div class="column is-10">
                        <VField class="is-rounded-select_Z  is-autocomplete-select" v-slot="{ id }">
                            <VControl icon="fa:user-md" fullwidth class="prime-auto ">
                                <AutoComplete v-model="input.hotlab" :suggestions="d_Dokter"
                                    @complete="fetchDokter($event)" :optionLabel="'label'" :dropdown="true"
                                    :minLength="3" :appendTo="'body'" :loadingIcon="'pi pi-spinner'" :field="'label'"
                                    placeholder="ketik untuk mencari..." />
                            </VControl>
