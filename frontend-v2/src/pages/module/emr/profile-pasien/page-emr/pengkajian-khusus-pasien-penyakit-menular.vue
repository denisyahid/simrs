...
import * as EMR from '../page-emr-plugins/pengkajian-khusus-pasien-penyakit-menular'
...
const COLLECTION: any = ref('PengkajianKhususPasienPenyakitMenular') //table mongodb
