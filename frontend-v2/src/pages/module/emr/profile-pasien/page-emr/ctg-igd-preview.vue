...
useHead({
  title: 'CTG IGD - ' + import.meta.env.VITE_PROJECT,
})
...
const setAutoFill = async () => {
  input.value.author = user.namaLengkap;
}

const loadRiwayat = () => {
  isLoading.value = true
  useApi().get(`/emr/berkas-pasien?nocm=${props.pasien.nocm}&noregistrasi=${props.registrasi.noregistrasi}&dokumen=CTG`).then((response: any) => {
