                ...
                <div class="column is-12 columns is-multiline pb-0 mb-0">
                    <table border="1" width="100%" style="" class="table-v-center">
                        ...
                        <tbody style="vertical-align: middle;">
                            <tr>
                                <td>1</td>
                                <td>Age (Umur) ≥ 60 Tahun</td>
                                <td>1</td>
                                <td>
                                    <VCheckbox
                                        v-model="input.skor[0]"
                                        color="primary"
                                        true-value="1"
                                        @change="handleSkor()"
                                    />
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ul style="list-style: inside;">
                                        <li>
                                            Tekanan darah sistolik ≥ 140mmHg atau tekanan darah
                                            diastolic ≥ 90mmHg
                                        </li>
                                    </ul>
                                </td>
                            ...
                            <tr>
                                <td>3</td>
                                <td>
                                    Clinical features of TIA (Gambaran klinis TIA), pilih salah satu <br>
                                    <ul style="list-style: inside;">
                                        <li>
                                            Kelemahan unilateral dengan atau tanpa gangguan bahasa atau
                                        </li>
                                        <li>Gangguan bahasa tanpa kelemahan unilateral</li>
                                    </ul>
                                </td>
                                <td>
                                    <span>
                            ...
                            <tr>
                                <td>4</td>
                                <td>
                                    Duration (Durasi berlangsung TIA) <br>
                                    <ul style="list-style: inside;">
                                        <li>
                                            Durasi TIA ≥ 60 menit
                                        </li>
                                        <li>Durasi TIA 10-59 menit</li>
                                    </ul>
                                </td>
                                <td>
                                    <span>
            ...
            <VCard class="mt-5">
                <div class="columns is-multiline m-0">
                    <div class="column is-6">
                        <h1 style="font-weight: bold; font-size: 16px" class="mb-4">
                            Interpretasi Skor ABCD
                        </h1>
                        <p>
                            Skor 0-3 : Risiko rendah <br>
                            Skor 4-5 : Risiko sedang <br>
