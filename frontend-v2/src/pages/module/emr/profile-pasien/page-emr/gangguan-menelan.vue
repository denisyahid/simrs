                    ...
                    <div class="column is-12">
                        <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-8" style="margin-top: -1rem;">
                                    <VField>
                                        <VControl>
                                            <VRadio v-model="input.GangguanMenelan" value="Ya" label="Gangguan Menelan (D.0063)"
                                                name="GangguanMenelan" color="info" square style="font-size: 15px" />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Diagnosa Keperawatan">
                                ...
                                <div class="column is-12">
                                    <h1> Definisi : Fungsi menelan abnormal akibat defisit struktur atau fungsi oral, faring atau esofagus
                                    </h1>
                                </div>
                                ...
                                <div class="column is-12">
                                    ...
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-4" v-for="(data, i) in kondisiKlinis">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                        :label="data.title" class="p-0" color="primary" square />
                                ...
                                <div class="column is-12">
                                    ...
                                    <div class="column is-12 p-0">
                                        ...
                                        <div class="column is-12 p-0">
                                            <div class="is-flex">
                                                <div class="column is-6" style="margin-top:0.5rem">
                                                    <h1> gangguan menelan teratasi dg : </h1>
                                                </div>
                                                <div class="column is-6" style="margin-left: -5rem;">
                                                    <VField>
                                                        <VControl>
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Rencana Tindakan">
                                <div class="column is-12">
                                    ...
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in pencegahan">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                        :label="data.title" class="p-0" color="primary" square />
                                ...
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;"> Terapi Menelan:</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in terapiMenelan">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                        :label="data.title" class="p-0" color="primary" square />
...
import * as EMR from '../page-emr-plugins/gangguan-menelan'
...
let pencegahan = ref(EMR.pencegahan())
let terapiMenelan = ref(EMR.terapiMenelan())
