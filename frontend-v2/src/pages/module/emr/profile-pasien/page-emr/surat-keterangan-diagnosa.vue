...
useHead({
    title: 'Surat Keterangan Diagnosa - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('SuratKeteranganDiagnosa') //table mongodb
...
const simpan = () => {
    ...
    let json = {
        ...
        'url_form': route.name,
        'name_form': 'Surat Keterangan Diagnosa',
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Surat Keterangan Diagnosa</h3>
                        </div>
                        <div class="right">
                ...
                <div class="columns is-multiline column is-12">
                    ...
                    <div class="column is-6">
                        <div class="column columns is-multiline">
                            <div class="column is-3">Dirawat dari tanggal</div>
                            <div class="column is-9">
                                <VDatePicker v-model="input.DDirawatDariTanggal" mode="date" trim-weeks>
