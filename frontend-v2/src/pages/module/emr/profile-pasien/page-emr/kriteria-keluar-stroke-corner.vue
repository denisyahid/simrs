<template>
                ...
                <div class="column is-12 columns is-multiline pb-0 mb-0">
                    <table border="1" width="100%" style="" class="table-v-center">
                        ...
                        <tbody style="vertical-align: middle;">
                            <tr>
                                <td>1</td>
                                <td>Perawatan hari ke 3-5 setelah onset stroke iskemik akut atau perawatan hari ke 10-14 setelah onset stroke perdarahan</td>
                                <td>
                                    <VCheckbox
                                        v-model="input.perawatan"
                                        color="primary"
                                        true-value="Ya"
                                    />
                                </td>
                            ...
                            <tr>
                                <td>2</td>
                                <td>
                                    Riwayat TIA dalam rentang waktu &lt; 72 jam dengan <br>
                                    skor ABCD &ge; 4 (Derajat sedang-berat)
                                </td>
                                <td>
                                    <VCheckbox
                                        v-model="input.riwayatTIA"
                                        color="primary"
                                        true-value="Ya"
                                    />
                                </td>
                            ...
                            <tr>
                                <td>3</td>
                                <td>
                                    Pasien post terapi trombolisis hari ke-3 dengan gejala klinis menetap
                                </td>
                                <td>
                                    <VCheckbox
                                        v-model="input.postterapi"
                                        color="primary"
                                        true-value="Ya"
                                    />
                                </td>
                            ...
                            <tr>
                                <td>4</td>
                                <td>
                                    Tanda vital membaik/menetap dan tidak berfluktuasi
                                </td>
                                <td>
                                    <VCheckbox
                                        v-model="input.vital"
                            ...
                            <tr>
                                <td>5</td>
                                <td>
                                    Faktor risiko stroke sudah teridentifikasi dan sudah <br>
                                    mendapatkan penanganan sesuai dengan faktor risiko
                                </td>
                                <td>
                                    <VCheckbox
                                        v-model="input.faktor"
                                        color="primary"
                                        true-value="Ya"
                                    />
                                </td>
                            ...
                            <tr>
                                <td>6</td>
                                <td>
                                    Gejala klinis membaik atau menetap
                                </td>
                                <td>
                                    <VCheckbox
   ...
   const input: any = ref({
        ...
        kesimpulan: 'Bedasarkan kondisi diatas maka pasien memenuhi kriteria keluar Stroke Corner dan masuk Stroke Ward'
   })
