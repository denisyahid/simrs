    ...
    <div class="form-outer" style="margin-top:15px">
      ...
      <div class="column is-12">
        <div class="columns is-multiline">
          ...
          <div class="column is-12">
            <Fieldset class="p-fieldsets" legend="10. Masalah keperawatan" :toggleable="true">
          ...
          <div class="column is-12">
            <Fieldset class="p-fieldsets" legend="11. Harapan pasien (Patient wishes)" :toggleable="true">
              <div class="column is-12">
                <VField>
                    <VTextarea rows="4" v-model="input.harapanPasien"></VTextarea>
                </VField>
              </div>
            </Fieldset>
          </div>
...
const COLLECTION: any = ref('PengkajianPasienTahapTerminal') //table mongodb
