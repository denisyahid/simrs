  ...
  <div class="column is-12">
    <VCard>
      <div class="column">
        ...
        <div class="column pt-0">
          <p>Dengan ini menyatakan PERSETUJUAN untuk ikut dalam pelayanan ambulan Saya memahami sebagaimana telah dijelaskan seperti diatas kepada saya.</p>
          <p>Saya bertanggung jawab secara penuh atas segala akibat yang mungkin timbul, Sehubungan dengan hal tersebut maka saya bersedia mengikuti peraturan yang berlaku dan segala resiko yang mungkin terjadi dalam pelayanan ambulan.</p>
          <p>Demikianlah pernyataan ini saya buat dengan penuh kesadaran dan bertanggung jawab atas resiko yang mungkin terjadi terhadap pasien sehubungan dengan pernyataan ini.</p>
        </div>
        ...
        <div class="columns is-multiline pt-5" style="justify-content: space-around;">
          <div class="column is-4" style="text-align: center;">
            ...
            <div class="column pl-0 pr-0 pt-5">
              <span class="label-ppap">Petugas / perawat</span>
              <VField class="pt-3">
                <VControl class="prime-auto">
          ...
          <div class="column is-4" style="text-align: center;">
            ...
            <div class="column pl-0 pr-0 pt-5">
              <span class="label-ppap">Dokter yang merawat</span>
              <VField class="pt-3">
                <VControl class="prime-auto">
