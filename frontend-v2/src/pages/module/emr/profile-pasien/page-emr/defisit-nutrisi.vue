                    ...
                    <div class="column is-12">
                        <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-8" style="margin-top: -1rem;">
                                    <VField>
                                        <VControl>
                                            <VRadio v-model="input.defisitNutrisi" value="Ya" label="Defisit Nutrisi (0019)"
                                                name="defisitNutrisi" color="info" square style="font-size: 15px" />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Outcome">
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Status Nutrisi:</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-6" v-for="(data, i) in statusNutrisi">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.title"
                                                        :label="data.title" class="p-0" color="primary" square />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Intervensi">
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Manajemen Nutrisi :</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in manajemenNutrisi">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.title"
                                                        :label="data.title" class="p-0" color="primary" square />
...
import * as EMR from '../page-emr-plugins/defisit-nutrisi'
...
let statusNutrisi = ref(EMR.statusNutrisi())
let skala = ref(EMR.skala())
let manajemenNutrisi = ref(EMR.manajemenNutrisi())
...
const COLLECTION: any = ref('DefisitNutrisi') //table mongodb
