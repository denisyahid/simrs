...
useHead({
    title: 'Hasil Pemeriksaan Bodyplethysmograph - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('HasilPemeriksaanBodyplethy') //table mongodb
...
const simpan = () => {
    ...
    let json = {
        ...
        'url_form': route.name,
        'name_form': 'Hasil Pemeriksaan Bodyplethysmograph',
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Hasil Pemeriksaan Bodyplethysmograph</h3>
                        </div>
                        <div class="right">
