        ...
        <div class="column is-12">
            <VCard>
                <div class="columns is-multiline">
                            ...
                            <div class="column is-3">
                                ...
                                <VField class="is-autocomplete-select" v-slot="{ id }">
                                    <VControl icon="feather:search">
                                        <AutoComplete v-model="input.dokterTindakan" :suggestions="d_Pegawai"
                                                ...
                                                <div class="column" v-for="(dot) in datas.keterangan">
                                                    <VField v-if="dot.type == 'checkBox'">
                                                        <VControl raw subcontrol>
                                                            <VCheckbox class="p-0" v-model="input[dot.model]" :true-value="dot.title"
                    ...
                    <div class="column is-12">
                        <Fieldset class="p-fieldsets" legend="PERSETUJUAN ANESTESI/SEDASI"
                            :toggleable="true">
                            <div class="column is-12">
...
import * as EMR from '../page-emr-plugins/informed-tindakan-anastesi'
...
const COLLECTION: any = ref('InformedConsentTindakanAnastesi') //table mongodb
