...
useHead({
    title: 'Surat Keterangan Sakit - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('SuratKeteranganSakit') //table mongodb
...
const loadRiwayat = async () => {
    ...
    if (response.length) {
        ...
        if (response_AsmedIGD != null) {
            input.value.TADiagnosa = response_AsmedIGD.TADiagnosis ? response_AsmedIGD.TADiagnosis : ''
        }
    }
}
const simpan = () => {
    ...
    let json = {
        ...
        'url_form': route.name,
        'name_form': 'Surat Keterangan Sakit',
        ...
        <div class="form-layout is-stacked-2">
            <div class="form-outer" style="margin-top:15px">
                ...
                <div class="columns is-multiline column is-12">
                    ...
                    <div class="column is-6">
                        <div class="column is-12">
                            <VField addons label="Dari Tanggal">
                                <VDatePicker v-model="input.DDariTanggal" mode="date" trim-weeks>
                        ...
                        <div class="column is-12">
                            <VField addons label="Ke Tanggal">
                                <VDatePicker v-model="input.DKeTanggal" mode="date" trim-weeks>
                                    <template #default="{ inputValue, inputEvents }">
                                        <VControl icon="feather:calendar" fullwidth>
                                            <VInput :value="inputValue" v-on="inputEvents" />
                                        </VControl>
                        ...
                        <div class="column is-12">
                            <VField addons label="Total Hari">
                                <VControl>
                                    <VInput type="number" class="input" v-model="input.TBTotalHari" />
                                </VControl>
                            </VField>
                        </div>
                    </div>
