        ...
        <div class="form-body">
          ...
          <div class="form-section is-grey">
            ...
            <div class="form-section-inner is-horizontal">
                ...
                <VControl>
                  <!-- <VRadio v-model="item.isRawatGabung" :value="true" label="Rawat Gabung" name="isRawatGabung"
                    ...
                    <VRadio v-model="item.isRawatGabung" :value="true" label="Rawat Gabung" name="isRawatGabung" square
                            color="primary" v-if="item.isRawatInap" style="margin-top: 5px; margin-left: 30px; font-size: 0.9rem;"/>
              ...
              <VField horizontal label="Diagnosa" style="display: none !important;">
                <VControl fullwidth>
                  <VTextarea class="textarea" v-model="item.diagnosa" rows="1"
                    placeholder="" autocomplete="off" autocapitalize="off"
                    spellcheck="true" disabled/>
  
                </VControl>
              </VField>
              <VField addons horizontal label="BB" style="display: none !important;">
                  <VControl expanded>
                      <VInput type="text" class="input" placeholder=""
                          v-model="item.bb" disabled/>
                  </VControl>
                  <VControl class="field-addon-body">
                      <VButton static>kg</VButton>
                  </VControl>
              </VField>
              <VField addons horizontal label="TB" style="display: none !important;">
                  <VControl expanded>
                      <VInput type="text" class="input" placeholder=""
                          v-model="item.tb" disabled/>
                  </VControl>
                  <VControl class="field-addon-body">
          ...
          <div class="column is-12 mt-0" style="display: none !important;">
              <div class="form-section pt-0 pl-0">
                  <div class="form-section-inner">
                      <h3 class="" style="font-size: 13pt; font-weight: bold; margin-top: 50px; margin-bottom: 20px;">Detail Pemeriksaan In Vivo</h3>
                      <div class="columns is-multiline">
                          ...
                          <div class="column is-12">
                                <VField>
                                    <VControl>
                                        <VTextarea class="textarea" v-model="item.catataninvivo"
...
const d_ProdukDef: any = ref([])
  ...
  const pasienByID = (id: any) => {
    ...
    "&collection=AsesmenAwalKeperawatanPasienRawatJalan" + "&field=tinggibadanObgyn,beratbadanObgyn"
    ).then((response) => {
    ...
    useApi().get(
        `/laboratorium/list-tindakan-for-order?ruanganfk=331`).then((response: any) => {
    ...
    useApi().get(
        `/registrasi/pasien-registrasi`).then((response: any) => {
            ...
            d_Radionuklida.value = response.radionuklidaterapi.map((e: any) => { return { label: e.radionuklida, value: e.id, default: e } })
...
const getSelectedRadioaktif = () => {
  ...
  const saveRegistrasi = async () => {
    ...
    isLoading.value = true
    let url = '/registrasi/save-registrasi-nuklir';
    if(item.isRawatInap){
