      ...
      <div class="form-outer" style="margin-top:15px">
        <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
          <div class="form-header-inner">
            <div class="left">
              <h3>Edukasi Pasien Untuk Persiapan Kolonoskopi GA Dengan Obat Fleet Fosfosodha</h3>
            </div>
            <div class="right">
          ...
          <table style="width: 100% !important;border-collapse: collapse !important;">
            ...
            <tr>
              ...
              <td>
                ...
                fleet II
                <br>Pemberian Pukul 21.00
                <br>Dosis dan Cara gePemberian Fleet II
                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Minum Fleet ½ botol + air dingin ½ gelas
...
useHead({ title: 'Edukasi Pasien Untuk Persiapan Kolonoskopi GA Dengan Obat Fleet Fosfosodha - ' + import.meta.env.VITE_PROJECT })
