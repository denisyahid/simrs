...
const setAutoFill = () =>{
  input.value.Diagnosistextdasar = 'Anamnesa, Pemeriksaan fisik, penunjang';
  input.value.pemeriksaantextTindakanKedokteran = 'SC';
  input.value.pemeriksaantextTataCara = 'Mengeluarkan bayi melalui insisi per-abdominal'
  input.value.pemeriksaantextTujuan = 'Melahirkan bayi dan plasenta'
  input.value.pemeriksaantextRisiko = 'Perdarahan, infeksi'
  input.value.pemeriksaantextKomplikasi = 'Perdarahan, infeksi'
  input.value.pemeriksaantextPrognosis = 'dubia ad bonam'
  input.value.persetujuan = 'SC'
}
