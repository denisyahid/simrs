                ...
                <div class="column">
                    <div class="columns is-multiline">
                        ...
                        <div class="column is-12">
                            ...
                            <VField>
                                <VTextarea rows="3" v-model="input.keterangan"></VTextarea>
                            </VField>
                        </div>
                        ...
                        <div class="column is-4" style="margin-right: auto;">
                            ...
                            <div style="text-align: center;">
                                <h1>Tanda Tangan Yang Diperiksa</h1>
                                <TandaTangan :elemenID="'TTD_Pasien'" :width="'150'" :height="'150'" class="dek mt-2" />
                                <VControl class="mt-2">
                                    <VInput type="text" class="input" v-model="input.namaPasien2" />
                                </VControl>
                            </div>
                        </div>
...
const setAutoFill = async () => {
    ...
    d.keterangan = 'Menerangkan dengan sesungguhnya bahwa nama tersebut di atas, organ Repropuksinya dalam keadaan SEHAT, sudah menikah ... Tahun dan belum hamil . Maka direkomendasikan untuk adopsi anak .'
}
