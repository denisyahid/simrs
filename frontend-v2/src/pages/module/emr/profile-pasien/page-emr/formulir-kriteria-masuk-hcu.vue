      ...
      <VCard>
        <div class="columns is-multiline">
              ...
              <tbody>
                <template v-for="(kategori, index) in kriteria" :key="index">
                  ...
                  <tr v-for="(item, idx) in kategori.detail" :key="idx">
                    <td class="td-pri" v-if="kategori.label !== 'PASIEN DENGAN KEPERLUAN PERSIAPAN DAN PEMANTAUAN PRA INTRA PASKA OPERASI'">{{ item.deskripsi }}</td>
                    <td class="td-pri" v-if="kategori.label !== 'PASIEN DENGAN KEPERLUAN PERSIAPAN DAN PEMANTAUAN PRA INTRA PASKA OPERASI'">
                      <VField>
                        <VControl>
                          <VCheckbox
                    ...
                    <td class="td-pri" v-if="kategori.label === 'PASIEN DENGAN KEPERLUAN PERSIAPAN DAN PEMANTAUAN PRA INTRA PASKA OPERASI'">
                      <VField>
                        <VControl>
                          <VTextarea
                            v-model="input.pasienDenganKepeluaranPraIntraPaskaOperasi1"
                            class="pt-1 pb-1"
                    ...
                    <td colspan="2" class="td-pri" v-if="kategori.label === 'PASIEN DENGAN KEPERLUAN PERSIAPAN DAN PEMANTAUAN PRA INTRA PASKA OPERASI'">
                      <VField>
                        <VControl>
                          <VTextarea
                            v-model="input.pasienDenganKepeluaranPraIntraPaskaOperasi2"
                            class="pt-1 pb-1"
                            true-value="TIDAK ADA"
                            label="TIDAK ADA"
                            color="primary"
          ...
          <div class="column is-12">
            ...
            <div class="column is-12">
              <h1 style="font-weight: bold">Memenuhi indikasi masuk HCU:</h1>
              <VField>
                <VControl class="prime-auto">
                  <VInput v-model="input.memenuhiIndikasi" placeholder="Memenuhi indikasi masuk HCU" type="text" color="primary" class="input" />
                </VControl>
              </VField>
            </div>
          </div>
...
const COLLECTION: any = ref("FormulirKriteriaMasukHCU"); //table mongodb
