<template>
      ...
      <div class="form-body">
        ...
        <div class="form-section is-grey">
          ...
          <div class="form-section-inner is-horizontal">
            ...
            <VField horizontal label=" Tanggal Rencana Terapi" style="display: none !important">
              <VDatePicker v-model="item.tglrencanaterapi" mode="dateTime" style="width: 100%;">
                <template #default="{ inputValue, inputEvents }">
                  <VField>
                    <VControl icon="feather:calendar" fullwidth>
                      <VInput :value="inputValue" v-on="inputEvents" />
            ...
            <div class="form-section-inner">
              ...
              <div class="columns is-multiline">
                ...
                <div class="column is-12 h-400-o">
                  <div class="column is-12" v-for="items in filteredLayanan" :key="items.detailjenisproduk">
                ...
                <div class="column is-12">
                  <VField>
                    <VLabel>Diagnosa</VLabel>
                    <VControl>
                      <VTextarea class="textarea" v-model="item.catatanKlinis" rows="2"
                        placeholder="Diagnosa (optional) ..." autocomplete="off" autocapitalize="off"
                        spellcheck="true" />
                    </VControl>
                  </VField>
                </div>
  ...
  <Dialog v-model:visible="modalRiwayat" modal header="Riwayat In Vitro" :style="{ width: '50vw' }">
    <TRiwayatOrderLab  :items="listRiwayat" @hapusItems="DialogConfirm" >  
    </TRiwayatOrderLab>
  </Dialog>
</template>
...
console.log('Parameters:', {
  ruanganfk: props.registrasi.apd.objectruanganfk,
  idkebangsaan: props.pasien.objectkebangsaanfk,
  kelasfk: props.registrasi.apd.objectkelasfk,
});
...
const pasienByID = (id: any) => {
  ...
  useApi().get(
    `/laboratorium/list-tindakan-for-order?ruanganfk=338&idkebangsaan=${props.pasien.objectkebangsaanfk}&kelasfk=${props.registrasi.apd.objectkelasfk}`).then((response: any) => {
...
const saveRegistrasi = async () => {
  ...
  let json = {
    ...
    'objSave': {
      ...
      'tglrencanaterapi': H.formatDate(item.tglrencanaterapi, 'YYYY-MM-DD HH:mm:ss'),
      'pegawaiorderfk': item.dokter ? item.dokter.id : null,
      'tb': item.tb ? item.tb : null,
      'bb': item.bb ? item.bb : null,
      'objectruangantujuanfk': 338,
      'tgloperasi': null,
      'norec_so': '',
      ...
      'farmakafk': null,
      'terapiIodium': null,
      'terapiRadiofarmaka': null,
      'kesimpulanterapi': null,
      'keterangan': null,
      'prefix': 'NT',
      'iscito': false,
