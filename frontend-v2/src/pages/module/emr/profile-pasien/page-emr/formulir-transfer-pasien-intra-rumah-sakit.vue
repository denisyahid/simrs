      ...
      <div class="form-outer" style="margin-top:15px">
        <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
          <div class="form-header-inner">
            <div class="left">
              <h3>Formulir Transfer Pasien Intra Rumah Sakit</h3>
            </div>
            <div class="right">
        ...
        <div class="column">
          ...
          <div class="columns is-multiline column is-12 pt-0 pb-0">
            ...
            <div class="columns is-multiline column is-12 pt-0 pb-3">
              ...
              <div class="column is-12">
                <div class="column is-4 pt-0">
                  <h1>Gelang Identitas</h1>
                  <VField>
                    <VControl>
                      <Multiselect v-model="input.gelangIdentitas" :attrs="{ value }" placeholder="--Pilih--" label="label"
...
const loadRiwayat = async () => {
  await useApi().get(`/emr/get-emr?nocmfk=${ID_PASIEN}&norec_pd=${props.registrasi.norec_pd}&collection=${COLLECTION.value}&emrpasienfk=${NOREC_EMRPASIEN.value}&namaruangan=${NAMA_RUANGAN.value}`).then(async (response: any) => {
    if (response.length) {
