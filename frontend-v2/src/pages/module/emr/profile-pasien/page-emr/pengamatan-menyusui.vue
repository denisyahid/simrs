                ...
                <div class="columns is-multiline">
                  <div class="column is-6">
                    <div class="columns is-multiline mt-5">
                        <div class="column is-4">
                            <h1 style="font-weight: bold;">Nama Ibu</h1>
                        </div>
                        ...
                        <div class="column is-4">
                            <h1 style="font-weight: bold;">Nama Bayi</h1>
                        </div>
                        <div class="column is-8">
                            <VField>
                                <VControl icon="">
                                    <VInput type="text" v-model="input.namabayi" placeholder="" />
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-4">
                            <h1 style="font-weight: bold;">Umur Bayi</h1>
                        </div>
                        <div class="column is-4">
                            <VField addons>
                            <VControl expanded>
                  ...
                  <div class="column is-6">
                    <div class="columns is-multiline mt-5">
                        <div class="column is-4">
                            <h1 style="font-weight: bold;">Tanda menyusui berjalan baik</h1>
                        </div>
                        <div class="column is-8">
                            <VField>
                                <VControl>
                                    <VTextarea v-model="input.tandamenyusui" rows="7">
                                    </VTextarea>
                                </VControl>
                            </VField>
                        </div>
              ...
              <div class="column is-12 mt-auto">
                <div class="columns is-multiline">
                  <div class="column is-6">
                    <div class="columns is-multiline mt-5">
                        <div class="column is-12">
                            <h1 style="font-weight: bold;">UMUM IBU</h1>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.ibusehat" true-value="Ibu tampak sehat" label="Ibu tampak sehat"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.ibusakit" true-value="Ibu tampak sakit atau depresi" label="Ibu tampak sakit atau depresi"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.ibutenang" true-value="Ibu tampak tenang dan rileks" label="Ibu tampak tenang dan rileks"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.ibutegang" true-value="Ibu tampak tegang dan tidak nyaman" label="Ibu tampak tegang dan tidak nyaman"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bounding" true-value="Terlihat tanda bounding ibu-bayi" label="Terlihat tanda bounding ibu-bayi"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.kontakmata" true-value="Tidak ada kontak mata ibu-bayi" label="Tidak ada kontak mata ibu-bayi"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                  ...
                  <div class="column is-6">
                    <div class="columns is-multiline mt-5">
                        <div class="column is-12">
                            <h1 style="font-weight: bold;">UMUM BAYI</h1>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayisehat" true-value="Bayi tampak sehat" label="Bayi tampak sehat"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayisakit" true-value="Bayi tampak sakit atau mengantuk" label="Bayi tampak sakit atau mengantuk"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayitenang" true-value="Bayi tampak tenang dan rileks" label="Bayi tampak tenang dan rileks"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayigelisah" true-value="Ibu tampak gelisah atau menangis" label="Ibu tampak gelisah atau menangis"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayilapar" true-value="Bayi mencari payudara (rooting) bila lapar" label="Bayi mencari payudara (rooting) bila lapar"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayitidaklapar" true-value="Bayi tidak mencari payudara (rooting)" label="Bayi tidak mencari payudara (rooting)"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
              ...
              <div class="column is-12 mt-auto">
                <div class="columns is-multiline">
                  <div class="column is-6">
                    <div class="columns is-multiline mt-5">
                        <div class="column is-12">
                            <h1 style="font-weight: bold;">POSISI BAYI</h1>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayilurus" true-value="Telinga dan bahu bayi dalam garis lurus" label="Telinga dan bahu bayi dalam garis lurus"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayiberputar" true-value="Leher dan kepala bayi berputar" label="Leher dan kepala bayi berputar"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayidipeluk" true-value="Bayi dipeluk dekat badan ibu" label="Bayi dipeluk dekat badan ibu"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayitidakdipeluk" true-value="Bayi tidak dipeluk dekat badan ibu" label="Bayi tidak dipeluk dekat badan ibu"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayiditopang" true-value="Seluruh badan bayi ditopang" label="Seluruh badan bayi ditopang"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.hanyalahir" true-value="Hanya leher dan badan bayi ditopang" label="Hanya leher dan badan bayi ditopang"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayipayudara" true-value="Bayi dekat di payudara, hidung berhadapan dengan puting" label="Bayi dekat di payudara, hidung berhadapan dengan puting"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayitidakpayudara" true-value="Bayi dekat di payudara, hidung tidak berhadapan dengan puting" label="Bayi dekat di payudara, hidung tidak berhadapan dengan puting"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                  ...
                  <div class="column is-6">
                    <div class="columns is-multiline mt-5">
                        <div class="column is-12">
                            <h1 style="font-weight: bold;">PERLEKATAN BAYI</h1>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayiaerola" true-value="Tampak lebih banyak aerola di atas bibir" label="Tampak lebih banyak aerola di atas bibir"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bawahaerola" true-value="Tampak lebih banyak aerola di bawah bibir" label="Tampak lebih banyak aerola di bawah bibir"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.mulutterbuka" true-value="Mulut bayi terbuka lebar" label="Mulut bayi terbuka lebar"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.muluttidak" true-value="Mulut bayi tidak terbuka lebar" label="Mulut bayi tidak terbuka lebar"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bibirbawah" true-value="Bibir bawah bayi berputar ke luar" label="Bibir bawah bayi berputar ke luar"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bibirdalam" true-value="Bibir bawah bayi berputar ke dalam" label="Bibir bawah bayi berputar ke dalam"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.dagumenempel" true-value="Dagu bayi menempel pada payudara" label="Dagu bayi menempel pada payudara"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.dagutidak" true-value="Dagu bayi tidak menempel pada payudara" label="Dagu bayi tidak menempel pada payudara"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
              ...
              <div class="column is-12 mt-auto">
                <div class="columns is-multiline">
                  <div class="column is-6">
                    <div class="columns is-multiline mt-5">
                        <div class="column is-12">
                            <h1 style="font-weight: bold;">MENGHISAP</h1>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.hisapanlambat" true-value="Hisapan lambat, dalam dan dengan istirahat" label="Hisapan lambat, dalam dan dengan istirahat"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.hisapandangkal" true-value="Hisapan dangkal dan cepat" label="Hisapan dangkal dan cepat"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.pipimembulat" true-value="Pipi membulat waktu menghisap" label="Pipi membulat waktu menghisap"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.pipitertarik" true-value="Pipi tertarik ke dalam waktu menghisap" label="Pipi tertarik ke dalam waktu menghisap"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.bayimelepas" true-value="Bayi melepasakan payudara waktu selesai" label="Bayi melepasakan payudara waktu selesai"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.ibumelepas" true-value="Ibu melepaskan bayi dari payudara" label="Ibu melepaskan bayi dari payudara"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.oksitosin" true-value="Ibu merasakan tanda-tanda reflek oksitosin" label="Ibu merasakan tanda-tanda reflek oksitosin"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                        <div class="column is-6">
                            <VField vertical>
                                <VControl>
                                    <VCheckbox class="fontcheckbox pt-1 pb-1" v-model="input.tandaoksitosin" true-value="Tidak tampak tanda oksitosin yang jelas" label="Tidak tampak tanda oksitosin yang jelas"
                                    color="primary"/>
                                </VControl>
                            </VField>
                        </div>
                  ...
                  <div class="column is-6">
                    <div class="columns is-multiline mt-5">
                        ...
                        <div class="column is-12">
                            <VField>
                                <VControl>
                                    <VTextarea v-model="input.catatan" rows="7">
                                    </VTextarea>
                                </VControl>
                            </VField>
                        </div>
