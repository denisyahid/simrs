  ...
  <div>
    <div>
      <div>
          ...
          <div class="form-outer" style="margin-top:15px">
            <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
              <div class="form-header-inner">
                ...
                <div class="right">
                  <ButtonEmr :NOREC_EMRPASIEN="NOREC_EMRPASIEN" :RUANGAN="props.registrasi.namaruangan" :COLLECTION="COLLECTION" :isLockSimpan="paramRiwayat"
                    :isLoading="isLoading" @simpan="simpan" @simpanTemplate="simpanTemplate" @kembaliKeun="kembaliKeun">
                  </ButtonEmr>
                </div>
              </div>
          ...
          <div class="column is-12">
            ...
            <div class="p-tabmenu-uy">
              <div class="p-tabmenu p-component" ref="contentRefScrollMenu">
                  ...
                  <li class="p-tabmenuitem" :class="[TAB_ITEMS == 'CPPT' || TAB_DEFAULT == 'CPPT' ? 'active' : '']"
                    role="presentation"><a role="menuitem" class="p-menuitem-link" aria-label="Dashboard" tabindex="0"
                      ...
                      <span class="p-menuitem-text"
                        v-if="props.registrasi.namaruangan.toUpperCase().indexOf('PSIKOLOGI') == -1">Pemeriksaan
                        Fisik</span>
                ...
                <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar"
                  v-if="(props.registrasi.namaruangan.toUpperCase().indexOf('GIGI') > -1 || props.registrasi.namaruangan.toUpperCase().indexOf('MULUT') > -1 || props.registrasi.namaruangan.toUpperCase().indexOf('ENDODONSIA') > -1)">
                ...
                <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar"
                  v-if="props.registrasi.namaruangan.toUpperCase().indexOf('OBGYN') > -1"
                  style="display: none !important">
                  <li class="p-tabmenuitem"
                    :class="[TAB_ACTIVE == 'Dashboard' || TAB_DEFAULT == 'Dashboard' ? 'active' : '']"
                    role="presentation"><a role="menuitem" class="p-menuitem-link" aria-label="Dashboard" tabindex="0"
                      @click="isPemeriksaanFisikObgyn = false">
                      <span class="p-menuitem-icon fas fa-laptop-medical"></span><span class="p-menuitem-text">Status
                        Lokalis Obgyn</span></a>
                  </li>
                </ul>
                <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar"
                  v-if="props.registrasi.namaruangan.toUpperCase().indexOf('GIGI') == -1 && props.registrasi.namaruangan.toUpperCase().indexOf('JANTUNG') == -1 && props.registrasi.namaruangan.toUpperCase().indexOf('LAKTASI') == -1 && props.registrasi.namaruangan.toUpperCase().indexOf('BEDAH MULUT') == -1 && props.registrasi.namaruangan.toUpperCase().indexOf('PSIKOLOGI') == -1">
                  <li class="p-tabmenuitem"
                    :class="[(TAB_ACTIVE == 'Dashboard' || TAB_DEFAULT == 'Dashboard' ? 'active' : ''), isLoading ? 'is-disabled' : '']"
                    role="presentation"><a role="menuitem" class="p-menuitem-link" aria-label="Dashboard" tabindex="0"
        ...
        <!-- <div class="column is-12"
                    v-if="isPemeriksaanFisik == false && props.registrasi.namaruangan.toUpperCase().indexOf('GIGI') > -1">
                    <TOdontogram></TOdontogram>
                </div> -->

        <div class="column is-12" align="center"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('JIWA') == -1"
          style="margin-top: -20px;">

          <template
            v-if="(props.registrasi.namaruangan.toUpperCase().indexOf('INTERNA') > -1 || props.registrasi.namaruangan.toUpperCase().indexOf('GERIATRI') > -1)">
          ...
          <ImgDraw elemenID="Gambar" :valueImg="input.Gambar" height="580" width="600"
            imageSrc="/images/simrs/paru-paru.jpeg"
            v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('PARU') > -1" />
          <ImgDraw elemenID="Gambar" :valueImg="input.Gambar" height="400" width="850"
            imageSrc="/images/simrs/penyakitdalam.png"
            v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('HEMODIALIS') > -1" />
          <ImgDraw elemenID="Gambar" height="550" width="850"
            v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('THT') > -1"
            imageSrc="/images/simrs/tht-full.png" :valueImg="input.Gambar" class="mb-5" />
          <ImgDraw elemenID="Gambar" height="500" width="500"
            v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('VCT') > -1"
            imageSrc="/images/simrs/paru-paru.jpeg" :valueImg="input.Gambar" class="mb-5" />
          <ImgDrawOdon elemenID="Gambar" height="490" width="900"
            v-else-if="(props.registrasi.namaruangan.toUpperCase().indexOf('GIGI') > -1 || props.registrasi.namaruangan.toUpperCase().indexOf('MULUT') > -1 || props.registrasi.namaruangan.toUpperCase().indexOf('ENDODONSIA') > -1)"
            imageSrc="/images/simrs/odon.png" :valueImg="input.Gambar" class="mb-5" />
          <template v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('HEMATOLOGI') > -1">
          ...
          <ImgDraw elemenID="Gambar" :valueImg="input.Gambar" height="500" width="700"
            imageSrc="/images/simrs/outline-human-body.jpg"
            v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('MEDICAL') > -1" />
          <ImgDraw elemenID="Gambar" :valueImg="input.Gambar" height="600" width="500"
            imageSrc="/images/simrs/outline-only-body.jpg"
            v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('KULIT') > -1 || props.registrasi.namaruangan.toUpperCase().indexOf('SPEKTRA') > -1 || props.registrasi.namaruangan.toUpperCase().indexOf('COSMEDIC') > -1" />
          <ImgDraw elemenID="Gambar" :valueImg="input.Gambar" height="300" width="1000"
            imageSrc="/images/simrs/obstetrifix.png"
            v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('OBGYN') > -1 && jenisObgyn == 'Obstetri'" />
          <ImgDraw elemenID="Gambar" :valueImg="input.Gambar" height="400" width="800"
            imageSrc="/images/simrs/ginekologifix.png"
            v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('OBGYN') > -1 && jenisObgyn == 'Ginekologi'" />
          <ImgDraw elemenID="Gambar" height="900" width="700" imageSrc="/images/simrs/kestrad.png"
            v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('TRADISIONAL') > -1" />
          <ImgDraw elemenID="Gambar" height="130" width="866" imageSrc="/images/emr/wongBaker.png"
            v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('FISIOTERAPI') > -1" />
          <template v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('JANTUNG') > -1">
            <ImgDraw elemenID="Gambar" height="400" width="700" imageSrc="" />
          </template>
          <ImgDraw elemenID="Gambar" height="600" width="500" imageSrc="/images/simrs/outline-only-body.jpg" v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('KULIT') > -1
            && props.registrasi.namaruangan.toUpperCase().indexOf('SPEKTRA') > -1
            && props.registrasi.namaruangan.toUpperCase().indexOf('COSMEDIC') > -1" />
          <template v-else-if="jenisTrauma != '' && jenisTrauma != null">
            ...
            <ImgDraw elemenID="Gambar" height="500" width="700" imageSrc="/images/simrs/odontogram.png"
              v-if="props.registrasi.namaruangan.toUpperCase().indexOf('BEDAH MULUT') > -1" />
            <template v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('DIGESTIVE') > -1">
            ...
            <!-- <template v-else>
                            ...
                            <ImgDraw elemenID="Gambar" height="300" width="500"
                            imageSrc="" class="mb-5" />
                            <VField>
                                <VControl>
                                    <VTextarea v-model="input.keteranganCanvasTrauma" rows="10" style="margin-top: 15px;"
                                        placeholder="Keterangan">
                                    </VTextarea>
                                </VControl>
                            </VField>
                            <hr>
                            <h1 style="margin-bottom: 10px; margin-top: 20px;font-weight: bold; ">
                                Skema
                            </h1>
                            <ImgDraw elemenID="Skema" class="gambar" height="300" width="500"
                            imageSrc="" />
                            <VField>
                                <VControl>
                                    <VTextarea v-model="input.keteranganCanvasNonTrauma" rows="10" style="margin-top: 15px;"
                                        placeholder="Keterangan">
                                    </VTextarea>
                                </VControl>
                            </VField>
          ...
          <!-- <ImgDraw v-else elemenID="Gambar" height="400" width="700"
                        imageSrc="/images/simrs/outline-human-body.jpg" />
                    <VField>
                        <VControl>
                            <VTextarea v-model="input.keteranganCanvas" rows="10" style="margin-top: 15px;"
                                placeholder="Keterangan">
                            </VTextarea>
                        </VControl>
                    </VField> -->
        ...
        <div class="column is-12 mt-5"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('HEMODIALIS') > -1"
          style="margin-top: -20px;">
          <div class="columns is-multiline">
            <div class="column is-12">
        ...
        <!-- START PERIODONSIA -->
        <div class="column is-12 mt-5"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('PERIODONSIA') > -1">
          <div class="columns is-multiline">
            <div class="column is-12">
        ...
        <!-- START THT -->
        <div class="column is-12 mt-5"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('THT') > -1"
          style="margin-top: -20px;">
          <div class="columns is-multiline">
        ...
        <div class="column is-12 mt-5 px-5"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('BEDAH UROLOGI') > -1"
          style="margin-top: -20px;">
          <div class="columns is-multiline">
            <div class="column is-4">
              <span>
        ...
        <!-- START POLI SARAF -->
        <div class="column is-12 mt-5 px-5"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('SARAF') > -1 && props.registrasi.namaruangan.toUpperCase().indexOf('BEDAH SARAF') == -1"
          style="margin-top: -20px;">
          <div class="columns is-multiline">
            <div class="column is-8"></div>
            <div class="column is-4" align="right">
        ...
        <!-- START:OBGYN -->
        <div class="column is-12"
          v-if="isPemeriksaanFisik && isPemeriksaanFisikLokalis == false && props.registrasi.namaruangan.toUpperCase().indexOf('OBGYN') > -1 && jenisObgyn == 'Obstetri'"
        ...
        <div class="column is-12"
          v-if="isPemeriksaanFisik && isPemeriksaanFisikLokalis == false && props.registrasi.namaruangan.toUpperCase().indexOf('OBGYN') > -1 && jenisObgyn == 'Ginekologi'"
        ...
        <!-- START:KULIT -->
        <div class="column is-12"
          v-if="isPemeriksaanFisikLokalis == true && (props.registrasi.namaruangan.toUpperCase().indexOf('KULIT') > -1 || props.registrasi.namaruangan.toUpperCase().indexOf('COSMEDIC') > -1 || props.registrasi.namaruangan.toUpperCase().indexOf('SPEKTRA') > -1)"
          style="margin-top: 40px;">
        ...
        <div class="column is-12"
          v-if="isPemeriksaanFisikLokalis == true && (props.registrasi.namaruangan.toUpperCase().indexOf('ANAK') > -1 || props.registrasi.namaruangan.toUpperCase().indexOf('KEMBANG') > -1)"
          style="margin-top: -20px;">
          <div class="columns is-multiline">
            <div class="column is-12">
        ...
        <div class="column is-12 mt-5"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('REHAB') > -1"
          style="margin-top: -20px;">
          <div class="columns is-multiline">
        ...
        <div class="column is-12"
          v-if="isPemeriksaanFisikLokalis == true && (((props.registrasi.namaruangan.toUpperCase().indexOf('INTERNA') > -1 || props.registrasi.namaruangan.toUpperCase().indexOf('MEDICAL') > -1) && jenisInterna == 'Obstetri') || props.registrasi.namaruangan.toUpperCase().indexOf('GERIATRI') > -1)"
          style="margin-top: -20px;">
        ...
        <div class="column is-12"
          v-if="isPemeriksaanFisik == true && props.registrasi.namaruangan.toUpperCase().indexOf('PSIKOLOGI') > -1"
          style="margin-top: -20px;">
          <div class="columns is-multiline">
            <div class="column is-12">
        ...
        <!-- START ANASTESI -->
        <div class="column is-12 mt-5"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('ANESTESI') > -1">
          <div class="columns is-multiline">
            <div class="column is-4">
        ...
        <div class="column is-12"
          v-if="isPemeriksaanFisik == true && props.registrasi.namaruangan.toUpperCase().indexOf('TRADISIONAL') > -1"
          style="margin-top: -20px;">
          <div class="columns is-multiline">
            <div class="column is-8"></div>
        ...
        <div class="column is-12"
          v-if="isPemeriksaanFisikLokalis == true && (jenisTrauma == 'Non Trauma' || props.registrasi.namaruangan.toUpperCase().indexOf('BEDAH MULUT') > -1)"
          style="margin-top: -20px;">
          <div class="columns is-multiline">
            <div class="column is-6">
        ...
        <div class="column is-12"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('MATA') > -1"
          style="margin-top: -20px;">
          <div class="columns is-multiline">
            <div class="column is-12">
        ...
        <!-- START GIGI -->
        <div class="column is-12 mt-5 px-5"
          v-if="(isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('GIGI') > -1 || isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('MULUT') > -1 || isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('ENDODONSIA') > -1)"
          style="margin-top: -20px;">
        ...
        <!-- START GIZI -->
        <div class="column is-12 mt-5 px-5"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('GIZI') > -1"
          style="margin-top: -20px;">
        ...
        <!-- START VCT -->
        <div class="column is-12 mt-5 px-5"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('VCT') > -1"
          style="margin-top: -20px;">
                    ...
                    <VControl fullwidth>
                      <VControl raw subcontrol>
                        <VCheckbox
                              ...
                              color="primary"
                              square
                              :true-value="vctValue.label"
                              :label="vctValue.label"
                              v-model="input[`${lokalisVCT.model}${index}`]"
                          />
                      </VControl>
                    </VControl>
                  </div>
        ...
        <div class="column is-12"
          v-if="isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('POLI ONKOLOGI RADIASI') > -1 || isPemeriksaanFisikLokalis == true && props.registrasi.namaruangan.toUpperCase().indexOf('PELAYANAN ONKOLOGI RADIASI') > -1"
          style="margin-top: -20px;">
          <div class="is-flex">
            <div class="column is-2">
        ...
        <div class="columns is-multiline">
          <div class="column is-12"
            v-if="props.registrasi.namaruangan.toUpperCase().indexOf('OBGYN') == -1 && props.registrasi.namaruangan.toUpperCase().indexOf('PSIKOLOGI KLINIS') == -1 && props.registrasi.namaruangan.toUpperCase().indexOf('TRADISIONAL') == -1 && props.registrasi.namaruangan.toUpperCase().indexOf('POLI ONKOLOGI RADIASI') == -1 && isPemeriksaanFisik && isPemeriksaanFisikLokalis == false">
            <TabMenu :model="[]" :scrollable="true" />
        ...
        <div class="column is-12">
          <div class="column is-12 pt-0"
            v-if="props.registrasi.namaruangan.toUpperCase().indexOf('POLI ONKOLOGI RADIASI') > -1 && isPemeriksaanFisik == true && isPemeriksaanFisikLokalis == false || props.registrasi.namaruangan.toUpperCase().indexOf('PELAYANAN ONKOLOGI RADIASI') > -1 && isPemeriksaanFisik == true && isPemeriksaanFisikLokalis == false">
            <div class="columns is-multiline">
              <div class="column is-8">
          ...
          <div class="column is-12 pt-0"
            v-else-if="props.registrasi.namaruangan.toUpperCase().indexOf('OBGYN') == -1 && props.registrasi.namaruangan.toUpperCase().indexOf('PSIKOLOGI KLINIS') == -1 && props.registrasi.namaruangan.toUpperCase().indexOf('TRADISIONAL') == -1 && isPemeriksaanFisik == true && isPemeriksaanFisikLokalis == false">
          ...
          <div class="column is-12 mb-0 pt-0">
            ...
            <div class="column is-12 pt-0 pl-0 pr-0">
              ...
              <VField label="Diet yang telah diberikan & diet yang harus dilakukan di rumah diet" v-if="props.registrasi.namadepartemen.indexOf('RAWAT INAP') > -1">
                  <VControl>
          ...
          <div class="column is-12 mb-0 pt-0" v-if="props.registrasi.namaruangan.toUpperCase().indexOf('IGD') > -1">
            <h1>MOI</h1>
            <div class="column is-12 pt-0 pl-0 pr-0">
              <VField>
...
useHead({
  title: 'Asesmen Medis - ' + import.meta.env.VITE_PROJECT,
})

useViewWrapper().setPageTitle(import.meta.env.VITE_PROJECT)
useViewWrapper().setFullWidth(true)
console.log('route', useRoute().query)
let ID_PASIEN = useRoute().query.nocmfk as string
let NOREC_PD = useRoute().query.norec_pd as string
let norec_emr = useRoute().query.norec_emr as string
let paramRiwayat = useRoute().query.riwayat as boolean
paramRiwayat = paramRiwayat == "true" ? true : false
// Parameter Asemed Ranap, bingung Aku asmed ranap pake asmed rajal wkwkwk
...
const modalConfirmObgyn: any = ref(true)
...
//   jenisObgyn.value = jenispilihan
//   jenisInterna.value = jenispilihaninterna
//   jenisTrauma.value = jenispilihantrauma
//   console.log('jenis obgyn', jenisObgyn.value)
//   console.log('jenis interna', jenisInterna.value)
//   setAutoFill().then(async(autofills) => {
//     isLoading.value = true
...
//           confirm.require({
//             message: 'Asesmen Medis sudah pernah diinput ' + calculateDays + ' hari dari tanggal registrasi pasien ini. Apakah anda ingin melihat riwayat terakhirnya ?',
//             group: 'templating2',
//             header: 'Informasi Asesmen Medis',
...
//       }
//       // console.log("IS IT TRAUMA ?", props.registrasi.namaruangan.toUpperCase())
//       // if(mapNeedTrauma(props.registrasi.namaruangan.toUpperCase().trim())) {
//       //     console.log("masuk confirm")

//       //     confirm.require({
//       //         message: 'Jenis Assesmen',
//       //         group: 'templating',
//       //         header: 'Silahkan pilih Jenis Assesmen untuk melanjutkan',
//       //         icon: 'pi pi-exclamation-circle',
//       //         rejectProps: {
//       //             label: 'Cancel',
//       //             icon: 'pi pi-times',
...
//       //         },
//       //         accept: () => {
//       //             mapForTraumas.value = true
//       //             isTrauma.value = false;
//       //             input.value.istrauma = false;
//       //         },
//       //         reject: () => {
//       //             mapForTraumas.value = true
//       //             isTrauma.value = true;
//       //             input.value.istrauma = true;
//       //         }
//       //     })
//       // }else {
//       //     if(mapNonTrauma(props.registrasi.namaruangan.toUpperCase().trim())) {
//       //         if(input.value.istrauma == undefined) {
//       //             input.value.istrauma = false;
//       //         }
//       //         isTrauma.value = false;
//       //         mapForTraumas.value = true
...
//   console.log('canvas mata', input.value.canvasmata)
...
//       await useApi().get("emr/auto-fill?norec_pd=" + props.registrasi.norec_pd +
//         "&collection=TriagePasienIGD" + "&field=" + fieldIGD).then((res) => {
//           if (res) {
//             let data = '';
//             dataNurse.value = {
...
//             // input.value.riwayatpengobatan = res.riwayatpengobatan
...
//                 if (responsey != null) {
//                   dataNurse.value = {
//                     tinggiBadan: responsey.tinggibadanObgyn ?? '',
//                     beratBadan: responsey.beratBadanObgyn ?? '',
//                   }
...
//                   data += responsey.tinggiBadanObgyn ? `Tinggi Badan : ${responsey.tinggiBadanObgyn} Cm\n` : ''
//                   data += responsey.beratBadanObgyn ? `Berat Badan : ${responsey.beratBadanObgyn} Kg\n` : ''
...
//                   datax += responsey.keluhanutama ? `Keluhan Utama : ${responsey.keluhanutama}\n` : 'Keluhan Utama : -\n'
//                   datax += responsey.riwayatpenyakit ? `Riwayat Penyakit Sekarang : ${responsey.riwayatpenyakit}\n` : 'Riwayat Penyakit Sekarang : -\n'
//                   datax += responsey.riwayatpenyakitdahulu ? `Riwayat Penyakit Dahulu : ${responsey.riwayatpenyakitdahulu}\n` : 'Riwayat Penyakit Dahulu : -\n'
//                   datax += responsey.riwayatpenyakitkeluarga ? `Riwayat Penyakit Keluarga : ${responsey.riwayatpenyakitkeluarga}\n` : 'Riwayat Penyakit Keluarga : -\n'
//                   datax += responsey.riwayatpengobatan ? `Riwayat Pengobatan : ${responsey.riwayatpengobatan}\n` : 'Riwayat Pengobatan : -\n'
//                   datax += responsey.isalergi ? `Alergi : ${responsey.isalergi} ${responsey.riwayatalergi}\n` : 'Alergi : -\n'
...
//                   input.value.keadaanumum = responsey.keadaanumumobgyn
//                   resolve(true)
//                 }
//               })
//             } else {
...
//               let datax = ''
//               dataNurse.value = {
//                 tinggiBadan: responsex.tinggibadanObgyn ?? '',
//                 beratBadan: responsex.beratBadanObgyn ?? '',
//               }
...
//               data += responsex.tinggibadanObgyn ? `Tinggi Badan : ${responsex.tinggibadanObgyn} Cm\n` : ''
//               data += responsex.beratBadanObgyn ? `Berat Badan : ${responsex.beratBadanObgyn} Kg\n` : ''
//               data += responsex.sao2Obgyn ? `SPO2 : ${responsex.sao2Obgyn} %\n` : ''
//               data += responsex.IMT ? `IMT : ${responsex.IMT}\n` : ''

//               datax += responsex.keluhanutama ? `Keluhan Utama : ${responsex.keluhanutama}\n` : 'Keluhan Utama : -\n'
//               datax += responsex.riwayatpenyakit ? `Riwayat Penyakit : ${responsex.riwayatpenyakit}\n` : 'Riwayat Penyakit : -\n'
//               datax += responsex.riwayatpenyakitdahulu ? `Riwayat penyakit dahulu : ${responsex.riwayatpenyakitdahulu}\n` : 'Riwayat penyakit dahulu : -\n'
//               datax += responsex.riwayatpengobatan ? `Riwayat pengobatan : ${responsex.riwayatpengobatan}\n` : 'Riwayat pengobatan : -\n'
//               datax += responsex.riwayatpenyakitkeluarga ? `Riwayat penyakit keluarga : ${responsex.riwayatpenyakitkeluarga}\n` : 'Riwayat penyakit keluarga : -\n'
//               datax += responsex.riwayatalergi ? `Riwayat alergi : ${responsex.riwayatalergi}\n` : 'Riwayat alergi : -\n'
...
//               input.value.tt = responsex.tinggibadanObgyn;
//               input.value.bb = responsex.beratbadanObgyn;
//               input.value.keadaanumum = responsex.keadaanumumobgyn
...
//           data += response.riwayatpengobatan ? `Riwayat pengobatan : ${response.riwayatpengobatan}` : 'Riwayat pengobatan: -\n'
//           data += response.riwayatpenyakitkeluarga ? `Riwayat penyakit keluarga : ${response.riwayatpenyakitkeluarga}` : 'Riwayat penyakit keluarga: -\n'
//           data += response.riwayatalergi ? `Riwayat alergi : ${response.riwayatalergi}` : 'Riwayat alergi: -\n'
...
const loadRiwayat = async () => {
  ...
  try {
    ...
    if (responsex.length) {
      ...
      // Cek apakah ada data EMR sebelumnya
      const responseTglRuangan = await useApi().get(`/emr/get-emr-tgl-terakhir-dengan-ruangan?nocmfk=${ID_PASIEN}&collection=${COLLECTION.value}`);
      const responseHistori = await useApi().get(`/emr/get-emr-history-terakhir?nocmfk=${ID_PASIEN}&collection=${COLLECTION.value}`);
...
const simpan = async () => {
  ...
  let json = {
    ...
    url_form: 'module-emr-profile-pasien-page-emr-asesmen-medis-rawat-jalan',
  ...
  try {
    ...
    if (isResumeMedis.value) {
      try {
        const res = await makeRingkasanData(json);
        if (!res) {
          H.alert('warning', 'Gagal membuat ringkasan keluar');
        } else {
          saveKlaimSEP();
          isResumeMedis.value = false; //? Menghindari double create, ketika salah nginput
        }
      } catch (err) {
...
async function makeRingkasanData(json: any) {
  return new Promise((resolve, reject) => {
    try {
      ...
      if(props.registrasi.namaruangan.toUpperCase().indexOf('MATA') > -1){
...
watch(
  ...
  (newValue, oldValue) => {
    if (newValue == "Batas Normal") {
      ...
      if (props.registrasi.namaruangan.toUpperCase().indexOf('OBGYN') > -1 && jenisObgyn.value == 'Obstetri') {
      ...
      } else if (props.registrasi.namaruangan.toUpperCase().indexOf('OBGYN') > -1 && jenisObgyn.value == 'Ginekologi') {
...
// watch(() => [
//     input.value.diagnosaIcd10,
// ], () => {
//     if (input.value.TADiagnosa == undefined) {
//         input.value.TADiagnosa = ''
//     }else  if(input.value.diagnosaIcd10 == undefined) {
//         input.value.TADiagnosa = ''
//     }else {
//         input.value.TADiagnosa += input.value.diagnosaIcd10.namadiagnosa + ','
//     }

//     if (input.value.diagnosaIcd10 && input.value.diagnosaIcd10.namadiagnosa) {
//         input.value.TADiagnosa += input.value.diagnosaIcd10.namadiagnosa + ',';
//     } else {
//         console.warn("diagnosaIcd10 atau namadiagnosa tidak ditemukan");
//     }
// });
