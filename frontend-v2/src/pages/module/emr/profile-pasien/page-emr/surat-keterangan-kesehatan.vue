                ...
                <div class="column">
                    <div class="columns is-multiline">
                        ...
                        <div class="column is-12 has-text-weight-bold mt-3">
                            Telah di periksa kesehatannya pada Rumah Sakit Umum Daerah Dr. M. Yunus Bengkulu, atas diri
                        </div>
                        ...
                        <div class="column is-12">
                            <span>
                                Maka kami berpendapat bahwa yang diperiksa tersebut kesehatannya :
                            </span>
                            <Multiselect v-model="input.hasilPemeriksaan" :attrs="{ value }" placeholder="--Pilih--"
                                label="label" :options="d_HasilPemeriksaan" :searchable="true" track-by="label"
                                mode="single" autocomplete="off">
                            </Multiselect>
                        </div>
                        ...
                        <div class="column is-6">
                            ...
                            <VField>
                                <VTextarea rows="1" v-model="input.catatan"></VTextarea>
                            </VField>
                        </div>
                        ...
                        <div class="column is-6">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-6 pb-0" style="text-align: right;">
                                    <VButton type="button" rounded outlined color="info" raised icon="feather:file"
                                        @click="template_TTV()"> Template TTV
                                    </VButton>
                                </div>
                            </div>
                            <VField>
                                <VTextarea rows="" v-model="input.catatanTambahan"></VTextarea>
                            </VField>
                        </div>
...
function template_TTV() {
    ...
    if (template_ttv == 1) {
        ...
        template_ttv = template_ttv - 1;
        return template_ttv;
    } else {
        d.catatanTambahan = undefined;
        template_ttv = template_ttv + 1
        return template_ttv;
    }
}
...
const d_HasilPemeriksaan: any = ref([
