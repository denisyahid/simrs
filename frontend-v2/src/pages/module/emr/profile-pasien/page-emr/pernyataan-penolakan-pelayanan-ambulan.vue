  ...
  <div class="column is-12">
    <VCard>
      <div class="column">
        ...
        <div class="column pt-0">
          <p>Dengan ini menyatakan PENOLAKAN untuk dibawa/ ikut ambulan gawat darurat. Saya memahami perlunya dan manfaat tindakan tersebut sebagaimana telah dijelaskan seperti diatas kepada saya,
            termasuk resiko dan komplikasi yang mungkin timbul apabila tindakan tersebut tidak dilakukan.</p>
          <p>Saya bertanggung jawab secara penuh atas segala akibat yang mungkin timbul sebagai akibat tidak dilakukannya tindakan kedokteran tersebut.</p>
