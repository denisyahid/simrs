    ...
    <div class="form-layout is-stacked-2">
      <div class="form-outer" style="margin-top: 15px">
        ...
        <Fieldset legend="KLINIS" :toggleable="true">
          <div class="columns pl-3 is-multiline is-flex-wrap-wrap p-0">
            <div class="column is-3 p-0" v-for="(items, index) in KLINIS" :key="index">
              <VField>
                <VControl>
                  <VCheckbox v-model="input[items.model]" :label="items.label" :true-value="items.label"/>
                </VControl>
        ...
        <div class="column is-flex p-0">
          ...
          <div class="column is-10">
            <VField>
              <VControl>
                <VInput v-model="input.diagnosaMedis" class="input" />
              </VControl>
            </VField>
          </div>
        </div>
        ...
        <div class="column is-flex p-0">
          <div class="column is-2">
            <h1 style="font-weight: bold">Diagnosis Gizi :</h1>
          </div>
          <div class="column is-10">
            <div class="columns pl-3 is-multiline is-flex-wrap-wrap p-0">
              <div class="column is-4">
                <h1 style="font-weight: bold">Problem</h1>
                <VField>
                  <VControl>
                    <VTextarea color="primary" v-model="input.problem" class="input" />
                  </VControl>
                </VField>
              </div>

              <div class="column is-4">
                <h1 style="font-weight: bold">Etiology</h1>
                <VField>
                  <VControl>
                    <VTextarea color="primary" v-model="input.etiology" class="input" />
                  </VControl>
                </VField>
              </div>

              <div class="column is-4">
                <h1 style="font-weight: bold">Sign & Symptom</h1>
                <VField>
                  <VControl>
                    <VTextarea color="primary" v-model="input.sign" class="input" />
                  </VControl>
                </VField>
              </div>
            </div>
        ...
        <div class="columns is-flex is-12 p-0 ml-1">
          <div class="column is-2">
        ...
        <div class="column is-flex p-0">
          <div class="column is-2">
            <h1 style="font-weight: bold">Jenis Diet:</h1>
          </div>
          <div class="column is-10">
            <VField>
              <VControl>
                <VInput v-model="input.jenisDiet" class="input" />
              </VControl>
            </VField>
          </div>
        </div>
        ...
        <div class="column is-flex p-0">
          <div class="column is-2">
            <h1 style="font-weight: bold">Tujuan Pemberian Diet:</h1>
          </div>
          <div class="column is-10">
            <VField>
              <VControl>
                <VTextarea v-model="input.tujuanDiet" class="input" />
              </VControl>
            </VField>
          </div>
        </div>
        ...
        <div class=" is-flex is-12 p-0 ml-1">
          <div class="column is-2">
        ...
        <div class="ml-3">
          <h1 style="font-weight: bold">
            Status Gizi berdasarkan Indek Masa Tubuh (WHO Asia Pasific, 2000)
          </h1>
        </div>
