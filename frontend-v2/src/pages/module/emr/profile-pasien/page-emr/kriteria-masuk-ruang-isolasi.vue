            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Kriteria Masuk Ruang Isolasi</h3>
                        </div>
                        <div class="right">
                ...
                <hr><br>
                  ...
                  <table class="table is-bordered is-fullwidth">
                      ...
                      <thead>
                         <tr>
                           <th class="grey-background">1. TB PARU</th>
                  ...
                  <th class="no-column grey-background">
                    <VCheckbox v-model="input.pemeriksaanNo" true-value="Tidak" color="primary" />
                      ...
                      <tr>
                      <th>A. Suspect TB Paru</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.EWYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.EWNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                      <tr>
                      <th>B. TB Paru dengan riwayat pengobatan OAT kurang 14 hari</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.OATYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.OATNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                      <tr>
                      <th>C. TB Paru dengan riwayat pengobatan OAT > 14 hari dengan klinis membutuhkan perawatan ruang isolasi</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.TBYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.TBNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                      </thead>
                      ...
                      <thead>
                      <tr>
                  <th class="grey-background">2. COVID 19</th>
                  <th class="yes-column grey-background">
                    <VCheckbox v-model="input.copitYes" true-value="Ya" color="primary" />
                  </th>
                  <th class="no-column grey-background">
                    <VCheckbox v-model="input.copitNo" true-value="Tidak" color="primary" />
                  </th>
                </tr>
                    <tr>
                      <th>A. Suspect/Probable Covid 19</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.SuspectYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.SuspectNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>B. Pasien konfirmasi Covid 19 dengan melampirkan laboratorium RT-PCR dari rumah sakit atau dari fasilitas pelayanan kesehatan lainnya. Jarak waktu pemeriksaan RT-PCR paling lama 7 (tujuh) hari dari pengambilan sampel</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.PasienYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.PasienNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>C. Pasien suspect/probable/konfirmasi tanpa gejala dan gejala ringan dengan co-insidens atau komorbid</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.probableYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.probableNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>D. Bayi baru lahir dengan kriteria suspect dirawat di ruang isolasi khusus terpisah dari ibunya, atau rawat gabung (Rooming In) tersendiri untuk bayi dan ibu sesuai dengan Pedoman Pelayanan Antenatal, Persalinan, Nifas dan Bayi Baru Lahir</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.bayiYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.bayiNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>E. Kasus konfirmasi Covid 19 dengan strain baru</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.kasusYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.kasusNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>F.Kasus suspect dengan strain baru dengan gejala sedang, gejala berat atau kritis</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.strainYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.strainNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                      </thead>
                      <thead>
                       ...
                       <tr>
                      <th>A. Penilaian Dokter Penanggung Jawab Pelayanan berdasarkan klinis dan pemeriksaan penunjang serta diagnosis terkait penyakit menular lainnya</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.InfarkYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.InfarkNo" true-value="Tidak" color="primary" />
                      </th>
                      </tr>
                  </table>
                   <table class="table is-bordered is-fullwidth mt-4">
                      ...
                      <tr>
                        <td colspan="2">
                          <VField>
                             <th>Memenuhi indikasi masuk Ruang Isolasi</th>
...
const COLLECTION: any = ref('KriteriaMasukRuangIsolasi') //table mongodb
