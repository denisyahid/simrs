...
useHead({
    title: 'Surat Keterangan Rekomendasi Psikologi - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('SuratKeteranganRekomendasiPsikologi') //table mongodb
...
const simpan = () => {
    ...
    let json = {
        ...
        'url_form': route.name,
        'name_form': 'Surat Keterangan Rekomendasi Psikologi',
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Surat Keterangan Rekomendasi Psikologi</h3>
                        </div>
                        <div class="right">
                ...
                <div class="columns is-multiline column is-12">
                    ...
                    <div class="column is-6">
                        ...
                        <div class="column is-12">
                            <VField label="Dinyatakan">
                                <VTextarea rows="2" v-model="input.TAADinyatakan"></VTextarea>
                            </VField>
                        </div>

                        <div class="column is-12">
                            <VField label="Keperluan">
                                <VTextarea rows="2" v-model="input.TAKeperluan"></VTextarea>
                            </VField>
                        </div>
