            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Kriteria Keluar High Care Unit</h3>
                        </div>
                        <div class="right">
                ...
                <hr><br>
                  ...
                  <th class="no-column grey-background">
                    <VCheckbox v-model="input.pemeriksaanNo" true-value="Tidak" color="primary" />
                      ...
                      <tr>
                      <th>A. Nilai pemantauan EWS hijau kuning tanpa tanda-tanda distress napas dan ancaman gagal napas</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.EWSYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.EWSNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                      <tr>
                      <th>B. Nilai pemantauan EWS oranye, merah dengan distress napas dan ancaman gagal napas (indikasi perawatan ICU)</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.nilaiYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.nilaiNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                      </thead>
                  ...
                  <th class="yes-column grey-background">
                    <VCheckbox v-model="input.pfisikYes" true-value="Ya" color="primary" />
                  </th>
                  <th class="no-column grey-background">
                    <VCheckbox v-model="input.fisikNo" true-value="Tidak" color="primary" />
                  </th>
                </tr>
                    <tr>
                      <th>A. Produksi urin 0,5 - 1 ml/kgBB/jam</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.poliguriaYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.poliguriaNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>B. Tidak ada dehidrasi</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.tdehidrasiYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.tdehidrasiNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>C. Bebas kejang > 72 jam</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.kejangYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.kejangNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>D. Tamponade jantung atau pneumothorax tanpa gangguan hemodinamik</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.jantungYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.jantungNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>E. Tidak ada overload cairan</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.tidakYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.tidakNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                      </thead>
                      <thead>
                        <tr>
                          ...
                          <th class="yes-column grey-background">
                          <VCheckbox v-model="input.ecgYes" true-value="Ya" color="primary" />
                        </th>
                        <th class="no-column grey-background">
                          <VCheckbox v-model="input.ecgNo" true-value="Tidak" color="primary" />
                        </th>
                      </tr>
                      </thead>
                       <tr>
                      <th>A. Irama sinus/aritmia tanpa gangguan hemodinamik</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.sinusYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.sinusNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                      <thead>
                         <tr>
                          ...
                          <th class="yes-column grey-background">
                          <VCheckbox v-model="input.labYes" true-value="Ya" color="primary" />
                        </th>
                        <th class="no-column grey-background">
                          <VCheckbox v-model="input.labNo" true-value="Tidak" color="primary" />
                        </th>
                      </tr>
                      </thead>
                      <tr>
                      <th>A. Kadar natrium serum 135 - 145 mmol/L</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.KadarrYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.KadarrNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>B. Kadar kalium serum 3,5 - 4,5 mmol/L</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.kaliummYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.kaliummNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>C. PaO2 ≥ 90 mmHg pada oksigen ruangan</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.oksigeenYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.oksigeenNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>D. pH 7,35 - 7,45 pada oksigen ruangan</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.ruangaanYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.ruangaanNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>E. Serum glukosa 75 - 200 mg/dll</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.gluskaYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.gluskaNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>F. Serum kalsium 9 - 12 mg/dl</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.kalsiummYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.kalsiummNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>G. Kadar keton urine 0</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.ketonYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.ketonNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>H. Perbaikan kadar BUN/SCa</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.bunYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.bunNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                    <tr>
                      <th>I. Kadar obat substansi kimia dalam darah tidak melebihi dosis toksis yang mengganggu hemodinamik dan status neurologis</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.kimiaYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.kimiaNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                      <thead>
                        <tr>
                  ...
                  <th class="yes-column grey-background">
                    <VCheckbox v-model="input.radiologiYes" true-value="Ya" color="primary" />
                  </th>
                  <th class="no-column grey-background">
                    <VCheckbox v-model="input.radiologiNo" true-value="Tidak" color="primary" />
                  </th>
                </tr>
                      </thead>
                        <tr>
                      <th>A. Perdarahan cerebral, contusion atau perdarahan subarachnoid tanpa gangguan status mental</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.CTYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.CTNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                        <tr>
                      <th>B. Ruptur viscera, blader, liver, varices esofagus, perdarahan tanpa gangguan hemodinamik</th>
                      <th class="yes-column">
                        <VCheckbox v-model="input.bladerYes" true-value="Ya" color="primary" />
                      </th>
                      <th class="no-column">
                        <VCheckbox v-model="input.bladerNo" true-value="Tidak" color="primary" />
                      </th>
                    </tr>
                     <tr>
                  <th class="grey-background">6. Pasien tidak lagi memerlukan persiapan dan pemantauan pra-intra-paska operasi</th>
                  <th class="yes-column grey-background">
                    <VCheckbox v-model="input.persiapanYes" true-value="Ya" color="primary" />
                  </th>
                  <th class="no-column grey-background">
                    <VCheckbox v-model="input.persiapanNo" true-value="Tidak" color="primary" />
                  </th>
                </tr>
                  </table>
                   <table class="table is-bordered is-fullwidth mt-4">
                      ...
                      <tr>
                        <td colspan="2">
                          <VField>
                             <th>Berdasarkan indikasi di atas, maka memenuhi indikasi keluar dari HCU ke ruang :</th>
...
const COLLECTION: any = ref('KriteriaKeluarHighCareUnit') //table mongodb
