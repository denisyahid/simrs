...
<template>
  <section>
    ...
    <div>
                ...
                <div class="form-section  pt-0 pr-0">
                  <div class="form-section-inner has-padding-bottom h-700-o">
                    ...
                    <div class="columns is-multiline">
                      ...
                      <div class="column is-12">
                        <TListOrderResep title="" straight class="list-widget-v3" :items="dataSource" :loading="isLoadBtnEdit"
                          @addItems="addItems" @editItems="editItems" @hapusItems="hapusItems" @copyResep="copyResep"
                          squared colored>
                        </TListOrderResep>
                ...
                <div class="columns is-multiline">
                  ...
                  <div class="column is-6 ">
                    <VField label="Filter Penulis Resep "
                      ...
                      <VControl icon="fa:user-md" class="prime-auto-select">
                        <AutoComplete v-model="item.filterPenulis" :suggestions="d_Dokter"
                  ...
                  <div class="column is-12">
                    <div class="content mb-0">
                      <div class="is-divider mb-0 mt-0" :data-content="'Terdapat ' + listRiwayat.length + ' data'">
                      </div>
                    </div>
                  </div>
                  <div class="column is-12">
      ...
      <Dialog v-model:visible="modalConfirm" modal header="Pilih Jenis Antibiotik" :style="{ width: '30vw' }" maximizable>
        <VButton icon="feather:book" color="success" raised @click="definitif()"
      ...
      <Dialog v-model:visible="modalInput" modal header="Order Resep" :style="{ width: '80vw' }" maximizable>
              ...
              <div class="s-card mt-0 p-5" style=" border-top: 3px solid var(--orange);">
                <div class="columns is-multiline">
                  ...
                  <div class="column is-4">
                    <h3 class="title is-5  mt-3-min">
                      <table style="border: 3px solid red; border-style: dotted;">
                        <tr>
                ...
                <div class="columns is-multiline">
                  <div class="column is-4">
                    ...
                    <div class="column is-1">
                      <VField>
                        <VRadio v-model="item.cito" value="Cito" label="Cito" color="primary" style="margin-top: 20px; height: 30px;"/>
                      </VField>
                    </div>
                    <div class="column is-5">
                      <VField>
                        <VRadio v-model="item.obatina" value="BPJS" label="Obat Non INACbg" color="primary" style="margin-top: 20px; height: 30px;"/>
                      </VField>
                    </div>
                ...
                <div class="column is-12 mt-5-min ">
                  ...
                  <VButton icon="feather:plus" @click="add()" outlined :loading="isLoading" color="info" raised
                    class="is-pulled-right  mr-2">Tambah
                  </VButton>
                  <VButton @click="paketObat()" :loading="isloadingPaketObat" color="info" raised
                    class="is-pulled-right  mr-2">Paket Obat
                  </VButton>
                  <VIconButton type="button" raised circle icon="feather:refresh-cw" @click="clearInput()" outlined
                    color="danger" class="is-pulled-right mr-2" v-tooltip-prime.right="'Kosongkan '">
                  </VIconButton>
                </div>
                <div class="column is-12">
              ...
              <div class="s-card mt-0 p-5" style=" border-top: 3px solid var(--green);">
                ...
                <div class="columns is-multiline">
                  ...
                  <div class="column is-12" v-else style="height:660px;overflow:auto">
                    <div class="columns is-multiline">
                      <div class="column is-12 mb-0 mt-3-min" v-for="itemZ  in listSIMRSLama"
                        v-if="listSIMRSLama.length">
                        <TWidgetListResep :title="itemZ.namaproduk" :pegawai=" itemZ.penulisResep"
                          :subtitle=" itemZ.jumlah" :subtitle1="itemZ.aturanpakai"
...
async function addItems() {
  ...
  confirm.require({
    message: 'Apakah anda meresepkan Antimikroba ?',
    header: 'Informasi',
...
const paketObat = async () => {
  ...
  await useApi().get(`/farmasi/data-paket-obat?${namaPaket}`).then((response: any) => {
