                    ...
                    <div class="columns is-multiline">
                        <div class="column is-12" style="width: 100%;overflow: auto;">
                            <table class="tg" style="width: 200%;">
                                ...
                                <tr>
                                    <th rowspan="3" class="bg-colatas">Paramater tambahan yang mendukung</th>
                                ...
                                <tr>
                                    ...
                                    <td class="bg-colatas3">GDS</td>

                                    <td class="tg-0lax" v-for="index in jumlahImdex">
                                        <VField>
                                            <VControl>
                                                <VInput type="text" v-model="input.gds[index]" placeholder=""
                                                    class="is-rounded_Z input-30" />
                                            </VControl>
                                        </VField>
                                    </td>
                                ...
                                <tr>
                                    <td class="bg-colatas3">Urin Output</td>

                                    <td class="tg-0lax" v-for="index in jumlahImdex">
                                        <VField>
                                            <VControl>
                                                <VInput type="text" v-model="input.urin[index]" placeholder=""
                                                    class="is-rounded_Z input-30" />
                                            </VControl>
                                        </VField>
                                    </td>
