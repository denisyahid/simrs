                        ...
                        <div class="columns is-multiline">
                            <div class="column is-12">
                                <div class="columns is-multiline">
                                        ...
                                        <VCard>
                                            ...
                                            <div class="columns is-multiline">
                                                <div class="column is-4">
                                                    <VDatePicker v-model="item.tglDiambil" color="green" trim-weeks
                                                ...
                                                <div class="column is-8">
                                                    <VField class="is-rounded-select is-autocomplete-select">
                                                        ...
                                                        <VControl icon="feather:search" fullwidth class="prime-auto-select">
                                                            <Dropdown v-model="item.ruangan" :options="d_Gudang"
                                                                optionLabel="label" placeholder="Pilih Jenis Darah"
                                            ...
                                            <div class="columns is-multiline">
                                                <div class="column is-4 pt-0">
                                                    <VField label="Pegawai Mengeluarkan"
                                                        class="is-rounded-select is-autocomplete-select">
                                                        <VControl icon="fa:user" class="prime-auto-cus">
                                                            <AutoComplete v-model="item.pegawaiMengeluarkan"
                                                                :suggestions="d_Pegawai" :optionLabel="'label'"
                                                                @complete="fetchPegawai($event)" :dropdown="true"
                                                ...
                                                <div class="column is-4 pt-0">
                                                    <VField label="Pegawai Penerima"
                                                        class="is-rounded-select is-autocomplete-select">
                                                        <VControl icon="fa:user" class="prime-auto-cus">
                                                            <AutoComplete v-model="item.pegawaiPenerima"
                                                                :suggestions="d_Pegawai" :optionLabel="'label'"
                                                                @complete="fetchPegawai($event)" :dropdown="true"
                                                                :minLength="3" :appendTo="'body'"
                                                                :loadingIcon="'pi pi-spinner'" :field="'label'"
                                                ...
                                                <div class="column is-4 pt-0">
                                                    <VField label="Wali Pasien">
                                                        <VControl>
                                                            <input v-model="item.waliPasien" type="text" class="input"
                                                                placeholder="wali Pasien" />
                                                        </VControl>
                                                    </VField>
                                                </div>
                                            </div>
                                    ...
                                    <div class="column is-12">
                                        <DataTable :value="sourceDarah" :paginator="true" :rows="5"
                                            :rowsPerPageOptions="[5, 10, 25]" :loading="sourceDarah.loading"
                                            ...
                                            <Column :exportable="false" header="Action"
                                                ...
                                                <template #body="slotProps">
                                                    <VIconButton type="button" icon="feather:edit" class="mr-3" color="info"
                                                        circle outlined raised :loading="loadingBtnEdit"
                                                        v-tooltip.top="'Edit'" @click="showModal(slotProps.data)">
                                                    </VIconButton>
                                                    <VIconButton type="button" icon="fas fa-trash" color="danger" circle
                    ...
                    <VField class="is-rounded-select is-autocomplete-select">
                        ...
                        <VControl icon="feather:search" fullwidth class="prime-auto-select">
                            <Dropdown v-model="item.jenisDarah" :options="d_JenisDarah" optionLabel="label"
                                placeholder="Pilih Jenis Darah" style="width: 100%;font-weight:bold" :filter="true"
                                disabled />
                        </VControl>
                    </VField>
                </div>
                    ...
                    <VField class="is-rounded-select is-autocomplete-select">
                        ...
                        <VControl icon="feather:search" fullwidth class="prime-auto-select">
                            <Dropdown v-model="item.golonganDarah" :options="d_GolonganDarah" optionLabel="label"
                                placeholder="Pilih Golongan Darah" style="width: 100%;font-weight:bold" :filter="true"
                                disabled />
                        </VControl>
                    </VField>
                </div>
                    ...
                    <VField class="is-rounded-select is-autocomplete-select">
                        ...
                        <VControl icon="feather:search" fullwidth class="prime-auto-select">
                            <Dropdown v-model="item.satuan" :options="d_Satuan" optionLabel="label"
                                placeholder="Pilih Produk Darah" style="width: 100%;font-weight:bold" :filter="true" />
                        </VControl>
                    </VField>
                </div>
