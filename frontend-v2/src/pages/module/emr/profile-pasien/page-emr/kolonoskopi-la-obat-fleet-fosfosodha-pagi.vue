      ...
      <div class="form-outer" style="margin-top:15px">
        <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
          <div class="form-header-inner">
            <div class="left">
              <h3>Edukasi Pasien Untuk Persiapan Kolonoskopi Dengan LA Dengan Obat Fleet Fosfosoda Tindakan Pagi</h3>
            </div>
            <div class="right">
              <ButtonEmr :NOREC_EMRPASIEN="NOREC_EMRPASIEN" :COLLECTION="COLLECTION" :isLoading="isLoading"
                @simpan="simpan" @simpanTemplate="simpanTemplate" @kembaliKeun="kembaliKeun" :isHideCetak="true"></ButtonEmr>
            </div>
          </div>
        </div>
          ...
          <table style="width: 100% !important;border-collapse: collapse !important;">
            ...
            <tr>
              ...
              <td>
                ...
                Hanya diperbolehkan makan bubur + kecap + telur rebus 1 (satu) butir atau bubur + sop kuah tanpa sayur +
                1 butir
                telur rebus
                Boleh minum 1 (satu) gelas air putih tiap jam, boleh pakai gula/madu/sirup pada pagi,siang, sore sampai
                pukul
                17.00
                <br><i>Susu/sayur/buah-buahan tidak diperbolehkan</i><br>
                ...
                <br>- Bisacodyl (dulcolac) 10mg (2 tablet sediaan 5mg) oral (tidak diberikan pada kasus obstruksi)<br>
                Pemberian Pukul 19.00
                <br>Dosis dan Cara Pemberian Fleet I
                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Minum Fleet ½ botol + air dingin ½ gelas
                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Selanjutnya minum air putih sebanyak-banyaknya 2-3 liter, sampai
                fleet II
                <br>Pemberian Pukul 04.00
                <br>Dosis dan Cara Pemberian Fleet II
                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Minum Fleet ½ botol + air dingin ½ gelas
                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Minum air putih sekuatnya (air gula bila tidak DM).
              </td>
              <td>
                <VField>
            ...
            <!-- <tr>
              ...
              <td>9. Jika menggunakan pembiusan umum, pasien puasa 6 jam</td>
              <td>
                <VField>
            ...
            <tr>
              ...
              <td>
                9. Persiapan obat dan bhp untuk premedikasi (dibawa ke ruang endoskopi)
            ...
            <tr>
              ...
              <td>
                11. Ada Persetujuan Tindakan (infomed concent)
              </td>
              <td>
                <VField>
            ...
            <tr>
              ...
              <td>
                12. Ada keluarga yang menemani (untuk pasien rawat jalan) dan ada perawat yang mengantar (untuk pasien
                rawat
                INAP)
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                13. Tanggal Tindakan dan Jika terjadi pembatalan Tindakan berikan alasan, tulis keluhan dan Diagnosa
                pasien,
...
useHead({ title: 'Edukasi Pasien Untuk Persiapan Kolonoskopi Dengan LA Dengan Obat Fleet Fosfosoda Tindakan Pagi - ' + import.meta.env.VITE_PROJECT })
