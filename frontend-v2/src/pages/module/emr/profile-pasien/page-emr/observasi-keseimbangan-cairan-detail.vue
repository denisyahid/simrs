<template>
  <div class="columns is-multiline">
    <div class="column is-12">
      <ObservasiKeseimbanganCairan :dataTertutup="props.data" :hideButtons="true" />
    </div>
  </div>
</template>
...
import ObservasiKeseimbanganCairan from '../page-emr/observasi-keseimbangan-cairan-v2.vue'
...
console.log('Received data:', JSON.stringify(props.data, null, 2));
