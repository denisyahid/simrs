                    ...
                    <div class="column is-12">
                        <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-8" style="margin-top: -1rem;">
                                    <VField>
                                        <VControl>
                                            <VRadio v-model="input.ResikoAspirasi" value="Ya" label="Resiko Aspirasi (D.0006)"
                                                name="ResikoAspirasi" color="info" square style="font-size: 14px" />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Diagnosa Keperawatan">
                                ...
                                <div class="column is-12">
                                    <h1> Definisi : beresiko mengalami masuknya sekresi gastrointestinal, sekresi orofaring, benda cair atau padat ke dalam saluran trakeobronkhial akibat disfungsi mekanisme protektif saluran napas
                                ...
                                <div class="column is-12">
                                    ...
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-4" v-for="(data, i) in dataObjektif">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                        :label="data.title" class="p-0" color="primary" square />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Perencanaan Keperawatan">
                                ...
                                <div class="column is-12 p-0">
                                    ...
                                    <div class="is-flex">
                                        <div class="column is-6" style="margin-top:0.5rem">
                                            <h1> Aspirasi tidak terjadi, ditandai dengan : </h1>
                                        </div>
                                        <div class="column is-6" style="margin-left: -5rem;">
                                            <VField>
                                                <VControl>
                                                    <VInput type="text" class="input"
                                                        placeholder="Tanda Aspirasi"
                                                        v-model="input.tandaAspirasi" />
                                                </VControl>
                                    ...
                                    <div class="column is-12">
                                        <h1 style="font-weight: bold;">Status Pernapasan:</h1>
                                        <div class="columns is-multiline pt-3 pl-3">
                                            <div class="column is-12" v-for="(data, i) in statusPernapasan">
                                                <VField>
                                                    <VControl raw subcontrol>
                                                        <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                            :label="data.title" class="p-0" color="primary" square />
                                    ...
                                    <div class="column is-12">
                                        <h1 style="font-weight: bold;">Status Menelan:</h1>
                                        <div class="columns is-multiline pt-3 pl-3">
                                            <div class="column is-6" v-for="(data, i) in statusMenelan">
                                                <VField>
                                                    <VControl raw subcontrol>
                                                        <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                            :label="data.title" class="p-0" color="primary" square />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Rencana Tindakan">
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Pencegahan Aspirasi:</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in pencegahanAspirasi">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                        :label="data.title" class="p-0" color="primary" square />
...
import * as EMR from '../page-emr-plugins/resiko-aspirasi'
...
let statusPernapasan = ref(EMR.statusPernapasan())
let statusMenelan = ref(EMR.statusMenelan())
let pencegahanAspirasi = ref(EMR.pencegahanAspirasi())
