...
// Judul
useHead({
    title: 'Asesmen Awal Medis Ilmu Penyakit Saraf Rawat Jalan - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('AsesmenAwalMedisIlmuPenyakitSarafRJ') //table mongodb
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header" style="margin-bottom: 10px">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Asesmen Awal Medis Ilmu Penyakit Saraf Rawat Jalan</h3>
                        </div>
                        <div class="right">
                            <div class="buttons">
                    ...
                    <div class="column is-12">
                        <Fieldset :toggleable="true" legend="Pemeriksaan Fisik">
                            <div class="columns is-multiline" style="padding: 10px; padding-top: 0px">
                                ...
                                <div class="column is-12">
                                    <span><b>C. Pemeriksaan Neurologik</b></span>
                                </div>
                                <div class="column is-12 columns is-multiline">
                                    <div class="column is-12">
                                        <VField>
                                            <label>1) Kranium (nspeksi, Palpasi, Perkusi, Auskultasi, Transiluminasi,
                                                dll)</label>
                                            <VTextarea v-model="input.TAkraniumPN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <VField>
                                            <label>2) Korpus Vertebra (nspeksi, Palpasi, Perkusi, Mobilitas,
                                                dll)</label>
                                            <VTextarea v-model="input.TAkorpusPN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <VField>
                                            <label>3) Tanda-tanda perangsang selaput otak</label>
                                            <div class="columns is-multiline column">
                                                <div class="column is-4">
                                                    <VControl raw subcontrol>
                                                        <VCheckbox class="p-0" color="primary" square
                                                            true-value="Kaku kuduk" label="Kaku kuduk"
                                                            v-model="input.CBKakuKudukTTPSO" />
                                                    </VControl>
                                                    <VControl style="margin-top: 5px">
                                                        <VInput type="text" class="input"
                                                            v-model="input.TBKakuKudukTTPSO" />
                                                    </VControl>
                                                </div>
                                                <div class="column is-4">
                                                    <VField>
                                                        <label>Tanda Kering</label>
                                                        <VControl>
                                                            <VInput type="text" class="input"
                                                                v-model="input.TBtandaKeringTTPSO" />
                                                        </VControl>
                                                    </VField>
                                                </div>
                                                <div class="column is-4">
                                                    <VField>
                                                        <label>Tanda leher Brudzinski</label>
                                                        <VControl>
                                                            <VInput type="text" class="input"
                                                                v-model="input.TBtandaLeherTTPSO" />
                                                        </VControl>
                                                    </VField>
                                                </div>
                                                <div class="column is-4">
                                                    <VControl raw subcontrol>
                                                        <VCheckbox class="p-0" color="primary" square
                                                            true-value="Tanda kaki Brudzinski" label="Tanda kaki Brudzinski"
                                                            v-model="input.CBTandaKakiTTPSO" />
                                                    </VControl>
                                                    <VControl style="margin-top: 5px">
                                                        <VInput type="text" class="input"
                                                            v-model="input.TBTandaKakiTTPSO" />
                                                    </VControl>
                                                </div>
                                                <div class="column is-4">
                                                    <VField>
                                    ...
                                    <div class="column is-12">
                                        <VField>
                                            <label>4) Saraf Otak (I – XII) (Kanan/Kiri)</label>
                                            <VTextarea v-model="input.TAsarafOtakPN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <VField>
                                            <label>5) Motorik (Tenaga, Tonus, Koordinasi, Gerakan nvolunter, Langkah dan Gaya Jalan) (Kanan/Kiri)</label>
                                            <VTextarea v-model="input.TAmotorikPN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <VField>
                                            <label>6) Refleks (Fisiologik, Patologik) (Kanan/Kiri)</label>
                                            <VTextarea v-model="input.TArefleksPN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <VField>
                                            <label>7) Sensorik (Permukaan, dalam) (Kanan/Kiri)</label>
                                            <VTextarea v-model="input.TAsensorikPN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <VField>
                                            <label>8) Vegetatif :</label>
                                            <VTextarea v-model="input.TAvegetatifPN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <VField>
                                            <label>9) Fungsi luhur (kesadaran, reaksi emosi, fungsi intelek, proses berpikir, fungsi psikomotorik, fungsi psikosensorik,
                                                fungsi bicara dan bahasa) :</label>
                                            <VTextarea v-model="input.TAfungsiLuhurkPN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <VField>
                                            <label>10) Tanda-tanda kemunduran mental (refleks memegang, refleks menetek, refleks snout, refleks glabela, refleks
                                                palmomental, refleks korneomandibuler, dll.)</label>
                                            <VTextarea v-model="input.TAkemunduranMentalPN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <VField>
                                            <label>11) Nyeri tekan saraf :</label>
                                            <VTextarea v-model="input.TAnyeriTekanSarafPN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <VField>
                                            <label>12) Tanda lasegue :</label>
                                            <VTextarea v-model="input.TAtandaLaseguePN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <VField>
                                            ...
                                            <VTextarea v-model="input.TAlainlainPN" rows="2">
                                            </VTextarea>
                                        </VField>
                                    </div>
                                </div>
