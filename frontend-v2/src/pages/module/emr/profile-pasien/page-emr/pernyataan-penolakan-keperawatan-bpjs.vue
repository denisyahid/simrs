        ...
        <div class="columns is-multiline">
          <div class="column is-12">
            ...
            <div class="column is-12 p-1">
              <h1>Saya telah mendapatkan informasi dari Petugas mengenai hak dan kewajiban saya serta tata tertib di Rumah Sakit ini dengan demikian saya menyatakan   </h1>
            </div>
          
            <div class="column is-12 p-1">
              <h1> Tidak menggunakan fasilitas BPJS Kesehatan dan bersedia menanggung seluruh biaya perawatan di Rumah Sakit ini.  </h1>
            </div>
            <div class="column is-12 p-1">
              <h1> Demikian pernyataan ini saya buat dengan sebenarnya dan penuh kesadaran tanpa paksaan dari pihak manapun.  </h1>
            </div>
            ...
            <div class="column is-12 p-0">
              <div class="is-flex">
                ...
                <div class="column is-6">
                  <VField>
                    <VControl>
                      <VInput type="number" class="input" placeholder=" Yang membuat pernyataan" v-model="input.yangMembuatPernyataan1" />
                    </VControl>
                  </VField>
                </div>
              </div>
