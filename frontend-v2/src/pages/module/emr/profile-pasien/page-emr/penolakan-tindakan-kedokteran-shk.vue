    ...
    <div class="form-outer" style="margin-top:15px">
      <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
        <div class="form-header-inner">
          <div class="left">
            <h3>Penolakan Tindakan Kedokteran SHK</h3>
          </div>
          <div class="right">
      ...
      <div class="column">
        ...
        <div class="column">
          ...
          <table class="table is-bordered  m-0">
            <thead>
              <tr>
                <th style="text-align: center;width:20%">JENIS INFORMASI<br><i>Type of information</i></th>
                <th style="text-align: center;;width:60%">ISI INFORMASI<br><i>Description of the information</i></th>
            ...
            <thead>
              ...
              <tr>
                ...
                <th class="yes-column">
                  SHK dilakukan pada bayi yang berumur 48-72 jam setelah lahir dengan mengambil sedikit darah pada
                  bagian
              ...
              <tr>
                ...
                <th class="yes-column">
                  Mendeteksi dini kejadian hipotiroid kongenital untuk mencegah anak mengalami keterlambatan pertumbuhan
                  dan
          ...
          <div class="is-12">
            <h1 style="font-weight: bold;">PERSETUJUAN TINDAKAN KEDOKTERAN SHK (AGREEMENT FOR MEDICAL ACTION)</h1>
          </div>
          <div class="is-12">
...
useHead({ title: 'Penolakan Tindakan Kedokteran SHK - ' + import.meta.env.VITE_PROJECT })
...
const COLLECTION: any = ref('PenolakanTindakanKedokteranSHK') //table mongodb
