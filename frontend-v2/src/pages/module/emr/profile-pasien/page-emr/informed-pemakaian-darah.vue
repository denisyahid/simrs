        ...
        <div class="column is-12">
            <VCard>
                <div class="columns is-multiline">
                    ...
                    <div class="column is-12">
                        <Fieldset class="p-fieldsets" legend="PERSETUJUAN TINDAKAN TANSFUSI DARAH"
                            :toggleable="true">
                            <div class="column is-12">
...
import * as EMR from '../page-emr-plugins/informed-pemakaian-darah'
...
const COLLECTION: any = ref('InformedConsentPemakaianDarah') //table mongodb
