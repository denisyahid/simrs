...
// Judul
useHead({
    title: 'Asesmen Awal Medis Ilmu Kedokteran Jiwa Rawat Jalan - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('AsesmenAwalMedisIlmuKedokteranJiwaRJ') //table mongodb
...
const loadRiwayat = async () => {
    ...
    // await loadGambar("GambarOrgan", dataTTD.value.GambarOrgan)
}
const simpan = () => {
    ...
    // object['GambarOrgan'] = H.tandaTangan().get("GambarOrgan");
...
//             context.drawImage(background, 0, 0, 300, 680);
//         }
//     }
// }
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header" style="margin-bottom: 10px">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Asesmen Awal Medis Ilmu Kedokteran Jiwa Rawat Jalan</h3>
                        </div>
                        <div class="right">
                            <div class="buttons">
                ...
                <div class="columns is-multiline p-2">
                    ...
                    <div class="column is-12">
                        <Fieldset :toggleable="true" legend="Genogram">
                            <div class="columns is-multiline">
                                <div class="column is-12">
                                    <VField>
                                        <VTextarea rows="2" v-model="input.TAgenogram"></VTextarea>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField>
                                        <label>Faktor pencetus/penyebab :</label>
                                        <VTextarea rows="2" v-model="input.TAFaktorPenyebabGenogram"></VTextarea>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField>
                                        <label>Faktor keluarga :</label>
                                        <VTextarea rows="2" v-model="input.TAFaktorKeluargaGenogram"></VTextarea>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField>
                                        <label>Fungsi kerja/sosial :</label>
                                        <VTextarea rows="2" v-model="input.TAFungsiKerjaGenogram"></VTextarea>
                                    </VField>
                                </div>
                                <div class="column is-12 columns is-multiline">
                                    <div class="column is-12">
                                        <label style="font-weight: bold;">Riwayat NAPZA</label>
                                    </div>
                                    <div class="columns column is-12" style="margin-top: -20px;">
                                        <div class="column is-6">
                                            <VControl raw subcontrol>
                                                <VCheckbox class="p-0" color="primary" square true-value="Ada"
                                                    label="Ada" v-model="input.CBadaNAPZA" />
                                            </VControl>
                                        </div>
                                        <div class="column is-6">
                                            <VControl raw subcontrol>
                                                <VCheckbox class="p-0" color="primary" square true-value="Tidak"
                                                    label="Tidak" v-model="input.CBtidakNAPZA" />
                                            </VControl>
                                        </div>
                                    </div>
                                    <div class="columns column is-12" style="margin-top: -30px;">
                                        <div class="column is-3">
                                            <VField label="Lama pemakaian">
                                                <VTextarea rows="2" v-model="input.TAlamaPemakaianGenogram"></VTextarea>
                                            </VField>
                                        </div>
                                        <div class="column is-3">
                                            <VField label="Jenis zat">
                                                <VTextarea rows="2" v-model="input.TAjenisZatGenogram"></VTextarea>
                                            </VField>
                                        </div>
                                        <div class="column is-3">
                                            <VField label="Cara pemakaian">
                                                <VTextarea rows="2" v-model="input.TAcaraPemakaianGenogram"></VTextarea>
                                            </VField>
                                        </div>
                                        <div class="column is-3">
                                            <VField label="Latar belakang pemakaian">
                                                <VTextarea rows="2" v-model="input.TAlatarBelakangGenogram"></VTextarea>
                                            </VField>
                                        </div>
                                    </div>
                                    <div class="columns column is-12" style="margin-top: -30px;">
                                        <div class="column is-6">
                                            <VField label="Faktor Premorbid">
                                                <VControl>
                                                    <VInput type="text" class="input"
                                                        v-model="input.TBfaktorPremorbidGenogram" />
                                                </VControl>
                                            </VField>
                                        </div>
                                        <div class="column is-6">
                                            <VField label="Faktor Organik">
                                                <VControl>
                                                    <VInput type="text" class="input"
                                                        v-model="input.TBfaktorOrganikGenogram" />
                                                </VControl>
                                            </VField>
                                        </div>
                                    </div>
                    ...
                    <div class="column is-12">
                        <Fieldset :toggleable="true" legend="Status Psikiatri">
                            <div class="columns is-multiline">
                                <div class="column is-4">
                                    <VField label="Deskripsi Umum">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBdeskripsiUmumSP" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField label="Kesadaran">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBkesadaranSP" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField label="Kontak">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBkontakSP" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField label="Bicara">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBbicaraSP" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField label="Orientasi">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBorientasiSP" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField label="Mood/Afek">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBmoodAfekSP" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField label="Proses Berpikir">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBprosesBerpikirSP" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField label="Persepsi">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBpersepsiSP" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField label="Kognisi dan Sensorium">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBkognisiSP" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField label="Daya Nilai dan Tilikan">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBtilikanSP" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField label="Psikomotor">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBpsikomotorSP" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-4">
                                    <VField label="Pengendalian Impuls">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.TBpengendalianImpulsSP" />
                                        </VControl>
                                    </VField>
                                </div>
                            </div>
                    ...
                    <div class="column is-12">
                        <Fieldset :toggleable="true" legend="Status Neurologis & Interna">
                            <div class="columns is-multiline">
                                <div class="column is-6">
                                    <label style="font-weight: bold;">Neurologis</label>
                                    <VField>
                                        <VTextarea rows="2" v-model="input.TAneurologis"></VTextarea>
                                    </VField>
                                </div>
                                <div class="column is-6">
                                    <label style="font-weight: bold;">Interna</label>
                                    <VField>
                                        <VTextarea rows="2" v-model="input.TAinterna"></VTextarea>
                                    </VField>
                                </div>
                            </div>
                        </Fieldset>
