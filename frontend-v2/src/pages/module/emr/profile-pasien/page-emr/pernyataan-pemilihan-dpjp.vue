      ...
      <VCard>
        <div class="columns is-multiline">
          <div class="column is-12">
            ...
            <div class="column is-12 p-1">
              <h1>
                1. Setuju dan memberi ijin kepada Dokter yang berwenang untuk merawat saya/pasien diatas.
              </h1>

            </div>
            <div class="column is-12 p-1">
              <h1>
                2. Setuju dan memberi ijin kepada Perawat untuk melakukan asuhan keperawatan dan petugas
                kesehatan Rumah Sakit ini yang lain untuk melakukan pemeriksaan terhadap saya/pasien tersebut
                diatas.</h1>
            </div>
            <div class="column is-12 p-1">
              <h1>
                3. Memberi Kuasa kepada Dokter/Rumah Sakit untuk memberikan keterangan yang diperlukan oleh
                pihak penanggung biaya perawatan saya/pasien tersebut diatas.
              </h1>
            </div>
            <div class="column is-12 p-1">
              <div class="flex">
                <h1>
                  4. Dan dengan ini memohon kesediaan Dokter untuk melakukan perawatan dan pengobatan atas
                  saya/pasien tersebut diatas kepada :
                </h1>
...
const COLLECTION: any = ref('PernyataanPemilihanDPJP') //table mongodb
