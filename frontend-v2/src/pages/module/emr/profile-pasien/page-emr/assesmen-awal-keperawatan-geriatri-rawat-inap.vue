            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Assesmen Awal Keperawatan Pasien Geriatri Rawat Inap</h3>
                        </div>
                        <div class="right">
                ...
                <div class="column">
                    ...
                    <div class="column columns is-multiline">
                        <div class="columns is-multiline m-0">
                            ...
                            <div class="column is-7 pt-1" style="text-align: center; overflow-x: auto;">
                    ...
                    <div class="column">
                        <div class="columns is-multiline">
                            <div class="column is-12 pb-0">
                                <h1>ASESMEN NYERI DAN KOGNITIF PERSEPRUAL</h1>
                            </div>
                            <div class="column is-4">
                    ...
                    <div class="column">
                        <div class="columns is-multiline">
                            ...
                            <div class="column is-3">
                                ...
                                <Multiselect v-model="input.MasalahPernikahan" :attrs="{ value }"
                                    placeholder="--Pilih--" label="label" :options="d_masalahPernikahan"
                                    :searchable="true" track-by="label" mode="single" autocomplete="off">
                                </Multiselect>
                                <VControl v-if="input.MasalahPernikahan == 2">
                                    <VInput type="text" class="input" v-model="input.MasalahPernikahanDetail"
                                        placeholder="Jelaskan..." />
                                </VControl>
                            </div>
                            <div class="column is-3">
                                <h1>Tinggal Bersama Keluarga</h1>
                                <Multiselect v-model="input.TinggalBersamaKeluarga" :attrs="{ value }"
                                    placeholder="--Pilih--" label="label" :options="d_tidakAda_ada" :searchable="true"
                                    track-by="label" mode="single" autocomplete="off">
                                </Multiselect>
                                <VControl v-if="input.TinggalBersamaKeluarga == 2">
                                    <VInput type="text" class="input" v-model="input.TinggalBersamaKeluargaDetail"
                                        placeholder="Jelaskan..." />
                                </VControl>
                            </div>
                            <div class="column is-3">
                                ...
                                <VControl v-if="input.SMengalamiKekerasanFisik == 2">
                                    <VInput type="text" class="input" v-model="input.TBMengalamiKekerasanFisik"
                                        placeholder="Jelaskan..." />
                                </VControl>
                            </div>
                            <div class="column is-3 pt-0">
                                <h1>Mencederai diri/orang lain</h1>
                                <Multiselect v-model="input.MencederaiDiri" :attrs="{ value }" placeholder="--Pilih--"
                                    label="label" :options="d_TPPernah" :searchable="true" track-by="label"
                                    mode="single" autocomplete="off">
                                </Multiselect>
                                <VControl v-if="input.MencederaiDiri == 2">
                                    <VInput type="text" class="input" v-model="input.MencederaiDiriDetail"
                                        placeholder="Jelaskan..." />
                                </VControl>
                            </div>
                            <div class="column is-3 pt-0">
                                <h1>Trauma dalam kehidupan</h1>
                                <Multiselect v-model="input.TraumaDalamKehidupan" :attrs="{ value }"
                                    placeholder="--Pilih--" label="label" :options="d_tidakAda_ada" :searchable="true"
                                    track-by="label" mode="single" autocomplete="off">
                                </Multiselect>
                                <VControl v-if="input.TraumaDalamKehidupan == 2">
                                    <VInput type="text" class="input" v-model="input.TraumaDalamKehidupanDetail"
                                        placeholder="Jelaskan..." />
                                </VControl>
                            </div>
                            <div class="column is-3 pt-0">
                                <h1>Gangguan Tidur/insomnia</h1>
                                <Multiselect v-model="input.GangguanTidur" :attrs="{ value }" placeholder="--Pilih--"
                                    label="label" :options="d_tidakAda_ada" :searchable="true" track-by="label"
                                    mode="single" autocomplete="off">
                                </Multiselect>
                                <VControl v-if="input.GangguanTidur == 2">
                                    <VInput type="text" class="input" v-model="input.GangguanTidurDetail"
                                        placeholder="Jelaskan..." />
                                </VControl>
                            </div>
                            <div class="column is-3 pt-0">
                                <h1>Konsultasi dengan psikologi/ psikiater</h1>
                                <Multiselect v-model="input.KonsultasiDP" :attrs="{ value }" placeholder="--Pilih--"
                                    label="label" :options="d_tidakAda_ada" :searchable="true" track-by="label"
                                    mode="single" autocomplete="off">
                                </Multiselect>
                                <VControl v-if="input.KonsultasiDP == 2">
                                    <VInput type="text" class="input" v-model="input.KonsultasiDPDetail"
                                        placeholder="Jelaskan..." />
                                </VControl>
                            </div>
                                    ...
                                    <div class="column is-4">
                                        <VControl raw subcontrol>
                                            <VCheckbox class="p-0" color="primary" square true-value="Merokok"
                                                label="Merokok" v-model="input.Merokok_RK" />
                                        </VControl>
                                    </div>
                                    <div class="column is-4">
                                        <VControl raw subcontrol>
                                            <VCheckbox class="p-0" color="primary" square true-value="Alkohol"
                                                label="Alkohol" v-model="input.Alkohol_RK" />
                                        </VControl>
                                    </div>
                                    <div class="column is-4">
                                        <VControl raw subcontrol>
                                            <VCheckbox class="p-0" color="primary" square true-value="Lain-lain"
                                                label="Lain-lain" v-model="input.Lainlain_RK" />
                                        </VControl>
                                        <VControl v-if="input.Lainlain_RK == 'Lain-lain'">
                                            <VInput type="text" class="input" v-model="input.LainlainDetail_RK" />
                                        </VControl>
                                    </div>
                                    <div class="column is-12 pt-0">
                                        <span>Jenis dan jumlah perhari</span>
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.JenisJumlahPerhari" />
                                        </VControl>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="column is-3 pt-0">
                                ...
                                <VControl v-if="input.SPembiayaanKesehatan == 2">
                            ...
                            <div class="column is-4 pt-0">
                                <h1>Sindrom Geriatri</h1>
                                <div class="columns is-multiline mt-0">
                                    <div class="column is-4 p-1" v-for="item in d_SindromGeriatri" :key="item.value">
                                        <VControl raw subcontrol>
                                            <VCheckbox class="p-0" color="primary" square :true-value="item.value"
                                                :label="item.label" v-model="input[item.value + '_SG']" />
                                        </VControl>
                                        <VControl>
                                            <VInput v-if="item.value === 'Lain-lain' && input['Lain-lain_SG']"
                                                class="mt-1" v-model="input.LainLainText_SG" placeholder="..." />
                                        </VControl>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="column">
                        <div class="columns is-multiline">
                            ...
                            <div class="column is-12 pb-0 ml-3">
                    ...
                    <div class="column">
                        <div class="columns is-multiline">
                            ...
                            <div class="column is-12 p-0"></div>
                            <div class="column is-6 pt-0">
                                <h1>a. Apakah asupan makanan berkurang selama 3 bulan
                                    terakhir karena kehilangan nafsu makan, gangguan
                                    pencernaan, kesulitan mengunyah atau menelan?</h1>
                                <Multiselect v-model="input.AsupanMakanKurang_SN" :attrs="{ value }"
                                    placeholder="--Pilih--" label="label" :options="d_AsupanMakanKurang"
                                    :searchable="true" track-by="label" mode="single" autocomplete="off">
                                </Multiselect>
                            </div>
                            <div class="column is-6 pt-0">
                                <h1>b. Penurunan berat badan selama 3 bulan terakhir?</h1>
                                <Multiselect v-model="input.PenurunanBB_SN" :options="d_PenurunanBB" label="label"
                                    track-by="label" mode="single" placeholder="--Pilih--" />
                            </div>

                            <div class="column is-6 pt-0">
                                <h1>c. Mobilitas</h1>
                                <Multiselect v-model="input.Mobilitas_SN" :options="d_Mobilitas" label="label"
                                    track-by="label" mode="single" placeholder="--Pilih--" />
                            </div>

                            <div class="column is-6 pt-0">
                                <h1>d. Menderita tekanan psikologis atau penyakit yang berat dalam 3 bulan terakhir</h1>
                                <Multiselect v-model="input.TekananPsikologis_SN" :options="d_TekananPsikologis"
                                    label="label" track-by="label" mode="single" placeholder="--Pilih--" />
                            </div>

                            <div class="column is-6 pt-0">
                                <h1>e. Gangguan neuropsikologis</h1>
                                <Multiselect v-model="input.GangguanNeuro_SN" :options="d_GangguanNeuro" label="label"
                                    track-by="label" mode="single" placeholder="--Pilih--" />
                            </div>

                            <div class="column is-6 pt-0">
                                <h1>f. Indeks Massa Tubuh (IMT) (berat dalam kg)/(tinggi dalam m)2</h1>
                                <Multiselect v-model="input.IMT_SN" :options="d_IMT" label="label" track-by="label"
                                    mode="single" placeholder="--Pilih--" />
                            </div>
                            <div class="column is-6 pt-0">
                                <h1>Total Skor</h1>
                                <VControl>
                                    <VInput type="text" class="input" v-model="input.TotalSkor_SN" />
                                </VControl>
                                Skor skrining (subtotal maksimal 14 poin)<br>
                                12-14 poin : status gizi normal<br>
                                8-11 poin : beresiko malnutrisi<br>
                                0-7 poin : malnutrisi
                            </div>
                            <div class="column is-6 pt-0">
                                <h1>Catatan</h1>
                                - Pasien yang berisiko malnutrisi dan malnutrisi dilakukan
                                pengkajian lebih lanjut oleh ahli gizi dan dirujuk ke Dokter
                                Gizi Klinik<br>
                                - Pasien yang status gizi normal dikaji lagi setelah 7 hari
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column">
                        <div class="columns is-multiline">
                            ...
                            <div class="column is-3 pt-1">
                                <span>PAP smear terakhir</span>
                                <Multiselect v-model="input.PAPSmear" :attrs="{ value }" placeholder="--Pilih--"
                                    label="label" :options="d_tidakYa" :searchable="true" track-by="label" mode="single"
                                    autocomplete="off">
                                </Multiselect>
                            </div>
                            <div class="column is-3 pt-1">
                                <span>SADARI tiap bulan</span>
                                <Multiselect v-model="input.SADARITiapBulan" :attrs="{ value }" placeholder="--Pilih--"
                                    label="label" :options="d_tidakYa" :searchable="true" track-by="label" mode="single"
                                    autocomplete="off">
                                </Multiselect>
                            </div>
                            <div class="column is-3 pt-1">
                                <span>Masalah dalam berhubungan seksual</span>
                                <Multiselect v-model="input.MasalahDalamBerhubunganSeks" :attrs="{ value }"
                                    placeholder="--Pilih--" label="label" :options="d_tidakYa" :searchable="true"
                                    track-by="label" mode="single" autocomplete="off">
                                </Multiselect>
                            </div>
                            <div class="column is-3 pt-1">
                                <span>Penyakit mengganggu fungsi seksual</span>
                                <Multiselect v-model="input.PenyakitMenggangguFungsiSeks" :attrs="{ value }"
                                    placeholder="--Pilih--" label="label" :options="d_tidakYa" :searchable="true"
                                    track-by="label" mode="single" autocomplete="off">
                                </Multiselect>
                            </div>
                        ...
                        <div class="columns is-multiline">
                            ...
                            <div class="column">
                                <div class="columns is-multiline">
                                    ...
                                    <div class="column is-6" v-if="input.SPerlu_RPP == 5">
                                        <VControl>
                                            <VInput type="text" class="input" v-model="input.Keterangan_BBLR"
                                                placeholder="Keterangan..." />
                                        </VControl>
                                    </div>
                                    <div class="column is-12 pt-0 pb-0"></div>
                            ...
                            <div class="column">
                                ...
                                <div class="columns">
                                    <div class="column is-4">
                                        <VControl raw subcontrol>
                                            <VCheckbox class="p-0" color="primary" square
                                                true-value="Central Line (CVC/TLC)" label="Central Line (CVC/TLC)"
...
useHead({ title: 'Asesmen Awal Keperawatan Pasien Geriatri Rawat Inap - ' + import.meta.env.VITE_PROJECT })
...
const COLLECTION: any = ref('AsesmenAwalKeperawatanGeriatriRawatInap') //table mongodb
...
watch(
    ...
    (newVal) => {
        let total = 0;
        total += parseFloat(newVal.AsupanMakanKurang_SN ?? 0);
        total += parseFloat(newVal.PenurunanBB_SN ?? 0);
        total += parseFloat(newVal.Mobilitas_SN ?? 0);
        total += parseFloat(newVal.TekananPsikologis_SN ?? 0);
        total += parseFloat(newVal.GangguanNeuro_SN ?? 0);
        total += parseFloat(newVal.IMT_SN ?? 0);
        input.value.TotalSkor_SN = total;
    },
    { deep: true }
);
...
const d_SindromGeriatri = ref([
    { value: "Delirium", label: "Delirium" },
    { value: "Instabilitasi/fall", label: "Instabilitasi/fall" },
    { value: "Immobilisasi", label: "Immobilisasi" },
    { value: "Inkontinensia Urine/ Alvi", label: "Inkontinensia Urine/ Alvi" },
    { value: "Demensia", label: "Demensia" },
    { value: "Ulkus Dekubitus", label: "Ulkus Dekubitus" },
    { value: "Depresi", label: "Depresi" },
    { value: "Malnutrisi", label: "Malnutrisi" },
    { value: "Insomnia", label: "Insomnia" },
    { value: "Lain-lain", label: "Lain-lain" }
]);
const d_AsupanMakanKurang = ref([
    { value: 0, label: "Asupan makanan sangat berkurang" },
    { value: 1, label: "Asupan makanan agak berkurang" },
    { value: 2, label: "Asupan makanan tidak berkurang" }
]);

const d_PenurunanBB = ref([
    { value: 0, label: "Penurunan berat badan lebih dari 3 Kg" },
    { value: 1, label: "Penurunan berat badan tidak diketahui" },
    { value: 2, label: "Penurunan berat badan antara 1 hingga 3 Kg" },
    { value: 3, label: "Tidak ada penurunan berat badan" }
]);

const d_Mobilitas = ref([
    { value: 0, label: "Terbatas di tempat tidur atau kursi" },
    { value: 1, label: "Mampu bangun dari tempat tidur/kursi tetapi tidak bepergian ke luar rumah" },
    { value: 2, label: "Dapat bepergian ke luar rumah" }
]);

const d_TekananPsikologis = ref([
    { value: 0, label: "Ya" },
    { value: 2, label: "Tidak" }
]);

const d_GangguanNeuro = ref([
    { value: 0, label: "Demensia tingkat berat atau depresi" },
    { value: 1, label: "Demensia ringan" },
    { value: 2, label: "Tidak ada gangguan psikologis" }
]);

const d_IMT = ref([
    { value: 0, label: "IMT kurang dari 19 (IMT < 19)" },
    { value: 1, label: "IMT 19 hingga kurang dari 21 (IMT: 19 hingga <21)" },
    { value: 2, label: "IMT 21 hingga kurang dari 23 (IMT: 21 hingga <23)" },
    { value: 3, label: "IMT 23 atau lebih (IMT ≥ 23)" }
]);
