                        ...
                        <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-8" style="margin-top: -1rem;">
                                    <VField>
                                        <VControl>
                                            <VRadio v-model="input.defisitPerawatan" value="Ya" label="Defisit perawatan diri: (mandi, berpakaian, makan, toileting, berhias) D.0109"
                                                name="defisitPerawatan" color="info" square style="font-size: 15px" />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Diagnosa Keperawatan">
                                <div class="column is-8" style="margin-top: -1rem;">
                                    <VField>
                                        <VControl>
                                            <VRadio v-model="input.definisi" value="Ya" label="Definisi : tidak mamapu melakukan atau menyelesaikan aktivitas perawatan diri"
                                                name="definisi" color="info" square style="font-size: 15px" />
                                ...
                                <div class="column is-12">
                                    ...
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in Hubungan">
                                            <VField>
                                ...
                                <div class="column is-12 p-0">
                                    ...
                                    <div class="column is-12 p-0">
                                        <div class="is-flex">
                                            <div class="column is-6" style="margin-top:0.5rem">
                                                <h1> klien mengatakan lemah pada tubuh bagian :</h1>
                                            </div>
                                            <div class="column is-6" style="margin-left: -5rem;">
                                                <VField>
                                                    <VControl>
                                                        <VInput type="text" class="input" placeholder="Lemah pada tubuh bagian"
                                                            v-model="input.LemahDi_" />
                                                    </VControl>
                                    ...
                                    <div class="column is-12 p-0">
                                        <div class="is-flex">
                                            <div class="column is-6" style="margin-top:0.5rem">
                                                <h1> klien mengatakan nyeri pada anggota tubuh bagian :
                                            ...
                                            <div class="column is-6" style="margin-left: -5rem;">
                                                <VField>
                                                    <VControl>
                                                        <VInput type="text" class="input" placeholder="Nyeri pada anggota tubuh bagian"
                                                            v-model="input.NyeriDi_" />
                                                    </VControl>
                                ...
                                <div class="column is-12">
                                    ...
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in dataObjektif">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                        :label="data.title" class="p-0" color="primary" square />
                                        ...
                                        <div class="column is-6" >
                                                <VField>
                                                    <VControl>
                                                        <VInput type="text" class="input" placeholder="Keterangan Minat Diri"
                                                            v-model="input.ketMinatDiri" />
                                                    </VControl>
                                                </VField>
                                            </div>
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Perencanaan Keperawatan">
                                <div class="column is-12">
                                    ...
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-6" v-for="(data, i) in Tujuan">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                        :label="data.title" class="p-0" color="primary" square />
                                ...
                                <div class="column is-12 p-0">
                                    ...
                                    <div class="column is-12 p-0">
                                        <div class="is-flex">
                                            <div class="column is-6" style="margin-top:0.5rem">
                                                <h1>Defisit perawatan diri tidak terjadi, ditandai dengan : </h1>
                                            </div>
                                            <div class="column is-6" style="margin-left: -5rem;">
                                                <VField>
                                                    <VControl>
...
import * as EMR from '../page-emr-plugins/defisit-perawatan-diri'
...
const COLLECTION: any = ref('DefisitPerawatanDiri') //table mongodb
