                ...
                <div class="container">
                    <table class="table is-bordered is-fullwidth">
                        ...
                        <thead>
                            ...
                            <tr>
                                <th>
                                    Nilai pemantauan EWS hijau kuning oranye, tanpa tanda-tanda distress napas dan
                                    ancaman gagal napas
                                </th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.nilaiPantau" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.nilaiPantau" true-value="Tidak" color="primary" />
                                </th>
                            </tr>
                        </thead>
                        ...
                        <thead>
                            <tr>
                                <th style="background-color: #0000CD; color: #FFFFFF" colspan="3">2. PEMERIKSAAN FISIK
                                </th>
                            </tr>
                            <tr>
                                <th>a. Produksi urin 0,5 - 1 ml/kgBB/jam</th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.produksiUrin" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.produksiUrin" true-value="Tidak" color="primary" />
                                </th>
                            </tr>

                            <tr>
                                <th>b. Tidak ada obstruksi jalan nafas</th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.obstruksiJalan" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.obstruksiJalan" true-value="Tidak" color="primary" />
                                </th>
                            </tr>

                            <tr>
                                <th>c. Bebas kejang > 72</th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.bebasKejang" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.bebasKejang" true-value="Tidak" color="primary" />
                                </th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VCheckbox v-model="input.tamponadeJantung" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.tamponadeJantung1" true-value="Tidak" color="primary" />
                                </th>
                            </tr>
                        </thead>
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VCheckbox v-model="input.iranaSinus" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.iranaSinus" true-value="Tidak" color="primary" />
                                </th>
                            </tr>
                        </thead>
                        ...
                        <thead>
                            <tr>
                                <th style="background-color: #0000CD; color: #FFFFFF" colspan="3">
                                    4. NILAI LABORATORIUM
                                </th>
                            </tr>
                            <tr>
                                <th>a. Kadar natrium serum 130 - 150 mmol/L</th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.kadarNatrium" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.kadarNatrium" true-value="Tidak" color="primary" />
                                </th>
                            </tr>

                            <tr>
                                <th>b. Kadar kalium serum 3,0 - 5,0 mmol/L</th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.kadarKalium" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.kadarKalium" true-value="Tidak" color="primary" />
                                </th>
                            </tr>

                            <tr>
                                <th>c. PaO<sub>2</sub> &gt; 90 mmHg pada oksigen ruangan</th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.oksigenRuangan" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.oksigenRuangan" true-value="Tidak" color="primary" />
                                </th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VCheckbox v-model="input.pH" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.pH" true-value="Tidak" color="primary" />
                                </th>
                            </tr>

                            <tr>
                                <th>e. Serum glukosa 75 - 200 mg/dl</th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.serumGlukosa" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.serumGlukosa" true-value="Tidak" color="primary" />
                                </th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <th class="yes-column">
                                    <VCheckbox v-model="input.serumKalsium" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.serumKalsium" true-value="Tidak" color="primary" />
                                </th>
                            </tr>

                            <tr>
                                <th>g. Kadar obat substansi kimia dalam darah tidak melebihi dosis toksis yang
                                    mengganggu hemodinamik dan status neurologis</th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.kadarObat" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.kadarObat" true-value="Tidak" color="primary" />
                                </th>
                            </tr>
                            
                            <!-- <tr>
                                <th>Bila kondisi fisiologi pasien telah mengalami perburukan dan intervensi aktif tidak
                                    direncanakan
                                    lagi</th>
                                <th class="yes-column">
                        ...
                        <thead>
                            <tr>
                                <th style="background-color: #0000CD; color: #FFFFFF" colspan="3">5. Nilai Radiologi
                                </th>
                            </tr>
                            <tr>
                                <th>a. Perdarahan cerebral, contusion atau perdarahan subarachnoid tanpa
                                    gangguan status mental</th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.pendarahanCerebal" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.pendarahanCerebal" true-value="Tidak" color="primary" />
                                </th>
                            </tr>
                            <tr>
                                <th>b. Ruptur viscera, blader, liver, varices esofagus, perdarahan tanpa
                                    gangguan hemodinamik</th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.rupturViscera" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.rupturViscera" true-value="Tidak" color="primary" />
                                </th>
                            </tr>
                            <tr>
                                <th>c. Diseksi aorta aneurisma yang telah distabilisasi dan tanpa gangguan
                                    hemodinamik</th>
                                <th class="yes-column">
                                    <VCheckbox v-model="input.diseksiAorta" true-value="Ya" color="primary" />
                                </th>
                                <th class="no-column">
                                    <VCheckbox v-model="input.diseksiAorta" true-value="Tidak" color="primary" />
                                </th>
                            </tr>
                        </thead>
                        ...
                        <thead>
                            <tr>
                                <th style="background-color: #0000CD; color: #FFFFFF" colspan="3">
                                    6. Bila kondisi fisiologi pasien telah mengalami perbaikan atau perburukan dan
                                       intervensi aktif tidak direncanakan lagi (Pasien terminal atau perawatan paliatif)
                                </th>
                            </tr>
                        </thead>
                    ...
                    <table class="table is-bordered is-fullwidth mt-4">
                            ...
                            <td colspan="4">
                                <VField>
                                    <b style="font-size: 17px">
                                        Berdasarkan indikasi di atas, maka memenuhi indikasi keluar dari ICU ke ruang :</b>
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="checkbox-container">
                                    <VCheckbox v-model="input.alatTransportasi" true-value="Brancard" color="primary" />
                                    <span>Brancard</span>
                                </div>
                            </th>
                            <th colspan="2">
                                <div class="checkbox-container">
                                    <VCheckbox v-model="input.alatTransportasi" true-value="Kursi Roda" color="primary" />
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="checkbox-container">
                                    <VCheckbox v-model="input.pendamping" true-value="Dokter" color="primary" />
                                    <span>Dokter / <i>Doctor</i></span>
                                </div>
                            </th>
                            <th>
                                <div class="checkbox-container">
                                    <VCheckbox v-model="input.pendamping" true-value="Perawat" color="primary" />
                                    <span>Paramedis / <i>Paramedic </i></span>
                                </div>
                            </th>
                            <th>
                                <div class="checkbox-container">
                                    <VCheckbox v-model="input.pendamping" true-value="Care Giver" color="primary" />
                        ...
                        <tr>
                            ...
                            <th colspan="2">
                                <div class="checkbox-container">
                                    <VCheckbox v-model="input.alatMedisTransfer" true-value="Ya" color="primary" />
                                    <span>YA</span>
                                    <VField v-if="input.alatMedisTransfer == 'Ya'">
                                        <VTextarea v-model="input.textAreaValue" placeholder="Sebutkan"
                                            color="primary" />
                                    </VField>
                                </div>
                            </th>
                            <th>
                                <div class="checkbox-container">
                                    <VCheckbox v-model="input.alatMedisTransfer" true-value="Tidak" color="primary" />
                                    <span>TIDAK</span>
                                </div>
                            </th>
                        </tr>
