...
import * as EMR from '../page-emr-plugins/form-pemeriksaan-jiwa-calon-tki'
...
// Judul
useHead({
    title: 'Form Pemeriksaan Jiwa Calon TKI - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('FormPemeriksaanJiwaCalonTKI') //table mongodb
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header" style="margin-bottom: 10px">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Form Pemeriksaan Jiwa Calon TKI</h3>
                        </div>
                        <div class="right">
                ...
                <div class="columns is-multiline" style="padding: 20px;">
                    <table class="tg2">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;vertical-align: middle;">Hasil Pemeriksaan</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="(row, rowIndex) in detailTable" :key="rowIndex">
                                <td width="5%" style="text-align: center;vertical-align: middle;">{{ rowIndex + 1 }}
                                </td>
                                <td width="100px" v-for="(item, itemIndex) in row.child" :key="itemIndex">
                                    <VField style="padding:0px 10px;" v-if="item.type == 'textarea'">
                                        <VControl>
                                            <VTextarea rows="2"
                                                v-model="input['texareaCalonTKI_' + rowIndex + '_' + itemIndex]">
                                            </VTextarea>
                                        </VControl>
                                    </VField>
                                    ...
                                    <VField style="padding:0px 10px;" v-if="item.type == 'textWlist'">
                                        <span>Mood / afek(suasana perasaan / ekspresi wajah)</span>
                                        <ul>
                                            <li> <b>-</b> Mood (eutim/normal, sedih, senang berlebihan, labil, iritabel,
                                                dll)</li>
                                            <li> <b>-</b> Efek (luas, terbatas, tumpul, mendatar)</li>
                                        </ul>
                                    </VField>
                                </td>
                            </tr>
                    ...
                    <div class="column" style="margin-top: 20px;">
                        <div class="column"><b>Kesimpulan Hasil Pemeriksaan Jiwa</b></div>
                        <VField>
                            <VTextarea rows="2" v-model="input.TAkesimpulanPemeriksaan"></VTextarea>
                        </VField>
                    </div>
                </div>
                ...
                <div class="columns">
                    ...
                    <div class="column is-4">
                        ...
                        <div class="column" style="text-align:center;">
                            <h1>Tanda Tangan Dokter Pemeriksa</h1>
