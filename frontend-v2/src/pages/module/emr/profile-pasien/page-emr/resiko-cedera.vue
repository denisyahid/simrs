                ...
                <div class="form-header-inner">
                    ...
                    <div class="right">
                        <div class="buttons">
                            ...
                            <VButton type="button" rounded outlined color="warning" :disabled="isDisabled" raised icon="lnir lnir-printer"
                                @click="print()"> Cetak
                            </VButton>
                    ...
                    <div class="column is-12">
                        <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-6" style="margin-top: -1rem;">
                                    <VField>
                                        <VControl>
                                            <VRadio v-model="input.NyeriAkut" value="Ya" label="Resiko Cedera (D.0136)"
                                                name="Resiko Cedera" color="info" square style="font-size: 15px" />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Diagnosa Keperawatan">
                                ...
                                <div class="column is-12">
                                    <h1> Definisi : berisiko mengalami bahaya atau kerusakan fisik yang menyebabkan seseorang tidak lagi sepenuhnya sehat atau dalam kondisi baik.
                                    </h1>
                                </div>

                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Berhubungan dengan :</h1>
                                    <h1 style="font-weight: bold;">Eksternal :</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in HubunganEksternal">
                                            <VField>
                                    ...
                                    <h1 style="font-weight: bold;">Internal :</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-4" v-for="(data, i) in HubunganInternal">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                        :label="data.title" class="p-0" color="primary" square />
                                ...
                                <div class="column is-12">
                                    ...
                                    <div class="column is-12" v-for="(datas, i) in dataObjektif">
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Perencanaan Keperawatan">
                                ...
                                <div class="column is-12 p-0">
                                    ...
                                    <div class="column is-12">
                                        <h1 style="font-weight: bold;">Kejadian Jatuh:</h1>
                                        <div class="columns is-multiline pt-3 pl-3">
                                            <div class="column is-6" v-for="(data, i) in kejadianJatuh">
                                                <VField>
                                                    <VControl raw subcontrol>
                                                        <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                            :label="data.title" class="p-0" color="primary" square />
                                    ...
                                    <div class="column is-12">
                                        <h1 style="font-weight: bold;">Kontrol Resiko:</h1>
                                        <div class="columns is-multiline pt-3 pl-3">
                                            <div class="column is-12" v-for="(data, i) in kontrolResiko">
                                                <VField>
                                                    <VControl raw subcontrol>
                                                        <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                            :label="data.title" class="p-0" color="primary" square />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Rencana Tindakan">
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Pencegahan Jatuh:</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in pencegahanJatuh">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                        :label="data.title" class="p-0" color="primary" square />
                                ...
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Manajemen Lingkungan:</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in manajemenLingkungan">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                        :label="data.title" class="p-0" color="primary" square />
...
import * as EMR from '../page-emr-plugins/resiko-cedera'

let ID_PASIEN = useRoute().query.nocmfk as string
let NOREC_PD = useRoute().query.norec_pd as string
let norec_emr = useRoute().query.norec_emr as string

let HubunganEksternal = ref(EMR.HubunganEksternal())
let HubunganInternal = ref(EMR.HubunganInternal())
let Tujuan = ref(EMR.Tujuan())
let dataObjektif = ref(EMR.dataObjektif())
let kejadianJatuh = ref(EMR.kejadianJatuh())
let kontrolResiko = ref(EMR.kontrolResiko())
let pencegahanJatuh = ref(EMR.pencegahanJatuh())
let manajemenLingkungan = ref(EMR.manajemenLingkungan())
...
const COLLECTION: any = ref('ResikoCedera') //table mongodb
