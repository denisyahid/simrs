...
import * as EMR from '../page-emr-plugins/form-pemeriksaan-laboratorium-calon-tki'
...
// Judul
useHead({
    title: 'Form Pemeriksaan Laboratorium Calon TKI - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('FormPemeriksaanLaboratoriumCalonTKI') //table mongodb
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header" style="margin-bottom: 10px">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Form Pemeriksaan Laboratorium Calon TKI</h3>
                        </div>
                        <div class="right">
                ...
                <div class="columns is-multiline" style="padding: 20px;">
                                    ...
                                    <VField style="padding:0px 10px;" v-if="item.type == 'textbox'">
                                        <VControl>
                                            <VInput type="text" class="input"
                                                v-model="input['texareaLaboTKI_' + rowIndex + '_' + itemIndex]" />
                                        </VControl>
                                    </VField>
                                    <VField style="padding:0px 10px;" v-if="item.type == 'text'">
                                        <span>{{ item.caption }}</span>
                                    </VField>
                                    <VField style="padding:0px 10px;background-color: lightgray;font-size: large;"
                                        v-if="item.type == 'head'">
                                        <span>{{ item.caption }}</span>
                                    </VField>
                                </td>
                    ...
                    <div class="column" style="margin-top: 20px;">
                        <div class="column"><b>Kesimpulan Hasil Pemeriksaan Laboratorium</b></div>
                        <VField>
                            <VTextarea rows="2" v-model="input.TAkesimpulanLaboratorium"></VTextarea>
                        </VField>
                    </div>
                </div>
