      ...
      <div class="form-outer" style="margin-top: 15px">
            ...
            <VField>
              <VControl>
                <AutoComplete v-model="input.dokterDPJP" :suggestions="d_Dokter" @complete="fetchDokter($event)"
                  ...
                  :loadingIcon="'pi pi-spinner'" :field="'label'" class="is-rounded" />
              </VControl>
            </VField>
          </div>
        </div>
        <div class="column" style="overflow: auto;">
          <table class="table-rpo">
            ...
            <tbody>
              <tr>
                <td class="td-pri">General consent (Tgl/Jam, Ttd pasien/Klg & Pemberi informasi)</td>
                <td class="td-pri" style="text-align: center;">
                  <VField>
                    <VControl>
                      <VCheckbox v-model="input.generalConsent" true-value="Ya" />
                    </VControl>
                  </VField>
                </td>
              </tr>
              <tr>
                <td class="td-pri">Catatan kegiatan</td>
                <td class="td-pri" style="text-align: center;">
                  <VField>
                    <VControl>
                      <VCheckbox v-model="input.catatanKegiatan" true-value="Ya" />
                    </VControl>
                  </VField>
                </td>
              </tr>
              <tr>
                <td class="td-pri">Lembar identitas pasien (termasuk: foto, diagnosis, stadium, PA)</td>
                <td class="td-pri" style="text-align: center;">
                  <VField>
                    <VControl>
                      <VCheckbox v-model="input.identitasPasien" true-value="Ya" />
                    </VControl>
                  </VField>
                </td>
              </tr>
              <tr>
                <td class="td-pri">Anamnesis (termasuk tanggal)</td>
                <td class="td-pri" style="text-align: center;">
                  <VField>
                    <VControl>
                      <VCheckbox v-model="input.anamnesis" true-value="Ya" />
                    </VControl>
                  </VField>
                </td>
              </tr>
              <tr>
                <td class="td-pri">Status lokalis (termasuk tanggal)</td>
                <td class="td-pri" style="text-align: center;">
                  <VField>
                    <VControl>
                      <VCheckbox v-model="input.statusLokalis" true-value="Ya" />
                    </VControl>
                  </VField>
                </td>
              </tr>
              <tr>
                <td class="td-pri">Informed consent (termasuk rincian penjelasan, Ttd DPJP/saksi)</td>
                <td class="td-pri" style="text-align: center;">
                  <VField>
                    <VControl>
                      <VCheckbox v-model="input.informedConsent" true-value="Ya" />
                    </VControl>
                  </VField>
                </td>
              </tr>
              <tr>
                <td class="td-pri">Resume pasien masuk (Ttd DPJP)/Form C4</td>
                <td class="td-pri" style="text-align: center;">
                  <VField>
                    <VControl>
                      <VCheckbox v-model="input.resumePasienMasuk" true-value="Ya" />
                    </VControl>
                  </VField>
                </td>
              </tr>
              <tr>
                <td class="td-pri">Perencanaan radiasi (Tanggal, Ttd DPJP)</td>
                <td class="td-pri" style="text-align: center;">
                  <VField>
                    <VControl>
                      <VCheckbox v-model="input.perencanaanRadiasi" true-value="Ya" />
                    </VControl>
                  </VField>
                </td>
              </tr>
              <tr>
                <td class="td-pri">Form skrining gizi terisi</td>
                <td class="td-pri" style="text-align: center;">
                  <VField>
                    <VControl>
                      <VCheckbox v-model="input.skriningGizi" true-value="Ya" />
                    </VControl>
                  </VField>
                </td>
              </tr>
              <tr>
                <td class="td-pri">Form pengkajian awal keperawatan rawat jalan (skor jatuh, VAS, tanda vital)</td>
                <td class="td-pri" style="text-align: center;">
                  <VField>
                    <VControl>
                      <VCheckbox v-model="input.pengkajianAwal" true-value="Ya" />
                    </VControl>
                  </VField>
                </td>
              </tr>
        ...
        <div class="is-12">
          <p>Catatan: bila salah satu data di atas belum dilengkapi, maka pasien tidak dapat dilanjutkan radiasinya dan
            di
            kembalikan ke poli klinik</p>
        </div>
        <div class="is-12 is-flex">
          ...
          <p class="mt-4">Dengan ini petugas menyatakan bahwa data yang dimaksud <span
              style="font-weight: bold;">LENGKAP</span>
          </p>
        </div>
      </div>
    </div>
...
useHead({
  title: "PRE-QC 1 - " + import.meta.env.VITE_PROJECT,
});
...
const COLLECTION: any = ref("PreQC1"); //table mongodb
