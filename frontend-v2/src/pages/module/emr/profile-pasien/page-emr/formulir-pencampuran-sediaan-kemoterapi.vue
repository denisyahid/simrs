<template>
  <div class="form-layout is-stacked-2" style="width: 100%;max-width: none;">
    <div class="form-outer" style="margin-top:15px">
        ...
        <div class="form-header-inner">
          ...
          <div class="right">
            <ButtonEmr :NOREC_EMRPASIEN="NOREC_EMRPASIEN" :COLLECTION="COLLECTION" :isLoading="isLoading"
              @simpan="simpanCatatan" @simpanTemplate="simpanTemplate" @kembaliKeun="kembaliKeun"></ButtonEmr>
          </div>
        </div>
      ...
      <div class="column is-12 isprotokol-kemo">
        <div class="columns is-multiline">
          ...
          <div class="column is-12 is-flex">
            ...
            <div class="column is-10">
              <VField>
                <VControl>
                  <VInput type="text" class="input" placeholder="Cara Bayar" v-model="input.caraBayar" />
                </VControl>
              </VField>
            </div>
          </div>
          ...
          <div class="column is-12 is-flex">
            ...
            <div class="column is-10">
              <VField>
                <VControl>
                  <VTextarea type="text" class="input" placeholder="Alergi" v-model="input.alergi" />
                </VControl>
              </VField>
            </div>
          </div>
              ...
              <div class="column is-12">
                <div class="columns is-multiline">
                  ...
                  <div class="column is-4">
                    ...
                    <VField addons>
                      <VControl expanded>
                        <VInput type="text" class="input" placeholder="BSA" v-model="input.bsa" />
                      </VControl>
                      <VControl class="field-addon-body">
                  ...
                  <div class="column is-4">
                    ...
                    <VField>
                      <VControl expanded>
                        <VInput type="text" class="input" placeholder="Protokol" v-model="input.Protokol" />
                      </VControl>
                    </VField>
                  </div>
                  <div class="column is-4">
                    ...
                    <VField>
                      <VControl expanded>
                        <VInput type="text" class="input" placeholder="Siklus" v-model="input.Siklus" />
                      </VControl>
                    </VField>
                  </div>
                  <div class="column is-4">
                    ...
                    <VField>
                      <VDatePicker v-model="input.tanggalRencanaKemoterapi" mode="date" trim-weeks>
                        <template #default="{ inputValue, inputEvents }">
                          <VField>
                            <VControl icon="feather:calendar" fullwidth>
          ...
          <div class="column is-12" style="overflow-x: auto;">
            <table style="width: 300%; text-align: center;">
              ...
              <tbody>
                ...
                <tr v-for="(data, index) in input.details" :key="index">
                  <td class="td-pri">
                    <VField>
                      <VControl>
              ...
              <tr>
                <td class="td-pri" colspan="3" rowspan="3">
                  <VControl>
                    <VTextarea class="textarea" v-model="input.catatanDokter" placeholder="Catatan Dokter"></VTextarea>
                  </VControl>
                </td>
                <td class="td-pri" colspan="4" rowspan="3">
                  <VControl>
                    <VTextarea class="textarea" v-model="input.catatanFarmasi" placeholder="Catatan Farmasi">
                    </VTextarea>
                  </VControl>
                </td>
...
const COLLECTION: any = ref('PencampuranSediaanKemoterapi') //table mongodb
...
onMounted(() => {
  ...
  if(q?.isfromKemo == "true" && q?.paramKemo != "kemoterapi") {
