            ...
            <div class="columns is-multiline">
                <div class="column is-4">
                    ...
                    <VField class="is-autocomplete-select" v-slot="{ id }">
                      <VControl icon="">
                        <Multiselect v-model="input.gestationalAges" :attrs="{ value }" placeholder="--Pilih--" label="label" :options="inputOptions"
...
const COLLECTION: any = ref('FentonPretermGrowthChartBoys')
