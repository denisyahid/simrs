<template>
    ...
    <div class="column is-12">
      <VCard>
        ...
        <div class="column is-4">
            <span style="font-weight: 500;">Tanggal Masuk Ruang Bersalin</span>
            <VField class="pt-3">
              <VControl class="prime-auto">
                <!-- Date Picker -->
                <VDatePicker class="pt-3" v-model="input.tglkeluar" color="green" mode="datetime">
          ...
          <table class="table-lo">
            <thead>
              <tr>
                ...
                <th class="th-lo" width="10%">Tgl/Jam</th>
                <th class="th-lo" width="10%">Tekanan Darah(mmHg)</th>
                <th class="th-lo" width="8%">Nadi(x/mnt)</th>
                <th class="th-lo" width="8%">RR(x/mnt)</th>
                <th class="th-lo" width="8%">Suhu(°C)</th>
                <th class="th-lo" width="8%">HIS</th>
                <th class="th-lo" width="8%">DJJ(x/mnt)</th>
                <th class="th-lo" width="8%">VT</th>
                <th class="th-lo" width="13%">Paraf Nama terang</th>
                <th class="th-lo">Keterangan/Obat</th>
                <th class="th-lo">#</th>
              </tr>
            </thead>
            <tbody v-for="(item, index) in input.details" :key="index">
              <tr>
                ...
                <td class="td-lo">
                  <VField class="p-3">
                    <VControl>
                      <VInput type="text" v-model="item.his" />
                    </VControl>
                  </VField>
                </td>
                <td class="td-lo">
                  <VField class="p-3">
                    <VControl>
                      <VInput type="text" v-model="item.djj" />
                    </VControl>
                  </VField>
                </td>
                <td class="td-lo">
                  <VField class="p-3">
                    <VControl>
                      <VInput type="text" v-model="item.vt" />
                    </VControl>
                  </VField>
                </td>
                <td class="td-lo">
  ...
  const props = withDefaults(
    ...
    }>(),
    {
      ...
      FORM_NAME: '',
      FORM_URL: '',
      COLLECTION: 'ObservasiPasienKebidanan',
    }
  )
