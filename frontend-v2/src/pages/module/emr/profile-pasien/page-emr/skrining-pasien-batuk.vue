...
import * as EMR from '../page-emr-plugins/skrining-pasien-batuk'
...
// Judul
useHead({
    title: 'Skrining Pasien Batuk - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('SkriningPasienBatuk') //table mongodb
    ...
    <div>
        <div class="form-layout is-stacked-2">
            <div class="form-outer" style="margin-top:15px">
                ...
                <!-- form baru -->
                <div class="columns" style="padding: 10px;text-align: center;">
                    <div class="column is-6">
                        <VControl raw subcontrol>
                            <VCheckbox class="p-0" color="primary" square true-value="Pasien" label="Pasien"
                                v-model="input.CBPasien" />
                        </VControl>
                    </div>
                    <div class="column is-6">
                        <VControl raw subcontrol>
                            <VCheckbox class="p-0" color="primary" square true-value="Penanggung Jawab"
                                label="Penanggung Jawab" v-model="input.CBPenanggungJawab" />
                        </VControl>
                    </div>
                </div>
                ...
                <div class="column" style="padding: 10px;">
                    <table class="tg">
                        <thead>
                            ...
                            <th style="text-align: center;vertical-align: middle;">TIDAK</th>
                        </thead>
                        <tbody>
                            <tr v-for="(row, rowIndex) in detailTable" :key="rowIndex">
                                <td width="20px" style="text-align: center;vertical-align: middle;">{{ rowIndex + 1 }}
                                </td>
                                <td width="200px" v-for="(item, itemIndex) in row.child" :key="itemIndex">
                                    <VControl raw subcontrol v-if="item.type === 'checkbox'">
                                        <VCheckbox class="p-0" color="primary" square :true-value="item.caption"
                                            :label="item.caption"
                                            v-model="input['checkboxSPB' + rowIndex + '_' + itemIndex]" />
                                    </VControl>
                ...
                <div class="columns is-multiline">
                    <div class="column is-8">
                        <div class="column"><b>Catatan : </b></div>
                        <div class="column" style="margin-top: -15px;">
                            Untuk pasien poli jika jawaban <b>“YA”</b> lebih dari atau sama dengan ( > ) 3 pertanyaan
                            maka silahkan ke <b>Loket 4 Pendaftaran</b>
                        </div>
                        <div class="column"><b>Keterangan : </b></div>
                        <div class="column" style="margin-top: -15px;">
                            <VField>
