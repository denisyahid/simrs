      ...
      <div class="form-outer" style="margin-top: 15px">
        ...
        <div>
          <div class="is-flex p-3">
            <div>
              <ImgDraw elemenID="Gambar" height="600" width="750" imageSrc="/images/simrs/clinical-drawing-1.png"
                :valueImg="input.Gambar" class="mb-5" />
            </div>
            <div class="is-flex is-flex-direction-column ml-3">
              <VField class="p-1">
                <VControl>
                  <VCheckbox class="fontcheckbox" v-model="input.atDiagnosis" true-value="At Diagnosis"
                    label="At Diagnosis" color="primary" circle />
                </VControl>
              </VField>
              <VField class="p-1">
                <VControl>
                  <VCheckbox class="fontcheckbox" v-model="input.atBrachytherapy" true-value="At Brachytherapy"
                    label="At Brachytherapy" color="primary" circle />
                </VControl>
              </VField>
              EBRT
              <VField class="p-1" addons>
                <VControl>
                  <VInput v-model="input.ebrt" placeholder="EBRT" />
                </VControl>
                <VControl>
                  <VButton color="primary">EBRT</VButton>
                </VControl>
              </VField>
              W
              <VField class="p-1" addons>
                <VControl>
                  <VInput v-model="input.WClinic1" placeholder="W" />
                </VControl>
                <VControl>
                  <VButton color="primary">W</VButton>
                </VControl>
              </VField>
              H
              <VField class="p-1" addons>
                <VControl>
                  <VInput v-model="input.HClinic1" placeholder="H" />
                </VControl>
                <VControl>
                  <VButton color="primary">H</VButton>
                </VControl>
              </VField>
              T
              <VField class="p-1" addons>
                <VControl>
                  <VInput v-model="input.TClinic1" placeholder="T" />
                </VControl>
                <VControl>
                  <VButton color="primary">T</VButton>
                </VControl>
              </VField>
              Vagina Involvemen
              <VField class="p-1" addons>
                <VControl>
                  <VInput v-model="input.VaginaInvolvemenClinic1" placeholder="Vagina Involvemen" />
                </VControl>
                <VControl>
                  <VButton color="primary" style="width: 80px;">Vagina <br> Involvemen</VButton>
                </VControl>
              </VField>
            </div>
          </div>
          ...
          <div class="is-flex p-3">
            <div>
              <ImgDraw elemenID="Gambar2" height="600" width="750" imageSrc="/images/simrs/clinical-drawing-2.png"
                :valueImg="input.Gambar2" class="mb-5" />
            </div>
            <div class="is-flex is-flex-direction-column ml-3">
              <VField class="p-1">
                <VControl>
                  <VCheckbox class="fontcheckbox" v-model="input.atDiagnosis2" true-value="At Diagnosis"
                    label="At Diagnosis" color="primary" circle />
                </VControl>
              </VField>
              <VField class="p-1">
                <VControl>
                  <VCheckbox class="fontcheckbox" v-model="input.atBrachytherapy2" true-value="At Brachytherapy"
                    label="At Brachytherapy" color="primary" circle />
                </VControl>
              </VField>
              EBRT
              <VField class="p-1" addons>
                <VControl>
                  <VInput v-model="input.ebrt2" placeholder="EBRT" />
                </VControl>
                <VControl>
                  <VButton color="primary">EBRT</VButton>
                </VControl>
              ...
              <VField class="p-1" addons>
                <VControl>
                  <VInput v-model="input.WClinic2" placeholder="W" />
                </VControl>
                <VControl>
                  <VButton color="primary">W</VButton>
                </VControl>
              ...
              <VField class="p-1" addons>
                <VControl>
                  <VInput v-model="input.HClinic2" placeholder="H" />
                </VControl>
                <VControl>
                  <VButton color="primary">H</VButton>
                </VControl>
              ...
              <VField class="p-1" addons>
                <VControl>
                  <VInput v-model="input.TClinic2" placeholder="T" />
                </VControl>
                <VControl>
                  <VButton color="primary">T</VButton>
                </VControl>
              ...
              <VField class="p-1" addons>
                <VControl>
                  <VInput v-model="input.VaginaInvolvemenClinic2" placeholder="Vagina Involvemen" />
                </VControl>
                <VControl>
                  <VButton color="primary" style="width: 80px;">Vagina <br> Involvemen</VButton>
                </VControl>
          ...
          <div class="is-flex p-3">
            <div>
              <ImgDraw elemenID="Gambar3" height="400" width="900" imageSrc="/images/simrs/clinical-drawing-3-new.png"
                :valueImg="input.Gambar3" class="mb-5" />
            </div>
          </div>
          <div class="is-flex p-3">
            <div>
              <ImgDraw elemenID="Gambar4" height="400" width="800" imageSrc="/images/simrs/clinical-drawing-4.png"
                :valueImg="input.Gambar4" class="mb-5" />
            </div>
          </div>
...
useHead({
  title: "Clinical Drawing - " + import.meta.env.VITE_PROJECT,
});
...
const COLLECTION: any = ref("ClinicalDrawing"); //table mongodb
...
const loadRiwayat = async () => {
  ...
  H.tandaTangan().set("Gambar", dataTTD.value.Gambar);
  H.tandaTangan().set("Gambar1", dataTTD.value.Gambar1);
  H.tandaTangan().set("Gambar2", dataTTD.value.Gambar2);
  H.tandaTangan().set("Gambar3", dataTTD.value.Gambar3);
  H.tandaTangan().set("Gambar4", dataTTD.value.Gambar4);
};
const simpan = () => {
