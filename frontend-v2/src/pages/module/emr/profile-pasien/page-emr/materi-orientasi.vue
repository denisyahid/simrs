      ...
      <div class="form-outer" style="margin-top:15px">
        <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
          <div class="form-header-inner">
            <div class="left">
              <h3>ORIENTASI PASIEN BARU RAWAT INAP</h3>
            </div>
        ...
        <div class="column is-12">
          <table class="table is-bordered is-fullwidth">
            ...
            <thead>
              ...
              <tr>
                <th>1. Peraturan dan tata tertib UPTD.RSUD Bali Mandara Provinsi Bali</th>
                <th class="yes-column">
            ...
            <thead>
              ...
              <tr>
                <th>2. Hak dan Kewajiban Pasien (Patient’s Rights and Obligations)</th>
                <th class="yes-column">
              ...
              <tr>
                <th>3. Perawat dan Dokter Penanggung Jawab (Primary Doctor and Nurse)</th>
                <th class="yes-column">
              ...
              <tr>
                <th>4. Jam Visite Dokter (Doctor’s Visiting Hours)</th>
                <th class="yes-column">
              ...
              <tr>
                <th>5. Waktu Berkunjung (Visiting Hours)</th>
                <th class="yes-column">
              ...
              <tr>
                <th>6. Layanan Obat (Pharmacy Care)</th>
                <th class="yes-column">
            ...
            <tr>
              <th>7. Jadwal Pemberian Makanan Pasien (Patient’s Medis Schedule)
              </th>
              <th class="yes-column">
            ...
            <tr>
              <th>8. Administrasi dan Pembayaran (Administration and Payment)</th>
              <th class="yes-column">
            ...
            <tr>
              <th>9. Penjelasan Penggunaan Gelang Identitas Pasien</th>
              <th class="yes-column">
            ...
            <tr>
              <th>10. Facilities (Kind and How to Use it) Fasilitas (Jenis dan Cara Penggunaan) :</th>
              <th class="yes-column">
            ...
            <tr>
              <th>b. Kipas Angin / AC (Electric Fan / AC)</th>
              <th class="yes-column">
            ...
            <tr>
              <th>d. Lemari Pasien (Patient’s Wardrobe)</th>
              <th class="yes-column">
            ...
            <tr>
              <th>g. Tempat Sampah (Recycle Bin)</th>
              <th class="yes-column">
            ...
            <tr>
              <th>h. Kotak Saran / Kepuasan Pelanggan (Suggestion Box / Customers Satisfaction)
              </th>
              <th class="yes-column">
                <VCheckbox v-model="input.saran" true-value="Ya" color="primary" />
              </th>
              <th class="no-column">
                <VCheckbox v-model="input.puas" true-value="Tidak" color="primary" />
              </th>
            </tr>
            <tr>
              <th>11. Layanan Pengaduan (Complaint Center)
              </th>
              <th class="yes-column">
                <VCheckbox v-model="input.comp" true-value="Ya" color="primary" />
              </th>
              <th class="no-column">
                <VCheckbox v-model="input.lai" true-value="Tidak" color="primary" />
              </th>
            </tr>
            <tr>
              <th>12. Keadaan Darurat / Jalur Evakuasi (Emergency Situation / Evacuation Route)
              </th>
              <th class="yes-column">
                <VCheckbox v-model="input.gency" true-value="Ya" color="primary" />
              </th>
              <th class="no-column">
                <VCheckbox v-model="input.emr" true-value="Tidak" color="primary" />
              </th>
            </tr>
            <tr>
              <th>13. Larangan Merokok Bagi Pengunjung dan Pasien (No Smoking for Patient and Visitor)
              </th>
              <th class="yes-column">
                <VCheckbox v-model="input.pasin" true-value="Ya" color="primary" />
              </th>
              <th class="no-column">
                <VCheckbox v-model="input.psn" true-value="Tidak" color="primary" />
              </th>
            </tr>
            <tr>
              <th>14. Menjelaskan Enam (6) Langkah Cuci Tangan (Six ( 6 )Steps of Hand Washing)
              </th>
              <th class="yes-column">
                <VCheckbox v-model="input.cuci" true-value="Ya" color="primary" />
              </th>
              <th class="no-column">
                <VCheckbox v-model="input.tangan" true-value="Tidak" color="primary" />
              </th>
            </tr>
          </table>
        </div>
...
const COLLECTION: any = ref('MateriOrientasi') //table mongodb
