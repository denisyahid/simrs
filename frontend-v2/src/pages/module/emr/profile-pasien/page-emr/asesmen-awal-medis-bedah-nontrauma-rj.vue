...
// Judul
useHead({
    title: 'Asesmen Awal Medis Bedah Non Trauma Rawat Jalan - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('AsesmenAwalMedisBedahNonTraumaRawatJalan') //table mongodb
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header" style="margin-bottom: 10px">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Asesmen Awal Medis Bedah Non Trauma Rawat Jalan</h3>
                        </div>
                        <div class="right">
                            <div class="buttons">
                ...
                <div class="columns is-multiline p-2">
                    ...
                    <div class="column is-12">
                        <Fieldset :toggleable="true" legend="Status Lokalis & Skema">
                            <div class="columns is-multiline" style="padding: 10px; padding-top: 0px">
                                <div class="column is-6">
                                    <VField label="Status Lokalis">
                                        <VTextarea rows="2" v-model="input.TAstatusLokalis"></VTextarea>
                                    </VField>
                                </div>
                                <div class="column is-6">
                                    <VField label="Skema">
                                        <VTextarea rows="2" v-model="input.TAskema"></VTextarea>
                                    </VField>
                                </div>
                            </div>
                        </Fieldset>
