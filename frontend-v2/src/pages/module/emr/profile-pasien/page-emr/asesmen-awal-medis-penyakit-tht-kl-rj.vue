...
// Judul
useHead({
    title: 'Asesmen Awal Medis Penyakit THT-KL - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('AsesmenAwalMedisPenyakitTHTKLRJ') //table mongodb
...
const loadRiwayat = async () => {
    ...
    await loadGambar("GambarTelinga", dataTTD.value.GambarTelinga)
    await loadGambar("GambarTenggorok", dataTTD.value.GambarTenggorok)
    await loadGambar("GambarHidung", dataTTD.value.GambarHidung)
    await loadGambar("GambarLeher", dataTTD.value.GambarLeher)
}
const simpan = () => {
    ...
    object['GambarTelinga'] = H.tandaTangan().get("GambarTelinga");
    object['GambarTenggorok'] = H.tandaTangan().get("GambarTenggorok");
    object['GambarHidung'] = H.tandaTangan().get("GambarHidung");
    object['GambarLeher'] = H.tandaTangan().get("GambarLeher");
...
const loadGambar = async (element_id: string, value: string) => {
    ...
    if (sigCanvas.id == "GambarTelinga") {
        ...
        background.onload = function () {
            context.drawImage(background, 0, 0, 570, 150);
        }
    }
    else if (sigCanvas.id == "GambarTenggorok") {
        let context = sigCanvas.getContext("2d");
        context.clearRect(0, 0, sigCanvas.width, sigCanvas.height);
        let imagess = value
        let background = new Image();
        background.src = imagess
        background.onload = function () {
            context.drawImage(background, 0, 0, 520, 300);
        }
    }
    else if (sigCanvas.id == "GambarHidung") {
        let context = sigCanvas.getContext("2d");
        context.clearRect(0, 0, sigCanvas.width, sigCanvas.height);
        let imagess = value
        let background = new Image();
        background.src = imagess
        background.onload = function () {
            context.drawImage(background, 0, 0, 520, 500);
        }
    }
    else if (sigCanvas.id == "GambarLeher") {
        let context = sigCanvas.getContext("2d");
        context.clearRect(0, 0, sigCanvas.width, sigCanvas.height);
        let imagess = value
        let background = new Image();
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header" style="margin-bottom: 10px">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Asesmen Awal Medis Penyakit THT-KL</h3>
                        </div>
                        <div class="right">
                            <div class="buttons">
                ...
                <div class="columns is-multiline p-2">
                    ...
                    <div class="column is-12">
                        <Fieldset :toggleable="true" legend="Pemeriksaan Khusus THT">
                            <div class="columns is-multiline" style="overflow: auto;">
                                <div class="column is-5">
                                    <div class="column">
                                        <label style="font-weight:bold;font-size: large">Telinga</label>
                                    </div>
                                    <Gambarin elemenID="GambarTelinga" height="150" width="570"
                                        imageSrc="/images/simrs/AAM_PenyakitTHT_Telinga.png" />
                                </div>
                                <div class="column is-2"></div>
                                <div class="column is-5">
                                    <div class="column">
                                        <label style="font-weight:bold;font-size: large">Tenggorok</label>
                                    </div>
                                    <Gambarin elemenID="GambarTenggorok" height="300" width="520"
                                        imageSrc="/images/simrs/AAM_PenyakitTHT_Tenggorok.png" />
                                </div>
                                <div class="column is-5">
                                    <div class="column">
                                        <label style="font-weight:bold;font-size: large">Hidung</label>
                                    </div>
                                    <Gambarin elemenID="GambarHidung" height="500" width="520"
                                        imageSrc="/images/simrs/AAM_PenyakitTHT_Hidung.png" />
                                </div>
                                <div class="column is-2"></div>
                                <div class="column is-5">
                                    <div class="column">
                                        <label style="font-weight:bold;font-size: large">Leher</label>
                                    </div>
                                    <Gambarin elemenID="GambarLeher" height="500" width="500"
                                        imageSrc="/images/simrs/AAM_PenyakitTHT_Leher.png" />
                                </div>
                                <div class="column is-12">
                                    <div class="column is-12" style="font-weight:bold">Tes Fungsi Pendengaran</div>
                                    <div class="column is-12">
                                        <label>a. Tes Suara Bisik</label>
                                        <VField>
                                            <VTextarea rows="2" v-model="input.TATesSuaraBisik"></VTextarea>
                                        </VField>
                                    </div>
                                    <div class="column is-12">
                                        <label>b. Tes Garpu Tala</label>
                                        <table class="tg">
                                            <thead>
                                                <tr>
                                                    <th width="33%"></th>
                                                    <th width="33%">Telinga Kiri</th>
                                                    <th width="33%">Telinga Kanan</th>
                                                </tr>
                                            </thead>
                                            <tr>
                                                <td
                                                    style="font-weight:bold;text-align:center;vertical-align:middle;font-size: large">
                                                    Rinne
                                                </td>
                                                <td>
                                                    <VField>
                                                        <VTextarea rows="2" v-model="input.TARinneTelinganKiri">
                                                        </VTextarea>
                                                    </VField>
                                                </td>
                                                <td>
                                                    <VField>
                                                        <VTextarea rows="2" v-model="input.TARinneTelinganKanan">
                                                        </VTextarea>
                                                    </VField>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <VField>
                                                        <VTextarea rows="2" v-model="input.TAWeberTelinganKiri">
                                                        </VTextarea>
                                                    </VField>
                                                </td>
                                                <td>
                                                    <VField>
                                                        <VTextarea rows="2" v-model="input.TAWeberTelinganKanan">
                                                        </VTextarea>
                                                    </VField>
                                                </td>
                                            </tr>
