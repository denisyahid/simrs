      ...
      <div class="form-outer" style="margin-top:15px">
        <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
          <div class="form-header-inner">
            <div class="left">
              <h3>Edukasi Pasien Untuk Persiapan Kolonoskopi Dengan Lokal Anastesi Dengan Obat Niflec Tindakan Pagi</h3>
            </div>
            <div class="right">
          ...
          <table style="width: 100% !important;border-collapse: collapse !important;">
            ...
            <tr>
              ...
              <td>
                ...
                - Makan bubur tanpa serat/bubur tanpa sayur dan daging(tahu,tempe dan telur boleh)pada pagi,siang dan sore hari sampai dengan pukul 18.00<br>
                ...
                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Tuangkan larutan Niflec setengah takar dengan dengan 1000ml air putih minum sedikit demi sedikit (1 gelas tiap 15 menit) sampai habis 5 gelas dalam 1 jam
                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Buang air besar yang pertama kali biasanya terjadi setelah sekitar 1 jam dari saat awal minum larutan Niflec
            ...
            <tr>
              ...
              <td>
                ...
                Pemberian obat fleet enema/fozen enema pukul 06.00<br>
            ...
            <tr>
              ...
              <td>9. Pasien bisa minum air putih sampai tindakan dan tidak memakai aksesoris (perhiasan atau kutex) saat tindakan</td>
              <td>
                <VField>
...
useHead({ title: 'Edukasi Pasien Untuk Persiapan Kolonoskopi Dengan Lokal Anastesi Dengan Obat Niflec Tindakan Pagi - ' + import.meta.env.VITE_PROJECT })
