<template>
  <div class="form-layout is-stacked-2">
    <div class="form-outer" style="margin-top:15px">
      ...
      <hr>
      <h1 class="p-2">Saya yang bertanda-tangan di bawah ini :</h1>
      ...
      <div class="column is-12 is-flex">
        ...
        <div class="column is-10">
          <VField>
            <VControl>
              <VInput v-model="input.alamatSayTTD" class="input" type="text" />
            </VControl>
          </VField>
        </div>
      </div>
      <div class="column is-12 is-flex">
        ...
        <div class="column is-10">
          <VField>
            <VControl>
              <VInput v-model="input.kartuIdentitasSaya" class="input" type="text" disabled />
            </VControl>
          </VField>
        </div>
      </div>

      <div class="columns column is-multiline is-12">
        <h1 class="ml-2 pt-3">Dengan ini menyatakan </h1>
        <VField class="p-0">
          <VControl>
            <VCheckbox true-value="Setuju" v-model="input.pernyataan" label="Setuju" />
          </VControl>
        </VField>

        <VField class="p-0">
          <VControl>
            <VCheckbox true-value="Menolak" v-model="input.pernyataan" label="Menolak" />
          </VControl>
        </VField>

        <h1 class="pt-3">atas penjelasan yang diberikan oleh petugas UPTD.RSUD Bali Mandara </h1>
        <h1 class="pl-2">Provinsi Bali berupa:</h1>
      </div>

      <div class="p-0 is-flex">
        <VControl>
          <VCheckbox v-model="input.berupa" true-value="Asuransi BPJS Kesehatan sebagai penanggung pelayanan" />
          <span>Hanya menggunakan <span style="font-weight: bold;">Asuransi BPJS Kesehatan</span> sebagai <span
              style="font-weight: bold;">penanggung pelayanan</span></span>
        </VControl>
      </div>

      <div class="column p-0 is-multiline">
        <div class="column columns is-multiline">
          <VControl>
            <VCheckbox v-model="input.berupa" true-value="Memiliki Asuransi selain BPJS Kesehatan yaitu Asuransi" />
            <span>Memiliki Asuransi selain BPJS Kesehatan yaitu Asuransi</span>
          </VControl>
          <VControl class="ml-2">
            <VInput v-model="input.asuransiLain" placeholder="Asuransi Lain" />
          </VControl>
          <div class="column">
            <span style="font-weight: bold;">TIDAK </span>
            <span>diperbolehkan melakukan Reiumberse Klaim</span>
          </div>
          <p style="margin-left: 10.5vh;">terhadap Asuransi lain tersebut jika status Pasien <span style="font-weight: bold;">Pasien Sesuai Hak Kelas Asuransi BPJS Kesehatan.</span></p>
        </div>
      </div>

      <div class="p-0 is-flex">
        <VControl>
          <VCheckbox v-model="input.berupa" true-value="Lainnya" />
        </VControl>
        <div class="is-12">
          <VControl>
      ...
      <div class="is-12 column columns is-multiline">
        <h1 class="p-2">Selaku Diri Saya</h1>
        <VField class="p-0">
          <VControl>
            <VCheckbox true-value="Istri" v-model="input.hubunganPasien" label="Istri" />
          </VControl>
        </VField>

        <VField class="p-0">
          <VControl>
            <VCheckbox true-value="Suami" v-model="input.hubunganPasien" label="Suami" />
          </VControl>
        </VField>

        <VField class="p-0">
          <VControl>
            <VCheckbox true-value="Anak" v-model="input.hubunganPasien" label="Anak" />
          </VControl>
        </VField>

        <VField class="p-0">
          <VControl>
            <VCheckbox true-value="Ayah" v-model="input.hubunganPasien" label="Ayah" />
          </VControl>
        </VField>

        <VField class="p-0">
          <VControl>
            <VCheckbox true-value="Ibu" v-model="input.hubunganPasien" label="Ibu" />
          </VControl>
        </VField>

        <VField class="p-0">
          <VControl>
            <VCheckbox true-value="Lainnya" v-model="input.hubunganPasien" label="Lainnya" />
          </VControl>
        </VField>
        ...
        <h1 style="font-weight: bold;" class="p-2">Saya*, dengan identitas pasien :</h1>
      </div>
      ...
      <div class="column is-12 is-flex pt-0">
        ...
        <div class="column is-10">
          <VField>
            <VControl>
              <VTextarea v-model="input.diagnosaPasien" class="input" type="text" />
            </VControl>
          </VField>
        </div>
      </div>

      <h1 class="p-2">Demikian surat pernyataan persetujuan ini saya buat dengan penuh kesadaran dan tanpa adanya
        paksaan</h1>
...
const COLLECTION: any = ref('SuratPernyataan') //table mongodb
