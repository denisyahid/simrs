        ...
        <div class="column is-12">
            <VCard>
                <div class="columns is-multiline">
                    ...
                    <div class="column is-12">
                        <Fieldset class="p-fieldsets" legend="PERSETUJUAN TINDAKAN & PENGOBATAN BERESIKO TINGGI"
                            :toggleable="true">
                            <div class="column is-12">
...
import * as EMR from '../page-emr-plugins/informed-tindakan-pengobatan'
...
const COLLECTION: any = ref('InformedConsentTindakanPengobatan') //table mongodb
