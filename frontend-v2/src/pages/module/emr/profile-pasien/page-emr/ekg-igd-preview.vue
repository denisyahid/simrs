...
useHead({
  title: 'EKG IGD - ' + import.meta.env.VITE_PROJECT,
})
...
const loadRiwayat = () => {
  ...
  useApi().get(`/emr/berkas-pasien?nocm=${props.pasien.nocm}&noregistrasi=${props.registrasi.noregistrasi}&dokumen=EKG`).then((response: any) => {
