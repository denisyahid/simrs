                    ...
                    <div class="column is-12">
                        <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-8" style="margin-top: -2rems;">
                                    <VField>
                                        <VControl>
                                            <VRadio v-model="input.Nuase" value="Ya" label="Nuase (D.0076)"
                                                name="Nuase" color="info" square style="font-size: 15px" />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Diagnosa Keperawatan">
                                ...
                                <div class="column is-12">
                                    <h1> Perasaan tidak nyaman pada bagian belakang tenggorok atau lambung yang dapat mengakibatkan muntah
                                    </h1>
                                </div>
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Perencanaan Keperawatan">
                                ...
                                <div class="column is-12 p-0">
                                    ...
                                    <div class="is-flex">
                                        <div class="column is-6" style="margin-top:0.5rem">
                                            <h1> mual tidak terjadi dengan </h1>
                                        </div>
                                        <div class="column is-6" style="margin-left: -5rem;">
                                            <VField>
                                                <VControl>
...
import * as EMR from '../page-emr-plugins/nuase'
...
const COLLECTION: any = ref('Nuase') //table mongodb
