                    ...
                    <div class="column is-12">
                        <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-8" style="margin-top: -1rem;">
                                    <VField>
                                        <VControl>
                                            <VRadio v-model="input.Hipertermia" value="Ya" label="Hipertermia (D.0130)"
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Diagnosa Keperawatan">
                                ...
                                <div class="column is-12">
                                    <h1> Suhu tubuh meningkat diatas rentang normal tubuh
                                    </h1>
                                </div>
                                ...
                                <div class="column is-12">
                                    ...
                                    <div class="column is-12 p-0">
                                        ...
                                        <div class="column is-12 p-0">
                                            <div class="is-flex">
                                                <div class="column is-6" style="margin-top:0.5rem">
                                                    <h1> diharapkan hipertemia teratasi ditandai dengan </h1>
                                                </div>
                                                <div class="column is-6" style="margin-left: -5rem;">
                                                    <VField>
                                                        <VControl>
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Rencana Tindakan">
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Perawatan Demam:</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in perawatanDemam">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.value"
                                                        :label="data.title" class="p-0" color="primary" square />
...
import * as EMR from '../page-emr-plugins/hipertemia'
...
let perawatanDemam = ref(EMR.perawatanDemam())
...
const COLLECTION: any = ref('Hipertemia') //table mongodb
