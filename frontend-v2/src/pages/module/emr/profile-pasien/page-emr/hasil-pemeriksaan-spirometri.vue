...
useHead({
    title: 'Hasil Pemeriksaan Spirometri - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('HasilPemeriksaanSpirometri') //table mongodb
...
const simpan = () => {
    ...
    let json = {
        ...
        'url_form': route.name,
        'name_form': 'Hasil Pemeriksaan Spirometri',
    ...
    <div>
        <div class="form-layout is-stacked-2">
            <div class="form-outer" style="margin-top:15px">
                ...
                <div class="columns is-multiline column is-12">
                    ...
                    <div class="column is-6">
                        <div class="column is-12">
                            <VField label="NRM">
                                <VControl>
                                    <VInput type="text" class="input" v-model="input.TBNomorRMPasien" />
                                </VControl>
                            </VField>
                        </div>
                ...
                <div class="columns is-multiline column is-12">
                    <div class="column is-12" style="font-weight: bold;font-size: large;">Hasil Pemeriksaan :</div>
