    ...
    <div class="form-outer" style="margin-top: 15px">
      <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
        <div class="form-header-inner">
          <div class="left">
            <h3>Surat Permintaan Dirawat</h3>
          </div>
          <div class="right">
            <div class="buttons">
              <ButtonEmr :NOREC_EMRPASIEN="NOREC_EMRPASIEN" :COLLECTION="COLLECTION" :isLoading="isLoading"
                @simpan="simpan" @kembaliKeun="kembaliKeun" :noreg="props.registrasi.noregistrasi" isHideST></ButtonEmr>
            </div>
          </div>
        </div>
      </div>
...
const COLLECTION: any = ref('SuratPermintaanDirawat') //table mongodb
...
const setView = () => {
  useHead({
    title: 'Surat Permintaan Dirawat' + ' - ' + import.meta.env.VITE_PROJECT,
  })
...
const simpan = () => {
  ...
  let json = {
    ...
    url_form: route.name,
    name_form: 'Surat Permintaan Dirawat',
