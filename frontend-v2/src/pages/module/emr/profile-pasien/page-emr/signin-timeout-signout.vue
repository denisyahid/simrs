        ...
        <VCard>
            <div class="column is-12">
                <Fieldset :toggleable="true" legend="SIGN IN (Sebelum Pembiusan)">
                    <div class="column is-12">
                        <h1 style="font-weight: bold; margin-bottom: 0.5rem;">Dari</h1>
                        <div class="columns is-multiline pt-3 pl-3">

                            <div class="column is-3" v-for="(data, i) in dari">
                                <VField>
            ...
            <div class="column is-12">
                <Fieldset :toggleable="true" legend="TIME OUT (Setelah dibius sesaat sebelum sayatan kulit)">
                    ...
                    <div class="column is-12">
                        ...
                        <div class="columns is-multiline">
                            <div class="column is-4">
                                <h1 style="font-weight: bold; margin-bottom: 0.5rem;"> Antibiotika profilaksis yang
                                    diberikan </h1>
                                <VField>
                                    <VControl>
                            ...
                            <div class="column is-4">
                                ...
                                <VField>
                                    <VControl>
                                        <VInput type="text" class="input" placeholder="Nama Pasien" v-model="input.dosis" />
                                    </VControl>
                                </VField>
                            </div>
                            <div class="column is-4">
                                ...
                                <VField>
                                    <VControl>
                                        <VInput type="text" class="input" placeholder="Jam" v-model="input.jamPemberian" />
                                    </VControl>
                                </VField>
                            </div>
                        ...
                        <div class="column is-12" v-for="(datas, i) in radiologi">
                            <h1 style="font-weight: bold; margin-bottom: 1rem;">{{ datas.title }}</h1>
                            <div class="columns is-multiline">
                                <div class="column is-5" v-for="(data, b) in datas.value">
                                    <VField v-if="data.type == 'checkBox'">
                                        <VControl raw subcontrol>
                                            <VCheckbox v-model="input[data.model + b]" :true-value="data.subTitle"
                                                :label="data.subTitle" class="p-0" color="primary" square />
            ...
            <div class="column is-12">
                <Fieldset :toggleable="true" legend="SIGN OUT (Setelah selesai operasi dan sebelum penutupan luka)">
...
import * as EMR from '../page-emr-plugins/signin-timeout-signout'
...
let dari = ref(EMR.dari())
let radiologi = ref(EMR.radiologi())
