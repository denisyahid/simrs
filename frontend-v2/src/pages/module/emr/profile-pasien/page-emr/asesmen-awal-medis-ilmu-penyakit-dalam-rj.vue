...
// Judul
useHead({
    title: 'Asesmen Awal Medis Ilmu Penyakit Dalam Rawat Jalan - ' + import.meta.env.VITE_PROJECT,
})
...
const COLLECTION: any = ref('AsesmenAwalMedisIlmuPenyakitDalamRJ') //table mongodb
            ...
            <div class="form-outer" style="margin-top:15px">
                <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header" style="margin-bottom: 10px">
                    <div class="form-header-inner">
                        <div class="left">
                            <h3>Asesmen Awal Medis Ilmu Penyakit Dalam Rawat Jalan</h3>
                        </div>
                        <div class="right">
                            <div class="buttons">
                ...
                <div class="columns is-multiline p-2">
                    ...
                    <div class="column is-12 columns" style="overflow: auto;text-align: center;">
                        <div class="column is-5">
                            <Gambarin elemenID="GambarParu" height="680" width="680"
                                imageSrc="/images/simrs/paru-paru.jpeg" />
                        </div>
                        <div class="column is-2"></div>
                        <div class="column is-5">
                            <Gambarin elemenID="GambarPerut" height="680" width="680"
                                imageSrc="/images/simrs/perut.jpeg" />
                        </div>
                    </div>
                    <div class="column is-12">
