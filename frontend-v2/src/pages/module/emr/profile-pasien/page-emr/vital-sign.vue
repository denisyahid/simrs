                        ...
                        <div class="column is-6">
                            <UIWidget class="calendar-widget" v-for="(items, index) in filteredList" :key="items.id">
                                ...
                                <template #body>
                                    ...
                                    <VTag rounded :label="H.formatDateIndoSimple(items.tanggal)" outlined
        ...
        <VCard :style="{height: '25vw'}">
            <div class="columns is-multiline">
                ...
                <div class="column is-3">
                    ...
                    <VField addons>
                        <VControl expanded>
                            <VInput type="text" class="input" placeholder="RR" v-model="input.pernapasan"
                                :tabindex="6" />
                        </VControl>
                        <VControl class="field-addon-body">
                            <VButton static>x/menit</VButton>
                ...
                <div class="column is-3">
                    <VField label="SaO2"></VField>
                    <VField addons>
                        <VControl expanded>
                            <VInput type="text" class="input" placeholder="SaO2" v-model="input.SPO2" :tabindex="7" />
                        </VControl>
                        <VControl class="field-addon-body">
                ...
                <div class="column is-12">
                    ...
                    <div class="columns is-multiline">
                      ...
                      <div class="column is-3" v-if="input?.SkalaNyeri">
                          <Multiselect v-model="input.SkorSkalaNyeri" :attrs="{ label }" placeholder="--Pilih--"
                              label="label" :options="d_skorskalanyeri" :searchable="true" track-by="label" mode="single"
                              autocomplete="off" >
                          </Multiselect>
                      </div>
                    </div>
