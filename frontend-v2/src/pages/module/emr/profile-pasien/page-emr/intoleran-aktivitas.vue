            ...
            <VCard>
                <div class="columns is-multiline">
                    <div class="column is-12">
                        <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-6 pl-5">
                                    <VField>
                                        <VDatePicker v-model="input.tanggalIntoleransi" mode="dateTime" style="width: 100%"
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Diagnosa Keperawatan">
                                <div class="column is-4" style="margin-top: -1rem;">
                                        <VField>
                                            <VControl>
                                                <VRadio v-model="input.intoleransiTeratasi" value="Ya"
                                                    label="Intoleransi aktivitas (D.0056)" name="intoleranAktivitas"
                                ...
                                <div class="column is-12">
                                    <h1> Definisi : ketidakcukupan energi untuk melakukan aktivitas sehari-hari </h1>
                                </div>
                                ...
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Kondisi Klinis:</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-3" v-for="(data, i) in kondisiKlinis">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.title"
                                                        :label="data.title" class="p-0" color="primary" square />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Rencana Keperawatan">

                                <h1 class="pl-3" style="font-weight: bold;">Tujuan</h1>
                                <div class="column is-12 p-0">
                                    ...
                                    <div class="column is-4" style="margin-top: -1rem;">
                                        <VField>
                                            <VControl>
                                                <VRadio v-model="input.intoleransiTeratasi" value="Ya"
                                                    label="Intoleransi aktivitas teratasi dengan" name="intoleran"
                                                    color="info" square style="font-size: 15px" />
                        ...
                        <div class="column is-12">
                            <Fieldset :toggleable="true" legend="Rencana Tindakan">
                                ...
                                <div class="column is-12">
                                    <h1 style="font-weight: bold;">Manajemen Energi:</h1>
                                    <div class="columns is-multiline pt-3 pl-3">
                                        <div class="column is-12" v-for="(data, i) in manajemenEnergi">
                                            <VField>
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input[data.model + i]" :true-value="data.title"
                                                        :label="data.title" class="p-0" color="primary" square />
...
import * as EMR from '../page-emr-plugins/intoleran-aktivitas'
...
let manajemenEnergi = ref(EMR.manajemenEnergi())
...
const COLLECTION: any = ref('IntoleranAktivitas') //table mongodb
