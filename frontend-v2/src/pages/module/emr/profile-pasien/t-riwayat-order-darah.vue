      ...
      <div class="search-results-body ">
        ...
        <div class="page-placeholder">
          <div class="placeholder-content">
            <img class="light-image" style=" max-width: 340px;" src="/@src/assets/illustrations/placeholders/search-7.svg"
              alt="" />
          ...
          <div class="timeline-item is-unread " v-for="(item, index)  in props.items" :key="item.norec">
            ...
            <div class="content-wrap is-grey">
              <div class="content-box ">
                ...
                <VIconBox size="small" :color="'pink'" rounded>
                  ...
                  <div class="meta-text">
                    <table class="tb-order">
                      ...
                      <tr>
                        <td>Dokter</td>
                        <td>:</td>
                        <td class="text-value">Dokter</td>
                      </tr>
                      <tr>
                        <td>Golongan Darah</td>
                        <td>:</td>
                        <td class="text-value">{{ item.golongandarah }}</td>
                      </tr>
                      <tr>
                        <td>Qty</td>
                        <td>:</td>
                        <td class="text-value">{{ item.qty }}</td>
                      </tr>
                    </table>
                    <div class="is-divider p-0 m-2"></div>
                    <div v-for="(detail, index2) in  item.details">
                      <p><span class="status mt-1" style="position: absolute;"></span> <span class="ml-3"> {{
                        detail.namaproduk }}</span></p>
                    </div>
                  </div>
                </div>
                <div class="box-end" style="width:30%">
                  <div class="columns is-multiline">
                    <div class="column is-12 mt-3">
                      ...
                      <VTag :label="item.status" :color="item.color_status" rounded class="is-pulled-right" />
                    </div>
                    <div class="column is-12 ">
                      <VIconButton icon="feather:trash" @click="$emit('hapusItems', item)" color="danger" raised circle
                        class="mr-2 is-pulled-right" v-tooltip.bubble="'Hapus'">
                      </VIconButton>
                      <VIconButton icon="feather:edit" @click="$emit('editItems', item)" color="info" raised circle
                        class="mr-2 is-pulled-right" v-tooltip.bubble="'Edit'">
                      </VIconButton>
                      <VIconButton icon="feather:file-text" @click="$emit('hasilItems', item)" raised circle
                        class="mr-2 is-pulled-right" v-tooltip.bubble="'Hasil'">
                      </VIconButton>
                    </div>
                  </div>
                </div>
