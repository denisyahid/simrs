<template>
  <section>
                  ...
                  <div class="columns is-multiline">
                    ...
                    <div class="column " :class="hideRiwayat == true ? 'is-hidden' : 'is-3'">
                      <div class="account-box is-navigation">
                        <div class="account-menu">
                          <VCard class="h-900" style="padding: 5px 5px 5px 5px;">
                            ...
                            <div class="column is-12" style="margin-top: -30px;">
                              ...
                              <VButton class="tombol" raised @click="onTabFisio()"
                                v-if="selectedRegistrasi.norec != undefined && pasien && selectedRegistrasi.namaruangan.toUpperCase().indexOf('POLI FISIOTERAPI') > -1">
                                FORMULIR KEDOKTERAN FISIK DAN REHABILITASI
                              </VButton>
                              <VButton class="tombol" raised @click="onTabJadwalFisio()"
                    ...
                    <div class="column " :class="hideRiwayat == true ? 'is-12' : 'is-9'">
                      <div class="columns is-multiline">
                        ...
                        <div class="column is-12"
                          v-else-if="kelompokUser.toUpperCase().indexOf('GIZI') > -1 && selectedRegistrasi.namaruangan != null && selectedRegistrasi.namaruangan.toUpperCase().indexOf('') !== -1">
                          <TabMenu :model="[]" :scrollable="true" />
                          <div class="p-tabmenu-uy">
                            <div class="p-tabmenu p-component p-no-width">
                              <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar">
                        ...
                        <div class="column is-12"
                          v-else-if="kelompokUser.toUpperCase().indexOf('ADMISSION') > -1 && selectedRegistrasi.namaruangan != null">
                          <TabMenu :model="[]" :scrollable="true" />
                          <div class="p-tabmenu-uy">
                            <div class="p-tabmenu p-component p-no-width">
                              <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar">
                        ...
                        <div class="column is-12" v-else-if="kelompokUser.toUpperCase().indexOf('PERAWAT') > -1 && selectedRegistrasi.namaruangan != null && selectedRegistrasi.namaruangan.toUpperCase().indexOf('PERINATOLOGI') !== -1">
                          <TabMenu :model="[]" :scrollable="true" />
                          <div class="p-tabmenu-uy">
                            <div class="p-tabmenu p-component p-no-width">
                              <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar">
                              ...
                              <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar">
                                <li class="p-tabmenuitem"
                                  ...
                                  <a role="menuitem" class="p-menuitem-link" aria-label="Dashboard" tabindex="0"
                                    @click="timeoutPOK()">
                                    <span class="p-menuitem-icon fas fa-book-medical"></span>
                                    <span class="p-menuitem-text">Timeout Pemberian Obat Kemoterapi</span>
                                  </a>
                                </li>
                              </ul>
                              <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar">
                              ...
                              <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar">
                                <li class="p-tabmenuitem"
                                  ...
                                  <a role="menuitem" class="p-menuitem-link" aria-label="Dashboard" tabindex="0"
                                    ...
                                    <span class="p-menuitem-icon fas fa-book-medical"></span>
                                    <span class="p-menuitem-text">Catatan Kegiatan Radioterapi</span>
                                  </a>
                                </li>
                              </ul>
                              <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar">
                                ...
                                <li class="p-tabmenuitem"
                                  ...
                                  role="presentation"><a role="menuitem" class="p-menuitem-link" aria-label="Dashboard"
                                    tabindex="0" @click="pengkajianEWS()"><span
                                      class="p-menuitem-icon fas fa-book-medical"></span><span
                                      class="p-menuitem-text">Pengkajian EWS</span></a>
                                </li>
                              </ul>
                              <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar"
                                v-if="selectedRegistrasi.norec != undefined && pasien">
                        ...
                        <div class="column is-12" v-else-if="kelompokUser.toUpperCase().indexOf('DOKTER') > -1">
                          <TabMenu :model="[]" :scrollable="true" />
                          <div class="p-tabmenu-uy">
                            <div class="p-tabmenu p-component p-no-width">
                              <ul class="p-tabmenu-nav p-reset content-scroll" role="menubar">
                        ...
                        <div class="column is-12" v-else-if="kelompokUser.toUpperCase().indexOf('BEDAH') > -1">
                          <TabMenu :model="[]" :scrollable="true" />
                          <div class="p-tabmenu-uy">
                            <VIconButton @click="scrollLeft" icon="fas fa-angle-left" class="mr-1 mt-2" raised bold>
                            </VIconButton>
    ...
    <Dialog v-model:visible="modalBerkasDokter" modal header="Berkas Pasien" :style="{ width: '100rem' }"
      maximizable>
...
const setRoutingEMR = (form: any, norec_emr: any) => {
  ...
  // if (!form.startsWith('module-emr-profile-pasien-page-emr')) { form = 'module-emr-profile-pasien-page-emr-' + form }
  router.push({
    name: form,
    query: query,
    params: params
...
const onTabAsuhanObservasi2 = () => {
  ...
  TAB_URL.value = `module-emr-profile-pasien-page-emr-formulir-asuhan-keperawatan-dan-observasi-pasien-hemodialisa`
  TAB_ACTIVE.value = 'Asuhan Keperawatan Pasien Hemodialisis'
  TAB_ACTIVE_ROUTER.value = `module-emr-profile-pasien-page-emr-formulir-asuhan-keperawatan-dan-observasi-pasien-hemodialisa`
...
const onTabCatatanPemberianObat = () => {
  COLLECTION.value = 'Formulir Catatan Pemberian Obat Kemoterapi'
...
const persetujuanTindakanKedokteranSHK = () => {
  ...
  TAB_URL.value = `module-emr-profile-pasien-page-emr-persetujuan-tindakan-kedokteran-shk`
  TAB_ACTIVE.value = 'Persetujuan Tindakan Kedokteran'
  TAB_ACTIVE_ROUTER.value = `module-emr-profile-pasien-page-emr-persetujuan-tindakan-kedokteran-shk`
...
const monitoringPemberianObatKIV = () => {
  ...
  TAB_URL.value = `module-emr-profile-pasien-page-emr-monitoring-pemberian-obat-kemoterapi-intra-vena`
  TAB_ACTIVE.value = 'Monitoring Pemberian Obat Kemoterapi Intra Vena'
  TAB_ACTIVE_ROUTER.value = `module-emr-profile-pasien-page-emr-monitoring-pemberian-obat-kemoterapi-intra-vena`
...
const formulirPemantauanKateter = () => {
  ...
  TAB_URL.value = `module-emr-profile-pasien-page-emr-formulir-pemantauan-kateter-intravena-perifer`
  TAB_ACTIVE.value = 'Formulir Pemantauan Kateter Intravena Perifer'
  TAB_ACTIVE_ROUTER.value = `module-emr-profile-pasien-page-emr-formulir-pemantauan-kateter-intravena-perifer`
...
const onTabKeperawatanNeonatus = () => {
  COLLECTION.value = 'Assesmen Keperawatan Rawat Inap'
  TAB_URL.value = `module-emr-profile-pasien-page-emr-asesmen-awal-keperawatan-neonatus`
  TAB_ACTIVE.value = 'Assesmen Keperawatan Rawat Inap'
  TAB_ACTIVE_ROUTER.value = `module-emr-profile-pasien-page-emr-asesmen-awal-keperawatan-neonatus`
...
const onTabKunjunganVCT = async () => {
  ...
  TAB_ACTIVE.value = 'FormKunjunganVCT'
...
const onTabMedis = () => {
  ...
  } else if (selectedRegistrasi.value.namaruangan.toUpperCase().indexOf('INTERNA') > -1 || selectedRegistrasi.value.namaruangan.toUpperCase().indexOf('MEDICAL') > -1) {
...
const onTabRadiasi = () => {
  COLLECTION.value = 'Perencanaan Radiasi Eksterna'
