                ...
                <div class="columns is-multiline">
                    <div class="column is-12">
                        <VCard>
                            <div class="columns is-multiline">
                                <div class="column is-12">
                                    <h3 class="title is-5 mb-2 mr-1">Buku Kas Umum </h3>
                                </div>
                            ...
                            <VCard>
                                <div class="columns is-multiline">
                                    ...
                                    <div class="column is-12" v-else-if="dataPenerimaan.length > 0">
                                        <div class="columns is-multiline">
                                            <div class="column is-12">
                                                <DataTable :value="dataPenerimaan" class="p-datatable-sm"
                                                    :loading="dataPenerimaan.loading" :paginator="true" :rows="10"
                                                    ...
                                                    <template #header>
                                                        <div class="columns is-multiline">
                                                            <div class="column is-3">
                                                                <span> Saldo Awal : {{ H.formatRupiah(item.saldolama, 'Rp.') }} </span>
                                                    ...
                                                    <Column :exportable="false" header="#" style="min-width: 30px" frozen>
                                                    ...
                                                    <Column field="tglStruk" header="Tanggal" style="width: 200px;" />
                                                    <Column field="nobukti" header="No. Bukti" style="width: 200px;"
                                                        sortable />
                                                    <Column field="nohistori" header="No. Histori" style="width: 200px;"
                                                        sortable />
                                                    <Column field="penyetor" header="Penyetor" style="width: 200px;" />
                                                    <Column field="jenisTransaksi" header="Jenis Transaksi"
                                                        style="width: 200px;" />
                                                    <Column field="keterangan" header="Keterangan Transaksi"
                                                        style="width: 200px;" />
                                                    <Column field="debit" header="Penerimaan (Debit)" style="width: 200px; text-align: right;">
                                                        <template #body="slotProps">
                                                    ...
                                                    <Column field="saldo" header="Saldo" style="width: 200px; text-align: right;">
                                                        <template #body="slotProps">
                                                    ...
                                                    <ColumnGroup type="footer">
                                                        <Row>
                                                            <Column :footer="'SALDO AKHIR'" :colspan="2" />
...
const fetchDana = async () => {
    ...
    await useApi().get(`bendahara/buku-kas-pengeluaran${dari}${sampai}${nohistoris}${keterangan}`).then((response) => {
...
const fetchDropdown = () => {
    useApi().get(
        `/bendahara/get-list-bk`).then((response: any) => {
...
const exportExcel = () => {
    ...
    // Center the text in cell A1 (BUKU KAS UMUM)
    // worksheet.A1.s = { alignment: { horizontal: 'center', vertical: 'center' } };

    // Center the text in cell A2 (Empty cell under BUKU KAS UMUM)
