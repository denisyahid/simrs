  ...
  <div class="columns is-multiline">
    <VCard style="padding-bottom: 0px">
      <div class="column c-title pt-2 mb-5">
        <label class="title-page">Laporan Kunjungan</label>
      </div>
      <div class="column is-12">
        <DataTable :value="dataSource" class="p-datatable-sm" :loading="isPlaceLoad" :paginator="true" :rows="10"
          :rowsPerPageOptions="[5, 10, 25, 100 ]" scrollable
          paginatorTemplate="CurrentPageReport FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink RowsPerPageDropdown"
          responsiveLayout="stack" breakpoint="960px" sortMode="multiple"
          currentPageReportTemplate="Showing {first} to {last} of {totalRecords}" showGridlines
          v-model:filters="filters"
          :globalFilterFields="['namapasien', 'nocm', 'kelompokpasien', 'noantrian', 'namalengkap', 'kelompokpasien']"
          filterDisplay="menu">
            ...
            <div class="columns is-multiline pb-3">
              ...
              <div class="column is-11">
                <div class="columns is-multiline" style="justify-content: flex-end;">
                  ...
                  <div class="column is-2 pb-0" style="margin-top: -7px;">
                    <VField label="Pelaksana">
                      <VControl class="prime-auto">
                        <AutoComplete v-model="item.filterPelaksana" :suggestions="d_Pegawai" placeholder="Pelaksana..."
          ...
          <Column field="nohp" header="No HP" :sortable="true" style="min-width: 50px"></Column>
          ...
          <Column field="pelaksana" header="Pelaksana tindakan" :sortable="true" style="min-width: 100px"></Column>
...
const fetchData = async () => {
  ...
  let pelaksana = item.value.filterPelaksana ? `&pelaksana=${item.value.filterPelaksana.value}` : ''

  await useApi().get(`pelayanan/get-laporan-kunjungan?${tglAwal}${tglAkhir}${ruanganfk}${dokter}${nama}${kelompokpasienfk}${pelaksana}`).then((response: any) => {
...
const exportExcel = () => {
  ...
  remakeData.value = dataSource.value.map((e: any) => {
    return {
      ...
      Antrian: e.noantrian, NoHp: e.nohp, Tanggal: e.tglregistrasi,Jam: e.jamregis, Dokter: e.namalengkap, Ruangan: e.namaruangan,
      CaraBayar: e.kelompokpasien, NoSEP: e.nosep, Bayar: e.bayar, PelaksanaTindakan: e.pelaksana, Status: e.statuspasien,
    }
  })
