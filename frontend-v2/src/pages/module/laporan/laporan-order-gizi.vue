            ...
            <VCard>
                <div class="column c-title pt-2 mb-0">
                    <div class="column is-10 p-0">
                        <label class="title-page">Laporan Order Gizi</label>
                        <label for="">List Daftar Pasien Order Gizi</label>
                    </div>
                </div>
...
const fetchData = async () => {
    ...
    await useApi().get(`laporan/indikator-pelayanan-rs?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}`).then((response) => {
