     ...
     <div class="columns is-multiline">
      <VCard style="padding-bottom: 0px">
        <div class="column c-title pt-2 mb-5">
          <label class="title-page">Laporan Kunjungan Radiologi</label>
        </div>
        ...
        <DataTable :value="dataSource" class="p-datatable-sm" :loading="isPlaceLoad" :paginator="true"
          ...
          <template #header>
            <div class="columns is-multiline pb-3">
             ...
             <Column field="jeniskelamin" header="Jenis Kelamin"  style="min-width: 50px"></Column>
             <Column field="umur" header="Umur"  style="min-width: 50px"></Column>
            <Column field="namaproduk" header="Nama Tindakan"  style="min-width: 50px"></Column>
            <Column field="catatanklinis" header="Catatan Klinis"  style="min-width: 50px"></Column>
            <Column field="namadokterpengirim" header="Nama Dokter Pengirim"  style="min-width: 50px"></Column>
            <Column field="namaruanganpengorder" header="Nama Ruangan Peng Order"  style="min-width: 50px"></Column>
            <Column field="kelompokpasien" header="Cara Bayar"  style="min-width: 50px"></Column>
        </DataTable>
        </div>
      </VCard>
     </div>
...
const fetchData = async () => {
  ...
  await useApi().get(`laporan/radiologi/laporan-rekap-kunjungan-radiologi?${tglAwal}${tglAkhir}`).then((response: any) => {
...
const exportExcel = () => {
  ...
  remakeData.value = dataSource.value.map((e: any) => {
    return {
      ...
      Catatan_Klinis: e.catatanklinis,
      Nama_Dokter_Pengirim: e.namadokterpengirim,
      Ruangan_Peng_Order: e.namaruanganpengorder,
      Cara_Pembayaran: e.kelompokpasien,
    }
  })
