  ...
  <div class="columns is-multiline">
    <VCard style="padding-bottom: 0px">
      <div class="column c-title pt-2 mb-5">
        <label class="title-page">Laporan Kuantitas Antimikroba</label>
      </div>
      ...
      <div class="column is-12">
        ...
        <template #header>
          ...
          <div v-if="item.status.value === 'ranap'">
              <Column field="no" :sortable="true" style="width: 30px">
                <template #header>
              ...
              <Column field="namapasien" :sortable="true" style="min-width: 100px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    Nama Pasien
                  </div>
              ...
              <Column field="nocm" :sortable="true" style="min-width:50px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    No Rm 
                  </div>
              ...
              <Column field="namaproduk" :sortable="true" style="min-width: 200px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    Nama Produk
                  </div>
              ...
              <Column field="jumlah" :sortable="true" style="width: 30px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    Jumlah
                  </div>
              ...
              <Column field="namagenerik" :sortable="true" style="min-width: 80px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    Nama Antimikroba
                  </div>
              ...
              <Column field="DiagnosaTindakan" :sortable="true" style="min-width: 80px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    Diagnosa / Tindakan
                  </div>
                ...
                <template #body="{ data }">
                  <div style="text-align: center;">
                    {{ data.diagnosatindakan }}
                  </div>
                </template>
              </Column>
              <Column field="tglregistrasi" :sortable="true" style="width: 80px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    Tanggal Masuk
                  </div>
              ...
              <Column field="tglpulang" :sortable="true" style="width: 80px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    Tanggal Pulang
                  </div>
              ...
              <Column field="antibiotik" :sortable="true" style="min-width: 80px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    Profilaksis/Empiris/Definitif
                  </div>
                </template>
                <template #body="{ data }">
                  <div style="text-align: center;">
          ...
          <div v-if="item.status.value === 'rajal'">
              <Column field="no" :sortable="true" style="width: 30px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    No
              ...
              <Column field="namaruangan" :sortable="true" style="min-width: 100px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    Nama Ruangan
                  </div>
              ...
              <Column field="totalpasien" :sortable="true" style="min-width:50px">
                <template #header>
                  <div style="text-align: center;width: 100%; margin-left:15px">
                    Jumlah Pasien 
                  </div>
...
const item: any = ref({
  ...
  status : { label: "Rawat Inap", value: "ranap" },
})
...
const fetchData = async () => {
  ...
  await useApi().get(`pelayanan/get-laporan-kuantitas-antimikroba?${tglAwal}${tglAkhir}${status}`).then((response: any) => {
...
const exportExcel = () => {
  if(item.value.status.value === 'ranap')
  {
      ...
      return {
        ...
        DiagnosaTindakan: e.diagnosatindakan, 
        TglRegistrasi: e.tglregistrasi, 
        TglPulang : e.tglpulang, 
        Antibiotik : e.antibiotik,
      }
    })
...
watch(() => item.value.status, (newVal, oldVal) => {
  console.log('Status berubah dari', oldVal, 'menjadi', newVal);
  fetchData();
});
