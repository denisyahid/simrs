...
<template>
    <div class="columns is-multiline">
      <VCard style="padding-bottom: 0px">
        <div class="column c-title pt-2 mb-5">
          <label class="title-page">Laporan Pelayanan Resep</label>
        </div>
        <div class="column is-12">
          ...
          <template #header>
            <div class="columns is-multiline pb-3">
              ...
              <Column field="namaruangan" header="Asal Ruangan" frozen :sortable="true" style="min-width: 150px"></Column>
              <Column field="kelompokpasien" header="Jenis Pasien" :sortable="true" style="min-width: 150px"></Column>
              <Column field="resepracikan" header="Resep Racikan" :sortable="true" style="min-width: 100px"></Column>
              <Column field="resepnonracikan" header="Resep Non Racikan" :sortable="true" style="min-width: 100px"></Column>
              <Column field="totalresep" header="Total Resep" :sortable="true" style="min-width: 100px"></Column>
              <Column field="generik" header="Generik" :sortable="true" style="min-width: 100px"></Column>
              <Column field="nongenerik" header="Non Generik" :sortable="true" style="min-width: 100px"></Column>
              <Column field="totalitem" header="Total Item" :sortable="true" style="min-width: 100px"></Column>
          </DataTable>
        </div>
      </VCard>
    </div>
  ...
  useHead({
    title: 'Laporan Penjualan Per Resep - ' + import.meta.env.VITE_PROJECT,
  })
  ...
  const fetchData = async () => {
    ...
    await useApi().get(`pelayanan/get-laporan-pelayanan-resep?${tglAwal}${tglAkhir}${ruanganfk}`).then((response: any) => {
  ...
  const exportExcel = () => {
    ...
    remakeData.value = dataSource.value.map((e: any) => {
      return {
        No : e.no, AsalRuangan : e.namaruangan, JenisPasien: e.kelompokpasien, ResepRacikan: e.resepracikan, ResepNonRacikan : e.resepnonracikan,
        TotalResep: e.totalresep, Generik: e.generik, NonGenerik : e.nongenerik, TotalItem : e.totalitem
      }
    })
