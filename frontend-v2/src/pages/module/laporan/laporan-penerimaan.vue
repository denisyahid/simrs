...
<template>
        ...
        <div class="column is-12">
          ...
          <template #header>
            <div class="columns is-multiline">
              ...
              <Column field="namarekanan" :sortable="true" style="min-width: 150px">
                <template #header>
                  <div style="text-align: center;width: 80%; margin-left:15px">
                    Nama Supplier
                  </div>
              ...
              <Column field="subtotal" :sortable="true" style="min-width: 150px">
                <template #header>
                  <div style="text-align: center;width: 80%; margin-left:15px">
                     Sub Total 
                  </div>
              ...
              <Column field="totalpembulatan" :sortable="true" style="min-width: 150px">
                <template #header>
                  <div style="text-align: center;width: 80%; margin-left:15px">
                    Total <br> Bulat
                  </div>
  ...
  useHead({
    title: 'Laporan Penerimaan Supplier - ' + import.meta.env.VITE_PROJECT,
  })
  ...
  const fetchData = async () => {
    ...
    await useApi().get(`pelayanan/get-laporan-penerimaan?${tglAwal}${tglAkhir}${nama}${status}`).then((response: any) => {
