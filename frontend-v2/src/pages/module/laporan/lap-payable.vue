        ...
        <div class="columns is-multiline">
            <div class="column is-3">
              <VCardCustom style="background-color: aliceblue;">
                <div :class="'label-cing'">
                  ...
                  <span class="ml-1"><b> Days Payable Turnover :  {{ parseFloat(item.days).toFixed(1) }} Days</b></span>
                </div>
            ...
            <div class="column is-3">
              <VCardCustom style="background-color: aliceblue;">
                <div :class="'label-cing'">
                  <i aria-hidden="true" class="fas fa-circle"></i>
                  <span class="ml-1"><b> Total Piutang Perusahaan :  {{ H.formatRupiah(parseFloat(item.totalTagihanALL).toFixed(2), 'Rp.') }}
            ...
            <div class="column is-3">
              <VCardCustom style="background-color: aliceblue;">
                <div :class="'label-cing'">
                  <i aria-hidden="true" class="fas fa-circle"></i>
                  <span class="ml-1"><b> Sisa Piutang Perusahaan :  {{ H.formatRupiah(parseFloat(item.sisahutangALL).toFixed(2), 'Rp.') }}
...
const title = 'Laporan Payable'
useHead({
  title: 'Laporan Payable - ' + import.meta.env.VITE_PROJECT,
})
...
const fetchData = async () => {
  ...
  await useApi()
    ...
    .then((response: any) => {
      ...
      let hasil = 0
      hasil = 365 / (item.sisahutangALL / (item.sisahutangALL / item.sisa))
