            ...
            <VCard>
                <div class="column c-title pt-2 mb-0">
                    <div class="column is-10 p-0">
                        ...
                        <label for="">REKAPITULASI PENGUNJUNG</label>
                    </div>
                </div>
                ...
                <DataTable v-else :rows="5" :value="dataSource" :loading="loadSearch" :rowsPerPageOptions="[5, 10, 15]"
                    ...
                    <Column field="jenispengunjung" style="min-width: 80px;" header="Jenis Pengunjung" />
...
const fetchData = async () => {
    ...
    await useApi().get(`/laporan/get-laporan-rekapitulasi-pengunjung?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}`).then((response) => {
...
const exportExcel = () => {
    ...
    XLSXStyle.writeFile(workbook, 'RL 3.4. Rekapitulasi pengunjung .xlsx');
}
