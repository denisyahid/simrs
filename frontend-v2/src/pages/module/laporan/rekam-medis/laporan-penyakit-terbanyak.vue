            ...
            <VCard>
                <div class="column c-title pt-2 mb-0">
                    <div class="column is-10 p-0">
                        <label for="">LAPORAN PENYAKIT TERBANYAK</label>
                    </div>
                </div>
                ...
                <DataTable v-else :rows="5" :value="dataSource" :loading="loadSearch" :rowsPerPageOptions="[5, 10, 15]"
                    ...
                    <Column field="kddiagnosa" header="Kode Diagnosa" />
                    <Column field="namadiagnosa" header="Nama Diagnosa" />
                    <Column field="jumlah" header="Jumlah" />
                    <Column field="jumlah07" header="Umur 0-7" />
                    <Column field="jumlah828" header="Umur 8-28" />
                    <Column field="jumlahkurang1" header="Umur < 1" />
                    <Column field="jumlah14" header="Umur 1-4" />
                    <Column field="jumlah59" header="Umur 5-9" />
                    <Column field="jumlah1014" header="Umur 10-14" />
                    <Column field="jumlah1519" header="Umur 15-19" />
                    <Column field="jumlah2044" header="Umur 20-44" />
                    <Column field="jumlah4554" header="Umur 45-54" />
                    <Column field="jumlah5559" header="Umur 55-59" />
                    <Column field="jumlah6069" header="Umur 60-69" />
                    <Column field="jumlah70" header="Umur 70" />
                </DataTable>
            </VCard>
        </div>
    </section>
...
const fetchData = async () => {
    ...
    await useApi().get(`laporan/penyakit-terbanyak?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}`).then((response) => {
...
const exportExcel = () => {
    ...
    const worksheet = XLSX.utils.aoa_to_sheet([
        ...
        [],
        ['KODE RS', 'KODE RS', 'KOTA', 'TAHUN', 'BOR', 'LOS','BTO','TOI','NDR','GDR','RATA-RATA KUNJUNGAN / HARI'],
