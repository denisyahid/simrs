            ...
            <VCard>
                <div class="column c-title pt-2 mb-0">
                    <div class="column is-10 p-0">
                        <label class="title-page">Formulir RL 3.9</label>
                        <label for="">REKAPITULASI KEGIATAN PELAYANAN RADIOLOGI</label>
                    </div>
                </div>
...
const exportExcel = () => {
    ...
    const worksheet = XLSX.utils.aoa_to_sheet([
        ['FORMULIR RL 3.9 - KEGIATAN RADIOLOGI'],
        [],
    ...
    XLSXStyle.writeFile(workbook, 'FORMULIR RL 3.9 - KEGIATAN RADIOLOGI.xlsx');
}
