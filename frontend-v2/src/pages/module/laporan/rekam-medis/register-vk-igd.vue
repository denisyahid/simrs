            ...
            <VCard>
                <div class="column c-title pt-2 mb-0">
                    <div class="column is-10 p-0">
                        <label for="">LAPORAN REGISTER VK IGD</label>
                    </div>
                </div>
                ...
                <DataTable v-else :rows="20" :value="dataSource" :loading="loadSearch" :rowsPerPageOptions="[5, 10, 20, 50]"
                    ...
                    <ColumnGroup type="header">
                        <Row>
                            ...
                            <Column header="Tanggal" :rowspan="2" style="min-width: 100px" :sortable="true"></Column>
                            <Column header="Jam" :rowspan="2" style="min-width: 100px" :sortable="true"></Column>
                            ...
                            <Column header="Kewarganegaraan" :rowspan="2" style="min-width: 180px"></Column>
                        </Row>
                        <Row>
...
useHead({
    title: 'Laporan Register VK IGD - ' + import.meta.env.VITE_PROJECT,
})
...
const fetchData = async () => {
    ...
    await useApi().get(`laporan/registrasi-vk-igd?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}${kelompokpasienfk}${dokterfk}${jeniskelaminfk}`).then((response) => {
...
const exportExcel = () => {
    ...
    XLSXStyle.writeFile(workbook, 'Laporan Register VK IGD.xlsx');
};
