            ...
            <VCard>
                <div class="column c-title pt-2 mb-0">
                    <div class="column is-10 p-0">
                        <label class="title-page">Formulir RL 3.13</label>
                        <label for="">PELAYANAN REHABILITASI MEDIK</label>
                    </div>
                </div>
...
useHead({
    title: 'PELAYANAN REHABILITASI MEDIK - ' + import.meta.env.VITE_PROJECT,
})
...
const fetchData = async () => {
    ...
    await useApi().get(`laporan/get-laporan-kegiatan-rehab-medik?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}`).then((response) => {
...
const exportExcel = () => {
    ...
    const worksheet = XLSX.utils.aoa_to_sheet([
        ['FORMULIR RL 3.13 - PELAYANAN REHABILITASI MEDIK'],
        [],
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'FORMULIR RL 3.9', true);
    XLSXStyle.writeFile(workbook, 'FORMULIR RL 3.13 - PELAYANAN REHABILITASI MEDIK.xlsx');
}
