            ...
            <VCard>
                <div class="column c-title pt-2 mb-0">
                    <div class="column is-10 p-0">
                        <label for="">LAPORAN DAFTAR PASIEN GROUP BY ICD TINDAKAN</label>
                    </div>
                </div>
                ...
                <DataTable v-else :rows="5" :value="dataSource" :loading="loadSearch" :rowsPerPageOptions="[5, 10, 15]"
                    ...
                    <Column field="tgltindakan" header="Tgl Tindakan" />
...
const fetchData = async () => {
    ...
    await useApi().get(`laporan/pasien-by-tindakan?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}`).then((response) => {
