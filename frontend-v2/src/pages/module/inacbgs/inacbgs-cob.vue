<template>
                          ...
                          <div class="column px-0">
                            <div class="columns is-multiline">
                              ...
                              <DataTable :value="dataSourcefiltered" class="p-datatable-md"
                                  ...
                                  <Column field="tgl_masuk" header="Tgl Masuk" style="min-width: 120px"></Column>
                                  ...
                                  <Column field="rujukanrs" header="Rujukan RS" style="min-width: 80px;"></Column>
                                  <Column field="penjaminanrs" header="Penjaminan Sebelumnya" style="min-width: 80px;"></Column>
                                  <Column field="riwayattambahan" header="Riwayat Tambahan" style="min-width: 80px;"></Column>
                                                  ...
                                                  <thead style="border-bottom: 1px solid #c7c8c9">
                                                      <tr>
                                                          ...
                                                          <td class="tg-0lax text-center" width="10%">
                                                              ...
                                                              <button type="button" aria-hidden="false" class="button is-outlined is-raised is-primary" @click="assmeddokter(slotProps.data)" v-if="slotProps.data.emrpasienfkasmed == true">
                                                                  <span style="color: blue;">Ada Data</span>
                                                              </button>
                                                          </td>
                                                          <td class="tg-0lax text-center" width="10%" style="display: none !important">Assesmen Keperawatan</td>
                                                          <td class="tg-0lax text-center" width="10%" style="display: none !important">
                                                          ...
                                                          <td class="tg-0lax text-center" width="10%">
                                                              ...
                                                              <button type="button" aria-hidden="false" class="button is-outlined is-raised is-primary" @click="cpptperawat(slotProps.data)" v-if="slotProps.data.emrpasienfkcpptperawat == true">
                                                                  <span style="color: blue;">Ada Data</span>
                                                              </button>
                                                          </td>
                                                      </tr>
  ...
  import InaCbgDetail from './inacbgs-detail-cob.vue'
  ...
  const fetchData = async () => {
      ...
      const response = await useApi().get(
          '/bridging/inacbgs-cob?dari=' + dari
          + '&sampai=' + sampai
          + '&search=' + search
          + '&ins=' + inst
          + '&ruang=' + ruang
  ...
  const assmeddokter = async (emrId) => {
    H.printBladeSelf(`emr/cetak/AsesmenMedisRawatJalan?emrpasienfk=${emrId.emrpasienfkassmed[0].emrpasienfk}&pdf=true&norec_pd=${emrId.norec}&nocmfk=${emrId.nocmfk}`);
  }

  const cpptdokter = async (emrId) => {
    console.log(emrId.emrpasienfkcppt[0].emrpasienfk);
    H.printBladeSelf(`emr/cetak/CatatanPerkembanganPasienTerintegrasi?emrpasienfk=${emrId.emrpasienfkcppt[0].emrpasienfk}&pdf=true&norec_pd=${emrId.norec}&flag=dokter&nocmfk=${emrId.nocmfk}`);
  }

  const cpptperawat = async (emrId) => {
    console.log(emrId.emrpasienfkcppt[0].emrpasienfk);
    H.printBladeSelf(`emr/cetak/CatatanPerkembanganPasienTerintegrasi?emrpasienfk=${emrId.emrpasienfkcppt[0].emrpasienfk}&pdf=true&norec_pd=${emrId.norec}&flag=perawat&nocmfk=${emrId.nocmfk}`);
  }
    ...
    useApi().get('/bridging/inacbgs/get-kunjungan-sebelumnya?nocmfk='+e.nocmfk+'&tglregistrasi='+e.tgl_masuk).then((x) => {
        ...
        if (x.data.length == 0) {
          ...
          return
            ...
            dataSource.value = []
            useApi().get(
                '/bridging/inacbgs-cob?dari=' +  H.formatDate(x.data[0].tglregistrasi, 'YYYY-MM-DD')
...
//   }
  ...
  const fetchDropdown = async () => {
      await useApi().get('/bridging/inacbgs/dropdown').then((r) => {
          ...
          item.qKelompok = r.idKelompokPasienCOB.map((e: any) => {
              return parseInt(e)
          })
      })
      fetchData()
