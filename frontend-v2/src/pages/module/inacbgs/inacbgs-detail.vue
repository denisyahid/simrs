<template>
  <section>
    ...
    <div class="form-layout is-stacked ">
        <!-- <div class="form-outer" style="margin-top:15px; margin-left: -150px; width: 1340px"> -->
        <div class="form-outer" style="margin-top:15px; width: 100%">
            <!-- <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header" style="position: fixed; background-color: white; width: 95%; z-index: 2; margin-top: -17px;"> -->
            <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header" style="background-color: white; width: 100%; z-index: 2; margin-top: -17px;">
            ...
            <div class="form-body p-2" style="margin-top: 30px">
        ...
        <VCard class="mt-2" style="margin-left: -150px; width: 1340px">
            <div class="columns is-multiline">
                            ...
                            <div class="form-sections-2">
                                            ...
                                            <div class="columns is-multiline">
                                                 ...
                                                 <div class="column is-3 mb-5-min">
                                                    ...
                                                    <div class="column is-3 mb-5-min">
                                                        <VDatePicker v-model="inacbg.tgl_pulang" mode="dateTime"
                                                            style="width: 100%;">
                                                            <template #default="{ inputValue, inputEvents }">
                                                                <VField>   <VLabel>Tanggal Pulang</VLabel>
                                                                    <VControl icon="feather:calendar" fullwidth>
                                                ...
                                                <div class="column is-6  mt-5">
                                                    <div class="form-section-inner">
                                                        <VField>
                                                            <VControl>
                                                                <button type="button" class="input-button" @click="showModalpersalinan()">
                                            ...
                                            <div class="columns is-multiline">
                                                ...
                                                <div class="column is-2" style="margin-top: 25px;">
                                                    <VField>
                                                        ...
                                                        <Multiselect mode="single" v-model="inacbg.dializer_single_use" :options="d_Dializer" class=" w-100"
                                                ...
                                                <div class="column is-2">
                                                    <VField>
                                                        <VLabel> </VLabel>
                                                        <VControl>
                                                            <VInput type="number" placeholder="Kantong Darah "
                                                                v-model="inacbg.kantong_darah" />
                                                        </VControl>
                                                    </VField>
                                                </div>
                                                <div class="column is-2">
                                                    <VButton type="button" style="margin-top:30px" rounded outlined color="danger" raised icon="feather:save" @click="simpanDializer()"
                                            ...
                                            <div class="columns is-multiline">
                                                    ...
                                                    <div class="column is-2">
                                                      ...
                                                      <div class="column is-10">
                                                        ...
                                                        <div class="column is-2">
                                                     <VButton type="button" rounded outlined color="danger" raised icon="feather:save" @click="simpanApgar()"
                                                        :loading="isLoading">  Simpan
                                                    </VButton>
                                ...
                                <Transition name="fade-slow">
                                      <div v-if="currentStep >= 3" id="form-step-3" class="form-section is-active">
                                          ...
                                          <div class="column is-12">
                                                <VField>
                                                    <VTextarea rows="2" v-model="item.TADiagnosa" disabled></VTextarea>
                                                </VField>
                                            </div>

                                          <!-- <div class="form-section-output" v-if="dataSourceXDokter.length > 0">
                                              <div class="output c-title" v-for="(items, index) in dataSourceXDokter" :key="index" style="height: 40px;">
                                                <i aria-hidden="true" class="iconify" data-icon="feather:archive"></i>
                                          ...
                                          <div class="form-section-output" v-if="dataSourceIXDokter.length > 0" style="margin-top: 50px;">
                                              <div class="output c-title" v-for="(items, index) in dataSourceIXDokter" :key="index" style="height: 40px;">
                                                  <i aria-hidden="true" class="iconify" data-icon="feather:archive"></i>
                                        ...
                                        <div class="columns is-multiline">
                                            <div class="column is-6 ">
                                                ...
                                                <div class="form-section-inner">
                                                    ...
                                                    <VField label="Diagnosis ICD 10 UNU" class="is-rounded-select  is-autocomplete-select" v-slot="{ id }">
                                                        <VControl icon="lnir lnir-diagnosis" fullwidth class="prime-auto-select">
                                                            <AutoComplete v-model="item.diagnosa10" :suggestions="d_Diagnosa"
                                                                @complete="fetchDiagnosa10INA($event)" :optionLabel="'label'" :dropdown="true" :minLength="3"
                                                ...
                                                <div class="form-section-output" v-if="dataSourceX.length > 0">
                                                    ...
                                                    <i aria-hidden="true" class="iconify" data-icon="feather:archive"></i>
                                                        ...
                                                        <span> &nbsp ICD10: {{ items.kddiagnosa + " - " + items.namadiagnosa }}</span>
                                                        <span class="txt-ina">{{ items.jenisdiagnosa }}</span>
                                                        <div class="action is-pulled-right" v-if="!item.DETAIL && (items.jenisdiagnosa == 'Secondary' || items.jenisdiagnosa == 'Secondary INA')">
                                                        ...
                                                        <VButton type="button" rounded outlined color="danger" raised icon="feather:arrow-down" v-if="items.objectjenisdiagnosaklaimfk != 1 && items.objectjenisdiagnosaklaimfk != 7"
                                                            class="is-pulled-right"   :loading="isLoadingBatal" @click="setPrimary(items)"> Set Primary
                                                        </VButton>
                                                ...
                                                <div class="form-section-inner mt-5">
                                                    ...
                                                    <VField label="Diagnosis ICD 9 UNU" class="is-rounded-select  is-autocomplete-select" v-slot="{ id }">
                                                        <VControl icon="lnir lnir-diagnosis" fullwidth class="prime-auto-select">
                                                            <AutoComplete v-model="item.diagnosa9" :suggestions="d_Diagnosa9"
                                                                @complete="fetchDiagnosa9INA($event)" :optionLabel="'label'" :dropdown="true" :minLength="3"
                                                                :appendTo="'body'" :loadingIcon="'pi pi-spinner'" :field="'label'"
                                                                placeholder="ketik untuk mencari " />
                                            ...
                                            <div class="column is-6 ">
                                                ...
                                                <div class="form-section-inner">
                                                    ...
                                                    <VField label="Diagnosis ICD 10 INA" class="is-rounded-select  is-autocomplete-select" v-slot="{ id }">
                                                        <VControl icon="lnir lnir-diagnosis" fullwidth class="prime-auto-select">
                                                            <AutoComplete v-model="item.diagnosa10INA" :suggestions="d_DiagnosaINA"
                                                                @complete="fetchDiagnosa10INA1($event)" :optionLabel="'label'" :dropdown="true" :minLength="3"
                                                                :appendTo="'body'" :loadingIcon="'pi pi-spinner'" :field="'label'"
                                                                placeholder="ketik untuk mencari " />
                                                ...
                                                <div class="form-section-output" v-if="dataSourceXINA.length > 0">
                                                    <div class="output c-title" v-for="(items, index) in dataSourceXINA" :key="index">
                                                    <i aria-hidden="true" class="iconify" data-icon="feather:archive"></i>
                                                        <span v-if="items.keterangan">Diagnosa dokter: {{ items.keterangan }}</span>
                                                        <span> &nbsp ICD10: {{ items.kddiagnosa + " - " + items.namadiagnosa }}</span>
                                                        <span class="txt-ina">{{ items.jenisdiagnosa }}</span>
                                                        ...
                                                        <div class="action is-pulled-right" style="margin-left:-0;" v-if="!item.DETAIL">
                                                            <VIconButton icon="feather:edit-2" @click="editItemsINA(items)" />
                                                            <!-- <VButton color="info" light rounded outlined @click="rencanaMutasi(item)">Set Primary&emsp;&emsp;&emsp;</VButton> -->
                                                        </div>
                                                        <div class="action" style="margin-left:-0;" v-if="!item.DETAIL">
                                                            <VIconButton icon="feather:trash-2" @click="hapusItems(items)" />
                                                ...
                                                <div class="form-section-inner mt-5">
                                                    ...
                                                    <VField label="Diagnosis ICD 9 INA" class="is-rounded-select  is-autocomplete-select" v-slot="{ id }">
                                                        <VControl icon="lnir lnir-diagnosis" fullwidth class="prime-auto-select">
                                                            <AutoComplete v-model="item.diagnosa9INA" :suggestions="d_Diagnosa9INA"
                                                                @complete="fetchDiagnosa9INA1($event)" :optionLabel="'label'" :dropdown="true" :minLength="3"
                                                                :appendTo="'body'" :loadingIcon="'pi pi-spinner'" :field="'label'"
                                                                placeholder="ketik untuk mencari " />
                                                ...
                                                <div class="form-section-output" v-if="dataSourceIXINA.length > 0">
                                                    <div class="output c-title" v-for="(items, index) in dataSourceIXINA" :key="index">
                                                        <i aria-hidden="true" class="iconify" data-icon="feather:archive"></i>
                                                        <span v-if="items.keterangantindakan">Diagnosa dokter: {{ items.keterangantindakan }} </span>
                                                        <span>&nbsp ICD 9: {{ items.kddiagnosatindakan + " - " + items.namadiagnosatindakan
                                                        }}</span>
                                                        ...
                                                        <div class="action is-pulled-right" v-if="!item.DETAIL">
                                                            <VIconButton icon="feather:edit-2" @click="editItemsIXINA(items)" />
                                                        </div>
                                                        <div class="action" style="margin-left:-0;" v-if="!item.DETAIL">
                                                            <VIconButton icon="feather:trash-2" @click="hapusItemsIX(items)" />
                                                        </div>
                                                    ...
                                                    <div class="column is-6">
                                                        <VCardCustom :style="'padding:5px 25px'">
                                                            ...
                                                            <small class="text-bold-custom text-elipsis">{{
                                                                resGrouper.response ?
                                                                resGrouper.response.cbg.code + '-' + resGrouper.response.cbg.description : '-' }}</small>
                                                        </VCardCustom>
                                                    </div>
                                                    <div class="column is-6">
                                                        <VCardCustom :style="'padding:5px 25px'">
                                ...
                                <div class="navigation-buttons">
                                    <div class="right">
                                        <div class="buttons">
                                            <VButton icon="lnir lnir-arrow-left rem-100" light dark-outlined @click="kembaliKeun()" style="display: none !important">
                                                Kembali
                                            </VButton>
                                            <VButton type="button" rounded outlined color="dark" raised icon="feather:file" style="display: none !important"
                                    ...
                                    <div class="buttons is-right">
                                        <VButton type="button" outlined color="dark" raised icon="feather:trash"
                                            :loading="isHapus" @click="hapusKlaim()" style="min-width: 10%; width: 10%"> Hapus
                                        </VButton>

                                        <VButton type="button" outlined color="primary" raised icon="feather:save"
                                            :loading="isLoading" @click="newKlaim()"> Simpan
                                        </VButton>

                                        <VButton type="button" outlined color="danger" raised icon="feather:list"
            ...
            <div class="columns is-multiline p-1">
                ...
                <div class="column is-12">
                    <VField label="Diagnosis ICD 10 " class="is-rounded-select  is-autocomplete-select" v-slot="{ id }">
                        <VControl icon="lnir lnir-diagnosis" fullwidth class="prime-auto-select">
                            <Dropdown v-model="item.diagnosa10" :suggestions="d_Diagnosa"
           ...
           <div class="columns is-multiline">
                <div class="column is-2 ">
                    <VField label="Usia Kehamilan">
                        <VControl>
                            <VInput type="number" placeholder="Usia Kehamilan"
                                v-model="inacbg.usia_kehamilan" />
                        </VControl>
                    </VField>
                </div>
                <div class="column is-2 ">
                    <VField label="Gravida">
                        <VControl>
                            <VInput type="number" placeholder="Gravida"
                                v-model="inacbg.gravida" />
                        </VControl>
                    </VField>
                </div>
                <div class="column is-2 ">
                    <VField label="Partus">
                        <VControl>
                            <VInput type="number" placeholder="Partus"
                                v-model="inacbg.partus" />
                        </VControl>
                    </VField>
                </div>
                <div class="column is-2 ">
                    <VField label="Abortus">
                        <VControl>
                            <VInput type="number" placeholder="Abortus"
                                v-model="inacbg.abortus" />
                        </VControl>
                    </VField>
                </div>
                    ...
                    <VField class="is-rounded-select is-autocomplete-select">
                        ...
                        <VControl icon="feather:search">
                            <Dropdown v-model="inacbg.onset_kontraksi" :options="d_onsetkontraksi"
                                :optionLabel="'nama'" placeholder="Pilih data" style="width: 100%;"
                ...
                <div class="columns is-12 is-multiline" style="margin-left:2px" v-for="(item, index) in delivery" :key="index" >
                    ...
                    <div class="column is-2">
                        ...
                        <div class="column is-2">
                        <VDatePicker v-model="item.delivery_dttm" mode="dateTime"
                            style="width: 100%;">
                            <template #default="{ inputValue, inputEvents }">
                                <VField>  <VLabel>waktu kelahiran</VLabel>
                                    <VControl icon="feather:calendar"  fullwidth>
                                        <VInput :value="inputValue" placeholder="Tanggal Masuk"
                                            v-on="inputEvents"   />
                                    </VControl>
                    ...
                    <div class="column is-2">
                        <VField class="is-rounded-select is-autocomplete-select">
                            ...
                            <VControl icon="feather:search">
                                <Dropdown v-model="item.letak_janin" :options="d_letakjanin"
                                    :optionLabel="'nama'" placeholder="Pilih data" style="width: 100%;"
                                    showClear :filter="true" />
                            </VControl>
                        </VField>
                    ...
                    <div class="column is-2">
                        <VField class="is-rounded-select is-autocomplete-select">
                            ...
                            <VControl icon="feather:search">
                                <Dropdown v-model="item.kondisi" :options="d_kondisi"
                                    :optionLabel="'nama'" placeholder="Pilih data" style="width: 100%;"
                                    showClear :filter="true" />
                            </VControl>
                        </VField>
                    ...
                    <div class="column is-1">
                        <VField class="is-rounded-select is-autocomplete-select">
                            ...
                            <VControl icon="feather:search">
                                <Dropdown v-model="item.use_manual" :options="d_yatidak"
                        ...
                        <div class="column is-1">
                                <VField class="is-rounded-select is-autocomplete-select">
                                    ...
                                    <VControl icon="feather:search">
                                        <Dropdown v-model="item.use_forcep" :options="d_yatidak"
                                            :optionLabel="'nama'"   style="width: 100%;"
                                             />
                                    </VControl>
                                </VField>
                    ...
                    <div class="column is-1">
                        <VField class="is-rounded-select is-autocomplete-select">
                            ...
                            <VControl icon="feather:search">
                                <Dropdown v-model="item.use_vacuum" :options="d_yatidak"
                                    :optionLabel="'nama'" style="width: 100%;"
                                      />
                            </VControl>
                        </VField>
                    ...
                    <div class="column is-1">
                            ...
                            <div class="column is-2">
                        <VDatePicker v-model="item.shk_spesimen_dttm" mode="dateTime"
                            style="width: 100%;">
                            <template #default="{ inputValue, inputEvents }">
                                <VField>  <VLabel>Tanggal</VLabel>
                                    <VControl icon="feather:calendar"  fullwidth>
                    ...
                    <div class="column is-1" style="margin-top:25px">
                        ...
                        <div class="column is-1" style="margin-top:25px">
                            ...
                            icon="feather:plus" @click="addNewItem(index)"> Tambah
                        </VButton>
                    </div>
                </div>
            </div>
            <template #footer>
                ...
                <VButton type="button" rounded outlined color="primary" raised icon="feather:save" @click="simpanPersalinan()"
                    :loading="isLoading"> {{ item.NOREC_DIAGNOSA9 != undefined ? 'Ubah' : 'Simpan' }}
                </VButton>
...
const item: any = reactive({
    ...
    diagnosa9: {
        label: '897',
        kddiagnosatindakan: '89.7',
        namadiagnosatindakan: 'General physical examination'
    },
    diagnosa9INA: {
        label: '897',
        kddiagnosatindakan: '89.7',
...
const dataSourceXINA: any = ref([])
const dataSourceIXINA: any = ref([])
const dataSourceXDokter: any = ref([])
const dataSourceIXDokter: any = ref([])
const d_Diagnosa9: any = ref([])
const d_Diagnosa: any = ref([])
const d_Diagnosa9INA: any = ref([])
const d_DiagnosaINA: any = ref([])
...
let d_Dializer: any = ref([{ value: 1, label: 'Single Use' }, { value: 0, label: 'Multiple Use' }])
...
//   console.log('GANTI WOI',ID_PASIEN)
// }
...
const inacbg: any = reactive({
    ...
    "specialdrugValue": 0,
    "cara_masuk": {"kode": 'outp', "nama": 'Dari Rawat Jalan '}
})
...
const inacbgDetail = async (NOREC_PD: any) => {
    ...
    await useApi().get(
        `/bridging/inacbgs-backup?norec_pd=${NOREC_PD}`).then((response: any) => {
            ...
            if(res.set_claim_data.data.sistole != ""){
                inacbg.sistole = res.set_claim_data.data.sistole
            }
            if(res.set_claim_data.data.diastole != ""){
            ...
            inacbg.dializer_single_use = res.dializer_single_use
            inacbg.kantong_darah = res.kantong_darah
...
const fetchDiagnosa10INA = async (filter: any) => {
    let query = ''
    if (filter) {
        query = filter.query.toLowerCase()
    }
    ...
    isLoading.value = true
    useApi().postBPJS('/bridging/inacbgs/save', { 'data': dt2 }).then(async (r) => {
            //$scope.sourceDiagnosisPrimer = responData[0].dataresponse.response.data

            //getdiag = [["Simple schizophrenia", "F20.6"], ["Other schizophrenia", "F20.8"]]
            getdiag = r.response.dataresponse[0].dataresponse.response.data;

            for (var x = 0; x < getdiag.length; x++) {
              arraynew = {
                kddiagnosa: getdiag[x][1],
                namadiagnosa: getdiag[x][0],
                label: getdiag[x][1] + '-' + getdiag[x][0]
              };

              arrnew.push(arraynew);
            }
            console.log(arrnew);

            d_Diagnosa.value = arrnew;
            console.log(d_Diagnosa.value);
    })
}
const fetchDiagnosa10INA1 = async (filter: any) => {
    let query = ''
    if (filter) {
        query = filter.query.toLowerCase()
    }
    ...
    useApi().postBPJS('/bridging/inacbgs/save', { 'data': dt2 }).then(async (r) => {
            ...
            for (var x = 0; x < getdiag.length; x++) {
              arraynew = {
                kddiagnosa: getdiag[x].code,
                namadiagnosa: getdiag[x].description,
                label: getdiag[x].code + '-' + getdiag[x].description
              };
            ...
            d_DiagnosaINA.value = arrnew;
            console.log(d_DiagnosaINA.value);
    })
}
const fetchDiagnosa9INA = async (filter: any) => {
    let query = ''
    if (filter) {
        query = filter.query.toLowerCase()
    }
    ...
    useApi().postBPJS('/bridging/inacbgs/save', { 'data': dt2 }).then(async (r) => {
            ...
            for (var x = 0; x < getdiag.length; x++) {
              arraynew = {
                kddiagnosatindakan: getdiag[x][1],
                namadiagnosatindakan: getdiag[x][0],
                label: getdiag[x][1] + '-' + getdiag[x][0]
              };
            ...
            d_Diagnosa9.value = arrnew;
            console.log(d_Diagnosa9.value);
    })
}
const fetchDiagnosa9INA1 = async (filter: any) => {
    let query = ''
    if (filter) {
        query = filter.query.toLowerCase()
    }
    ...
    useApi().postBPJS('/bridging/inacbgs/save', { 'data': dt2 }).then(async (r) => {
            ...
            for (var x = 0; x < getdiag.length; x++) {
              arraynew = {
                kddiagnosatindakan: getdiag[x].code,
                namadiagnosatindakan: getdiag[x].description,
                label: getdiag[x].code + '-' + getdiag[x].description
              };
            ...
            d_Diagnosa9INA.value = arrnew;
            console.log(d_Diagnosa9INA.value);
    })
}
...
const simpanICD9 = async () => {
      ...
      let json = {
          ...
          'detaildiagnosapasien': {
              'objectdiagnosatindakanklaimfk': item.diagnosa9.kddiagnosatindakan,
              'namadiagnosatindakan': item.diagnosa9.namadiagnosatindakan,
              'objectjenisdiagnosatindakanklaimfk': item.jenisdiagnosa9,
      ...
      isLoading.value = true
      await useApi().post(
          `/diagnosa/save-diagnosa-ix-klaim`, json).then((response: any) => {
              isLoading.value = false
              modalInput9.value = false
  ...
  const simpanICD9INA = async () => {
      ...
      let json = {
          ...
          'detaildiagnosapasien': {
              'objectdiagnosatindakanklaimfk': item.diagnosa9INA.kddiagnosatindakan,
              'namadiagnosatindakan': item.diagnosa9INA.namadiagnosatindakan,
              'objectjenisdiagnosatindakanklaimfk': item.jenisdiagnosa9,
              'tglinputdiagnosa': H.formatDate(item.tglpelayanan, 'YYYY-MM-DD HH:mm:ss'),
              'noregistrasi': item.noregistrasi,
          },
...
const simpanICD10 = async () => {
    if (!item.tglpelayanan) {
      ...
      let json = {
          ...
          'detaildiagnosapasien': {
              'objectdiagnosafk': item.diagnosa10.kddiagnosa,
              'namadiagnosa': item.diagnosa10.namadiagnosa,
              'tglinputdiagnosa': H.formatDate(item.tglpelayanan, 'YYYY-MM-DD HH:mm:ss'),
              'objectjenisdiagnosaklaimfk': jenisdiagnosa,
              'noregistrasi': item.noregistrasi,
              'iskematian': null
          }, 'pasien' : {
              'nocm':item.nocm,
      ...
      isLoading.value = true
      await useApi().post(
          `/diagnosa/save-diagnosa-klaim`, json).then((response: any) => {
              isLoading.value = false
              modalInput.value = false
...
const simpanICD10INA = async () => {
    if (!item.tglpelayanan) {
      ...
      if (!item.diagnosa10 && !item.diagnosa10INA) {
          H.alert('error', 'Diagnosis harus di isi')
          return
      }

      let jenisdiagnosa = 7
      if(dataSourceXINA.value.length != 0){
        jenisdiagnosa = 8
      }
      ...
      let json = {
          ...
          'detaildiagnosapasien': {
              'objectdiagnosafk': item.diagnosa10INA.kddiagnosa,
              'namadiagnosa': item.diagnosa10INA.namadiagnosa,
              'tglinputdiagnosa': H.formatDate(item.tglpelayanan, 'YYYY-MM-DD HH:mm:ss'),
              'objectjenisdiagnosaklaimfk': jenisdiagnosa,
              'noregistrasi': item.noregistrasi,
              'iskematian': null
...
const riwayatDiagnosa10 = async () => {
    ...
    await useApi().get(
        `/diagnosa/riwayat-diagnosa-x-klaim?norec_pd=${NOREC_PD}&nocmfk=${ID_PASIEN}`).then((response: any) => {
    ...
    dataSourceXINA.value.loading = true
    await useApi().get(
    `/diagnosa/riwayat-diagnosa-x-klaim-ina?norec_pd=${NOREC_PD}&nocmfk=${ID_PASIEN}`).then((response: any) => {
        dataSourceXINA.value.loading = false
        dataSourceXINA.value = response.data.sort(compare)
    }).catch((e: any) => {
        dataSourceXINA.value.loading = false
    })
...
const riwayatDiagnosa9 = async () => {
    ...
    await useApi().get(
        `/diagnosa/riwayat-diagnosa-ix-klaim?norec_pd=${NOREC_PD}&nocmfk=${ID_PASIEN}`).then((response: any) => {
    ...
    dataSourceIXINA.value.loading = true
    await useApi().get(
        `/diagnosa/riwayat-diagnosa-ix-klaim-ina?norec_pd=${NOREC_PD}&nocmfk=${ID_PASIEN}`).then((response: any) => {
            dataSourceIXINA.value.loading = false
            dataSourceIXINA.value = response.data
        }).catch((e: any) => {
            dataSourceIXINA.value.loading = false
        })

}
const editItemsINA = (e: any) => {
    clearInput()
...
const setPrimary = (e: any) => {
    console.log(e)
    let json = {
        'norec_dp': e.norec_diagnosapasien,
        'norec_ddp': e.norec_detaildpasien,
    }
    isLoading.value = true
    useApi().post(`/diagnosa/save-diagnosa-klaim-primary`, json).then((response: any) => {
        isLoading.value = false
        riwayatDiagnosa10()
    }).catch((e: any) => {
        isLoading.value = false
...
const editItemsIX = (e: any) => {
    ...
    item.diagnosa9 = {
        id: e.objectdiagnosatindakanklaimfk,
...
const editItemsIXINA = (e: any) => {
    ...
    item.tglpelayanan = new Date(e.tglinputdiagnosa)
    item.jenisdiagnosa9 = e.objectjenisdiagnosatindakanklaimfk
    isEdit9.value = true
    // modalInput9.value = true
...
const newKlaim = async () => {
    console.log(delivery.value[0].agemin.length)
    console.log(inacbg.cara_masuk)

    if(inacbg.nomor_sep == '0000000000000'){
        H.alert('error', 'No. SEP belum sesuai')
        return
    }
    ...
    let diagnsosa10INA = ''
    for (let z = 0; z < dataSourceXINA.value.length; z++) {
        const element = dataSourceXINA.value[z];
        diagnsosa10INA = diagnsosa10INA + '#' + element.kddiagnosa
    }
    console.log(diagnsosa10INA)
    diagnsosa10INA = diagnsosa10INA.substr(1, diagnsosa10INA.length)
    console.log(diagnsosa10INA)
    ...
    let diagnsosa9INA = ''
    for (let z = 0; z < dataSourceIXINA.value.length; z++) {
        const element = dataSourceIXINA.value[z];
        diagnsosa9INA = diagnsosa9INA + '#' + element.kddiagnosatindakan
    }
    diagnsosa9INA = diagnsosa9INA.substr(1, diagnsosa9INA.length)
    ...
    let tempdevlivery = ''
    if(delivery.value[0].agemin.length != 0){
        tempdevlivery =[];
         for (var x = 0; x < delivery.value.length; x++) {
            var y = {
    ...
    json.push({
        ...
        "data": {
            ...
            "diagnosa_inagrouper": diagnsosa10INA,
            "procedure_inagrouper": diagnsosa9INA,
            "tarif_rs": {
...
useApi().get(`emr/auto-fill?nocmfk=${ID_PASIEN}&norec_pd=${NOREC_PD}&collection=CatatanPerkembanganPasienTerintegrasi&field=tekananDarah`).then((responsex) => {
const tekananDarah = responsex.tekananDarah
    if (responsex != null) {
        inacbg.sistole = tekananDarah.split('/')[0]
        console.log(tekananDarah.split('/'))
        inacbg.diastole = tekananDarah.split('/')[1]
        console.log(inacbg.sistole)
    }
})
useApi().get(`emr/auto-fill?nocmfk=${ID_PASIEN}&norec_pd=${NOREC_PD}&collection=CPPTDetail&field=A`).then((responsey) => {
const dataDiagnosa = responsey.A
    if (responsey != null) {
        item.TADiagnosa = dataDiagnosa;
    }
})

if(inacbg.sistole == undefined && item.TADiagnosa == undefined){
    useApi().get(`emr/auto-fill?nocmfk=${ID_PASIEN}&norec_pd=${NOREC_PD}&collection=AsesmenMedisRawatJalan&field=TADiagnosa,tekananDarah`).then((response) => {
        if (response != null) {
            const dataDiagnosa = response.TADiagnosa
            const tekananDarah = response.tekananDarah
            ...
            // useApi().get(`emr/auto-fill?nocmfk=${ID_PASIEN}&norec_pd=${NOREC_PD}&collection=AsesmenAwalMedisGawatDarurat&field=TADiagnosis,tekananDarah`).then((response) => {
            //     const dataDiagnosa = response.TADiagnosis
            //     const tekananDarah = response.tekananDarah
            //     if (dataDiagnosa != null) {
            //         input.value.TADiagnosa = dataDiagnosa;
            //         inacbg.sistole = tekananDarah.split('/')[0]
            //         inacbg.diastole = tekananDarah.split('/')[1]
            //     }
            // })
...
watch(
  () => item.diagnosa10,
  (newValue, oldValue) => {
    console.log('NOREC', item.NOREC_DIAGNOSA10)
    console.log('EDIT', isEdit.value)
    if(item.diagnosa10 != undefined  && isEdit.value == false){
        if(item.diagnosa10.kddiagnosa != undefined){
            simpanICD10()
        }
    } 
    isEdit.value = false
...
watch(
  ...
  (newValue, oldValue) => {
    console.log('NOREC', item.NOREC_DIAGNOSA10)
    console.log('EDIT', isEdit.value)
    if(item.diagnosa10INA != undefined  && isEdit.value == false){
        if(item.diagnosa10INA.kddiagnosa != undefined){
            simpanICD10INA()
        }
    } 
    isEdit.value = false
...
watch(
  () => item.diagnosa9,
  (newValue, oldValue) => {
    console.log('EDIT', isEdit9.value)
    if(item.diagnosa9 != undefined && isEdit9.value == false){
        if(item.diagnosa9.kddiagnosatindakan != undefined){
            item.jenisdiagnosa9 = 9
            simpanICD9()
        }
    }
    isEdit9.value = false
...
watch(
  ...
  (newValue, oldValue) => {
    console.log('EDIT', isEdit9.value)
    if(item.diagnosa9INA != undefined && isEdit9.value == false){
        if(item.diagnosa9INA.kddiagnosatindakan != undefined){
            item.jenisdiagnosa9 = 10
            simpanICD9INA()
        }
    }
    isEdit9.value = false
