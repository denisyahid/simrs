            ...
            <div class="columns is-multiline">
              <div class="column is-12">
                <VField>
                  ...
                  <VControl icon="feather:user">
                    <VInput type="text" v-model="item.namaPasien" autocomplete="given-name" />
                  </VControl>
                </VField>
              </div>
              <div class="column is-6">
                <VField>
                  ...
                  <VControl icon="feather:user">
                    <VInput type="text" v-model="item.noRegistrasi" autocomplete="family-name" />
                  </VControl>
                </VField>
              </div>
              <div class="column is-6">
                <VField>
                  ...
                  <VControl icon="feather:bookmark">
                    <VInput type="text" v-model="item.jenisPasien" autocomplete="family-name" />
                  </VControl>
                </VField>
              </div>
              <div class="column is-12">
...
useHead({
    title: 'Verifikasi Tagihan  - Transmedic',
})
...
let NOREC_PD = useRoute().query.norec_pd as string
  ...
  await useApi().get(
  `/kasir/verifikasi-tagihan?norec_pd=${NOREC_PD}`).then((response: any) => {
    item.value = response
  })
}
