<template>
    ...
    <VCard>
        <div class="columns column c-title">
            <h3 class="title is-5 mb-2 mr-1">Satuan Hasil</h3>
        </div>
            ...
            <div class="column is-8" style="margin-top: 2.2rem;">
                ...
                <div class="user-grid user-grid-v2" v-if="selectView == 'list'">
                    <DataTable :value="dataSourcefiltered" :paginator="true" :rows="5" :rowsPerPageOptions="[5, 10, 25]"
                        ...
                        <Column field="satuanstandar" header="Satuan Hasil" :sortable="true"></Column>
                        ...
                        <div v-for="(item, key) in dataSourcefiltered" :key="key" class="column is-6">
                            <div class="tile-grid-item">
                                <div class="tile-grid-item-inner">
                                    ...
                                    <div class="meta">
                                        <span class="dark-inverted mb-2">{{ item.satuanstandar }}</span>
                ...
                <VCard>
                    <div class="columns is-multiline">
                        ...
                        <div class="column is-12">
                            <VField label="Satuan Standar">
                                <VControl icon="feather:bookmark">
                                    <VInput type="text" v-model="item.satuanstandar" placeholder="Satuan Standar"
                                        class="is-rounded" />
                                </VControl>
                            </VField>
                        </div>
        ...
        <VModal :open="modalDetail" title="Detail Satuan Hasil" actions="right"
...
useHead({
  title: 'Satuan Hasil - ' + import.meta.env.VITE_PROJECT,
})
...
const dataSourcefiltered = computed(() => {
    ...
    return dataSource.value.filter((items: any) => {
        return (
            items.rhesus.match(new RegExp(filters.value, 'i'))
        )
    })
})
...
const fetchData = async ()=>{
    ...
    await useApi().get(`/laboratorium/get-satuan-hasil?statusenabled=${item.value.aktif}`).then((response)=>{
...
const save = async ()=>{
    if (!item.value.satuanstandar) {
        useToaster().error('Satuan Hasil harus di isi')
        return
    }
    var objSave =
    {
    ...
    await useApi().post(
        `/laboratorium/save-satuan-hasil`, objSave).then((response: any) => {
