<template>
    <VCard>
        <VTabs id="custom" centered selected="diagnosa" :tabs="[
            ...
            { label: 'Diagnosa Kanker', value: 'diagnosakanker' },
        ]">
            <template #tab="{ activeValue }">
                ...
                <p v-else-if="activeValue === 'diagnosakanker'">
                    <MasterDiagnosaKanker></MasterDiagnosaKanker>
                </p>
            </template>
        </VTabs>
    </VCard>
...
import MasterDiagnosaKanker from './master-diagnosa-kanker.vue'
