<template>
    ...
    <VCard>
        <div class="columns column c-title">
            <h3 class="title is-5 mb-2 mr-1">Rhesus</h3>
        </div>
            ...
            <div class="column is-8" style="margin-top: 2.2rem;">
                ...
                <div class="user-grid user-grid-v2" v-if="selectView == 'list'">
                    <DataTable :value="dataSourcefiltered" :paginator="true" :rows="5" :rowsPerPageOptions="[5, 10, 25]"
                        ...
                        <Column field="rhesus" header="Rhesus" :sortable="true"></Column>
...
useHead({
  title: 'Rhesus - ' + import.meta.env.VITE_PROJECT,
})
...
const fetchData = async ()=>{
    ...
    await useApi().get(`/sysadmin/master-rhesus?statusenabled=${item.value.aktif}`).then((response)=>{
