                ...
                <div class=" illustration-header-2 columns is-multiline">
                  ...
                  <div class="column is-6 p-0">
                    <div class="header-meta">
                      <h3 style="color:white"><i class="fas fa-home"></i> Kedokteran Nuklir</h3>
                      <p>
                ...
                <TabView class="tabview-custom " :scrollable="true" @tab-click="klikTab($event)">
                  <TabPanel>
                    ...
                    <div v-if="activeTab == 0">
                      ...
                      <div class="list-view list-view-v3" style="min-height: 400px;">
                          ...
                          <DataTable
                              ...
                              <Column header="Action">
                                  <template #body="slotProps">
                                      <div class="columns">
                                          <div class="column">
                                              <VDropdown icon="pi pi-ellipsis-v" class="is-pushed-mobile is-raised is-primary is-custom-dd" spaced left style="font-size: 22px;">
                              ...
                              <Column field="noregistrasi" header="No Reg" :sortable="true" style="min-width: 190px"></Column>
                              <Column field="namapasien" header="Nama Pasien" :sortable="true" style="min-width: 190px"></Column>
                              <Column field="nocm" header="No RM" :sortable="true" style="min-width: 150px"></Column>
                              <Column field="kebangsaan" header="Kebangsaan" :sortable="true" style="min-width: 120px"></Column>
                              <Column field="nobpjs" header="No BPJS" :sortable="true" style="min-width: 190px"></Column>
                              <Column field="jeniskelamin" header="JK" :sortable="true" style="min-width: 90px"></Column>
                              <Column field="tglregistrasi" header="Tanggal" :sortable="true" style="min-width: 120px">
                              <template #body="slotProps">
                                  <span>{{ H.formatDateToLocalString(slotProps.data.tglregistrasi) }}</span>
                              </template>
                              </Column>
                              <Column field="namaruangan" header="Ruangan" :sortable="true" style="min-width: 190px"></Column>
                              <Column field="kelompokpasien" header="Cara Bayar" :sortable="true" style="min-width: 190px"></Column>
                              <Column field="status" header="Status" :sortable="true" style="min-width: 100px">
                                  <template #body="slotProps">
                                      <VTag class="ml-4" :color="getBadgeStatusPasien(slotProps.data.status)" rounded>{{ slotProps.data.status }}</VTag>
                                      <!-- <span>{{ H.formatDateToLocalString(slotProps.data.tglregistrasi) }}</span> -->
                                  </template>
                              </Column>
                          </DataTable>
