            ...
            <div class="column is-12">
              <div class="illustration-header-2 large-screen">
                ...
                <div class="header-meta" style="margin-left : -2rem;">
                  <h3 style="color:white"><i class="fas fa-id-card" aria-hidden="true"></i> Dashboard Kedokteran Nuklir
                    Terapi
                  </h3>
                  <p>
                      ...
                      <div v-for="(items, m) in dataOrder" :key="m" class="list-view-item">
                        <div class="list-view-item-inner">
                          ...
                          <div class="meta-left">
                            ...
                            <VTag color="danger" rounded >{{items.terapiradioaktif}}
                            </VTag>
            ...
            <div class="column is-4">
              <VField class="is-rounded-select is-autocomplete-select">
                ...
                <VControl icon="fa:user" class="prime-auto-cus ">
                  <AutoComplete v-model="item.petugasverify" :suggestions="d_Pegawai" :optionLabel="'label'"
...
const fetchPegawai = async (filter: any) => {
  ...
  await useApi().get(
    `/dashboard/radiologi/get-pegawai-nuklir-terapi`
  ).then((response) => {
...
const response1 = await useApi().get(`/dashboard/radiologi/get-dokter`)
d_Ruangan.value = response1.ruangan.map((e: any) => { return { label: e.namaruangan, value: e.id, default: e } })
item.value.filterRuangan = 389
...
const getListPelayanan = async (data: any) => {
  const response = await useApi().get(`/dashboard/radiologi/get-pelayanan-nuklir-terapi?idkelas=${data.idkelas}&idjenispelayanan=${data.idJenisPelayanan}`)
...
const getListDokter = async () => {
  const response = await useApi().get(`/dashboard/radiologi/get-dokter?iskemo=true`)
