...
<template>
                        ...
                        <div class="list-view-inner mt-2" style="max-height:1000px;overflow: auto;">
                          <div name="list-complete" tag="div">
                            ...
                            <div class="column" v-if="dataPasien.length > 0">
                                ...
                                <DataTable lazy :filters="ds_PASIEN_FILTER"  :value="dataPasien" class="p-datatable-md" :loading="isLoading" :paginator="true" @update:rows="limit = $event" :rows="limit"
                                :rowsPerPageOptions="rowOptions" scrollable v-model:expandedRows="expandedRows" @page="onPageChange($event)"
                                scrollHeight="600px"
  ...
  const kelompokUser = 'nurse-station-basement'
  const kelompokUserID = 57
