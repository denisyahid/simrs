                                ...
                                <div class="columns is-multiline">
                                    ...
                                    <div class="column is-2">
                                        <VField>
                                            ...
                                            <VControl>
                                            <VInput v-model="item.nofpk" type="text" placeholder="No Formulir Pengajuan Klaim" />
                                            </VControl>
                                        </VField>
                                    </div>
                                    <div class="column is-3">
                                        <VField>
                                            <VLabel>Pelayanan </VLabel>
                                            <VControl>
                            ...
                            <div class="column is-12" v-else>
                                ...
                                <template #header>
                                    <div class="flex justify-content-between">
                                        ...
                                        <VButtons>
                                            <VButton color="primary" icon="fas fa-file-excel" elevated @click="exportExcel()"> Export To Excel </VButton>
                                        </VButtons>
                                        <VButtons>
...
const item: any = reactive({
    ...
    jenispelayanan:2,
    statusklaim:optionsStatusKlaim[2].value
})
...
const exportExcel = () => {
    ...
    const worksheet = XLSX.utils.aoa_to_sheet([
        ...
        [],
        ['NO', 'NO MR', 'NAMA PASIEN', 'NO SEP', 'TGL SEP', 'BIAYA TARIF RS', 'BIAYA PENGAJUAN', 'BIAYA SETUJUI'],
    ...
    const columnWidths = [10, 15, 15, 15, 15, 15, 15, 15];
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Klaim BPJS', true);
    XLSXStyle.writeFile(workbook, 'Monitoring Klaim BPJS.xlsx');
}
