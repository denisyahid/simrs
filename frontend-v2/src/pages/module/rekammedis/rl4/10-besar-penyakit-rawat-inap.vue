<template>
  <VCard>
    <div>
      <h3 class="title is-5 mb-2 mr-1">Formulir RL 4.2</h3>
...
useHead({
  title: 'RL 4.2 10 Besar Penyakit Rawat Inap' + import.meta.env.VITE_PROJECT,
})
...
const fetchData = async () => {
  ...
  await useApi().get(`laporan/get-laporan-rl42?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}`).then((response: any) => {
...
const exportExcel = () => {
    ...
    const worksheetData = [
    ['Daftar RL 4.2 10 BESAR PENYAKIT RAWAT INAP'],
    [],
    [
      'NO',
      'Kelompok ICD-10',
    ...
    XLSXStyle.writeFile(workbook, 'RL 4.2 10 Besar penyakit Rawat Inap.xlsx');
};
