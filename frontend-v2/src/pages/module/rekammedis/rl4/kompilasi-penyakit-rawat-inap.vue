<template>
  <VCard>
    <div>
      <h3 class="title is-5 mb-2 mr-1">Formulir RL 4.1</h3>
      <span>Kompilasi Penyakit/Morbiditas Pasien Rawat Inap</span>
    </div>
    <div class="columns">
      <div class="column is-9">
        ...
        <div class="column" v-else>
          <DataTable v-model:expandedRowGroups="expandedRowGroups" :class="`p-datatable-small`" :value="dataSource"
            ...
            <Column field="hiduplaki" style="min-width: 50px; text-align: center;" />
            <Column field="hidupperempuan" style="min-width: 50px;text-align: center;" />
            <Column field="jumlahhiduppl" style="min-width: 50px;text-align: center;" />
            <Column field="matilaki" style="min-width: 50px;text-align: center;" />
            <Column field="matiperempuan" style="min-width: 50px;text-align: center;" />
            <Column field="matipl" style="min-width: 50px;text-align: center;" />
          </DataTable>
        </div>
      </div>
      <div class="column is-3">
...
useHead({
  title: 'RL 4.1 Kompilasi Penyakit/Morbiditas Pasien Rawat Inap' + import.meta.env.VITE_PROJECT,
})
...
const fetchData = async () => {
  ...
  await useApi().get(`laporan/get-laporan-rl41?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}`).then((response: any) => {
...
const exportExcel = () => {
    ...
    const worksheetData = [
    ['Daftar RL 4.1 PENYAKIT/MORBIDITAS PASIEN RAWAT INAP'],
    [],
    [
      'NO',
      'Kode ICD',
      ...
      '65-69 th',null,'70-74 th',null,'75-79 th',null,'80-84 th',null,'≥85 th',null,'Jumlah Pasien Hidup dan Mati menurut Jenis Kelamin',null,null,'Jumlah Pasien Keluar Mati',null,null,
    ],
    [
    ...
    XLSXStyle.writeFile(workbook, 'RL 4.1 Kompilasi Penyakit/Morbiditas Pasien Rawat Inap.xlsx');
};
