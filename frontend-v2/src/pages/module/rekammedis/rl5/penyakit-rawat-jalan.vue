<template>
  <VCard>
    <div>
      ...
      <span>10 BESAR KUNJUNGAN PENYAKIT RAWAT JALAN</span>
    </div>
    <div class="columns">
...
const fetchData = async () => {
  ...
  const response = await useApi().get(`laporan/get-laporan-rl53?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}&ruanganfk=${ruangan}`)
