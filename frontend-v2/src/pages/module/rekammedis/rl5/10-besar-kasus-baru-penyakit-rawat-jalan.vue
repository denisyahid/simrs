<template>
  <VCard>
    <div>
      <h3 class="title is-5 mb-2 mr-1">Formulir RL 5.2</h3>
      <span>10 BESAR KASUS BARU PENYAKIT RAWAT JALAN</span>
    </div>
    <div class="columns">
      <div class="column is-9">
        ...
        <div class="column" v-else>
          <DataTable v-model:expandedRowGroups="expandedRowGroups" :class="`p-datatable-small`" :value="dataSource"
            ...
            :rowsPerPageOptions="[10]" :rows="10" paginator :loading="isLoading" sortMode="single"
            ...
            <ColumnGroup type="header">
              <Row>
                ...
                <Column header="KASUS BARU MENURUT JENIS KELAMIN" :colspan="3" style="text-align: center;" />
                <!-- <Column header="Jumlah Kasus Baru (4 + 5)" /> -->
                <Column header="Jumlah Kunjungan" :colspan="3" style="text-align: center;"/>
              </Row>
              <Row>
            ...
            <Column field="barulaki"></Column>
            <Column field="baruperempuan"></Column>
            <Column field="totalbaru"></Column>
            <Column field="kunjlaki"></Column>
            <Column field="kunjperempuan"></Column>
            <Column field="totalkunj"></Column>
          </DataTable>
        </div>
      </div>
      <div class="column is-3">
...
useHead({
  title: 'RL5.3 10 Besar Kunjungan Penyakit Rawat Jalan' + import.meta.env.VITE_PROJECT,
})
...
const fetchData = async () => {
  ...
  const response = await useApi().get(`laporan/get-laporan-rl52?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}&ruanganfk=${ruangan}`)
...
const exportExcel = () => {
    ...
    const worksheetData = [
    ['Daftar RL 5.3 10 BESAR KUNJUNGAN PENYAKIT RAWAT JALAN'],
    [],
    [
      'NO',
      'Kelompok ICD-10',
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, '10 Besar Penyakit Rawat Jalan');
    XLSXStyle.writeFile(workbook, 'RL 5.3 10 Besar Kunjungan Penyakit Rawat Jalan.xlsx');
};
