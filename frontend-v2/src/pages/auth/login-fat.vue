...
<template>
  <div class="modern-login" :style="isMobile && !showLogin?
    'margin-top: -50px; background: #D8E938;':''">
            ...
            <div class="container">
              <div class="columns">
                <div class="column">
                  ...
                  <!-- <img class="hero-image" src="/@src/assets/illustrations/login/Logo-rs-fatmawati.png" alt=""  -->
                  <img class="hero-image" src="/@src/assets/illustrations/login/login.svg" alt="" 
                  style="
    position: relative;
    z-index: 2;
        ...
        <div class="hero is-image" style="margin-top:50px;">
          <div class="hero-body">
            <div class="container">
              <div class="columns">
                <div class="column">
                  <!-- <img class="hero-image" src="/@src/assets/illustrations/login/logo.svg" alt=""  -->
                  <img class="hero-image" src="/@src/assets/illustrations/login/login.jpeg" alt="" 
...
"/>
    ...
    width: 100%;" /> -->
      ...
      <div class="column is-4 is-relative">
        ...
        <label class="dark-mode ml-auto" tabindex="0" style="
    margin-top: -50px;"
          @keydown.space.prevent="(e) => (e.target as HTMLLabelElement).click()">
          <input type="checkbox" :checked="!darkmode.isDark" @change="darkmode.onChange" />
          <span></span>
