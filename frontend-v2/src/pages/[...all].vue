...
const { t } = useI18n()
const title = ref("We couldn't find that page")
onMounted(() => {
  /**
  ...
  if(route.path.indexOf('denied') > -1){
    title.value = 'Anda tidak memiliki akses ke halaman ini'
  }
})
  ...
  <MinimalLayout>
    ...
    <div class="error-wrapper">
      <div class="error-inner has-text-centered">
        ...
        <p>
         Silakan coba lagi atau hubungi administrator jika masalah masih berlanjut
        </p>
        <div class="button-wrap">
          <VButton color="primary" elevated rounded :to="{ name: 'index' }">
            <!-- <VButton color="primary" elevated rounded @click="back"> -->
           Ke Halaman Utama
          </VButton>
        </div>
      </div>
